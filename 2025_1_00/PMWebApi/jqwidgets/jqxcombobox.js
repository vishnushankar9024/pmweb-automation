...
(function (a) {
    ...
    a.extend(a.jqx._jqxComboBox.prototype, {
        ...
        createInstance: function (b) {
            ...
            a.jqx.aria(this);
            if (e.isMaterialized()) {
                var g = window.getComputedStyle(this.element);
                var f = g.getPropertyValue("--jqx-dropdown-animation");
                var d = g.getPropertyValue("--jqx-list-item-height");
                var c = g.getPropertyValue("--jqx-action-button-size");
                if (c) {
                    this.arrowSize = parseInt(c);
                }
                if (f && this.animationType == "default") {
                    this.animationType = f.trim();
                }
                if (d && this.itemHeight === -1) {
                    this.itemHeight = parseInt(d);
                }
            }
            if (this.promptText != "") {
        ...
        render: function () {
            ...
            i.dropdownlistContent.append(
                a('<input autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="box-sizing: border-box; margin: 0; padding: 0; padding-left: 3px; padding-right: 3px; border: 0;" type="textarea"/>')
            );
            ...
            try {
                ...
                l.addClass(i.toThemeProperty("jqx-listbox-container"));
                i.container = l;
                ...
                if (i.dropDownContainer == "element") {
                    i.listBoxContainer.css({ position: "absolute", top: 0, left: 0 });
                } else {
                    i.listBoxContainer.css({ position: "absolute", zIndex: i.popupZIndex, top: 0, left: 0 });
                }
                ...
                i.addHandler(i.listBoxContainer, "unselect", function (e) {
                    if (!i.multiSelect) {
                        i._raiseEvent("3", { index: e.args.index, type: e.args.type, item: e.args.item });
                    }
                });
                i.addHandler(i.listBoxContainer, "change", function (e) {
                    if (!i.multiSelect) {
                        i.selectedIndex = i.listBox.selectedIndex;
                        i._raiseEvent("4", { index: e.args.index, type: e.args.type, item: e.args.item });
                    }
                });
        ...
        _search: function (d) {
            ...
            var k = i.input.val();
            if (d.keyCode == -1000 && i.searchString == "") {
            ...
            if (i.remoteAutoComplete) {
                ...
                if (k.length >= i.minLength) {
                    if (!d.ctrlKey && !d.altKey) {
                        if ((i.searchString != k)|| (d.keyCode == -1000 && i.searchString == "")) {
                            var c = i.listBoxContainer.jqxListBox("source");
                            if (c == null) {
                                i.listBoxContainer.jqxListBox({ source: i.source });
                            }
                            if (i._searchTimer) {
                    ...
                    i.searchString = "";
                    i.search("");
                    i.listBoxContainer.jqxListBox({ source: null });
                }
                return;
            }
            var i = this;
        ...
        _setSize: function () {
            ...
            if (g) {
                ...
                this.listBoxContainer.jqxListBox({ width: d });
        ...
        _updateHandlers: function () {
                    ...
                    if (!e.isanimating) {
                        if (f) {
                            ...
                            if (e.autoDropDownHeight) {
                                ...
                                if (!g) {
                                    e.listBoxContainer.jqxListBox({ autoHeight: e.autoDropDownHeight });
                                    e.listBox._arrange();
            ...
            this.addHandler(a(document), "mousedown." + this.id, e.closeOpenedListBox, { that: this, listbox: this.listBox, id: this.id });
            if (this.touch) {
                this.addHandler(a(document), a.jqx.mobile.getTouchEventName("touchstart") + "." + this.id, e.closeOpenedListBox, { that: this, listbox: this.listBox, id: this.id });
            }
            this.addHandler(this.host, "keydown", function (k) {
                ...
                if (k.keyCode == "13" || k.keyCode == "9") {
                    if (h && !e.isanimating) {
                        ...
                        if (!e.keyboardSelection) {
                            e._raiseEvent("2", { index: e.selectedIndex, type: "keyboard", item: e.getItem(e.selectedIndex) });
                        }
                        if (k.keyCode == "9") {
                            return true;
                        }
                ...
                if (g === 8 && e.multiSelect) {
                    if (e.input.val().length === 0) {
                        ...
                        if (i) {
                            e._raiseEvent("3", { index: i.index, type: "keyboard", item: i });
                            e._raiseEvent("4", { index: i.index, type: "keyboard", item: i });
                        }
                        e.listBox.selectedValue = null;
                        e.doMultiSelect();
                        return false;
            ...
            this.addHandler(this.listBoxContainer, "checkChange", function (f) {
                ...
                e._raiseEvent(5, { label: f.args.label, value: f.args.value, checked: f.args.checked, item: f.args.item });
            });
            this.addHandler(this.listBoxContainer, "select", function (f) {
                if (!e.disabled) {
                    if (f.args.type != "keyboard" || e.keyboardSelection) {
                        ...
                        if (!e.multiSelect) {
                            e._raiseEvent("2", { index: f.args.index, type: f.args.type, item: f.args.item });
                        }
        ...
        showListBox: function (n) {
            ...
            if (this.dropDownWidth == "auto" && this.width != null && this.width.indexOf && this.width.indexOf("%") != -1) {
                if (this.listBox.host.width() != this.host.width()) {
                    ...
                    this.listBoxContainer.jqxListBox({ width: u });
            ...
            if (this.dropDownWidth == "auto" && this.host.css("border-left-width") === "0px") {
                var u = this.element.offsetWidth;
                this.listBoxContainer.jqxListBox({ width: u + 1 });
                this.container.width(parseInt(u) + 25);
            }
            var j = this;
            ...
            if (this.enableBrowserBoundsDetection) {
                var k = this.testOffset(h, { left: parseInt(this.container.css("left")), top: parseInt(p) }, parseInt(this.host.outerHeight()));
            ...
            h.addClass(this.toThemeProperty("jqx-popup-show"));
        },
            ...
            a.each(this.selectedItems, function (l) {
                ...
                if (n) {
                    ...
                    if (e.showCloseButtons) {
                        var m =
                            '<div style="position: relative; overflow: hidden; float: ' +
                            o +
                            ...
                            e.toThemeProperty("jqx-icon-close") +
                            '"></div></div>';
                        if (a.jqx.browser.msie && a.jqx.browser.version < 8) {
                            m =
                                '<div style="position: relative; overflow: hidden; float: left; min-height: 16px; min-width: 18px;"><div style="position: absolute; left: 100%; top: 50%; margin-left: -18px; margin-top: -7px; float: none; width: 16px; height: 16px;" class="' +
                                e.toThemeProperty("jqx-icon-close") +
                                '"></div></div>';
                        }
                        if (e.rtl) {
                            ...
                            if (a.jqx.browser.msie && a.jqx.browser.version < 8) {
                                m =
                                    '<div style="position: relative; overflow: hidden; float: left; min-height: 16px; min-width: 18px;"><div style="position: absolute; left: 0px; top: 50%; margin-top: -7px; float: none; width: 16px; height: 16px;" class="' +
                                    e.toThemeProperty("jqx-icon-close") +
                                    '"></div></div>';
                            }
                        }
        ...
        propertyChangedHandler: function (e, k, c, j) {
            ...
            if (k == "autoItemsHeight") {
                e.listBoxContainer.jqxListBox({ autoItemsHeight: j });
            }
            if (k == "itemHeight") {
                e.listBoxContainer.jqxListBox({ itemHeight: j });
            }
            if (k == "renderSelectedItem") {
                e.renderSelection("mouse");
            }
            if (k == "renderer") {
                e.listBoxContainer.jqxListBox({ renderer: j });
            }
            if (k == "enableSelection") {
                e.listBoxContainer.jqxListBox({ enableSelection: j });
            }
            if (k == "enableHover") {
                e.listBoxContainer.jqxListBox({ enableHover: j });
            }
            if (k === "touchMode") {
                e.listBoxContainer.jqxListBox({ touchMode: j });
            ...
            if (k == "popupZIndex") {
                e.listBoxContainer.css({ zIndex: e.popupZIndex });
            }
            if (k == "promptText") {
                e.placeHolder = j;
            }
            ...
            if (k == "source") {
                e.input.val("");
                e.listBoxContainer.jqxListBox({ source: e.source });
                e.renderSelection("mouse");
                if (e.source == null) {
                    e.clearSelection();
                }
            ...
            if (k == "rtl") {
                ...
                e.listBoxContainer.jqxListBox({ rtl: e.rtl });
            }
            if (k == "displayMember" || k == "valueMember") {
                e.listBoxContainer.jqxListBox({ displayMember: e.displayMember, valueMember: e.valueMember });
                e.renderSelection("mouse");
            }
            ...
            if (k == "dropDownWidth" || k == "scrollBarSize") {
                ...
                e.listBoxContainer.jqxListBox({ width: b, scrollBarSize: e.scrollBarSize });
            ...
            if (k == "checkboxes") {
                e.listBoxContainer.jqxListBox({ checkboxes: e.checkboxes });
                if (e.checkboxes) {
            ...
            if (k == "theme" && j != null) {
                e.listBoxContainer.jqxListBox({ theme: j });
            ...
            if (k == "width" || k == "height") {
                ...
                if (k == "width") {
                    if (e.dropDownWidth == "auto") {
                        var b = e.host.width();
                        e.listBoxContainer.jqxListBox({ width: b });
                        e.container.width(parseInt(b) + 25);
                    }
                }
                e._arrange();
