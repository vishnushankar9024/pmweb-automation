...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        <script language="javascript" type="text/javascript">
            ...
            function maintoolbarClick(Value) {
                ...
                switch (Value) {
                    //case 'Test':
                    //    OpenPOPUp('EstimateAssembliesSelect.aspx?Source=Assembly', 900, 500, true);
                    //    break;
    ...
    <table style="width: 100%;" cellpadding="0" cellspacing="0" class="ToolBar LargeToolBar">
        <tr valign="top">
                        ...
                        <td class="ToolbarTd">
                            <asp:LinkButton runat="server" ID="btnSearchDocument" PostBackUrl="SearchDocument.aspx?O=4">
                                            <div class="btnToolbarSearchDocument">
                                                &nbsp; 
                                            </div>
                            </asp:LinkButton>
                        </td>
                        <td class="ToolbarTd HideOnMobileToolbar Recent showOnIpad">
                        ...
                        <td class="ToolbarTd">
                            ...
                            <%--<telerik:RadToolBarButton SecurityButtonType="Read" CommandName="TreeSearch" ImageUrl="Images/ToolBar/Tree.png"
                                        Value="Search" NavigateUrl="AssembliesSearch.aspx" CausesValidation="false">
                                    </telerik:RadToolBarButton>--%>
                        </td>
                        <td style="width: 240px" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                            <telerik:RadComboBox ID="ddlAssemblies" runat="server" Skin="Default" OnClientTextChange="LOD_DropDownTextChange"
                                Filter="Contains" EmptyMessage="Select Assembly..." Width="240px" Height="400px"
                                AutoPostBack="True" AllowCustomText="True" CausesValidation="False" NoWrap="True"
                                LoadingMessage="<%$ Resources:PMWeb, Loading %>" meta:resourcekey="ddlAssemblies"
                                EnableLoadOnDemand="True" ShowMoreResultsBox="True" EnableVirtualScrolling="True" MarkFirstMatch="True"
                                OnItemsRequested="ddlAssemblies_ItemsRequested" CheckForDirt="True">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="controlWidth">
                                                            ...
                                                            <asp:RequiredFieldValidator ID="rfvDescription" runat="server" ControlToValidate="txtDescription" ValidationGroup="Save"
                                                                CssClass="Validator" Display="Dynamic" ForeColor="" meta:resourcekey="rfvDescription"></asp:RequiredFieldValidator>
                                                        </td>
                                                ...
                                                <fieldset>
                                                    ...
                                                    <table class="colTable">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="controlWidth">
                                                                <telerik:RadComboBox ID="ddlBidCategories" runat="server" Width="100%" Skin="Default" AllowCustomText="true" Filter="Contains" MarkFirstMatch="true">
                                                                    <CollapseAnimation Duration="200" Type="OutQuint" />
                                                                </telerik:RadComboBox>
                                                            </td>
                                                        </tr>
