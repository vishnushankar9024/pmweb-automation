<%@ Page Language="vb" AutoEventWireup="false" meta:resourcekey="Page" CodeBehind="OCRCEPopup.aspx.vb" Inherits="Website.OCRCEPopup" %>
                    ...
                    <table class="colTable" style="width: 400px">
                        <tr>
                            ...
                            <td class="controlWidth">
                                <asp:TextBox ID="txtProject" runat="server" Enabled="false" Text="" Width="100%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="labelWidth">
                            ...
                            <td class="controlWidth">
                                <asp:TextBox ID="txtCompany" runat="server" Enabled="false" Text="" Width="100%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="labelWidth">
                                <asp:Label ID="lblCENumber" runat="server" meta:resourcekey="lblCENumber" Text="Change Event #"></asp:Label>
                            </td>
                            <td class="controlWidth">
                                <asp:TextBox ID="txtChangeEventNumber" runat="server" Enabled="false" ReadOnly="true" Width="100%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="labelWidth">
                            ...
                            <td class="controlWidth">
                                <asp:TextBox ID="txtDescription" Enabled="false" runat="server" Width="100%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="labelWidth">
                                <asp:Label ID="lblEffectiveDate" runat="server" meta:resourcekey="lblEffectiveDate" Text="Effective Date"></asp:Label>
                            </td>
                            <td class="controlWidth">
                                <asp:TextBox ID="txtEffectiveDate" Enabled="false" runat="server" ReadOnly="true" Width="100%" style="text-align:right"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                ...
                                <telerik:GridTableView SkinID="PM" ShowHeader="True" ShowStatusBar="false" CommandItemDisplay="None"
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="<%$Resources: GridColumn_UnitCost %>" UniqueName="UnitCost"
                                            ...
                                            <ItemTemplate>
                                                <%#FormatCurrency(Eval("UnitCost"), CurrencyId:=Container.DataItem("CurrencyId"))%>
                                            </ItemTemplate>
                                            <HeaderStyle Width="90px"></HeaderStyle>
                                            <ItemStyle CssClass="Right" />
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn HeaderText="<%$Resources: GridColumn_TotalCost %>" UniqueName="TotalCost"
                                            ...
                                            <ItemTemplate>
                                                <%#FormatCurrency(Eval("TotalCost"), CurrencyId:=Container.DataItem("CurrencyId"))%>
                                            </ItemTemplate>
                                            <HeaderStyle Width="90px"></HeaderStyle>
                                            <ItemStyle CssClass="Right" />
                                        </telerik:GridTemplateColumn>
