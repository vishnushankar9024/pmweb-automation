...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0">
        <tr class="ToolBar SmallToolbar">
            <td class="ToolbarTd">
                <asp:LinkButton runat="server" ID="btnSearchDocument" PostBackUrl="SearchDocument.aspx?O=87">
                    ...
                    <Items>
                        ...
                        <telerik:RadToolBarSplitButton ImageUrl="Images/ToolBar/NewDoc.png" CommandName="New"
                            ...
                            <Buttons>
                                ...
                                <telerik:RadToolBarButton SecurityButtonType="Copy" Width="150px" CommandName="Copy" Value="CopyRecord" ImageUrl="Images/ToolBar/CopyRecord.png">
                                </telerik:RadToolBarButton>
                        ...
                        <div class="col-4 col-4-left ">
                            <table class="colTable">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlSource" runat="server" Skin="Default" AllowCustomText="true" Filter="Contains" MarkFirstMatch="true"
