        ...
        <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
            ...
            <Columns>
                <telerik:GridTemplateColumn HeaderText="Document Id" UniqueName="DocumentId" Groupable="false" Reorderable="true"
                    SortExpression="RecordNumber" meta:resourcekey="GridColumn_DocumentId" CurrentFilterFunction="EqualTo" DataField="DocumentId" DataType="System.Int64" FilterListOptions="VaryByDataType">
                    <ItemTemplate>
                        <a href='<%#Container.DataItem("MainPage") & "&Workflow=O" %>'>
