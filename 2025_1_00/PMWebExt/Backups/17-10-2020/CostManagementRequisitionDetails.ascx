<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="CostManagementRequisitionDetails.ascx.vb" Inherits="Website.CostManagementRequisitionDetails" %>
    ...
    <div class="row">
        <div class="col-12 ResponsiveMargin">
            <telerik:RadGrid ID="rdgRequisitionDetails" AllowMultiRowSelection="true" runat="server" ShowGroupPanel="true"
                ...
                AutoGenerateColumns="False" AllowMultiRowEdit="true" AllowSorting="true" ShowStatusBar="true" AllowPaging="true" PageSize="10"
                FilterType="HeaderContext" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true" UseEditFormInMobile="true">
                <PagerStyle Mode="NextPrevAndNumeric"
                    AlwaysVisible="true" />
                <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>" AllowFilteringByColumn="true"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Currency" UniqueName="Currency" SortExpression="Currency"
                            GroupByExpression="Currency [GridColumn_Currency] Group By Currency" DataField="Currency" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                                <span>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Scheduled<br/>Quantity" UniqueName="ScheduledQuantity"
                            ...
                            <ItemTemplate>
                                <div id='<%# "Detail_" & Eval("DetailId").tostring()%>' oncontextmenu="contextM(this,event)" style="width: 100%; height: 100%;">
                                    <span style="float: right"><%# FormatNumber(Container.DataItem("ScheduledQuantity"))%></span>&nbsp;
                                </div>
                            </ItemTemplate>
                            <EditItemTemplate>
                                ...
                                <asp:TextBox ID="txtScheduledQuantity" runat="server" Width="100%" CssClass="Double"
                                    MaxLength="15" Text='<%#FormatNumber(IIF(Eval("ScheduledQuantity") is system.DBNULL.value, "1", Eval("ScheduledQuantity"))) %>'></asp:TextBox>
                            </EditItemTemplate>
                            <%--   <FooterTemplate>
                    <asp:Label ID="lblSumScheduledQuantity" runat="server"></asp:Label> 
                        ...
                        <telerik:GridTemplateColumn HeaderText="Unit Price" UniqueName="UnitCost"
                            SortExpression="UnitCost" Groupable="false" DataField="UnitCost"
                            CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                                <span><%#FormatCurrency(Container.DataItem("UnitCost"), CurrencyId:=Eval("CurrencyId"))%></span>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:Label ID="lblUnitPrice" runat="server" Width="100%" CssClass="Currency"
                                    Text='<%#FormatCurrency(Eval("UnitCost"), CurrencyId:=IIf(Eval("CurrencyId") Is DBNull.Value, 0, Eval("CurrencyId")))%>'></asp:Label>
                                <asp:TextBox ID="txtUnitPrice" CssClass="Currency" runat="server" Width="100%" MaxLength="15"
                    ...
                    <asp:Label ID="lblSumPriorQuantity" runat="server"></asp:Label> 
                        ...
                        <telerik:GridTemplateColumn HeaderText="Current<br/>Quantity" Groupable="false" DataField="CurrentQuantity" Aggregate="Sum" FooterAggregateFormatString="{0:F6}"
                            UniqueName="CurrentQuantity" SortExpression="CurrentQuantity" CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                    ...
                    <asp:Label ID="lblSumCurrentQuantity" runat="server"></asp:Label>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Total<br/>Quantity" Groupable="false" DataField="TotalQuantity" Aggregate="Sum" FooterAggregateFormatString="{0:F6}"
                            UniqueName="TotalQuantity" SortExpression="TotalQuantity" CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                    ...
                    <asp:Label ID="lblSumTotalQuantity" runat="server"></asp:Label> 
                        ...
                        <telerik:GridTemplateColumn HeaderText="% Complete" Groupable="false"
                            UniqueName="PctComplete" SortExpression="PctComplete" DataField="PctComplete" CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn Groupable="false"
                            HeaderText="Scheduled<br/>Value" UniqueName="ScheduledValue" DataField="ScheduledValue"
                            SortExpression="ScheduledValue" CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                            ...
                            <EditItemTemplate>
                                ...
                                <asp:TextBox ID="txtScheduledValue" CssClass="Currency" runat="server" Width="100%" MaxLength="15"
                                    Text='<%#FormatCurrency(Eval("ScheduledValue"), CurrencyId:=IIf(Eval("CurrencyId") Is DBNull.Value, 0, Eval("CurrencyId")))%>'></asp:TextBox>
                            </EditItemTemplate>
                            <%-- <FooterTemplate>
                    <asp:Label ID="lblSumScheduledValue" runat="server"></asp:Label> 
                        ...
                        <telerik:GridTemplateColumn Groupable="false"
                            HeaderText="Prior<br/>Invoices" UniqueName="PriorInvoices" DataField="PriorInvoices"
                            SortExpression="PriorInvoices" CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                    ...
                    <asp:Label ID="lblSumPriorInvoices" runat="server"></asp:Label> 
                        ...
                        <telerik:GridTemplateColumn Groupable="false"
                            HeaderText="Current<br/>Invoice" UniqueName="CurrentInvoice" DataField="CurrentInvoice"
                            SortExpression="CurrentInvoice" CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                    ...
                    <asp:Label ID="lblSumCurrentInvoice" runat="server"></asp:Label>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Prior Stored<br/>Material" GroupByExpression="PriorStoredMaterial [GridColumn_PriorStoredMaterial] Group By PriorStoredMaterial ASC"
                            UniqueName="PriorStoredMaterial" SortExpression="PriorStoredMaterial" DataField="PriorStoredMaterial"
                            CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                                <span><%#FormatCurrency(Container.DataItem("PriorStoredMaterial"), CurrencyId:=Eval("CurrencyId"))%></span>
                            </ItemTemplate>
                            <EditItemTemplate>
                    ...
                    <asp:Label ID="lblSumStoredMaterial" runat="server"></asp:Label> 
                        ...
                        <telerik:GridTemplateColumn Groupable="false" DataField="TotalThisInvoice"
                            HeaderText="Total This<br/>Invoice" UniqueName="TotalThisInvoice"
                            SortExpression="TotalThisInvoice" CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                    ...
                    <asp:Label ID="lblSumTotalThisInvoice" runat="server"></asp:Label>
                        ...
                        <telerik:GridTemplateColumn Groupable="false"
                            HeaderText="Total<br/>Invoiced" UniqueName="TotalInvoiced" DataField="TotalInvoiced"
                            SortExpression="TotalInvoiced" CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                    ...
                    <asp:Label ID="lblSumTotalInvoiced" runat="server"></asp:Label>
                        ...
                        <telerik:GridTemplateColumn Groupable="false" DataField="BalanceToInvoice"
                            HeaderText="Balance to<br/>Invoice" UniqueName="BalanceToInvoice"
                            SortExpression="BalanceToInvoice" CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                    ...
                    <asp:Label ID="lblSumBalanceToInvoice" runat="server"></asp:Label> 
                        ...
                        <telerik:GridTemplateColumn HeaderText="Services<br/>Retain %" UniqueName="PctServicesRetain"
                            SortExpression="PctServicesRetain" Groupable="false" DataField="PctServicesRetain" CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                    ...
                    <asp:Label ID="lblSumServicesRetainAmount" runat="server"></asp:Label> 
                        ...
                        <telerik:GridTemplateColumn HeaderText="Materials<br/>Retain %" UniqueName="PctMaterialsRetain"
                            SortExpression="PctMaterialsRetain" Groupable="false" DataField="PctMaterialsRetain" CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Prior Materials <br/>Retain Amount" GroupByExpression="PriorMaterialsRetainAmount [GridColumn_PriorMaterialsRetainAmount] Group By PriorMaterialsRetainAmount ASC" UniqueName="PriorMaterialsRetainAmount"
                            ...
                            <ItemTemplate>
                                <span><%#FormatCurrency(Container.DataItem("PriorMaterialsRetainAmount"), CurrencyId:=Eval("CurrencyId"))%></span>
                            </ItemTemplate>
                            <EditItemTemplate>
                    ...
                    <asp:Label ID="lblSumMaterialsRetainAmount" runat="server"></asp:Label> 
                        ...
                        <telerik:GridTemplateColumn HeaderText="Total<br/>Retained" UniqueName="TotalRetained"
                            SortExpression="TotalRetained" Groupable="false" DataField="TotalRetained"
                            CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
            ...
            <span class="Icon"></span>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Adjustment 1 Converted" Visible="false" UniqueName="Adjustment1Converted" ItemStyle-HorizontalAlign="Right"
                            SortExpression="Adjustment1Converted" DataField="Adjustment1Converted" Aggregate="Sum" FooterAggregateFormatString="{0:F6}"
                            CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Tax Converted" Visible="false" UniqueName="TaxConverted" ItemStyle-HorizontalAlign="Right"
                            SortExpression="TaxConverted" DataField="TaxConverted" Aggregate="Sum" FooterAggregateFormatString="{0:F6}"
                            CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Adjustment 2 Converted" Visible="false" UniqueName="Adjustment2Converted" ItemStyle-HorizontalAlign="Right"
                            SortExpression="Adjustment2Converted" DataField="Adjustment2Converted" Aggregate="Sum" FooterAggregateFormatString="{0:F6}"
                            CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Unit Price Converted" Visible="false" UniqueName="UnitCostConverted" ItemStyle-HorizontalAlign="Right"
                            SortExpression="UnitCostConverted" DataField="UnitCostConverted" Aggregate="Sum" FooterAggregateFormatString="{0:F6}"
                            CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Scheduled Value Converted" Visible="false" UniqueName="ScheduledValueConverted" ItemStyle-HorizontalAlign="Right"
                            SortExpression="ScheduledValueConverted" DataField="ScheduledValueConverted" Aggregate="Sum" FooterAggregateFormatString="{0:F6}"
                            CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                                <asp:Label Text='<%#FormatCurrency(Eval("ScheduledValueConverted"), CurrencyId:=Container.DataItem("CurrencyId"))%>' runat="server" ID="lblScheduledValueConverted" />
                            </ItemTemplate>
                            <EditItemTemplate>
                                &nbsp;
                            </EditItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Prior Invoices Converted" Visible="false" UniqueName="PriorInvoicesConverted" ItemStyle-HorizontalAlign="Right"
                            SortExpression="PriorInvoicesConverted" DataField="PriorInvoicesConverted" Aggregate="Sum" FooterAggregateFormatString="{0:F6}"
                            CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                                <asp:Label Text='<%#FormatCurrency(Eval("PriorInvoicesConverted"), CurrencyId:=Container.DataItem("CurrencyId"))%>' runat="server" ID="lblPriorInvoicesConverted" />
                            </ItemTemplate>
                            <EditItemTemplate>
                                &nbsp;
                            </EditItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Current Invoice Converted" Visible="false" UniqueName="CurrentInvoiceConverted" ItemStyle-HorizontalAlign="Right"
                            SortExpression="CurrentInvoiceConverted" DataField="CurrentInvoiceConverted" Aggregate="Sum" FooterAggregateFormatString="{0:F6}"
                            CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                                <asp:Label Text='<%#FormatCurrency(Eval("CurrentInvoiceConverted"), CurrencyId:=Container.DataItem("CurrencyId"))%>' runat="server" ID="lblCurrentInvoiceConverted" />
                            </ItemTemplate>
                            <EditItemTemplate>
                                &nbsp;
                            </EditItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Prior Stored Material Converted" Visible="false" UniqueName="PriorStoredMaterialConverted" ItemStyle-HorizontalAlign="Right"
                            SortExpression="PriorStoredMaterialConverted" DataField="PriorStoredMaterialConverted" Aggregate="Sum" FooterAggregateFormatString="{0:F6}"
                            CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                                <asp:Label Text='<%#FormatCurrency(Eval("PriorStoredMaterialConverted"), CurrencyId:=Container.DataItem("CurrencyId"))%>' runat="server" ID="lblPriorStoredMaterialConverted" />
                            </ItemTemplate>
                            <EditItemTemplate>
                                &nbsp;
                            </EditItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Current Stored Material Converted" Visible="false" UniqueName="CurrentStoredMaterialConverted" ItemStyle-HorizontalAlign="Right"
                            SortExpression="CurrentStoredMaterialConverted" DataField="CurrentStoredMaterialConverted" Aggregate="Sum" FooterAggregateFormatString="{0:F6}"
                            CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                                <asp:Label Text='<%#FormatCurrency(Eval("CurrentStoredMaterialConverted"), CurrencyId:=Container.DataItem("CurrencyId"))%>' runat="server" ID="lblCurrentStoredMaterialConverted" />
                            </ItemTemplate>
                            <EditItemTemplate>
                                &nbsp;
                            </EditItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Total Stored Material Converted" Visible="false" UniqueName="StoredMaterialConverted" ItemStyle-HorizontalAlign="Right"
                            SortExpression="StoredMaterialConverted" DataField="StoredMaterialConverted" Aggregate="Sum" FooterAggregateFormatString="{0:F6}"
                            CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                                <asp:Label Text='<%#FormatCurrency(Eval("StoredMaterialConverted"), CurrencyId:=Container.DataItem("CurrencyId"))%>' runat="server" ID="lblStoredMaterialConverted" />
                            </ItemTemplate>
                            <EditItemTemplate>
                                &nbsp;
                            </EditItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Total This Invoice Converted" Visible="false" UniqueName="TotalThisInvoiceConverted" ItemStyle-HorizontalAlign="Right"
                            SortExpression="TotalThisInvoiceConverted" DataField="TotalThisInvoiceConverted" Aggregate="Sum" FooterAggregateFormatString="{0:F6}"
                            CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                                <asp:Label Text='<%#FormatCurrency(Eval("TotalThisInvoiceConverted"), CurrencyId:=Container.DataItem("CurrencyId"))%>' runat="server" ID="lblTotalThisInvoiceConverted" />
                            </ItemTemplate>
                            <EditItemTemplate>
                                &nbsp;
                            </EditItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Total Invoiced Converted" Visible="false" UniqueName="TotalInvoicedConverted" ItemStyle-HorizontalAlign="Right"
                            SortExpression="TotalInvoicedConverted" DataField="TotalInvoicedConverted" Aggregate="Sum" FooterAggregateFormatString="{0:F6}"
                            CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                                <asp:Label Text='<%#FormatCurrency(Eval("TotalInvoicedConverted"), CurrencyId:=Container.DataItem("CurrencyId"))%>' runat="server" ID="lblTotalInvoicedConverted" />
                            </ItemTemplate>
                            <EditItemTemplate>
                                &nbsp;
                            </EditItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Balance To Invoice Converted" Visible="false" UniqueName="BalanceToInvoiceConverted" ItemStyle-HorizontalAlign="Right"
                            SortExpression="BalanceToInvoiceConverted" DataField="BalanceToInvoiceConverted" Aggregate="Sum" FooterAggregateFormatString="{0:F6}"
                            CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                                <asp:Label Text='<%#FormatCurrency(Eval("BalanceToInvoiceConverted"), CurrencyId:=Container.DataItem("CurrencyId"))%>' runat="server" ID="lblBalanceToInvoiceConverted" />
                            </ItemTemplate>
                            <EditItemTemplate>
                                &nbsp;
                            </EditItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Prior Services Retain Amount Converted" Visible="false" UniqueName="PriorServicesRetainAmountConverted" ItemStyle-HorizontalAlign="Right"
                            SortExpression="PriorServicesRetainAmountConverted" DataField="PriorServicesRetainAmountConverted" Aggregate="Sum" FooterAggregateFormatString="{0:F6}"
                            CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                                <asp:Label Text='<%#FormatCurrency(Eval("PriorServicesRetainAmountConverted"), CurrencyId:=Container.DataItem("CurrencyId"))%>' runat="server" ID="lblPriorServicesRetainAmountConverted" />
                            </ItemTemplate>
                            <EditItemTemplate>
                                &nbsp;
                            </EditItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Current Services Retain Amount Converted" Visible="false" UniqueName="CurrentServicesRetainAmountConverted" ItemStyle-HorizontalAlign="Right"
                            SortExpression="CurrentServicesRetainAmountConverted" DataField="CurrentServicesRetainAmountConverted" Aggregate="Sum" FooterAggregateFormatString="{0:F6}"
                            CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                                <asp:Label Text='<%#FormatCurrency(Eval("CurrentServicesRetainAmountConverted"), CurrencyId:=Container.DataItem("CurrencyId"))%>' runat="server" ID="lblCurrentServicesRetainAmountConverted" />
                            </ItemTemplate>
                            <EditItemTemplate>
                                &nbsp;
                            </EditItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Total Services Retain Amount Converted" Visible="false" UniqueName="ServicesRetainAmountConverted" ItemStyle-HorizontalAlign="Right"
                            SortExpression="ServicesRetainAmountConverted" DataField="ServicesRetainAmountConverted" Aggregate="Sum" FooterAggregateFormatString="{0:F6}"
                            CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                                <asp:Label Text='<%#FormatCurrency(Eval("ServicesRetainAmountConverted"), CurrencyId:=Container.DataItem("CurrencyId"))%>' runat="server" ID="lblServicesRetainAmountConverted" />
                            </ItemTemplate>
                            <EditItemTemplate>
                                &nbsp;
                            </EditItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Prior Materials Retain Amount Converted" Visible="false" UniqueName="PriorMaterialsRetainAmountConverted" ItemStyle-HorizontalAlign="Right"
                            SortExpression="PriorMaterialsRetainAmountConverted" DataField="PriorMaterialsRetainAmountConverted" Aggregate="Sum" FooterAggregateFormatString="{0:F6}"
                            CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                                <asp:Label Text='<%#FormatCurrency(Eval("PriorMaterialsRetainAmountConverted"), CurrencyId:=Container.DataItem("CurrencyId"))%>' runat="server" ID="lblPriorMaterialsRetainAmountConverted" />
                            </ItemTemplate>
                            <EditItemTemplate>
                                &nbsp;
                            </EditItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Current Materials Retain Amount Converted" Visible="false" UniqueName="CurrentMaterialsRetainAmountConverted" ItemStyle-HorizontalAlign="Right"
                            SortExpression="CurrentMaterialsRetainAmountConverted" DataField="CurrentMaterialsRetainAmountConverted" Aggregate="Sum" FooterAggregateFormatString="{0:F6}"
                            CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                                <asp:Label Text='<%#FormatCurrency(Eval("CurrentMaterialsRetainAmountConverted"), CurrencyId:=Container.DataItem("CurrencyId"))%>' runat="server" ID="lblCurrentMaterialsRetainAmountConverted" />
                            </ItemTemplate>
                            <EditItemTemplate>
                                &nbsp;
                            </EditItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Total Materials Retain Amount Converted" Visible="false" UniqueName="MaterialsRetainAmountConverted" ItemStyle-HorizontalAlign="Right"
                            SortExpression="MaterialsRetainAmountConverted" DataField="MaterialsRetainAmountConverted" Aggregate="Sum" FooterAggregateFormatString="{0:F6}"
                            CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                                <asp:Label Text='<%#FormatCurrency(Eval("MaterialsRetainAmountConverted"), CurrencyId:=Container.DataItem("CurrencyId"))%>' runat="server" ID="lblMaterialsRetainAmountConverted" />
                            </ItemTemplate>
                            <EditItemTemplate>
                                &nbsp;
                            </EditItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Total Retained Converted" Visible="false" UniqueName="TotalRetainedConverted" ItemStyle-HorizontalAlign="Right"
                            SortExpression="TotalRetainedConverted" DataField="TotalRetainedConverted" Aggregate="Sum" FooterAggregateFormatString="{0:F6}"
                            CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                                <asp:Label Text='<%#FormatCurrency(Eval("TotalRetainedConverted"), CurrencyId:=Container.DataItem("CurrencyId"))%>' runat="server" ID="lblTotalRetainedConverted" />
                            </ItemTemplate>
                            <EditItemTemplate>
                                &nbsp;
                            </EditItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Current Total Converted" Visible="false" UniqueName="CurrentPaymentConverted" ItemStyle-HorizontalAlign="Right"
                            SortExpression="CurrentPaymentConverted" DataField="CurrentPaymentConverted" Aggregate="Sum" FooterAggregateFormatString="{0:F6}"
                            CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                                <asp:Label Text='<%#FormatCurrency(Eval("CurrentPaymentConverted"), CurrencyId:=Container.DataItem("CurrencyId"))%>' runat="server" ID="lblCurrentPaymentConverted" />
                            </ItemTemplate>
                            <EditItemTemplate>
                                &nbsp;
                            </EditItemTemplate>
                    ...
                    <CommandItemTemplate>
                        <div style="padding: 2px">
                            ...
                            <asp:LinkButton ID="btnCancel" runat="server" CausesValidation="False" CommandName="CancelAll" CssClass="GridCmdCancelAll"
                                Visible='<%# rdgRequisitionDetails.EditIndexes.Count > 0 Or rdgRequisitionDetails.MasterTableView.IsItemInserted %>'
                            ...
                            <asp:LinkButton ID="btnPctComplete" runat="server"
                                SecurityButtonType="ItemMode" CausesValidation="False" CommandName="PctComplete" CssClass="GridCmdPctComplete"
                                Visible='<%# rdgRequisitionDetails.EditIndexes.Count = 0 And (Not rdgRequisitionDetails.MasterTableView.IsItemInserted)%>' ToolTip="% Complete From Schedule">
                                <span class="Icon"></span>
                            ...
                            <asp:LinkButton ID="lnkPreviewConversion" runat="server" CausesValidation="False" CommandName="PreviewConversion" CssClass="GridCmdPreviewConversion"
                                ...
                                meta:resourcekey="btnRefreshResource1">
                                <span class="Icon"></span>
                                <asp:Label ID="Label6" runat="server" Text="Refresh" meta:resourcekey="lblRefreshResource1"></asp:Label>
                                &nbsp;&nbsp;
                            </asp:LinkButton>
                ...
                <ClientSettings ClientEvents-OnRowDeselected="ShowHideActualCostBtn" ClientEvents-OnRowSelected="ShowHideActualCostBtn" EnableRowHoverStyle="true" AllowColumnHide="true" AllowColumnsReorder="true" AllowDragToGroup="true" AllowRowsDragDrop="False"
                    ClientEvents-OnGridCreated="ShowHideActualCostBtn">
