...
<div class="PMHeader">
    <div class="row">
        <div class="col-12 ResponsiveMargin">
            <telerik:RadGrid ID="rdgPropertyFloors" runat="server"   HeaderStyle-Font-Size="8" CssClass="WithoutTopBorder"  SetWidth="true"  ClientSettings-Scrolling-AllowScroll="true"
