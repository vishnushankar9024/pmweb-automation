...
<%@ Register Src="DocumentSpecifications.ascx" TagName="DocumentSpecifications" TagPrefix="uc13" %>
<%--<%@ Register Src="DocumentInspections.ascx" TagName="DocumentInspection" TagPrefix="uc14" %>--%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ACPH1" runat="server">
    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        <script type="text/javascript">
                ...
                switch (Value) {
                    case 'ViewReports':
                        if (HasReports == 'True') {
                            ...
                            window.open("ReportsPreviewPopup.aspx?ObjectType=Equipment&Id=" +
                                        Id
            ...
            //        var comboBox = $find("<%= ddlLocations.ClientID %>");
            //        var node = args.get_node();
            //        var strText = "";
            //        var strValue = "";
            //        strValue = node.get_value();
            //        if (node._element.id.toString().indexOf(comboBox._element.id) == -1) {
            //            return false;
            //                }
    ...
    <table class="ToolBar SmallToolbar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:LinkButton runat="server" ID="btnSearchDocument" PostBackUrl="SearchDocument.aspx?O=38">
            ...
            <td style="width: 240px" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                <telerik:RadComboBox ID="ddlEquipments" runat="server"
                    CloseDropDownOnBlur="true" Visible="true"
                    Width="240px" AutoPostBack="False" NoWrap="true"
                    CausesValidation="False" Height="400px" OnClientSelectedIndexChanging="MainDropDown_SelectedIndexChanging"
            ...
            <td valign="middle" style="vertical-align: middle; width: 70%" class="ToolbarTd">
                <telerik:RadToolBar ID="mainToolBar" OnClientContextMenu="ContexMenu" runat="server" AutoPostBack="true">
                    <Items>
                        <%--<telerik:RadToolBarButton SecurityButtonType="Read" PostBackUrl="SearchDocument.aspx?O=38" CommandName="Search" ImageUrl="Images/ToolBar/lookup.png"
                    ...
                    <%--    <telerik:RadToolBarSplitButton ImageUrl="Images/ToolBar/NewDoc.png" CommandName="New"
                            ...
                            <Buttons>
                                <telerik:RadToolBarButton SecurityButtonType="Add" ImageUrl="Images/ToolBar/NewDoc.png" Width="150px" CommandName="New" AccessKey="n" ToolTip="New (Alt+n)" CausesValidation="false"></telerik:RadToolBarButton>
                            </Buttons>
    ...
    <div id="trMplDetails" runat="server">
        <telerik:RadMultiPage ID="mlpEquipments" runat="server" SelectedIndex="0"
                                ...
                                <table class="colTable" id="tblPredictiveMaintenance">
                                    ...
                                    <tr>
                                        ...
                                        <td class="controlWidth">
                                            <asp:TextBox runat="server" ID="txtEquipmentId" MaxLength="10" Text="10002ABC"></asp:TextBox>
            ...
            <%--  <telerik:RadPageView ID="pvDocumentInspections" runat="server">
                <uc14:DocumentInspection ID="DocumentInspection1" runat="server" />
            </telerik:RadPageView>--%>
