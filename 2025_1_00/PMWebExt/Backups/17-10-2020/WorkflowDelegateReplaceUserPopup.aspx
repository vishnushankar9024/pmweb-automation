    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        ...
        <script type="text/javascript">
            ...
            function OpenConfirmActivationPopup() {
                ...
                var wnd = window.radopen("WorkflowDelegateActivationPopup.aspx?UserDelegationId=" + userDelegationId + "&UserId=" + userId + "&FromSettings=" + WorkflowDelegateReplace_OpenFromSettings);
                if (browserWidth < 1024) {
                    wnd.setSize(browserWidth - 10, browserHeight);
                    wnd.moveTo(0, 0);
                }
                else {
                    wnd.setSize(450, browserHeight * 0.85);
                    wnd.Center();
                }
            ...
            <div class="row">
                <div class="col-12" runat="server" id="divGrid">
                    <telerik:RadGrid ID="rdgDelegates" UseEditFormInMobile="true" GroupingEnabled="true" runat="server" AutoGenerateColumns="False" FilterType="HeaderContext"
                        ...
                        PageSize="10" AllowPaging="true" ShowGroupPanel="True" AllowSorting="true" ShowStatusBar="true" ShowFooter="true"
