...
<telerik:RadAjaxManagerProxy ID="RadAjaxManager1" runat="server">
    <AjaxSettings>
        <telerik:AjaxSetting AjaxControlID="rdgAPPaymentApplication">
            ...
            <telerik:RadGrid ID="rdgAPPaymentApplication" runat="server"   AutoGenerateColumns="False" ShowFooter="true" AllowPaging="True" PageSize="20" AllowFilteringByColumn="true" FilterType ="HeaderContext" EnableHeaderContextMenu ="true" EnableHeaderContextFilterMenu="true"
