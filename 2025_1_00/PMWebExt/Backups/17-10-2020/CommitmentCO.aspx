...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <table style="width: 100% !important;" cellpadding="0" cellspacing="0" border="0">
        <tr class="ToolBar SmallToolbar">
            <td class="ToolbarTd">
                <asp:LinkButton runat="server" ID="btnSearchDocument" PostBackUrl="SearchDocument.aspx?O=55">
                        ...
                        <div class="col-4 col-4-middle">
                            <table class="colTable">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <asp:TextBox ID="txtDays" MaxLength="9" runat="server" CssClass="Double"></asp:TextBox>
                                            ...
                                            <table class="TableNoSpacingNoBorder">
                                                <tr>
                                                    ...
                                                    <td style="width: 40%; padding-left: 10px;">
                                                        <asp:TextBox ID="txtOriginalCommitmentAmountDays" CssClass="Double" runat="server"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td class="controlWidth">
                                            <table class="TableNoSpacingNoBorder">
                                                <tr>
                                                    ...
                                                    <td style="width: 40%; padding-left: 10px;">
                                                        <asp:TextBox ID="txtPriorAppChangesDays" CssClass="Double" runat="server"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td class="controlWidth">
                                            <table class="TableNoSpacingNoBorder">
                                                <tr>
                                                    ...
                                                    <td style="width: 40%; padding-left: 10px;">
                                                        <asp:TextBox ID="txtPriorRevContractDays" CssClass="Double" runat="server"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td class="controlWidth">
                                            <table class="TableNoSpacingNoBorder">
                                                <tr>
                                                    ...
                                                    <td style="width: 40%; padding-left: 10px;">
                                                        <asp:TextBox ID="txtTotalChangesDays" CssClass="Double" runat="server"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td class="controlWidth">
                                            <table class="TableNoSpacingNoBorder">
                                                <tr>
                                                    ...
                                                    <td style="width: 40%; padding-left: 10px;">
                                                        <asp:TextBox ID="txtContractChangeDays" CssClass="Double" runat="server"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
