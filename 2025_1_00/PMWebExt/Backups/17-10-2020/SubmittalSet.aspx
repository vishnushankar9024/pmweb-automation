...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <table class="ToolBar SmallToolbar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:LinkButton runat="server" ID="btnSearchDocument" PostBackUrl="SearchDocument.aspx?O=89">
            ...
            <td style="width: 240px" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                <telerik:RadComboBox ID="ddlSubmittalSet" runat="server"
                    Skin="Default" Width="240px" AutoPostBack="False" NoWrap="True" AllowCustomText="True"
                    CausesValidation="False" Height="250px" LoadingMessage="<%$ Resources:PMWeb, Loading %>" OnClientTextChange="LOD_DropDownTextChange"
                    ShowMoreResultsBox="True" EnableLoadOnDemand="true" meta:resourcekey="ddlSubmittalSet" CheckForDirt="True"
                ...
                <telerik:RadToolBar ID="mainToolBar" runat="server" Skin="Default" AutoPostBack="True">
                    <Items>
                        ...
                        <%--   <telerik:RadToolBarButton IsSeparator="true" CssClass="HideOnMobileToolbar">
                                    ...
                                    <telerik:RadToolBarButton SecurityButtonType="Read" Visible="false" CommandName="Generate" ImageUrl="Images/ToolBar/Generate.png" Text="<%$ Resources:PMWeb, Generate %>">
                                    </telerik:RadToolBarButton>--%>

                        <%-- <telerik:RadToolBarButton IsSeparator="true">
                                    </telerik:RadToolBarButton>--%>
                        <%--    <telerik:RadToolBarButton Value="btnCalendarAssign" SecurityButtonType="Calendar" ImageUrl="Images/Toolbar/user.png" CommandName="Assignement" CausesValidation="false">
                                    </telerik:RadToolBarButton>--%>
                        <%-- <telerik:RadToolBarSplitButton Text="Assign" CommandName="Assign" PostBack="false" EnableTheming="false" SecurityButtonType="Calendar"
                                        DisabledCssClass="true" EnableDefaultButton="false" DropDownWidth="300px" Value="CalendarSplit">
                                        <Buttons>
                                            <telerik:RadToolBarButton CssClass="" PostBack="False" Text="" Value="CalendarAssignement">
                                                <ItemTemplate>
                                                    <table style="padding-right: 20px; width: 200px">
                                                        <tr>
                                                            <td align="right">
                                                                <telerik:RadDateInput Width="150px" ID="rdCalendar" runat="server" InvalidStyleDuration="100" EmptyMessage="">
                                                                </telerik:RadDateInput>
                                                            </td>
                                                        </tr>
                                                        <tr>
                            ...
                            <table class="colTable" cellpadding="0" cellspacing="0" border="0">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        ...
                                        <asp:Label ID="lblSetNumUnique" meta:resourcekey="lblSetNumUnique" Text="<br/>Set Number should be unique by Project & Phase & Revision." runat="server" CssClass="Validator" Visible="false"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="labelWidth">
