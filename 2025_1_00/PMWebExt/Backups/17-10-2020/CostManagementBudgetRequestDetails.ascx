    ...
    <div class="row">
        <div class="col-12 ResponsiveMargin">
            <telerik:RadGrid ID="rdgBudgetRequestDetails" AllowMultiRowSelection="true" runat="server" CssClass="WithoutTopBorder"
                ...
                ShowFooter="True" AllowPaging="true" PageSize="10" UseEditFormInMobile="true">
...
<span class="Icon"></span>
                        ...
                        <telerik:GridTemplateColumn HeaderText="WBS" SortExpression="WBS" UniqueName="WBS" DataField="WBS"
                            ...
                            <EditItemTemplate>
                                <div style="width: 100%; white-space: nowrap">
                                    <telerik:RadComboBox ID="ddlWBS" runat="server" Width="110px" AutoPostBack="false" OnClientItemsRequesting="GetValueToReturn"
