...
<telerik:RadCodeBlock ID="CodeBlock" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OnTabSelected(sender, args) {
            ...
            $find($("[id$=tbsDocumenthorizontal]")[0].id).set_selectedIndex(sender.get_selectedTab().get_index())
        ...
        function pageLoad() {
            ...
            $('#ctl00_CPH1_UserProf_txtOldPassword').focus(function () {
                passwordfocus('ctl00_CPH1_UserProf_lbloldpasswordmask');
            });
            $('#ctl00_CPH1_UserProf_txtOldPassword').blur(function () {
                passwordblur('ctl00_CPH1_UserProf_lbloldpasswordmask', 'ctl00_CPH1_UserProf_txtOldPassword');
            });
            $('#ctl00_CPH1_UserProf_txtPassword').focus(function () {
                passwordfocus('ctl00_CPH1_UserProf_lblPasswordmask');
            });
            $('#ctl00_CPH1_UserProf_txtPassword').blur(function () {
                passwordblur('ctl00_CPH1_UserProf_lblPasswordmask', 'ctl00_CPH1_UserProf_txtPassword');
            });
            $('#ctl00_CPH1_UserProf_txtConfirmPassword').focus(function () {
                passwordfocus('ctl00_CPH1_UserProf_lblConfirmPasswordmask');
            });
            $('#ctl00_CPH1_UserProf_txtConfirmPassword').blur(function () {
                passwordblur('ctl00_CPH1_UserProf_lblConfirmPasswordmask', 'ctl00_CPH1_UserProf_txtConfirmPassword');
            });
        }
        ...
        function onlblPasswordfocus(lblId, txtId) {
            var txt = $('#ctl00_CPH1_UserProf_' + txtId);
            var lbl = $('#ctl00_CPH1_UserProf_' + lblId);
            lbl.removeClass('Hide');
            txt.focus();
        }
...
<table style="width: 100%; border-bottom: 1px solid #999; top: 51px;" cellpadding="0" cellspacing="0" class="ToolBar">
    <tr valign="top">
        <td valign="top">
            <table style="width: 100% !important;" cellpadding="0" cellspacing="0" border="0">
                <tr class="ProjectCenterToolbar">
                    <td class="ToolbarTd">
                        <telerik:RadToolBar ID="mainToolBar" runat="server" OnClientButtonClicked="click_handler" AutoPostBack="true" Width="100%" Skin="Default" CssClass="toolbar">
                            <Items>
...
<div class="PMSettings">
    <div class="col-2">
        <telerik:RadTabStrip OnClientTabSelecting="onTabSelecting" ID="tbsDocument" SelectedIndex="0" runat="server" MultiPageID="mlpUserProfile" Skin="Default" EnableViewState="True" CausesValidation="False" CssClass="VerticalTabs tbsDocSpec" Orientation="VerticalLeft" Align="Left" OnClientTabSelected="OnTabSelected">
            <Tabs>
        ...
        <telerik:RadTabStrip ID="tbsDocumenthorizontal" OnClientTabSelecting="onTabSelecting" SelectedIndex="0"
            runat="server" MultiPageID="mlpUserProfile" Skin="Default" ScrollButtonsPosition="Left" CssClass="tbshorizantaltabs" OnClientTabSelected="OnTabSelected"
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 col-4-right">
                            <table class="TableNoSpacingNoBorder">
                                ...
                                <tr>
                                    <td style="padding-top: 46px; padding-bottom: 5px;" id="tdEvents">
                                        <fieldset>
