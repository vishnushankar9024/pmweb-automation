        ...
        <div class="col-8">
            <div runat="server" id="tdAcknowledgments" width="100%">
                <fieldset>
                    ...
                    <telerik:RadGrid ID="rdgAK" runat="server" FilterType="HeaderContext" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true"
                        AutoGenerateColumns="False" ShowStatusBar="True" Font-Size="8px" PageSize="20" SetWidth="true"
