...
<%--<%@ Register Src="ItemDetails.ascx" TagName="ItemDetails" TagPrefix="uc1" %>--%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        ...
        <script type="text/javascript">
            ...
            function maintoolbarClick(Value) {
                ...
                switch (Value) {
                    case 'Items':
                        OpenPOPUp("ObjectImport.aspx?ObjectType=ITEM&EntityID=-1", 800, 550, true);
                        break;
    ...
    <table style="width: 100%;" cellpadding="0" cellspacing="0" class="ToolBar SmallToolbar">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:LinkButton runat="server" ID="btnSearchDocument" PostBackUrl="SearchDocument.aspx?O=3">
            ...
            <td class="ToolbarTd">
                ...
                <%--<telerik:RadToolBarButton SecurityButtonType="Read" CommandName="Search" ImageUrl="Images/ToolBar/Tree.png"
                                        Value="Delete" CausesValidation="false">
                                    </telerik:RadToolBarButton>--%>
            </td>
            <td style="width: 240px" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                <telerik:RadComboBox ID="ddlItems" runat="server" OnClientTextChange="LOD_DropDownTextChange"
                    LoadingMessage="<%$ Resources:PMWeb, Loading %>" Skin="Default" Width="100%" OnClientSelectedIndexChanging="MainDropDown_SelectedIndexChanging"
                    AutoPostBack="False" NoWrap="True" AllowCustomText="True" CausesValidation="False"
                ...
                <telerik:RadToolBar ID="mainToolBar" runat="server" Skin="Default" AutoPostBack="True" CssClass="item-toolbar">
                    <Items>
                        <%--<telerik:RadToolBarButton SecurityButtonType="Read" CommandName="SearchItems" ImageUrl="Images/ToolBar/lookup.png"
                                        Value="Search" NavigateUrl="SearchDocument.aspx?O=3" CausesValidation="false">
                                    </telerik:RadToolBarButton>--%>
                        ...
                        <%--<telerik:RadToolBarButton SecurityButtonType="Read" ImageUrl="Images/ToolBar/Printer.png" PostBack ="false" 
                                        CommandName="Print" Enabled="false" >
                                    </telerik:RadToolBarButton>--%>
                        ...
                        <telerik:RadToolBarSplitButton SecurityButtonType="Edit" CommandName="Import" Enabled="true" CssClass="ToolbarImport" ImageUrl="Images/ToolBar/Import.png" ToolTip="Import"
                            PostBack="false" EnableDefaultButton="false" OuterCssClass="HideOnMobileToolbar">
                            <Buttons>
                                <telerik:RadToolBarButton Text="Items" CommandName="Items" PostBack="false">
                                </telerik:RadToolBarButton>
                            </Buttons>
                        </telerik:RadToolBarSplitButton>
                                    ...
                                    <Items>
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem Text="Import" Value="Import" CssClass="Import">
                                                    <Items>
                                                        <telerik:RadMenuItem Text="Items" Value="Items"></telerik:RadMenuItem>
                                                    </Items>
                                                </telerik:RadMenuItem>
                                                ...
                                                <telerik:RadMenuItem Text="Help" Value="Help" onclick="helpClick();" CssClass="Help" EnableImageSprite="true" OuterCssClass="Recent"></telerik:RadMenuItem>
                                            </Items>
                                        </telerik:RadMenuItem>
    ...
    <telerik:RadTabStrip OnClientTabSelecting="onTabSelecting" ID="tbsDocument" SelectedIndex="0" CssClass="documentTabs"
        ...
        <Tabs>
            ...
            <%--            <telerik:RadTab Text="Alternates" Value="Alternates" />--%>
                        ...
                        <table class="colTable">
                            ...
                            <tr>
                                ...
                                <td class="controlWidth">
                                    ...
                                    <%--  <asp:CompareValidator ID="cvItemGroup" runat="server" ValidationGroup="Save"  ValueToCompare="-- Select --"
                                                        ControlToValidate="ddlItemGroup" Operator="NotEqual" Display="Dynamic"
                                                        ErrorMessage="Required111">
                        ...
                        <fieldset style="width: 100%">
                            ...
                            <table class="colTable">
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlEstimatingUOM" runat="server" Width="100%" Skin="Default" AllowCustomText="true"
                                            LoadingMessage="<%$ Resources:PMWeb, Loading %>" Filter="Contains">
                                            <CollapseAnimation Duration="200" Type="OutQuint" />
                                        </telerik:RadComboBox>
                                    </td>
                                </tr>
                        ...
                        <fieldset>
                            ...
                            <table class="colTable">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <asp:TextBox ID="txtServiceIntervalDays" runat="server" MaxLength="15" CssClass="PositiveDouble"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="labelWidth">
