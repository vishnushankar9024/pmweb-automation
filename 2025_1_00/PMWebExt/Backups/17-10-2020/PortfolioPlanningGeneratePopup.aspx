            ...
            <tr>
                <td class="ToolbarTd">
                    <telerik:RadToolBar ID="mainToolBar" runat="server" Skin="Default" AutoPostBack="true" OnClientButtonClicked="click_handler">
                        <Items>
                            <telerik:RadToolBarButton EnableImageSprite="true" CssClass="ToolbarNewEmail" CommandName="CreateProjects" Text="<%$ Resources:PMWeb, CreateProjects %>"></telerik:RadToolBarButton>
                            <telerik:RadToolBarButton EnableImageSprite="true" CssClass="ToolbarNewEmail" PostBack="false" CommandName="CreateRecords" Text="<%$ Resources:PMWeb, CreateRecords %>"></telerik:RadToolBarButton>
                ...
                <div class="col-4 col-4-right">
                    <fieldset>
                        ...
                        <table class="colTable">
                            <tr>
                                <td>
                                    <asp:CheckBox Checked="true" runat="server" ID="chkInitiativeApproved" Text="Mark Linked Initiatives as Approved" meta:Resourcekey="chkInitiativeApproved" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:CheckBox runat="server" ID="chkFundPortfolio" Text="Fund Portfolio, Not the Project" meta:Resourcekey="chkFund_Portfolio" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <asp:CheckBox Checked="true" runat="server" ID="chkFundBudget" Text="Fund Budgets" meta:Resourcekey="chkFundBudget" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                    ...
                    <telerik:RadGrid ID="rdgInitiatives" runat="server" SetWidth="true" ClientSettings-Scrolling-AllowScroll="true" FitPageHeightOffset="24"
                        ...
                        <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
                            ...
                            <Columns>
                                ...
                                <telerik:GridTemplateColumn HeaderText="Plan<br/>Line #" UniqueName="PlanLineNumber"
                                    Groupable="false">
                                    <ItemTemplate>
