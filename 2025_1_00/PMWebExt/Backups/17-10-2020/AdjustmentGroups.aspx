...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <table style="width: 100% !important;" cellpadding="0" cellspacing="0" border="0" class="ToolBar SmallToolbar">
        <tr>
            <td class="ToolbarTd">
                <asp:LinkButton runat="server" ID="btnSearchDocument" PostBackUrl="SearchDocument.aspx?O=153">
                ...
                <div class="col-4 col-4-left">
                    <table class="colTable">
                        ...
                        <tr>
                            ...
                            <td class="controlWidth">
                                <telerik:RadComboBox ID="ddlAdjustmentGroupType" runat="server" Skin="Default" AllowCustomText="True" Filter="Contains" MarkFirstMatch="true"></telerik:RadComboBox>
                            </td>
                        </tr>
                        <%-- <tr>
                                        <td class="labelWidth">
