<%@ Page Language="vb" meta:resourcekey="Page" AutoEventWireup="false" CodeBehind="MySettings_ProjectCenterPopup.aspx.vb" Inherits="Website.MySettings_ProjectCenterPopup" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <telerik:RadGrid ID="rdgConfigureProjectCenter" runat="server" FitPageHeightOffset="5" ClientSettings-Scrolling-AllowScroll="true" setwidth="true" Style="margin-top: 50px;"
