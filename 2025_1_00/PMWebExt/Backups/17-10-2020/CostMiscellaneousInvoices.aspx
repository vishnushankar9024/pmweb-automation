...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <table style="width: 100% !important;" cellpadding="0" cellspacing="0" border="0">
        <tr class="ToolBar SmallToolbar">
            <td class="ToolbarTd">
                <asp:LinkButton runat="server" ID="btnSearchDocument" PostBackUrl="SearchDocument.aspx?O=74">
                                ...
                                <tr>
                                    <td colspan="2" width="100%">
                                        <table class="TableNoSpacingNoBorder" width="100%" style="color: #666666;">
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblpost" meta:resourcekey="lblpost" runat="server" Text="Post to Non-commitment Costs"></asp:Label>
                                                </td>
