...
<table style="width: 100%; margin-top: 41px; height: 50px; border-bottom: 1px solid black" cellspacing="0" cellpadding="0" border="0" runat="server" id="tblRequiredFields" class="ToolBar">
    <tr>
...
<telerik:RadSplitter ID="RadSplitter1" runat="server" Width="100%" Height="100%" Skin="Default" CssClass="AssetExplorerVerticalSplitter" SplitBarsSize="" OnClientLoad="onResized" OnClientResized="AssetSplitterResized">
    ...
    <telerik:RadPane ID="RadContentPane" CssClass="RequiredFieldsSplitterPane" runat="server" Width="70%" Index="2" Skin="Default">
