    ...
    <div class="row">
        <div class="col-12 ResponsiveMargin">
            <telerik:RadGrid ID="rdgTodoListDetails" ShowGroupPanel="true" runat="server" HeaderStyle-Font-Size="8" ClientSettings-Scrolling-AllowScroll="true"
                ...
                EnableHeaderContextFilterMenu="true" Width="100%" AutoGenerateColumns="False" PageSize="10" AllowPaging="true" SetWidth="true"
                AllowMultiRowEdit="True" AllowMultiRowSelection="true" AllowSorting="true" ShowStatusBar="true" UseEditFormInMobile="true">
