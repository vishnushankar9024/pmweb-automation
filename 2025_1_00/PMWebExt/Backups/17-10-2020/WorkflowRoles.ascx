...
<table class="ToolBarWorkflowRoles" style="width: 100%;background-color: RGB(237,237,237) !important;margin-top:68px;" cellpadding="0" cellspacing="0">
    <tr>
        <td>
                    ...
                    <tr class="DisplayOnMobileAsTable">
                        ...
                        <td style="padding: 0px;" class="RoleGridWidth DisplayOnMobileAsRow">
                            <telerik:RadGrid ID="rdgRoles" UseEditFormInMobile="true" GroupingEnabled="true" runat="server" AutoGenerateColumns="False" Width="100%" SetWidth="true"
                                ...
                                PageSize="10" AllowPaging="true" ShowGroupPanel="true" AllowSorting="true" ShowStatusBar="true" ClientSettings-Scrolling-AllowScroll="true">
                                    ...
                                    <Nodes>
                                        ...
                                        <telerik:RadTreeNode meta:resourcekey="lblCan" Text="Can:">
                                            <Nodes>
                                                ...
                                                <telerik:RadTreeNode ID="chkCanEditAttachments" runat="server" Text="Edit Attachments" meta:resourcekey="chkCanEditAttachments" Visible="false"></telerik:RadTreeNode>
                                                <telerik:RadTreeNode ID="chkCanDeleteWorkflow" runat="server" Text="Delete Workflow" meta:resourcekey="chkCanDeleteWorkflow" Visible="false"></telerik:RadTreeNode>
                                            </Nodes>
                                        </telerik:RadTreeNode>
                                    </Nodes>
                                </telerik:RadTreeView>
