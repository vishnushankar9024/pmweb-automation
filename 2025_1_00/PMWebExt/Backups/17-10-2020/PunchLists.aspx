...
<%@ Register Src="NotificationLog.ascx" TagName="NotificationLog" TagPrefix="uc3" %>
        ...
        <tr valign="top">
            <td valign="top">
                <table style="width: 100% !important;" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td class="ToolbarTd">
                            <asp:LinkButton runat="server" ID="btnSearchDocument" PostBackUrl="SearchDocument.aspx?O=92">
                        ...
                        <td style="width: 240px" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                            <telerik:RadComboBox ID="ddlPunchList" runat="server" OnClientTextChange="LOD_DropDownTextChange"
                        ...
                        <td valign="middle" style="vertical-align: middle; width: 70%" class="ToolbarTd">
                            <telerik:RadToolBar ID="mainToolBar" runat="server" Skin="Default" AutoPostBack="True">
                                <Items>
                                    ...
                                    <%--                                <telerik:RadToolBarButton Value="btnCalendarAssign" SecurityButtonType="Calendar" ImageUrl="Images/Toolbar/user.png"
                                        CommandName="Assignement" CausesValidation="false" CssClass="ToolbarAssignement HideOnMobileToolbar" >
                                    </telerik:RadToolBarButton>--%>
                        ...
                        <div class="col-4 col-4-left">
                            <table class="colTable">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        ...
                                        <asp:RequiredFieldValidator ID="cmpPunchListNum" runat="server" ControlToValidate="txtPunchListNum"
                                            CssClass="Validator" meta:resourcekey="cmpPunchListNum" ErrorMessage="<br/>Enter PunchList #" Display="Dynamic" ForeColor=""
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlFromContact" runat="server" Width="100%"
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlToContact" runat="server" Width="100%"
                                            Skin="Default" CloseDropDownOnBlur="true" EnableItemCaching="false" EmptyMessage='<%$Resources:PMWeb, ListContactEmptyMsg %>'
