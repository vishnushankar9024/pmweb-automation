...
<telerik:RadCodeBlock runat="server">
    <style type="text/css">
        ...
        .trvScheduling > .rtSp, .trvDocument .rtSp, .NoChildren > .rtSp {
        ...
        .trvWorkflow > .rtSp, .HasChildren > .rtSp, .trvtoolbox > .rtSp, .trvPlanning > .rtSp, div.trvDocument > .rtSp, .rtTop .rtSp {
            background-image: url(CSS/Images/ResponsiveIcons/16White.png) !important;
            width: 16px;
            height: 22px;
            margin-left: -3px;
...
<table style="width: 100% !important; margin-top: 41px; border-bottom: 1px solid #666666;" cellpadding="0" cellspacing="0" border="0" class="ToolBar">
    <tr>
...
<telerik:RadSplitter ID="RadSplitter1" runat="server" Width="100%" Height="100%" Skin="Default" CssClass="AssetExplorerVerticalSplitter" SplitBarsSize="" OnClientLoad="onResized">
    ...
    <telerik:RadPane ID="treeGroupsAndItemsPane" runat="server" Width="30%" Index="0" Skin="" CssClass="GridLayoutsLeftSplitterPane" EnableEmbeddedBaseStylesheet="False" OnClientCollapsed="OnClientCollapsed" OnClientExpanded="OnClientExpanded" OnClientResized="AssetSplitterResized">
        <div id="dvlayoutTree">
    ...
    <telerik:RadPane ID="RadContentPane" CssClass="GridLayoutsSplitterPane" runat="server" Width="70%" Index="2" Skin="Default">
                    ...
                    <fieldset>
                                    ...
                                    <td class="controlWidth">
                                        ...
                                        <span id="divLayoutNameError">
                                            <asp:RequiredFieldValidator ID="rfvLayoutName" ControlToValidate="txtLayoutName"
                                                runat="server" CssClass="Validator" ErrorMessage="<%$ Resources:WarningMsg_Required%>" Display="Dynamic"
                                    ...
                                    <td class="controlWidth">
                                        ...
                                        <span id="divGridError">
                                            <asp:RequiredFieldValidator ID="rfvGrid" ControlToValidate="ddlGrid" Display="Dynamic"
                                                runat="server" CssClass="Validator" ErrorMessage="<%$ Resources:WarningMsg_Required%>"
                                                ValidationGroup="Save"></asp:RequiredFieldValidator>
                                        </span>
                                    </td>
                                </tr>
                        ...
                        <div>
                            <telerik:RadGrid ID="rdgLayout" runat="server" SetWidth="true" FitParentContainer="true"
                                        ...
                                        AllowMultiRowEdit="True" AllowMultiRowSelection="True" PageSize="12"
