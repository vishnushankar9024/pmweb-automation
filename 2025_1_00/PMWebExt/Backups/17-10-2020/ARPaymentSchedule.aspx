<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ARPaymentSchedule.aspx.vb" Inherits="Website.ARPaymentSchedule" meta:resourcekey="Page" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="PMMainPage PMPopupMainPage documentSinglePage">
            <div class="row" id="trTbsDetails">
                <div class="col-4 col-4-left">
                    <table class="colTable">
                        ...
                        <tr>
                            <td class="labelWidth">
                                <asp:Label runat="server" ID="lblContract" meta:resourcekey="lblContract" Text="Contract"></asp:Label>
                            </td>
                            <td class="controlWidth">
                                <asp:TextBox runat="server" Enabled="false" ID="txtContract" Text="" Width="100%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="labelWidth">
                    ...
                    <fieldset>
                        ...
                        <table class="colTable">
                            <tr>
                                ...
                                <td class="controlWidth">
                                    <telerik:RadNumericTextBox ID="txtnbrOftransactions" CssClass="Right" Value="1"
                                        MinValue="1" Type="Number" ShowSpinButtons="true" Width="100%" runat="server">
                            ...
                            <tr>
                                ...
                                <td class="controlWidth">
                                    <asp:CheckBox AutoPostBack="true" runat="server" ID="chkUseDates" class="mobile-switch" Width="100%" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                ...
                <div class="col-4 col-4-right">
                    <fieldset runat="server" id="fldDates">
                        ...
                        <table class="colTable" cellpadding="5">
                            ...
                            <tr>
                                <td class="labelWidth">
                                    <asp:RadioButton ID="rdoMonthlyOnDay" Checked="true" runat="server" Text="Day" meta:resourcekey="rdoMonthlyOnDay" CssClass="RadioCss" GroupName="Monthly" />
                                </td>
                                <td class="controlWidth">
                                    <table width="100%">
                                        <tr>
                                ...
                                <td class="controlWidth">
                                    <table>
                                        <tr>
                                            ...
                                            <td width="50%">
                                                <telerik:RadComboBox ID="ddlWeekDay" Width="100%" Skin="Default" runat="server">
                                                </telerik:RadComboBox>
                                            </td>
                                        </tr>
                                    </table>
                                        ...
                                        <tr>
                                            <td width="50%">
                                                <telerik:RadNumericTextBox ID="txtEveryMonth" CssClass="Right" Value="1" MinValue="1"
                                                    Type="Number" ShowSpinButtons="true" Width="100%" runat="server">
                                                    <NumberFormat DecimalDigits="0" />
                                                </telerik:RadNumericTextBox>
                                            </td>
                                            <td width="50%">
                                                <asp:Label ID="lblMonth" runat="server" meta:resourcekey="lblMonth" Text="Month(s)" Width="100%">  </asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
            ...
            <div class="row">
                <div class="col-12">
                    <telerik:RadGrid ID="rdgPayments" runat="server" AllowFilteringByColumn="false" FilterType="HeaderContext" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true"
                        AutoGenerateColumns="False" ShowStatusBar="True" Font-Size="8px" ShowFooter="False" FitPageHeightOffset="24"
