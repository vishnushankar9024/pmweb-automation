...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <table class="ToolBar SmallToolbar" style="width: 100% !important;" cellpadding="0" cellspacing="0" border="0">
        <tr>
            <td class="ToolbarTd">
                <asp:LinkButton runat="server" ID="btnSearchDocument" PostBackUrl="SearchDocument.aspx?O=113">
                        ...
                        <div class="col-4 col-4-left ">
                            <table class="colTable">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <asp:TextBox ID="txtDays" CssClass="Numeric" MaxLength="9" runat="server" ></asp:TextBox>
                                            ...
                                            <table class="TableNoSpacingNoBorder">
                                                <tr>
                                                    ...
                                                    <td style="width: 40%; padding-left: 10px;">
                                                        <asp:TextBox ID="txtOriginalContractAmountDays" CssClass="Double" runat="server"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
