...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function UpdateImageSize() {
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                data: "{'Source':'" + drawingsCateg + "','Size':'" + size + "'}",
                dataType: "json",
                async: true
            });
        }
    ...
    margin: 3px;
        right: -8px;
           ...
           .drawing-viewer-toolbar     .RadSlider_Default div.rslHorizontal .rslTrack {left:22px !important;}
...
.drawing-viewer-toolbar .rtbItemFocused .ToolbarRedo .rtbIcon {
    ...
    background-image: url(css/Images/2007Small.png) !important;
            ...
            .drawing-viewer-toolbar .rtbDisabled{opacity:0.3 !important}
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                if (canvas.length > 0) {
                            ...
                            if (tempType != '' && isEdit != 'Edit' && cursorType == 'Draw') {
                                ...
                                switch (tempType) {
                                    ...
                                    case 'space':
                                        ...
                                        var img = paper.image("Images/Redlining/smallSpace" + skin + ".png", tempX1, tempY1, 16, 16)
                                    ...
                                    case 'equipment':
                                        ...
                                        var img = paper.image("Images/Redlining/smallEquipment" + skin + ".png", tempX1, tempY1, 16, 16)
                                        img.id = 'EQU_' + countId;
                                        var text = paper.text(tempX1 + 18, tempY1 + 7, tempStamp).attr(
                                             {
                                                 "text-anchor": "start",
                    ...
                    $(divZoomer).mousemove(function (e) {
                        mouseX = e.pageX;
                        mouseY = e.pageY;
            ...
            function GetFileForFileManager(me) {
                ...
                var URL = "FilesLookup.aspx?EntityId=0";
                var ProjectId = 0;
    ...
    <table class="ToolBar SmallToolbar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr>
            <td class="ToolbarTd ">
                <asp:LinkButton runat="server" ID="btnSearchDocument" PostBackUrl="SearchDocument.aspx?O=156">
            ...
            <td style="width: 240px" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                <telerik:RadComboBox ID="ddlRedlinings" runat="server" OnClientTextChange="LOD_DropDownTextChange"
                    ...
                    ShowMoreResultsBox="True" EnableLoadOnDemand="true" meta:resourcekey="ddlRedlinings"
                                                        ...
                                                        <table class="colTable" id="tblPMWebViewerHeader" border="0">
                                                            <tr>
                                                                ...
                                                                <td class="controlWidth">
                                                                    <asp:TextBox ID="txtCode" MaxLength="100" runat="server"></asp:TextBox>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="controlWidth">
                                                                    <asp:LinkButton ID="lnkBtnDownload" runat="server" Style="height: 35px; width: 100%" CssClass="lnkBtnDownload Link">
                                                                        ...
                                                                        <asp:Label ID="lblDownload" runat="server" Text="Download Image" Style="display: inline-block;"></asp:Label>
                                                                    </asp:LinkButton>
                                                                </td>
                                                            </tr>
