...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server"> 
    ...
    <style>
      ...
      */
        ...
        .RadGrid .rgRow input, .RadGrid .rgAltRow input, .RadGrid .RadComboBox {
            width: 100% !important;
        }
    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        <script type="text/javascript">
            ...
            function RedirectToSearchDocument() {
                window.location = "SearchDocument.aspx?C=" + "<%=PM.Workflow.CustomFormInfo.CustomFormTypeId%>";
                return false;
            }
        </script>
        ...
        <tr valign="top">
            <td valign="top">
                <table style="width: 100% !important;" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td class="ToolbarTd">
                            <asp:LinkButton runat="server" ID="btnSearchDocument" OnClientClick="return RedirectToSearchDocument();">
                                    ...
                                    <telerik:RadToolBarSplitButton ImageUrl="Images/ToolBar/NewDoc.png" CommandName="NewInitiative"
                                        ...
                                        <Buttons>
                                            ...
                                            <telerik:RadToolBarButton SecurityButtonType="Copy" Width="150px"
                                                CommandName="Copy" Value="CopyRecord" ImageUrl="Images/ToolBar/CopyRecord.png">
                                            </telerik:RadToolBarButton>
                                        </Buttons>
                        ...
                        <div class="col-4">
                            <table class="colTable">
                                <tr>
                                    ...
                                    <td class="controlWidth customDate">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvProjects" runat="server" ControlToValidate="ddlProjects"
                                            CssClass="Validator" InitialValue="" ErrorMessage="Project is required" ValidationGroup="Save"
                                        ...
                                        <asp:CustomValidator ID="csvProjects" runat="server" ControlToValidate="ddlProjects"
                                            ...
                                            CssClass="Validator" ErrorMessage="Project is required">
                                        </asp:CustomValidator>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvRecordNumber" ControlToValidate="txtRecordNumber" Display="Dynamic" ValidationGroup="Save"
                                            runat="server" ForeColor="" ErrorMessage="<%$Resources:PMWeb, WarningMsg_Required %>" CssClass="Validator"></asp:RequiredFieldValidator>
