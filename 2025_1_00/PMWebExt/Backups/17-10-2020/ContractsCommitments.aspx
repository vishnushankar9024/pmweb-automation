...
<%@ Register Src="NotificationLog.ascx" TagName="NotificationLog" TagPrefix="uc11" %>
...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function maintoolbarClick(Value) {
                ...
                var HasPMWebReports = '<%= PM.QueryBuilderPermissionController.HasReports("CostManagement_Commitments")%>';
    ...
    <table class="ToolBar SmallToolbar" style="width: 100% !important;" cellpadding="0" cellspacing="0">
        <tr>
            <td class="ToolbarTd">
                <asp:LinkButton runat="server" ID="btnSearchDocument" PostBackUrl="SearchDocument.aspx?O=52">
                    ...
                    <div class="row">
                        <div class="col-4 col-4-left">
                            <table class="colTable">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <span runat="server" id="rmd_txtRevisionDate" style="display: block">
                                            <telerik:RadDatePicker ID="txtRevisionDate" runat="server" MinDate="1901-01-01" MaxDate="2100-01-01" SelectedDate='<%# Date.Today %>'
                                ...
                                <tr>
                                    <td class="labelWidth">
                                        <asp:Label ID="lblEffectiveDate" runat="server" Height="16px" Text="Effective Date"
                                            ...
                                            <table class="colTable" style="text-align: center; color: #666666; text-transform: uppercase;">
                                                <tr>
                                                    <td style="width: 60%;" class="NoWrap">
                                                        <asp:Label ID="lblCosts" meta:resourcekey="lblCosts" runat="server" Height="16px" Text="Costs" Style="text-transform: uppercase; color: #999999;"></asp:Label>
                                                    </td>
                                                    <td style="width: 40%;" class="NoWrap">
                                                        <asp:Label ID="lblDaysHeader" meta:resourceKey="lblDays" runat="server" Height="16px" Text="Days" Style="text-transform: uppercase; color: #999999;"></asp:Label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                            ...
                                            <table width="100%" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="width: 40%; padding-left: 10px;">
                                                        <asp:TextBox ID="txtOriginalValueDays" CssClass="Double" runat="server" Width="98%"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td class="controlWidth">
                                            <table width="100%" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="width: 40%; padding-left: 10px;">
                                                        <asp:TextBox ID="txtApprovedChangesDays" CssClass="Double" runat="server" Width="98%"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td class="controlWidth">
                                            <table width="100%" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="width: 40%; padding-left: 10px;">
                                                        <asp:TextBox ID="txtRevisedValueDays" CssClass="Double" runat="server" Width="98%"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td class="controlWidth">
                                            <table width="100%" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="width: 40%; padding-left: 10px;">
                                                        <asp:TextBox ID="txtPendingChangesDays" runat="server" CssClass="Double" Width="98%"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td class="controlWidth">
                                            <table width="100%" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td style="width: 40%; padding-left: 10px;">
                                                        <asp:TextBox ID="txtProjectedValueDays" CssClass="Double" runat="server" Width="98%"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                            ...
                            <fieldset runat="server" id="tdDelivery">
                                ...
                                <table class="colTable ">
                                    <tr id="trDueDate" runat="server">
                                        <td class="labelWidth">
                                            <asp:Label ID="lblDueDate" runat="server" Height="16px" Text="Due Date" meta:Resourcekey="lblDueDate"></asp:Label>
                                        </td>
                                        <td class="controlWidth">
