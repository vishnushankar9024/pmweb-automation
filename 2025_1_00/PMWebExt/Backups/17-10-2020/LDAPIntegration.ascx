        ...
        <div class="col-12 ResponsiveMargin">
            <telerik:RadGrid ID="rdgUsers" runat="server" CssClass="WithoutTopBorder" BorderWidth="0"
                ...
                <MasterTableView DataKeyNames="Id" NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
                    ...
                    EditMode="InPlace">
                    <Columns>
                        <telerik:GridTemplateColumn ItemStyle-HorizontalAlign="Center" AllowFiltering="false" UniqueName="Select" HeaderText="Select" Groupable="False" HeaderStyle-Width="80px">
                            <HeaderTemplate>
