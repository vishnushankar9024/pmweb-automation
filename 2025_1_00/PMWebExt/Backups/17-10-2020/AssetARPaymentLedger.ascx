<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="AssetARPaymentLedger.ascx.vb" Inherits="Website.AssetARPaymentLedger" %>
...
<div class="PMHeader">
    <div class="row">
        <div class="col-12 ResponsiveMargin">
            <telerik:RadGrid ID="rdgARPaymentLedger" runat="server" AutoGenerateColumns="False" AllowPaging="True" Width="100%"
                PageSize="20" HeaderStyle-Font-Size="8" AllowMultiRowEdit="true" AllowMultiRowSelection="true" ShowGroupPanel="True" AllowSorting="true">
                ...
                <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>" DataKeyNames="Id" CommandItemDisplay="Top" TableLayout="Fixed" InsertItemDisplay="Top"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="20%" UniqueName="Program" ItemStyle-Wrap="false" HeaderText="Program*" Groupable="true" Reorderable="true"
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="20%" UniqueName="Location" ItemStyle-Wrap="false" HeaderText="Location" Groupable="true" Reorderable="true"
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="20%" UniqueName="Lease" ItemStyle-Wrap="false" HeaderText="Lease" Groupable="true" Reorderable="true"
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="10%" UniqueName="LinkedInvoice" ItemStyle-Wrap="false" HeaderText="Linked A/R Invoice" Groupable="true" Reorderable="true"
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="10%" UniqueName="AppliedAmount" ItemStyle-Wrap="false" HeaderText="Applied Amount" Groupable="true" Reorderable="true"
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="10%" UniqueName="PaymentDate" ItemStyle-Wrap="false" HeaderText="Payment Date" Groupable="true" Reorderable="true"
                    ...
                    <CommandItemTemplate>
                        <div>
                            ...
                            <asp:LinkButton ID="btnDelete" runat="server" CausesValidation="false" OnClientClick="javascript:return ConfirmDelete();" CssClass="GridCmdDeleteRows"
                                SecurityButtonType="ItemMode_Delete" CommandName="DeleteRows" Visible='<%# rdgARPaymentLedger.EditIndexes.Count = 0 %>'>
