...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    <%--  <telerik:RadAjaxManagerProxy ID="AjaxManagerProxy1" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="mlpTaskSheet">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="mlpTaskSheet" LoadingPanelID="ldpPM" />
    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        ...
        function OpenTaskSheetsPopUp() {
            OpenPOPUp('TaskSheetsLookup.aspx');
            //wnd.setSize(570, 450);
    ...
    <table style="width: 100%;" cellpadding="0" cellspacing="0" class="ToolBar LargeToolBar">
        <tr>
            <td class="ToolbarTd">
                <asp:LinkButton runat="server" ID="btnSearchDocument" PostBackUrl="SearchDocument.aspx?O=69" OnClientClick="DisableValidator()">
            ...
            <td style="width: 240px" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                <telerik:RadComboBox ID="ddlTaskSheets" runat="server" Skin="Default" CloseDropDownOnBlur="true" OnClientSelectedIndexChanging="MainDropDown_SelectedIndexChanging"
                    EmptyMessage="Select Task..." Width="240px" AutoPostBack="false" AllowCustomText="true" meta:resourcekey="ddlTaskSheets"
                    CausesValidation="False" Height="400px" LoadingMessage="<%$ Resources:PMWeb, Loading %>" NoWrap="true" DropDownWidth="350px"
                ...
                <telerik:RadToolBar ID="mainToolBar" runat="server" AutoPostBack="true" OnClientButtonClicked="click_handler">
                    <Items>
                        <%--<telerik:RadToolBarButton SecurityButtonType="Read" CommandName="Search" ImageUrl="Images/ToolBar/lookup.png"
                                        Value="Search" NavigateUrl="SearchDocument.aspx?O=69" CausesValidation="false">
                                    </telerik:RadToolBarButton>--%>
                        <%--<telerik:RadToolBarButton ImageUrl="Images/ToolBar/NewDoc.png" SecurityButtonType="Add" PostBack="false" CommandName="New" AccessKey="n" ToolTip="New (Alt+n)" CausesValidation="false"></telerik:RadToolBarButton>--%>
                        ...
                        <%-- <telerik:RadToolBarButton ImageUrl="Images/ToolBar/Calculate.png" SecurityButtonType="Edit" ToolTip="Recalculate" value="Recalculate" CommandName="Recalculate"></telerik:RadToolBarButton>--%>
                        ...
                        <telerik:RadToolBarButton SecurityButtonType="Add" CommandName="PctCompleteTimesheets" ImageUrl="Images/ToolBar/PctCompleteTimesheets.png" ToolTip="Update %C From Timesheets" Visible="true" OuterCssClass="HideOnMobileToolbar HideOniPadToolbar"></telerik:RadToolBarButton>

                        <telerik:RadToolBarButton SecurityButtonType="Add" CommandName="SaveAsBaseline" ImageUrl="Images/ToolBar/Check.png" ToolTip="Save As Baseline" Visible="true" OuterCssClass="HideOnMobileToolbar HideOniPadToolbar"></telerik:RadToolBarButton>
            ...
            <%--     <tr>
                        <td style="padding-left: 10px;">
                            <asp:CheckBox ID="chkHideHeader" Visible="false" runat="server" Text="Hide Header" onClick="HideHeaderCheckedChanged(this)" meta:resourcekey="chkHideHeader" class="mobile-switch" />
                        </td>
                    </tr>--%>
        </tr>
    </table>
                        ...
                        <telerik:RadAjaxPanel ID="pnlDetailPane" runat="server" Width="100%" EnableAJAX="False">
                            ...
                            <div class="PMMainPage">
                                <div class="row" style="padding-top: 4px; padding-bottom: 4px;">
                                    <div class="col-4">
                                        <%--<img id="tblTaskHeaderimg" alt="" src="Images/Workflow/wMinus.png" onclick="return ToggleTaskHeaderSection(this);" />--%>
                                            ...
                                            <tr>
                                                ...
                                                <td class="controlWidth">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="rfvProjects" runat="server" ControlToValidate="ddlProjects"
                                                        CssClass="Validator" InitialValue="" meta:resourcekey="cmpProjects" ValidationGroup="Save"
                                                    ...
                                                    <asp:CustomValidator ID="csvProjects" runat="server" ControlToValidate="ddlProjects" ValidationGroup="Save"
                                                        ClientValidationFunction="ValidateCombo" Display="Dynamic"
                                                        CssClass="Validator" meta:resourcekey="cmpProjects">
                                                    </asp:CustomValidator>
                                                </td>
                                            </tr>
                                            <tr>
    ...
    <asp:Button runat="server" ID="btnSaveTaskSheet" CssClass="Hide" ValidationGroup="Save" />
</asp:Content>
