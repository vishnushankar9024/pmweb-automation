<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReportPreview.aspx.vb"
    Inherits="Website.ReportPreview" %>
...
<body style="background-color: White">
    ...
    <form id="form1" runat="server">
     <asp:ScriptManager ID="ScriptManager1" runat="server" AsyncPostBackTimeout="240">
    </asp:ScriptManager>
        <asp:Panel ID="pnlMessage" runat="server" Visible="false">
            <table style="width: 100%; height: 300px" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td align="center">
                        <asp:Label ID="lblAccessDeniedMessage" Text="<%$ Resources:PMWeb, WarningMsg_ReportSecurityRight %>" runat="server" CssClass="Validator"></asp:Label>
                    </td>
                </tr>
            </table>
        </asp:Panel>
        ...
        <rsweb:ReportViewer ID="rvSqlReport2" runat="server" ShowParameterPrompts="true" ShowBackButton="true" ShowDocumentMapButton="true"
         DocumentMapWidth="200" Width="100%" style="height:calc(99vh)" ShowZoomControl="true" ShowFindControls="true" AsyncRendering="false"
            ProcessingMode="Remote" Font-Names="Verdana" Font-Size="8pt" PromptAreaCollapsed="False" KeepSessionAlive="true">
        </rsweb:ReportViewer>
    </form>
