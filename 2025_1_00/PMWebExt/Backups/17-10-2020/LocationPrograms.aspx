...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <table class="ToolBar LargeToolBar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:LinkButton runat="server" ID="btnSearchDocument" PostBackUrl="SearchDocument.aspx?O=206">
                        ...
                        <div class="col-4 col-4-left">
                            <table class="colTable">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlTypes" runat="server" AllowCustomText="true" Filter="Contains" MarkFirstMatch="true" Width="100%" meta:Resourcekey="ddlTypes" Skin="Default">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlProgramStatus" runat="server" AllowCustomText="true" Width="100%" Filter="Contains" MarkFirstMatch="true" meta:Resourcekey="ddlProgramStatus" Skin="Default">
                                            <CollapseAnimation Duration="200" Type="OutQuint" />
                                        </telerik:RadComboBox>
                                    </td>
                                </tr>
