...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <div class="PMMainPage">
        <div class="row">
            ...
            <div class="row row-8-4" style="padding-top:0;">
                <div class="col-4">
                    <fieldset>
                        <legend>
                    ...
                    <fieldset>
                        ...
                        <telerik:RadGrid ID="rdgSpecificationTemplate" AllowMultiRowSelection="true" runat="server" SetWidth="true" AppendMenus="true" FitParentContainer="true"
                            ...
                            <MasterTableView DataKeyNames="Id" ClientDataKeyNames="Id" CommandItemDisplay="Top"
                                ...
                                <Columns>
                                    <telerik:GridTemplateColumn HeaderText="Line Number" UniqueName="FieldsSortOrder" SortExpression="FieldsSortOrder"
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="UOM" UniqueName="UOM" meta:Resourcekey="GridColumn_UOM"
                                        HeaderStyle-HorizontalAlign="Center" SortExpression="UOM" Visible="False">
                                        <ItemTemplate>
                                            <%#IIf(Container.DataItem("UOM").ToString = String.Empty, "&nbsp;", Container.DataItem("UOM").ToString)%>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <telerik:RadComboBox ID="ddlUOM" Filter="Contains" MarkFirstMatch="true" Width="100%" Height="220px" DropDownWidth="120px" AllowCustomText="True" runat="server" Skin="Default">
                                            </telerik:RadComboBox>
                                        </EditItemTemplate>
