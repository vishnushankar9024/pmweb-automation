        ...
        <telerik:RadGrid ID="rdgSpecifications" ShowGroupPanel="false" runat="server"   HeaderStyle-Font-Size="8"  SetWidth="true" ClientSettings-Scrolling-AllowScroll="true" AppendMenus="true"
                ...
                <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
                    ...
                    <Columns>                                    
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="80px" HeaderText="UOM" SortExpression="UOM" UniqueName="UOM" Visible="False">
                            <ItemTemplate>
                       ...
                       <telerik:GridTemplateColumn UniqueName="Measure" HeaderText="Measure"  HeaderStyle-Width="200px"  SortExpression="Measure">
                           ...
                           <asp:LinkButton Visible="False" runat="server" ID="imgMemo" CssClass="SearchButton" OnClientClick="return OpenApplicationNoteDetailPopup(this.id.replace('imgMemo','txtMemo'))">
                       ...
                       <telerik:GridTemplateColumn Visible="False" UniqueName="Notes" HeaderText="Notes" HeaderStyle-Width="200px" SortExpression="Notes" GroupByExpression="Notes [Notes] Group By Notes ASC">
                           <ItemTemplate>
