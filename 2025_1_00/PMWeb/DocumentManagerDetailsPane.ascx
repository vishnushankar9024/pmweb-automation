...
<div id="divDetails" runat="server" class="PMHeader detailPane" visible="false">
    ...
    <div style="margin-top:15px;" id="imgDiv" runat="server" visible="false">
        <div class="col-12">
            <div style="padding: 0 40px; text-align:center">
                <asp:Image ID="imgDisplay" CssClass="imgDisplayDetailsPane" style="max-height:200px; max-width:400px; display:block;width:auto;height:auto; margin: 0 auto" runat="server" />
            </div>
        </div>
    </div>
    <div class="row" id="divTopButtons" runat="server" visible="true">
        <div class="col-12" style="display: flex; justify-content: space-between">
            <asp:LinkButton ID="btnEdit" Visible="true" CssClass="Edit" runat="server" meta:resourcekey="btnEdit">
            ...
            <asp:LinkButton ID="btnSave" Visible="false" runat="server" CssClass="Save" meta:resourcekey="btnSave" CausesValidation="true" ValidationGroup="Save">
                    <span class="Icon"></span>
            </asp:LinkButton>
    ...
    <div class="row" style="padding-top: 16px !important">
        <asp:Button ID="btnSubmit" runat="server" meta:ResourceKey="btnSubmit" Text="Submit" Style="text-transform: uppercase; width: 100%" OnClientClick="return OpenWorkflowSubmitPopup('FILEMANGER');" />
    </div>
            ...
            <table class="colTable" id="fileContentTable" runat="server"> 
                <tr>
                    ...
                    <td class="controlWidth">
                        <asp:TextBox ID="txtDescription" Visible="false" runat="server" Width="100%"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td class="controlWidth">
                        <telerik:RadComboBox ID="ddlType" Width="100%" Filter="Contains"
                            Skin="Metro" CloseDropDownOnBlur="true" EnableItemCaching="true"
                            NoWrap="True" AllowCustomText="true"
                            EnableLoadOnDemand="False" EnableVirtualScrolling="true" Visible="false"
                ...
                <tr>
                    ...
                    <td class="controlWidth">
                        <telerik:RadComboBox ID="ddlCategory" Width="100%" Filter="Contains"
                            Skin="Metro" CloseDropDownOnBlur="true" EnableItemCaching="true"
                            NoWrap="True" AllowCustomText="true"
                            EnableLoadOnDemand="False" EnableVirtualScrolling="true" Visible="false"
                            AutoPostBack="False" runat="server">
                ...
                <tr id="trGeolocation" runat="server">
                     <td class="labelWidth">
                         ...
                         <div style="float: right; display: inline-block; position: relative; bottom: -1px;" runat="server" id="btnGeolocation">
                             <asp:LinkButton CssClass="SearchButton" runat="server" ID="btnGoogleAddress">
                                 <span class="Icon"></span>
                             </asp:LinkButton>
                         </div>
                    </td>
                ...
                <tr runat="server" id="trAttributesHeader">
