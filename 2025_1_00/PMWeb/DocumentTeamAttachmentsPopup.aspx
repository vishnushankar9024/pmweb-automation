<%@ Page meta:resourcekey="Page" Language="vb" AutoEventWireup="false" CodeBehind="DocumentTeamAttachmentsPopup.aspx.vb" Inherits="Website.DocumentTeamAttachmentsPopup" %>
    ...
    <form id="form1" runat="server">
                ...
                <td class="ToolbarTd">
                    <telerik:RadToolBar ID="mainToolBar" runat="server" Skin="Default" AutoPostBack="true" Width="100%">
                        <Items>
                            ...
                            <telerik:RadToolBarButton EnableImageSprite="true" CssClass="ToolbarCancel" CommandName="Close"></telerik:RadToolBarButton>
                        </Items>
                    </telerik:RadToolBar>
                </td>
            </tr>
        ...
        <div class="PMHeader">
            <div class="row documentSinglePage">
                <telerik:RadGrid ID="rdgActionAttachments" runat="server" Skin="Default" ItemStyle-HorizontalAlign="Left" AlternatingItemStyle-CssClass="Left"
                    Width="100%" SetWidth="true" FitParentContainer="true" ClientSettings-Scrolling-AllowScroll="true" AutoGenerateColumns="False"
                    HeaderStyle-Font-Size="8" AllowSorting="true" ShowStatusBar="true">
                    <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>" DataKeyNames="AttachmentId" ClientDataKeyNames="AttachmentId">
                        <Columns>
                            <telerik:GridTemplateColumn HeaderText="" HeaderStyle-Width="80px" ItemStyle-Wrap="false" UniqueName="AttachPreview">
                                <ItemTemplate>
                                    <asp:Image ID="imgAttachPreview" runat="server" />&nbsp;
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>

                            <telerik:GridTemplateColumn HeaderText="File Name" HeaderStyle-Width="200px" DataField="FileNameWithExtension" CurrentFilterFunction="Contains"
                            ...
                            <telerik:GridTemplateColumn ItemStyle-Wrap="false" DataField="FileSize" CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType"
                                AutoPostBackOnFilter="true" HeaderText="Size" HeaderStyle-Width="110px" UniqueName="FileSize" SortExpression="FileSize"
                            ...
                            <telerik:GridTemplateColumn ItemStyle-Wrap="false" DataField="FileExtension" CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType"
                                AutoPostBackOnFilter="true" HeaderText="Ext." HeaderStyle-Width="50px" UniqueName="FileExtension" SortExpression="FileExtension"
                            ...
                            <telerik:GridTemplateColumn HeaderText="Attached By" DataField="AttachedBy" ItemStyle-Wrap="false" UniqueName="AttachedBy"
                                CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true" HeaderStyle-Width="120px"
                            ...
                            <telerik:GridTemplateColumn HeaderText="Attached Date" DataField="AttachedDate" ItemStyle-Wrap="false" UniqueName="AttachedDate"
                                CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true" HeaderStyle-Width="100px"
