...
<div class="PMHead HomePageManagerLayoutMargin" >
    <div class="row">
        <div class="col-1">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="col-4">
                                                <table class="colTable">
                                                    ...
                                                    <tr>
                                                        <td class="labelWidth">
                                                            <asp:Label ID="lblFreezeColumns" runat="server" meta:resourcekey="lblFreezeColumns" Text="Freeze Columns" />
                                                        </td>
                                                       <td style="text-align: right; width: 10% !important;">
                                                            <label class="switch">
                                                                <input id="chkFreezeColumns" runat="server" type="checkbox" />
                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr>
                                                        <td class="labelWidth" style="width: 90% !important;">
                                                            <asp:Label ID="lblFreezeColumnsNumber" runat="server" meta:resourcekey="lblFreezeColumnsNumber" Text="Freeze Columns Number" />
                                                        </td>
                                                        <td class="controlWidth">
                                                            <telerik:RadNumericTextBox ID="txtFreezeColumnsNumber" CssClass="Right" Value="0" MinValue="0" Type="Number" 
                                                                ShowSpinButtons="true" MaxValue="31" Width="100%" runat="server" style="text-align:left;">
                                                    ...
                                                    <tr>
                                                        <td class="labelWidth">
                                                            <asp:Label ID="lblPageSize" runat="server" meta:resourcekey="lblPageSize" Text="Default Page Size" />
                                                        </td>
                                                        <td class="controlWidth">
                                                            <telerik:RadComboBox ID="ddlPageSize" Height="200px"  Filter="Contains" runat="server" Width="100%" Skin="Default"
                                                                CloseDropDownOnBlur="true" EnableItemCaching="false" EmptyMessage="Select"
                                                                NoWrap="True" EnableLoadOnDemand="True" ShowMoreResultsBox="true" EnableVirtualScrolling="true"   >
                                                                <Items>
                                                                    ...
                                                                    <telerik:RadComboBoxItem Text="250" Value="250" />
                                                                </Items>
                                                            </telerik:RadComboBox>
                                                        </td>
                                                    </tr>
                                                     ...
                                                     <tr>
                                                        <td class="labelWidth" style="width: 90% !important;">
                                                            <asp:Label ID="lblVirtualScrolling" runat="server" meta:resourcekey="lblVirtualScrolling" Text="Virtual Scrolling" />
                                                        </td>
                                                        <td style="text-align: right; width: 10% !important;">
                                                            <label class="switch">
                                                                <input id="ChckVirtualScrollingControl" runat="server" type="checkbox" />
                                                                <span class="slider round"></span>
                                                            </label>
                                                        </td>
                                                    </tr>
