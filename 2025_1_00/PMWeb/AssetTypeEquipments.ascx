...
<div class="PMHeader">
    <div class="row">
        <div class="col-12 ResponsiveMargin">
            <telerik:RadGrid ID="rdgAssetTypeEquipments" runat="server"   HeaderStyle-Font-Size="8"  CssClass="WithoutTopBorder RDGAssetsGrid" SetWidth="true" MasterTableView-AllowSorting="true"
