...
<head id="Head1" runat="server">
    <title></title>ReportsPreviewPopup.aspx
    ...
    <script type="text/javascript">
        ...
        function OpenNotificationMultipleCompanyFilterPopup(txtContact, txtEmail, txtIds, Type, Source) {
            ...
            var EntityId = querySt('EntityId');
                ProjectId = EntityId
            var wnd = window.radopen('CompaniesFilterPopup.aspx?txtContact=' + txtContact + '&Bidder=0&txtEmail=' + txtEmail + '&Type=' + Type + '&txtIds=' + txtIds + '&ddlType=Multiple&Source=' + Source + '&ProjectRequired=0&ProjectId=' + ProjectId);
            if (isMobileScreen()) {
