...
<%@ Register Src="ngDocNotes.ascx" TagName="DocumentNotes" TagPrefix="uc6" %>
<%@ Register Src="ngDocAttachments.ascx" TagName="DocumentAttachments" TagPrefix="uc7" %>
    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        ...
        <script type="text/javascript">
            ...
            function maintoolbarClick(Value) {
                ...
                switch (Value) {
                    ...
                    case 'BluebeamSync':
                        ...
                        break;
                    case 'Submit':
                        return OpenWorkflowSubmitPopup('BLUEBEAMMARKUPS');
                        break;
            ...
            function OpenBlueBeamLoginPopup() {
                ...
                window.document.location.href = 'BlueBeamLoginPopup.aspx?Action=Authenticate';
                return false;
            }
                                    ...
                                    <Items>
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem Text="Submit" Value="Submit" onclick="OpenWorkflowSubmitPopup('BLUEBEAMMARKUPS');" CssClass="Help" EnableImageSprite="true" ></telerik:RadMenuItem>
