...
<div class="PMHeader">
    <div class="row">
        <div class="col-12 ResponsiveMargin">
            <telerik:RadGrid ID="rdgFundingDetails" AllowMultiRowSelection="true" runat="server" CssClass="WithoutTopBorder"  ShowFooter="true"
    ...
    ShowStatusBar="true" AllowPaging="true" PageSize="250" UseEditFormInMobile="true">
    ...
    <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
        ...
        <Columns>
            ...
            <telerik:GridTemplateColumn HeaderText="Source" DataField="FundingSourceText" SortExpression="FundingSourceText" 
                ...
                <EditItemTemplate>
                    <telerik:RadComboBox ID="ddlFundingSources" Width="100%" Height="300px" runat="server" AllowCustomText="true" OnItemsRequested="ddl_ItemsRequested" Filter="Contains"
                        EnableLoadOnDemand="true" NoWrap="true" ShowMoreResultsBox="True" EnableVirtualScrolling="True"></telerik:RadComboBox>
                </EditItemTemplate>
