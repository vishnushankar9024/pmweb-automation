                                            ...
                                            <td valign="top" style="height: 215px">
                                                <fieldset style="height: 230px; width: 420px;">
                                                    ...
                                                    <div style="height: 215px; overflow: auto; border: solid 1px #688caf">
                                                        <telerik:RadGrid ID="rdgAttachToEmail" BorderStyle="None" runat="server" Height="100%" AllowPaging="true" PageSize="250" Width="100%" AutoGenerateColumns="False" HeaderStyle-Font-Size="8" AllowMultiRowEdit="false" AllowMultiRowSelection="false" ShowGroupPanel="false" AllowSorting="false" AllowFilteringByColumn="false">
