...
<style>
 ...
 <div class="PMHeader" style="padding-top:0px">
    <div class="row">
        <div class="col-2" style="padding-right:20px;width:fit-content;">
             <telerik:RadTabStrip ID="tbsSpecs" CssClass="tbsSpecPC tbsFolderManagerSpecs tbsDocSpec" Height="100%" 
                ...
                EnableViewState="True" ScrollChildren="true" ScrollButtonsPosition="Left" CausesValidation="False" AutoPostBack ="true" >
            </telerik:RadTabStrip>
                ...
                <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="80px"
                            SortExpression="UOM" UniqueName="UOM" DataField="UOM" >
                            <ItemTemplate>
