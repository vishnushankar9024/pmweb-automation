...
<%@ Register Src="ngDocChecklists.ascx" TagName="DocumentCheckList" TagPrefix="uc7" %>
...
<%@ Register Src="ngDocCollaborate.ascx" TagName="DocumentTeam" TagPrefix="uc17" %>
    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function contextM(div, event) {
                ...
                if (DetailId != '0') {
                    OpenPOPUp("UnitRecap.aspx?Source=COSTMANAGEMENT_CONTRACT&DetailId=" + DetailId, 740, 500, false);
                }
                try {
            ...
            function MoreMenuClicked(sender, args) {
                if (args.get_item().get_value() != null && args.get_item().get_items().get_count() == 0)
                    sender.close(true);
                if (args.get_item().get_value() == "GenerateContractChangeOrder") {
                    var mainToolBar = $find("<%= mainToolBar.ClientID%>");
                    var button = mainToolBar.findItemByValue("GenerateContractChangeOrder");
                        button.click();
                    }
                if (args.get_item().get_value() == "GenerateContractRequisition") {
                        var mainToolBar = $find("<%= mainToolBar.ClientID%>");
                    var button = mainToolBar.findItemByValue("GenerateContractRequisition");
                        button.click();
                    }
                ...
                <telerik:RadToolBar ID="mainToolBar"
                    ...
                    <Items>
                                        ...
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem EnableImageSprite="true" Text="Generate" Value="Generate" CssClass="Generate">
                                                    <Items>
                                                        <telerik:RadMenuItem Text="Generate Contract Change Order"  Value="GenerateContractChangeOrder"></telerik:RadMenuItem>
                                                        <telerik:RadMenuItem Text="Generate Requisition"  Value="GenerateContractRequisition"></telerik:RadMenuItem>
                        ...
                        <telerik:RadToolBarSplitButton CommandName="Generate" PostBack="false" ImageUrl="Images/ToolBar/Generate.png"
                            ...
                            <Buttons>
                                <telerik:RadToolBarButton Text="Generate Contract Change Order" Width="150px" Value="GenerateContractChangeOrder" CommandName="GenerateContractChangeOrder" ImageUrl="Images/CostControl/ChangeOrder.png"></telerik:RadToolBarButton>
                                 <telerik:RadToolBarButton Text="Generate Requisition" Width="150px" Value="GenerateContractRequisition" CommandName="GenerateContractRequisition" ImageUrl="Images/CostControl/ChangeOrder.png"></telerik:RadToolBarButton>
                        ...
                        <div class="col-4 col-4-left ">
                            <table class="colTable">
                                ...
                                <tr runat="server" id="trCurrency">
                                 ...
                                 <tr>
                                    <td class="labelWidth">
                                        <asp:Label ID="lblType" runat="server" Text="Type" meta:Resourcekey="lblTypeContracts"></asp:Label>
                                    </td>
                                    <td class="controlWidth">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvContractType" runat="server" ControlToValidate="ddlTypes"
                                        ...
                                        <asp:CustomValidator ID="csvContractType" runat="server" ControlToValidate="ddlTypes"
