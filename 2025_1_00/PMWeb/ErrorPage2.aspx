                ...
                <td rowspan="2" class="tdSidebar" valign="top">
                    <div id="SideBar1">
                        <div id="img_pmweb" style="text-align: center">
                            <img id="imgLogo" style="margin-top: 40px" src="CSS/Images/LoginLogo.png" />
                        </div>

                        <div style="color: white !important; margin-right: 24px; margin-top: 100px; font-size: 12px;">
                            PMWeb was not able to process your request at
                            <br />
                            this time, please try again later. For immediate
                            <br />
                            assistance, please contact your PMWeb
                            <br />
                            administrator.
                        </div>
                        <asp:LinkButton runat="server" ID="btnHelp" OnClientClick="return OpenPOPUpAngular('AboutPMWeb.aspx')" Style="color: white !important; margin-top: 100px; display: block; text-decoration: none">
