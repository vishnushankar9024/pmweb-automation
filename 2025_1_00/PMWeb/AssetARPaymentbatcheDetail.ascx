<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="AssetARPaymentbatcheDetail.ascx.vb" Inherits="Website.AssetARPaymentbatcheDetail" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<telerik:RadAjaxManagerProxy ID="AjaxManagerProxy1" runat="server">
    <AjaxSettings>
        <telerik:AjaxSetting AjaxControlID="rdgARPayments">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="rdgARPayments" LoadingPanelID="ldpPM" />
...
<div class="PMHeader">
    <div class="row">
        <div class="col-12 ResponsiveMargin">
            <telerik:RadGrid ID="rdgARPayments" GroupingEnabled="true" runat="server" AutoGenerateColumns="False" AllowFilteringByColumn="true" FilterType="HeaderContext" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true"
                AllowMultiRowEdit="True" AllowMultiRowSelection="True" ItemStyle-Height="20px" GridLines="None" HeaderStyle-Font-Size="8"
                PageSize="250" AllowPaging="true" ShowGroupPanel="True" AllowSorting="true" ShowStatusBar="False" ShowFooter="true" UseEditFormInMobile="true" Width="100%">
                ...
                <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>" DataKeyNames="Id" CommandItemDisplay="Top"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="110px" UniqueName="LinkedInvoice" ItemStyle-Wrap="false" HeaderText="Linked A/R Invoice1" DataField="LinkedInvoice"
                            CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" Groupable="true" Reorderable="true"
                            ...
                            <EditItemTemplate>
                                <telerik:RadComboBox ID="ddlLinkedARInvoice" Filter="Contains" OnSelectedIndexChanged="ddlLinkedARInvoice_SelectedIndexChanged" MarkFirstMatch="true" AllowCustomText="true"
                                    runat="server" AutoPostBack="true" Skin="Default" DropDownWidth="255px" NoWrap="true" Width="100%"
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="110px" UniqueName="PaymentAmount" ItemStyle-Wrap="false" HeaderText="Payment Amount1"
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="txtPaymentAmount" CssClass="Currency" MinNumber="0" runat="server" Width="100%" Text='<%#FormatCurrency(Eval("PaymentAmount")) %>'></asp:TextBox>
                            </EditItemTemplate>
                            <HeaderStyle Width="110px" />
                            <ItemStyle HorizontalAlign="Right" />
                            <FooterStyle HorizontalAlign="Right" />
                    ...
                    <CommandItemTemplate>
                        <div style="padding: 2px">
                            ...
                            <asp:LinkButton ID="btnLink" runat="server" CausesValidation="False" SecurityButtonType="ItemMode_Add" CommandName="LinkPayments" CssClass="GridCmdLinkPayments" OnClientClick="return OpenSelectAssetARPaymentsPopup();"
                                Visible='<%# rdgARPayments.EditIndexes.Count = 0 And (Not rdgARPayments.MasterTableView.IsItemInserted) %>' meta:resourcekey="btnAddResource1">
                                <span class="Icon"></span>
                                <asp:Label ID="Label2" runat="server" Text="Add line"></asp:Label>
                                &nbsp;&nbsp;
                            </asp:LinkButton>
                            <asp:LinkButton ID="btnUnlink" CausesValidation="False" SecurityButtonType="ItemMode_Delete" CssClass="GridCmdUnlinkPayments"
                                Visible='<%# rdgARPayments.EditIndexes.Count = 0 And (Not rdgARPayments.MasterTableView.IsItemInserted) %>'
                            ...
                            <asp:LinkButton ID="btnPayInvoices" runat="server" CausesValidation="False" SecurityButtonType="ItemMode_Add" CommandName="PayInvoices" CssClass="GridCmdPayInvoices" OnClientClick="return OpenAssetPayARInvoicesPopup();"
                ...
                <ClientSettings ClientEvents-OnRowDblClick="RowDblClick" Resizing-AllowColumnResize="true" Resizing-ResizeGridOnColumnResize="true" Resizing-ClipCellContentOnResize="true" AllowDragToGroup="true" AllowColumnsReorder="true">
