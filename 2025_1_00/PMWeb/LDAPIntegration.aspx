...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <style>
        ...
        .checkboxHeight input[type="checkbox"]{
            height: 13px;
        }
                                    ...
                                    <table class="colTable" width="100%">
                                        ...
                                        <tr>
                                            <td class="labelWidth" style="display: flex;">
                                                <asp:CheckBox ID="chkUseAuthentication" Text="UseAuthentication11" runat="server" meta:resourcekey="chkUseAuth" class="checkboxHeight"/>
                                            </td>
                                            <td class="controlWidth">
                                        ...
                                        <tr>
                                            <td class="labelWidth" style="display: flex;">
                                                <asp:CheckBox ID="chkUseFilter" Text="UseFilter11" runat="server" meta:resourcekey="chkUseFilter" class="checkboxHeight" />
                                            </td>
                                            <td class="controlWidth">
