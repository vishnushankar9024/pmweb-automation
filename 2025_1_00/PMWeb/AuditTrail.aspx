    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function Audit_GetValueToReturn(combo, eventArgs) {
                ...
                if (ServerId == "ddlProjects") {
                    var programHiddenField = $("[id$='hddnddlProgramsValues']")[0];
                    context["ProgramIds"] = programHiddenField.value;
                }
            ...
            function CheckComboItem(sender, ComboClientId, SelectedValue) {
                ...
                if (ServerId == "ctl00_CPH1_ddlPrograms") {
                    var ddlProjects = $find("ctl00_CPH1_ddlProjects");
                    ddlProjects.set_selectedIndex(-1)
                    ddlProjects.clearItems();
                    $("[id$='hddnddlProjectsValues']")[0].value = "0"
                       ddlProjects.set_text(TranslatedAll);
                }
                if (ServerId.lastIndexOf('_') >= 0) {
                    ServerId = ServerId.substring(ServerId.lastIndexOf('_') + 1, ServerId.length);
                    PreClientId = combo.get_id().substring(0, combo.get_id().lastIndexOf('_') + 1);
                    ...
                    <div class="row">
                        <div class="col-4 col-4-left">
                            <table class="colTable">
                                ...
                                <tr>
                                    <td class="labelWidth">
                                        <asp:Label ID="lblPrograms" runat="server" Text="Program(s)" meta:resourcekey="lblPrograms"></asp:Label>
                                    </td>
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlPrograms" runat="server" Width="100%" OnClientItemsRequested="Audit_StopPropagation"
                        ...
                        <div class="col-4 col-4-middle">
                            <table class="colTable" border="0">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlRecordTabs" Filter="Contains" MarkFirstMatch="true" runat="server" Width="100%" AllowCustomText="true" OnClientDropDownOpened="Audit_StopPropagation"
                            ...
                            <div class="col-4 col-4-left">
                                <table class="colTable">
                                    <tr>
                                        ...
                                        <td class="controlWidth">
                                            <span runat="server" id="rmd_rdpStartDate" style="display: block ; width: 100%">
                            ...
                            <div class="col-4 col-4-right">
                                 <table class="colTable">
                                     <tr>
                                         ...
                                         <td class="controlWidth">
                                             <span runat="server" id="rmd_rdpEndDate" style="display: block ; width: 100%">
                    ...
                    <div class="row">
                                                <div class="col-12">
                                                    <table class="colTable">
                                                        <tr>
                                                            <td style="">
                                                                <telerik:RadGrid ID="RDG" runat="server" AutoGenerateColumns="False" ShowStatusBar="True" Font-Size="8px" PageSize="250" ClientSettings-Scrolling-AllowScroll="true" SetWidth="true"
                                                                    ...
                                                                    <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>" ClientDataKeyNames="Id"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <telerik:GridTemplateColumn HeaderText="Program/Location (current)" DataField="Program" AutoPostBackOnFilter="true"
                                                                                SortExpression="Program" UniqueName="Program" GroupByExpression="Program [GridColumn_Program] Group By Program ASC">
                                                                                <ItemTemplate>
                                                                                    <span><%#IIf(Container.DataItem("Program") = String.Empty, "&nbsp;", Container.DataItem("Program"))%></span>
                                                                                </ItemTemplate>
