    ...
    <form id="form1" runat="server">
        ...
        <telerik:RadCodeBlock ID="rdcb" runat="server">
            <script type="text/javascript">
                ...
                function ddlAddedSelectedIndexChanged(sender, args) {
                    var index = sender.get_selectedIndex();
                    var trFrom = document.querySelector("#trAddedFrom");
                    var trTo = document.querySelector("#trAddedTo");
                    if (index == 6) {
                        trFrom.style.display = "table-row";
                        trTo.style.display = "table-row";
                    }
        ...
        <table class="TableNoSpacingNoBorder" style="width: 100%; margin-top: 12px">
            <tr>
                            ...
                            <div class="col-4">
                                <table class="colTable">
                                    ...
                                    <tr style="display: table-row !important">
                                     ...
                                     <tr>
                                        <td class="labelWidth" style="width:160px !important">
                                            <asp:Label ID="lblAddedBy" runat="server" Text="Added By" meta:Resourcekey="lblAddedBy"></asp:Label>
                                        </td>
                                        <td class="controlWidth" style="width:240px !important">
                                            <asp:TextBox ID="txtAddedBy" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="labelWidth" style="width:160px !important">
                                        ...
                                        <td class="controlWidth" style="width:240px !important">
                                            <telerik:RadComboBox ID="ddlAdded" runat="server" OnClientSelectedIndexChanged="ddlAddedSelectedIndexChanged">
                                                <Items>
                                    ...
                                    <tr id="trAddedFrom" style="display:  none !important">
                                        <td class="labelWidth"></td>
                                        <td class="controlWidth">
                                            <telerik:RadDatePicker runat="server" ID="dtpAddedFromDate"></telerik:RadDatePicker>
                                        </td>
                                    </tr>
                                    <tr id="trAddedTo" style="display:  none !important">
                                        <td class="labelWidth" style="width:160px !important"></td>
                                        <td class="controlWidth" style="width:240px !important">
                                            <telerik:RadDatePicker runat="server" ID="dtpAddedtoDate"></telerik:RadDatePicker>
                                        </td>
                                    </tr>
                                        <tr>
                                        <td class="labelWidth" style="width:160px !important">
