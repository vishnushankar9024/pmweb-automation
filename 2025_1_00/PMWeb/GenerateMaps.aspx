    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        ...
        <script type="text/javascript">
            ...
            function CheckddlToRecord(sender, args) {
                ...
                else if (combo.get_selectedItem() != null && combo.get_selectedItem().get_index() > 0) {
                    args.IsValid = true;
                }
                else {
                    args.IsValid = false;
                    ...
                    <div class="col-6">
                        ...
                        <fieldset>
                            ...
                            <telerik:RadGrid ID="rdgMapping" runat="server" AutoGenerateColumns="False" AllowSorting="true" SetWidth="true" AppendMenus="true" FitParentContainer="true"
                                HeaderStyle-Font-Size="8" ShowStatusBar="true" PageSize="250" ShowFooter="false" ClientSettings-Scrolling-AllowScroll="true">
