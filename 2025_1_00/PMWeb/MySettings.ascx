...
<telerik:radajaxpanel runat="server" id="pnlajax" loadingpanelid="ldpPM">
    <table style="width: 100%; padding-left:24px;background-color: #ededed" cellpadding="0" cellspacing="0">
        <tr>
                    ...
                    <telerik:RadToolBar ID="SaveToolBar" CssClass="popup-toolbar" runat="server" Skin="Default" AutoPostBack="True">
                        <Items>
                            <telerik:RadToolBarButton SecurityButtonType="Edit" EnableImageSprite="true" 
                                CommandName="Save" ValidationGroup="Save"  CssClass="ToolbarSave" Value="Save">
                            </telerik:RadToolBarButton>
                        </Items>
                    </telerik:RadToolBar>
                </td>
                            ...
                            <Columns>
                                ...
                                <telerik:GridTemplateColumn HeaderText="Tab Label*" UniqueName="TabName" HeaderStyle-Width="170px"
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvTabName" ControlToValidate="txtShowTabName"
                                    ...
                                    <EditItemTemplate>
                                        ...
                                        <div>
                                            <asp:RequiredFieldValidator ID="rfvTabName"
                                                runat="server" ControlToValidate="txtTabName" CssClass="Validator"
                                                ErrorMessage="Required" Display="Dynamic" ValidationGroup="Save">
                                            </asp:RequiredFieldValidator>
                                        </div>
                                    </EditItemTemplate>
                                </telerik:GridTemplateColumn>
