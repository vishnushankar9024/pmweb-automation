...
<%@ Register Src="SystemSettingsDetails.ascx" TagName="SystemSettings" TagPrefix="uc15" %>
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        ...
        var hasConditionalSecurityOpen = false;
        var SegmentOneIsOpen = false;
        var SegmentTwoIsOpen = false;
        var SegmentThreeIsOpen = false;
        var FlyoutIsOpen = false;
            window.onload = function () {
                //ChangeOrders();
                TabSelected();
                //PaddingRemove();
                //BreadCrumb on button click animation
                document.addEventListener("click", function (event) {
                    ...
                    if (Segments[0] != undefined && (event.target.id === Segments[0].id || event.target.id === Segments[1].id || event.target.id === Segments[2].id || event.target.id === $("[id$=btnPortfolio]")[0].id)) {
        ...
        function fixSplitterSize1(isRail) {
...
<style type="text/css">
        ...
        .SettingsMainTab .rtsLI {
            position: relative;
                }
           .SettingsMainTab .rtsSelected:after {
            position: absolute;
            content: " ";
            width: 100%;
            height: 2px;
           ...
           .SettingsMainTab .rtsLI:hover::after {
            position: static; 
                }
                    ...
                    <div class="row">
                        ...
                        <div class="col-10" id="divGrids">
                            <telerik:RadMultiPage ID="mlpGeneralSettings" SelectedIndex="0" runat="server">
                                <telerik:RadPageView runat="server" ID="pvSystemSettings" >
                                    <uc15:SystemSettings Id="SystemSettings" runat="server" ></uc15:SystemSettings>
                                </telerik:RadPageView>
                                <telerik:RadPageView runat="server" ID="pvProjectGeneralSettings" TabIndex="1">
                                    <table width="100%"  id="tableEntities" cellpadding="0" cellspacing="0">
                                ...
                                <telerik:RadPageView runat="server" TabIndex="2" ID="pvAssetGeneralSettings">
