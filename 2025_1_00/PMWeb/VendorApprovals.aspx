...
<%@ Register Src="~/ngDocWorkflow.ascx" TagName="WorkflowDocument" TagPrefix="uc13" %>
<%@ Register Src="ngDocNotes.ascx" TagName="DocumentNotes" TagPrefix="uc9" %>
<%@ Register Src="ngDocAttachments.ascx" TagName="DocumentAttachments" TagPrefix="uc10" %>
...
<%@ Register Src="ngDocSpecs.ascx" TagName="DocumentSpecifications" TagPrefix="uc15" %>
            ...
            function maintoolbarClick(Value) {
                ...
                switch (Value) {
                    ...
                    case 'New':
                        ...
                        break;
                    case 'Submit':
                        var ApprovalId = document.getElementById("ctl00_CPH1_txtApprovalId").value;
                        if (ApprovalId !== "") {
                            return OpenWorkflowSubmitPopup('VENDORAPPROVALS');
                        }
                        else {
                            return false;
                        }
                                    ...
                                    <Items>
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem Text="Submit" Value="Submit" onclick="OpenWorkflowSubmitPopup('VENDORAPPROVALS');" CssClass="Help" EnableImageSprite="true" ></telerik:RadMenuItem>
                        ...
                        <div class="col-4 col-4-left ">
                            <table class="colTable">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlType" runat="server"  Filter="Contains" MarkFirstMatch="true" Skin="Default" Style="font-size: 11px" AllowCustomText="true"></telerik:RadComboBox>
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlCountry"  Filter="Contains" MarkFirstMatch="true" runat="server" Skin="Default" Style="font-size: 11px" AllowCustomText="true" ></telerik:RadComboBox>
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlState" runat="server"  Filter="Contains" MarkFirstMatch="true" Skin="Default" Style="font-size: 11px" AllowCustomText="true"></telerik:RadComboBox>
