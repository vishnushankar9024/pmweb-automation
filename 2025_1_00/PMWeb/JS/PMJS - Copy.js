...
var skippages = ["properties.aspx", "buildings.aspx", "floors.aspx", "spaces.aspx", "equipments.aspx", "asset_suites.aspx", "leases.aspx", "workorders.aspx", "mergetemplates.aspx", "reservationrequest.aspx", "rfi.aspx", "vendorapprovals.aspx"]
    ...
    if (sender != null) {
        ...
        if (containingGrid) {
            if (containingGrid.isContentEditable === false)
                var wnd = window.radopen('HtmlNotes.aspx?ObjectType=' + ObjectType + '&RecordId=' + RecordId + '&ColumnName=' + ColumnName + '&LiteralID=' + LiteralID + '&EditMode=0', null);
            else
