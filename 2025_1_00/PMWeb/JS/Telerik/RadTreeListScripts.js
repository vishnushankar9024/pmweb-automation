...
//var j = this.get_element().getElementsByClassName("rtlPagerCell");
var j = $(".rtlPagerCell", this.get_element());
for(var h=0;
h<j.length;
...
if($telerik.isIE7){var a=this.get_element().getElementsByTagName("col");
for(e=0;
e<a.length;
e++){var d=a[e];
...
var c=this;
if($telerik.isIE7){c._adjustPadding(c._dataDiv,c._headerDiv,true);
...
if($telerik.isIE7){var e=this._owner.get_columns();
for(var g=0;
g<c;
...
if(this.get_element().className.indexOf("rtlCF")>-1){var b=($telerik.isIE7)?this._correctSpanForIE(this._columnElement):(this._columnElement.colSpan-1)*this._getFirstColWidth();
...
if($telerik.isIE7){a=parseInt(this._columnElement.currentStyle.borderLeftWidth,10)+parseInt(this._columnElement.currentStyle.borderRightWidth,10)+parseInt(this._columnElement.currentStyle.paddingLeft,10)+parseInt(this._columnElement.currentStyle.paddingRight,10);
...
if($telerik.isIE7){a=this._ownerElement.offsetWidth-2;
}var b=a+(d-c)+"px";
