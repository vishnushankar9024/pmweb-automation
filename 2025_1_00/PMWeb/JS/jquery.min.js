...
jQuery.fn.numeric = function (options, callback) {
    ...
    this.focus(
        function (e) {
            ...
            var tr = $(this).parents(".rgEditForm:first");
            if (!tr || tr.length == 0)
            ...
            if (this.readOnly != "readOnly" && this.readOnly != "true" && this.readOnly != true) {
                if ($(this)[0].className === 'SpecDouble') {
                    $(this).val(numberFormatter.RemoveCharsSpecs($(this).val(), decimalCharacter, decimalSeparator));
	    ...
	    .blur(
		    function (e) {
		        ...
		        if (this.readOnly != "readOnly" && this.readOnly != "true" && this.readOnly != true) {
                    var val = jQuery(this).val();
                    if ($(this)[0].className === 'SpecDouble' && val === '') {
                        return this
                    }
		            var newVal;
		            if (isInt) {
