...
function ProjectExplorerStatusddlOpened(sender, args) {
    ...
    if (sender._value == -1) {
        document.querySelector(".rcbList").classList.add("SelectedItemClassNoImage");
    }
    $("#" + comboId + "_DropDown").find("input[type='checkbox']").each(function () {
        if (this.checked) {
            this.parentElement.parentElement.classList.add("SelectedItemClassNoImage");
        }
...
function ClearSelection(sender) {
    ...
    $("#" + comboID + "_DropDown").find("input[type='checkbox']").each(function () {
            this.checked = false;
            this.parentElement.parentElement.classList.remove("SelectedItemClassNoImage")
        this.parentElement.parentElement.parentElement.classList.remove("SelectedItemClassNoImage");
    });
