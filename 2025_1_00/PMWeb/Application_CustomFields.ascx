        ...
        <telerik:RadGrid ID="rdgSpecifications" ShowGroupPanel="false" runat="server"   HeaderStyle-Font-Size="8"  SetWidth="true" ClientSettings-Scrolling-AllowScroll="true" AppendMenus="true"
                ...
                <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
                    ...
                    <Columns>                                    
                       ...
                       <telerik:GridTemplateColumn UniqueName="Measure" HeaderText="Measure"  HeaderStyle-Width="200px"  SortExpression="Measure" ItemStyle-HorizontalAlign ="Left">
                           <ItemTemplate>
                               <asp:Label runat="server" ID="lblMeasure" ></asp:Label> 
                               <asp:Image runat="server" ID="imgMeasure" />                           
                            </ItemTemplate>
                            <EditItemTemplate>
