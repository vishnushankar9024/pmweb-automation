        ...
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="rdgReminders">
             ...
             <telerik:AjaxSetting AjaxControlID="btnOpenReminderEdit">
                ...
                <telerik:RadGrid ID="rdgReminders" runat="server"
                    AutoGenerateColumns="False" ShowStatusBar="false" ShowFooter="False"
                    Font-Size="8px" PageSize="250" AllowPaging="True" ShowGroupPanel="true" FilterType="HeaderContext" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true"
