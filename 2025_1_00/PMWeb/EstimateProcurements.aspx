...
<%@ Register Src="ngDocCollaborate.ascx" TagName="DocumentTeam" TagPrefix="uc13" %>
<%@ Register Src="DocumentSpecificationsHeader.ascx" TagName="DocumentSpecificationsHeader" TagPrefix="uc14" %>
<%@ Register Src="BidPackageRFIBid.ascx" TagName="BidPackageRFIBid" TagPrefix="uc15" %>
...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        <style>
          ...
          textarea.RfiBIdQuestion:disabled{
        ...
        <script type="text/javascript">
            ...
            function pageLoad() {
                ...
                $("#chkAll").change(function () {
                    if ($(this).prop("checked")) {
                        $('table[id$="tblOptions"] input[type="checkbox"]').prop("checked", true);
                    } else {
                        $('table[id$="tblOptions"] input[type="checkbox"]').prop("checked", false);
                    }
                })

                $('table[id$="tblOptions"]').not('#chkAll').on('change', 'input[type="checkbox"]:not("#chkAll")', function () {
                    if (!$(this).prop("checked")) {
            ...
            function chkParent() {
                var checked = true;
                $('table[id$="tblOptions"] input[type="checkbox"]:not("#chkAll")').each(function () {
                    if (!$(this).prop("checked")) {
                        checked = false;
                        return false;
                    }
            ...
            function maintoolbarClick(Value) {
                {
                    ...
                    case 'BIReporting':
                     ...
                     'location=no,status=0,menubar=0,addressbar=0,resizable=1,scrollbars=1,width=800,height=500,top=' + top + ',left=' + left);
                        ...
                        case 'Contract':
                            OpenPOPUpToRedirect('GenerateContractsFromBidPackages.aspx?type=Subcontract', 950, 500);
                            break;
            ...
            function HideCutOffCalender() {
                var CutOffCalender = $("[id$=rdpBidCutoffDate_popupButton]")[0];
                CutOffCalender.classList.add("Hide")
                var CutOffDate = $("[id$=rdpBidCutoffDate_dateInput]")[0];
                CutOffDate.readOnly = true;
            }
        </script>
        <script type="text/javascript">
                ...
                <telerik:RadToolBar ID="mainToolBar" runat="server" AutoPostBack="true" OnClientButtonClicked="click_handler">
                    <Items>
                                            ...
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem EnableImageSprite="true" Text="Generate" Value="Generate" CssClass="Generate">
                                                    <Items>
                                                        ...
                                                        <telerik:RadMenuItem Text="Contract" Value="Contract"></telerik:RadMenuItem>
                                                    </Items>
                                                </telerik:RadMenuItem>
                        ...
                        <telerik:RadToolBarSplitButton CommandName="Generate" PostBack="false" ImageUrl="Images/ToolBar/Generate.png"
                            ...
                            <Buttons>
                                <telerik:RadToolBarButton PostBack="false" CommandName="Commitment" ImageUrl="Images/ToolBar/PMWebW.gif"></telerik:RadToolBarButton>
                                  <telerik:RadToolBarButton PostBack="false" CommandName="Contract" ImageUrl="Images/ToolBar/PMWebW.gif"></telerik:RadToolBarButton>
    ...
    <telerik:RadMultiPage ID="mlpProcurements" runat="server" SelectedIndex="0" Width="100%" CssClass="documentMultiPages"
                        ...
                        <div class="col-4 col-4-left">
                            ...
                            <table class="colTable">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <asp:TextBox ID="txtDescription" MaxLength="500" runat="server"></asp:TextBox>
                                         <asp:RequiredFieldValidator ID="rfvDescription" Visible="false" runat="server" ControlToValidate="txtDescription" Display="Dynamic" ForeColor=""
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlBidCategories" runat="server" AllowCustomText="true" Width="100%" Skin="Metro" Filter="Contains" MarkFirstMatch="true">
                                         ...
                                         <asp:RequiredFieldValidator ID="rfvBidCategory" Visible="false" runat="server" ControlToValidate="ddlBidCategories" Display="Dynamic" ForeColor=""
                                            CssClass="Validator" InitialValue="" ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>" ValidationGroup="Save">
                                        </asp:RequiredFieldValidator>
                                        <asp:CustomValidator ID="csvBidCategory" Visible="false" runat="server" ControlToValidate="ddlBidCategories"
                                            ClientValidationFunction="ValidateCombo" ValidationGroup="Save" Display="Dynamic"
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        ...
                                        <telerik:RadComboBox
                                          ...
                                          <asp:RequiredFieldValidator ID="rfvBiddingCompany" Visible="false" runat="server" ControlToValidate="ddlCompanies" Display="Dynamic" ForeColor=""
                                            CssClass="Validator"  ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>" ValidationGroup="Save">
                                        </asp:RequiredFieldValidator>
                                         <asp:CustomValidator ID="csvBiddingCompany" Visible="false" runat="server" ControlToValidate="ddlCompanies"
                                            ClientValidationFunction="ValidateCombo" ValidationGroup="Save" Display="Dynamic"
                                            CssClass="Validator" ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>">
                                        </asp:CustomValidator>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlBidderContact" runat="server" Width="100%" 
                                         ...
                                         <asp:RequiredFieldValidator ID="rfvBiddingContact" Visible="false" runat="server" ControlToValidate="ddlBidderContact" Display="Dynamic" ForeColor=""
                                            CssClass="Validator"  ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>" ValidationGroup="Save">
                                        </asp:RequiredFieldValidator>
                                          <asp:CustomValidator ID="csvBiddingContact" Visible="false" runat="server" ControlToValidate="ddlBidderContact"
                                            ClientValidationFunction="ValidateCombo" ValidationGroup="Save" Display="Dynamic"
                                            CssClass="Validator" ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>">
                                        </asp:CustomValidator>
                                    </td>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlTypes" runat="server" Skin="Metro" Filter="Contains" MarkFirstMatch="true"></telerik:RadComboBox>
                                         <asp:RequiredFieldValidator ID="rfvType" Visible="false" runat="server" ControlToValidate="ddlTypes" Display="Dynamic" ForeColor=""
                                          ...
                                          <asp:CustomValidator ID="csvType" Visible="false" runat="server" ControlToValidate="ddlTypes"
                                            ClientValidationFunction="ValidateCombo" ValidationGroup="Save" Display="Dynamic"
                                            CssClass="Validator" ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>">
                                        </asp:CustomValidator>
                                    </td>
                                ...
                                <tr>
                                   ...
                                   <tr>
                                    <td class="labelWidth">
                                        <asp:Label ID="lblBidCutoffDate" meta:Resourcekey="lblBidCutoff" runat="server" Text="Bid RFI Cutoff Date"></asp:Label>
                                    </td>
                                    <td class="controlWidth">
                                ...
                                <tr>
                                    ...
                                    <tr>
                                    <td class="labelWidth">
                                        <asp:Label ID="lblContractId" meta:Resourcekey="lblContract" runat="server" Visible="false"></asp:Label>
                                        <asp:HyperLink runat="server" CssClass="Link" ID="hliContractId" meta:Resourcekey="lblContract" Visible="false"></asp:HyperLink>
                                    </td>
                                    <td class="controlWidth">
                                        <asp:TextBox ID="txtContractId" ReadOnly="true" runat="server" Text="" disabled="disabled"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </div>
                            ...
                            <fieldset style="width: 100%">
                                ...
                                <table id="tblOptions" class="TableOptionsNoSpacingNoBorder" width="100%" cellpadding="0" cellspacing="0" runat="server">
                                    ...
                                    <tr>
                                      ...
                                      <tr>
                                        <td class="labelChkWidth">
                                            <asp:Label runat="server" ID="lblNotifyBidContact" Text=" Notify Bid Contact on Bid RFI Questions" meta:Resourcekey="chkNotifyBidContact" ></asp:Label>
                                        </td>
                                        <td style="text-align: right;">
                                            <asp:CheckBox runat="server" ID="chkNotifyBidContact"/>
                                        </td>
                                    </tr>
                                </table>
                            </fieldset>
        ...
        <telerik:RadPageView ID="pvDetails" runat="server" Width="100%">
         ...
         <telerik:RadPageView ID="pvBIDRFIs" runat="server" >
            <uc15:BidPackageRFIBid ID="BIDRFIs" runat="server" />
            <asp:Button ID="btnRefreshAttachment" runat="server" class="Hide"/>
        </telerik:RadPageView>
