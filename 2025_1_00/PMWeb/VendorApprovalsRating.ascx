<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="VendorApprovalsRating.ascx.vb" Inherits="Website.VendorApprovalsRating" %>
...
<telerik:RadGrid ID="rdgRating" runat="server"   AutoGenerateColumns="False" ShowStatusBar="True" UseEditFormInMobile="true"
    ...
    <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>" DataKeyNames="Id" CommandItemDisplay="Top"   
        ...
        EnableHeaderContextMenu="true">
                ...
                <telerik:GridTemplateColumn HeaderText="Rating" UniqueName="Rating" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true" 
                            Groupable="true" Reorderable="true" SortExpression="Rating" GroupByExpression="Rating [GridColumn_Rating] Group By Rating ASC">
                    <ItemTemplate>
                ...
                <telerik:GridTemplateColumn HeaderText="Date"  UniqueName="Date" 
                  SortExpression="Date" GroupByExpression="Date [GridColumn_Date] Group By Date ASC">
                    ...
                    <EditItemTemplate>
                    <div>
                            <telerik:RadDatePicker ID="dtpDate" Height="13px" runat="server" MinDate="1901-01-01"
                ...
                <telerik:GridTemplateColumn HeaderText="User" UniqueName="User" 
                           SortExpression="User" GroupByExpression="User [GridColumn_User] Group By User ASC" >
                    <ItemTemplate>
                       <%#Eval("User").ToString%>
                    </ItemTemplate>
                    <EditItemTemplate>
