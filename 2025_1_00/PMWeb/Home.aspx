...
<%@ Register Src="ProjectExplorer.ascx" TagName="ProjectExplorer" TagPrefix="uc12" %>
<%@ Register Src="ngDocNotifications.ascx" TagName="NotificationLog" TagPrefix="uc13" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <telerik:radcodeblock id="RadCodeBlock1" runat="Server">
        ...
        <script language="javascript" type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                if (ua.includes("firefox") || (ua.includes("safari") && !ua.includes("chrome") && !ua.includes("chromium"))) {
                    $(".divMenuPages .row").each(function () {
                ...
                var Iframe = document.querySelector(".Homeiframe");
                if (Iframe != undefined && Iframe != null && Iframe != '') {
                    Iframe.addEventListener('load', function () {
                        var iframeWindow = Iframe.contentWindow;
                        iframeWindow.document.body.addEventListener('click', CloseSegment);
                    });
                }
                var webPageFrame = '<%= WebPageFrame.ClientID%>';
                if (pvWidget) {
                    var divPvWidget = $('#' + pvWidget)
                    if (showImage == "True" && backgroundimage != '') {
                ...
                $('#' + webPageFrame).on('load', function () {
                    var elementExt = document.getElementById("MasterToolbarTopExtension")
                    var elementbreadCrumb = document.querySelector(".tblBreadCrumSegment");
                    $(this).contents().find("head")
                        .append($("<style type='text/css'>:root {--Content-height: calc(100vh);} #ctl00_CPH1_ngFrame{height: calc(100vh - 94px) !important;} .drawer{display:none !important} .Folder_DocumentManager #ctl00_CPH1_rdgFiles .rgDataDiv {max-height: calc(100vh - 230px)!important;} .Folder_DocumentManager .detailPane{height: calc(100vh - 100px)!important;} .DocumentManagerTree {height: calc(100vh - 140px) !important;} .ToolBar.MsgTemplateToolbarHomePage{top: 33px !important;} .ToolBar.SecurityHomePageToolbar{top: 31px !important;} .SecurityMainTab .rtsLevel.rtsLevel1{width: 100% !important} .GroupsToolbarOnHomePage{margin-top:2px !important} .RadTabStrip.SecurityMainTab,.RadTabStrip.documentTabWithoutToolbar {top: 0 !important; padding-top: 0 !important;}  .ToolBar.ToolboxSettingsHomePage{top: 41px !important} .ToolBar.ManagerLayoutToolbarForHomePage{top: 41px !important} .MultiPageForHomePage {padding-top:50px !important} .HomePageManagerLayoutMargin{margin-top:35px !important}.SettingsMainTab .rtsLevel.rtsLevel1 {width: calc(100vw - 17px) !important;}.RadTabStrip.SettingsMainTab{width:100vw !important} .ToolBar.documentSubToolbar{margin-top:38px !important;top: 0 !important;} .RadTabStrip.EmailSetupTabs,.RadTabStrip.SettingsMainTab {top:0 !important} .AssetExplorerVerticalSplitter .documentTabs{top:0 !important} .MobileFixedMenu div{display:none !important} .RadTabStrip.WorkflowTabsOnMobile{top:0 !Important} .TopToolbarWorkflowCss{margin-top:0px !important;} .divContentHolder{padding-top:0px !important;} .ToolBar{top:0px; margin-top:0px;} .RadTabStrip{top:50px !important;left:0px !important;} .Top ,.bottomtoolbar,.MobileFixedMenu, .MenuContainer,.homeSecondHeader,.homeThirdHeader {display:none !important;} .Top.breadcrumbTable{display:block!important;padding:0 !important} .FolderManagerToolbar{display:block !important;Top:0 !important;} .divContentHolder{margin-top:0;} .ContentPane{width:100% !important;height:100vh !important;} @media screen and (min-width: 844px){.ToolbarPositionOnMobile {left: unset !important; top:0 !important}} @media screen and (max-width: 843px) and (min-width: 320px){.GroupsToolbarOnHomePage{margin-top:33px !important} .ToolBar{top:0 !important;}.documentTabs{margin-top:0 !important}.documentMultiPages{margin-top:90px !important}.showhiderail{display:none !important}} @media screen and (max-width: 1060px) and (min-width: 320px){.FolderManagerToolbar{margin-left:0 !important;}  .Folder_DocumentManager .ToolBar{margin-top:50 !important;top:50px !important}.RadSplitter .rspPane{top: 0 !important;} .DocumentManagerTree{margin-top:0 !important;}}</style>"));
                    var FixedElementsHeight = 0
                    if ($(".toolbartop:visible").length > 0)
                        FixedElementsHeight = FixedElementsHeight + $(".toolbartop:visible").height() + elementExt.offsetHeight + elementbreadCrumb.offsetHeight;
                    if ($(".bottomtoolbar:visible").length > 0)
                        FixedElementsHeight = FixedElementsHeight + $(".bottomtoolbar:visible").height() + 2;
                    if ($(".MobileFixedMenu:visible").length > 0)
                        FixedElementsHeight = FixedElementsHeight + $(".MobileFixedMenu:visible").height();
                    ...
                    $(this).css('height', document.documentElement.clientHeight - FixedElementsHeight - 1);
                });
                ...
                $(window).resize(function () {
                    ...
                    $('#' + webPageFrame).css('height', document.documentElement.clientHeight - FixedElementsHeight - 1);
                })
    ...
    <style type="text/css">
        ...
        .hideclosebtn .RadDock .rdTitleBar .rdCommands > li:nth-child(2) {
    ...
    <telerik:radcodeblock id="CodeBlock" runat="server">
        <script type="text/javascript">
         ...
         function ViewNotification() {
                var Id = '<%= PM.ProjectInfo.Id%>';
                var Description = '<%=JSEscape(PM.ProjectInfo.ProjectName)%>';
                var RecordDescription = '<%=JSEscape(PM.ProjectInfo.ProjectNumber & " - " & PM.ProjectInfo.ProjectName)%>';

                if (Id == 0) { return;}
                        var left = (screen.width - 900) / 2;
                        var top = (screen.height - 500) / 2;
                        OpenPOPUp("Notification.aspx?ObjectType=PROJECT&Id=" +
                                '<%=PM.ProjectInfo.Id%>' + "&Description="
                                                + Description
                                                + "&RecordDescription=" + RecordDescription
                                                + "&EntityId=" + '<%=PM.ProjectInfo.Id%>' + "&EntityType=0", "Notification",
    ...
    <telerik:radajaxmanagerproxy id="PMAjaxManager" runat="server">
            <AjaxSettings>
                <telerik:AjaxSetting AjaxControlID="btnPortfolioHome">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="btnPortfolioHome" />
                        <telerik:AjaxUpdatedControl ControlID="tblProjectExplorer" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
            </AjaxSettings>
          </telerik:radajaxmanagerproxy>
    <table style="width: 100%; table-layout: fixed;height:100%;" cellpadding="0" cellspacing="0">

        <tr style="position:absolute; z-index:998;" class="HomeDocument">
           <td>
               <table style="width: 100%" cellpadding="0" cellspacing="0" class="HomeTabTabsMobile" >
                    <tr>
                        <td>
                            <telerik:radtabstrip id="tbsHomeDocument" EnableRtl="true"  multipageid="mlpHome" runat="server" cssclass="HomeTabTabs" height="30px" ScrollChildren="true" ScrollButtonsPosition="Left"
        ...
        <tr>
            <td>
                <telerik:radmultipage id="mlpHome" runat="server" selectedindex="0" width="100%" Height="100%"
                    renderselectedpageonly="True" cssclass="ProjectCenterMultiPage">
                    <telerik:RadPageView ID="pvWidget" runat="server" Width="100%" Style="min-height: calc(100vh - 82px);">
                    ...
                    <telerik:RadPageView ID="pvDashboard" runat="server" Width="100%">
                        ...
                        <iframe runat="server" id="Iframe1" frameborder="0" visible="false" width="100%" class="ProjectCenterIframe Homeiframe"
                            height="100%" style="background-image: none !important; border: 0px;height:100%"></iframe>
                    </telerik:RadPageView>
                    ...
                    <telerik:RadPageView ID="pvMapView" runat="server" Width="100%">
                        <iframe src="ProjectsMapViewFrame.aspx" class="ProjectCenterIframe Homeiframe" runat="server" id="ProjectsFrame" visible="false"
                    ...
                    <telerik:RadPageView ID="pvProjectCenter" runat="server" Width="100%">
                        <div style="padding-left: 0px;">
                                                ...
                                                <td valign="middle" style="vertical-align: middle; width: 80%" class="ToolbarTd ProjectCenterToolbarWidth">
                                                    <telerik:RadToolBar ID="mainToolBar" runat="server" Skin="Default" AutoPostBack="True">
                                                        <Items>
                                                            ...
                                                            <telerik:RadToolBarButton CssClass="ToolbarNotification" EnableImageSprite="true"
                                                                CommandName="Notification" SecurityButtonType="Read" PostBack="false">
                                                            </telerik:RadToolBarButton>
                            ...
                            <div class="ProjectCenterContainer" id="iframContent" runat="server">
                    ...
                    <telerik:RadPageView ID="pvWebPage" runat="server" Width="100%" >
                        <iframe src="" runat="server" frameborder="0" id="WebPageFrame" visible="false" width="100%" class="Homeiframe"
                    ...
                    <telerik:RadPageView ID="pvPDF" runat="server" Width="100%">
                        <iframe src="" runat="server" frameborder="0" id="PDFFrame" visible="false" width="100%"
                            height="100%" style="background-image: none !important; border: 0px;height:100%" class="PDFIframe Homeiframe"></iframe>
                    </telerik:RadPageView>
    ...
    <telerik:RadCodeBlock runat="server" ID="rdblockprojectexplorer">
<%--            <div class="flyoutPopup Hide">--%>
                
               <%-- <telerik:RadAjaxLoadingPanel ID="ldpFlyout" runat="server" BackgroundTransparency="100" />--%>
              <%--  <div id="tblProjectExplorer" class="ProjectExplorerContainer" runat="server">
                    <uc12:ProjectExplorer ID="ProjectExplorer1" runat="server" visible="False" />
                </div>--%>
           <%-- </div>--%>
            ...
            <div id="flyoutBackdrop" onclick="javascript:return CloseMasterfader();" class="Hide" style="position: fixed; top: 0; right: 0; left: 0; bottom: 0; z-index: 7002;"></div>
