                        ...
                        <table class="TableNoSpacingNoBorder" style="width: 100%">
                            ...
                            <tr>
                                <td style="padding-top: 24px; text-align: center;">
                                    <asp:Button ID="btnDocumentManager" Enabled="false" Text="Attach from Document Manager" OnClientClick="return OpenFolderManagerPopup();" runat="server" Style="width: 60%; text-decoration: none; display: inline-block; padding-left:8px !important; padding-right:8px !important;" />
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
            ...
            <div class="row ">
                <div class="col-12">
                    <telerik:RadGrid ID="rdgAttachments" runat="server" Skin="Default" ItemStyle-HorizontalAlign="Left" AlternatingItemStyle-CssClass="Left" AllowFilteringByColumn="true" FilterType="HeaderContext" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true" AllowMultiRowSelection="true" setwidth="true" AppendMenus="true"
                        AllowPaging="true" PageSize="250" AutoGenerateColumns="False" HeaderStyle-Font-Size="8" AllowSorting="true" ShowStatusBar="true" ShowGroupPanel="True" GroupPanelPosition="Top">
