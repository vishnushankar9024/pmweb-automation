    ...
    <div class="row">
        <div class="col-12 ResponsiveMargin">
            <telerik:RadGrid ID="rdgStageGatesDetails" runat="server"
                ...
                Font-Size="8px" PageSize="250" ShowFooter="true" AllowPaging="True" ShowGroupPanel="True" UseEditFormInMobile="true"
                ...
                <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Record Type" SortExpression="RecordType" UniqueName="RecordType" DataField="RecordType"
                            ...
                            <EditItemTemplate>
                                <telerik:RadComboBox ID="ddlRecordType" Enabled="true" runat="server" Width="100%" AllowCustomText="true"></telerik:RadComboBox>
                            </EditItemTemplate>
