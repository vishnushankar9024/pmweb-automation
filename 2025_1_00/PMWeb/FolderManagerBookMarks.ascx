<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="FolderManagerBookMarks.ascx.vb" Inherits="Website.FolderManagerBookMarks" %>
...
<telerik:RadAjaxManagerProxy ID="AjaxManager" runat="server">
       <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="btnCardClickBookmark">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="DetailPane1" LoadingPanelID="ldpPM" />  
                    <telerik:AjaxUpdatedControl ControlID="btnCardClickBookmark" LoadingPanelID="ldpPM" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        </AjaxSettings>
...
<telerik:RadGrid ID="rdgBookMarks" runat="server" AllowMultiRowSelection="true" AutoGenerateColumns="false" CssClass="rdgDocumentManager" Visible="true"
    GridLines="None" HeaderStyle-Font-Size="8" SetWidth="true" FitPageHeightOffset="24" AppendMenus="true" allow-scroll="true"
    ShowStatusBar="false" PageSize="250" AllowPaging="false" ClientSettings-Scrolling-AllowScroll="true"
    ...
    <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>" UseAllDataFields="true"
        ...
        <Columns>
            ...
            <telerik:GridTemplateColumn HeaderText="Document#" UniqueName="Document#" SortExpression="DocumentNbr" Groupable="true"
...
<asp:Button ID="btnCardClickBookmark" runat="server" CssClass="Hide btnBookMarkCardView"/>