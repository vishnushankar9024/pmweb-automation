<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/PmMaster.Master" CodeBehind="WorkflowCalendars.aspx.vb" Inherits="Website.WorkflowCalendars" %>
...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function CopyCalendarPopup() {
            var wnd = window.radopen('WorkflowCalendarsLookup.aspx');
            wnd.setSize(465, 570);
                        ...
                        <td valign="middle" style="vertical-align: middle;" class="ToolbarTd">
                            <telerik:RadToolBar ID="mainToolBar" runat="server" Skin="Default" AutoPostBack="true" OnClientButtonClicking="CustomClientButtonClicking">
                                <Items>
                                    ...
                                    <telerik:RadToolBarButton ImageUrl="Images/Toolbar/Help.png" ToolTip="<%$ Resources:PMWeb, RadToolBarButton_help %>" CausesValidation="false" Target="_blank" NavigateUrl="Help/PMWebUserManual_Scheduling.htm#WorkflowCalendarDays"></telerik:RadToolBarButton>
                                </Items>
                            </telerik:RadToolBar>
                        </td>
                        <td></td>
            ...
            <div class="row">
                ...
                <div class="col-4 col-4-right">
                    <fieldset>
                        ...
                        <telerik:RadGrid runat="server" ID="rdgDaysOff" AutoGenerateColumns="False" ShowStatusBar="True" SetWidth="true" ClientSettings-Scrolling-AllowScroll="true" CssClass="LightWeight" PageSize="250" AllowPaging="true"
                            Font-Size="8px" ShowGroupPanel="False" AllowMultiRowEdit="True" AllowMultiRowSelection="True" AllowSorting="true" GridLines="None">
                            <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>" Width="100%"
                                ...
                                <Columns>
                                    <telerik:GridTemplateColumn HeaderText="Date" ItemStyle-Wrap="false" UniqueName="Day" DataField="Day"
                                        SortExpression="Day" Groupable="false" DataType="System.DateTime">
                                        <ItemTemplate>
                                       <span><%#FormatDate(Container.DataItem("Day"))%>&nbsp;</span>
                                             </ItemTemplate>
                                        <EditItemTemplate>
