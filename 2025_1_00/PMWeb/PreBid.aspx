...
<%@ Register Src="ngDocSpecs.ascx" TagName="DocumentSpecifications" TagPrefix="uc4" %>
                            ...
                            <table class="colTable">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvBidCategory" runat="server" ValidationGroup="Save" ControlToValidate="ddlBidCategories"
                                            CssClass="Validator" Display="Dynamic" ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>"
                                            ForeColor="" Visible="false"></asp:RequiredFieldValidator>
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvBiddingCompany" runat="server" ControlToValidate="ddlCompanies"
                                        ...
                                        <asp:CustomValidator ID="csvBiddingCompany" runat="server" ControlToValidate="ddlCompanies"
                                            ClientValidationFunction="ValidateCombo" Display="Dynamic" ValidationGroup="Save"
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        ...
                                        <asp:CustomValidator ID="csvBiddingContact" runat="server" ControlToValidate="ddlBidderContact"
                                            ClientValidationFunction="ValidateCombo" Display="Dynamic" ValidationGroup="Save"
                                            CssClass="Validator" Visible="false" ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>">
                                        </asp:CustomValidator>
                                    </td>
                                ...
                                <tr runat="server" id="trCurrency">
                                    ...
                                    <td class="controlWidth">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvCurrencies" Visible="false" runat="server" ControlToValidate="ddlCurrencies" Display="Dynamic" ForeColor=""
                                            CssClass="Validator"  ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>" ValidationGroup="Save">
                                        </asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                        ...
                                        <table class="TableNoSpacingNoBorder" id="tblStatusRevision" runat="server">
                                            <tr>
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="rfvStatus" Visible="false" runat="server" ControlToValidate="ddlStatus" Display="Dynamic" ForeColor=""
                                            CssClass="Validator"  ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>" ValidationGroup="Save">
                                        </asp:RequiredFieldValidator> 
                                        <asp:CustomValidator ID="csvStatus" runat="server" ControlToValidate="ddlStatus"
                                            ...
                                            CssClass="Validator" Visible="false" ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>">
                                                ...
                                                <td style="padding-left: 8px; width: 50px; text-align: right">
                                                    ...
                                                    <%--<asp:RequiredFieldValidator ID="rfvRevisionNumber" Visible="false" runat="server" ControlToValidate="txtRevisionNumber" Display="Dynamic" ForeColor=""
                                            CssClass="Validator"  ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>" ValidationGroup="Save">
                                        </asp:RequiredFieldValidator>--%>
                                                </td>
                                            </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlTypes" runat="server" Skin="Default" AllowCustomText="true" Style="font-size: 11px" Filter="Contains" MarkFirstMatch="true"></telerik:RadComboBox>
                                         <asp:RequiredFieldValidator ID="rfvCommitmentType" Visible="false" runat="server" ControlToValidate="ddlTypes" Display="Dynamic" ForeColor=""
                                            CssClass="Validator"  ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>" ValidationGroup="Save">
                                        </asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <telerik:RadComboBox ID="ddlProcurement" runat="server" Width="100%"
                                                     ...
                                                     <asp:RequiredFieldValidator ID="rfvProcurements" Visible="false" runat="server" ControlToValidate="ddlProcurement" Display="Dynamic" ForeColor=""
                                            CssClass="Validator" InitialValue="" ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>" ValidationGroup="Save">
                                        </asp:RequiredFieldValidator>
                                                     <asp:CustomValidator ID="csvProcurements" runat="server" ControlToValidate="ddlProjects"
                                            ClientValidationFunction="ValidateCombo" Display="Dynamic" ValidationGroup="Save"
                                            CssClass="Validator" meta:resourcekey="cmpProject">
                                        </asp:CustomValidator>
