                    ...
                    <div class="row">
                        ...
                        <div class="col-4 col-4-middle">
                            <table class="colTable">
                                ...
                                <tr>
                                    <td class="labelWidth">
                                        <asp:Label ID="lblUseWith" runat="server" Text="Use With" meta:resourcekey="lblUseWith"></asp:Label>
                                    </td>
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlUseWith" runat="server" Height="99%" skin="Default" CloseDropDownOnBlur="true" NoWrap="true"></telerik:RadComboBox>
                                    </td>
                                </tr>
                                    </table>
                        </div>
                        ...
                        <div class="row" style="padding: 0;">
                            <div class="col-6" style="padding-bottom: 5px">
                                <fieldset>
                                    ...
                                    <telerik:RadGrid ID="rdgCustomFormFields" runat="server" AllowPaging="true" PageSize="250" Width="100%" SetWidth="true"
                            ...
                            <div class="col-6">
                                <fieldset>
                                    ...
                                    <telerik:RadGrid ID="rdgCustomTables" runat="server" AllowPaging="true" PageSize="250" Width="100%" SetWidth="true"
                                        FitParentContainer="true" ClientSettings-Scrolling-AllowScroll="true"
                                        Skin="Default" HeaderStyle-Font-Size="8" AutoGenerateColumns="False" ShowStatusBar="True"
                                        ItemStyle-VerticalAlign="Top" AlternatingItemStyle-VerticalAlign="Top" AllowMultiRowEdit="True"
