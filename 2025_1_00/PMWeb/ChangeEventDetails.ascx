        ...
        <div class="col-12 ResponsiveMargin">
            <fieldset>
                ...
                <telerik:RadGrid ID="rdgChangeEventDetails" runat="server" FilterType="HeaderContext" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true"
                    AutoGenerateColumns="False" ShowStatusBar="true" HeaderStyle-Font-Size="8" HasPasteFromExcel="True" AllowFilteringByColumn="true"
                    ...
                    <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Status" SortExpression="CostLedgerStatus" DataField="CostLedgerStatus"
                                ...
                                <EditItemTemplate>
                                    <telerik:RadComboBox radcomboox runat="server" ID="ddlCostLedgerStatuses" Width="100%" > </telerik:RadComboBox>
                                </EditItemTemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderText="WBS" SortExpression="WBS" UniqueName="WBS" DataField="WBS"
                                ...
                                <EditItemTemplate>
                                    <div style="width: 100%; white-space: nowrap">
                                        <telerik:RadComboBox ID="ddlWBS" runat="server" Width="80%" AutoPostBack="false"
                        ...
                        <CommandItemTemplate>
                            <div style="padding: 2px">
                                ...
                                &nbsp;&nbsp
                                 ...
                                 <asp:LinkButton ID="btnPasteClipBoard" runat="server" OnClientClick="return GetClipboardData(this);"
        ...
        <div class="col-12 ResponsiveMargin">
            <fieldset>
                ...
                <telerik:RadGrid ID="rdgCost"
                    ...
                    runat="server" AutoGenerateColumns="False" AllowPaging="True" HasPasteFromExcel="True" PageSize="250" HeaderStyle-Font-Size="8" AllowMultiRowEdit="true"
                    ...
                    <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>" DataKeyNames="Id" CommandItemDisplay="Top" Width="100%" TableLayout="Fixed" InsertItemDisplay="Top"
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Status" SortExpression="CostLedgerStatus" DataField="CostLedgerStatus"
                                ...
                                <EditItemTemplate>
                                    <telerik:RadComboBox runat="server" ID="ddlCostLedgerStatuses" Width="100%" > </telerik:RadComboBox>
                                </EditItemTemplate>
                                <HeaderStyle Width="100px"></HeaderStyle>
                            </telerik:GridTemplateColumn>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Quantity" UniqueName="Quantity" ItemStyle-HorizontalAlign="Right" DataField="Quantity" Aggregate="Sum" FooterAggregateFormatString="{0:F6}"
                                ...
                                <ItemTemplate>
                                    <div id='<%# "Detail_" & IIf(Eval("DetailId") > 0, "C_" & Eval("DetailId").ToString(), "CO_" & Eval("CommitmentCODetailId").ToString())%>' oncontextmenu="contextM(this,event)" style="width: 100%; height: 100%;">
                            ...
                            <telerik:GridTemplateColumn HeaderText="Ext. Cost" UniqueName="ExtCost" DataField="ExtCost"
                                ...
                                <ItemTemplate>
                                    <div id='<%# "DetailV_" & IIf(Eval("DetailId") > 0, "C_" & Eval("DetailId").ToString(), "CO_" & Eval("CommitmentCODetailId").ToString())%>' oncontextmenu="contextM(this,event)" style="width: 100%; height: 100%;">
                            ...
                            <telerik:GridTemplateColumn HeaderText="WBS" SortExpression="WBS" UniqueName="WBS" DataField="WBS"
                                ...
                                <EditItemTemplate>
                                    <div style="width: 100%; white-space: nowrap">
                                        <telerik:RadComboBox ID="ddlWBSCost" runat="server" Width="80%" AutoPostBack="false"
                                            Skin="Default" CloseDropDownOnBlur="true" EnableItemCaching="false"
                                            NoWrap="True" AllowCustomText="true" EnableLoadOnDemand="True" ShowMoreResultsBox="true" EnableVirtualScrolling="true"
                                            OnItemsRequested="ddl_ItemsRequested" Style="font-size: 11px" Height="250px">
                                        </telerik:RadComboBox>
