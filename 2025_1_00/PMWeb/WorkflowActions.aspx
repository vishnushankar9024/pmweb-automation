...
<head runat="server">
    ...
    <telerik:RadScriptBlock ID="rsbDocument" runat="server">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function OpenTeamInputPopup(ObjectType, EntityType, EntityId, CustomFormTypeId) {
                var tdActions = $("#tdAction").find("input[type='radio']");
                for (var i = 0; i < tdActions.length; i++) {
                ...
                var wnd = window.radopen('WorkflowTeamInput.aspx?ObjectType=' + ObjectType + '&EntityType=' + EntityType + '&EntityId=' + EntityId + '&CustomFormTypeId' + CustomFormTypeId);
                if (isMobileScreen()) {
                                        ...
                                        <table cellpadding="0" cellspacing="0" style="width: 100%">
                                            ...
                                            <tr valign="top">
                                                ...
                                                <td style="padding-top: 4px">
                                                    <div id="dvEmailBody" style="display: block; border: solid 1px #cbe9ff; padding: 4px; background-color: #f1f1f1; width: 700px; height: 350px; overflow: auto"
                                                        runat="server">
                                                    </div>
                                                </td>
                                            </tr>
