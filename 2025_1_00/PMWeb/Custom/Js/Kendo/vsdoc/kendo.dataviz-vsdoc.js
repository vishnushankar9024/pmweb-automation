...
kendo.data.DataSource.prototype = {
    ...
    filter: function(value) {
        /// <summary>
        /// Gets or sets the filter configuration.A list of the supported operators you can find in this filter operator configuration article.
        /// </summary>
    ...
    pushMove: function(index,items) {
        ...
        /// </summary>
        /// <param name="index" type="Number" >The zero-based index at which the data item should be moved to.</param>
        /// <param name="items" type="Object" >The data item or data items to append to the data source.</param>
...
$.fn.kendoDataSource = function(options) {
    ...
    /// &#10;If set to true, the data source will leave the data item paging implementation to the remote service. By default, the data source performs paging client-side.The following options are sent to the server when server paging is enabled: page - The page of data item to return (1 means the first page).; pageSize - The number of items to return.; skip - The number of data items to skip. or take - The number of data items to return (the same as pageSize).. The skip and take values are automatically calculated based on the current page and pageSize. This means that a dataSource with page = 3 and pageSize = 20 will generate a request that has skip = 40 and take = 20.Use the parameterMap option to send the paging options in a different format.For more information and tips about client and server data operations, refer to the introductory article on the DataSource.For a runnable example with enabled server paging, you can visit the Grid remote data binding demo.
    /// &#10;
...
kendo.data.ObservableArray.prototype = {
    ...
    every: function(callback) {
        ...
        /// </summary>
        /// <param name="callback" type="Function" >The function that will be executed for every item.</param>
        /// <returns type="Boolean">—Returns true if all items pass the test function condition. Otherwise, returns false.</returns>
    ...
    filter: function(callback) {
        ...
        /// </summary>
        /// <param name="callback" type="Function" >The function that will be executed for every item.</param>
        /// <returns type="Array">—A new array with items that pass the filter condition.</returns>
    ...
    find: function(callback) {
        ...
        /// </summary>
        /// <param name="callback" type="Function" >The testing function.</param>
        /// <returns type="Object">—The first item that passes the search condition.</returns>
    ...
    indexOf: function(item) {
        ...
        /// </summary>
        /// <param name="item" type="Object" >The searched item.</param>
        /// <returns type="Number">—The index of the specified data item. Returns -1 if the data item is not found.</returns>
    ...
    map: function(callback) {
        ...
        /// </summary>
        /// <param name="callback" type="Function" >The function that will be executed for every item.</param>
        /// <returns type="Array">—A new array with the results from the executed callback.</returns>
    ...
    reduce: function(callback) {
        ...
        /// </summary>
        /// <param name="callback" type="Function" >The function that will be executed for every item.</param>
        /// <returns type="Number">—The accumulated result.</returns>
    ...
    remove: function(item) {
        ...
        /// </summary>
        /// <param name="item" type="Object" >The item that will be removed.</param>
    ...
    some: function(callback) {
        /// <summary>
        /// Executes a callback function for every single item in the array and returns true or false depending if any of the items in the array passes the condition. An equivalent of Array.prototype.some.
        /// </summary>
        /// <param name="callback" type="Function" >The function that will be executed for every item.</param>
        /// <returns type="Boolean">—Returns true if any of the items passes the test function condition. Otherwise, returns false.</returns>
...
kendo.data.PivotDataSourceV2 = function() { };

kendo.data.PivotDataSourceV2.prototype = {
...
$.fn.getKendoPivotDataSourceV2 = function() {
    /// <summary>
    /// Returns a reference to the kendo.data.PivotDataSourceV2 widget, instantiated on the selector.
    /// </summary>
    /// <returns type="kendo.data.PivotDataSourceV2">The kendo.data.PivotDataSourceV2 instance (if present).</returns>
};

$.fn.kendoPivotDataSourceV2 = function(options) {
    /// <summary>
    /// Instantiates a kendo.data.PivotDataSourceV2 widget based the DOM elements that match the selector.
    ...
    /// &#10;
    /// &#10;measures - Array|Object 
    /// &#10;The configuration of measures. A string array whose values are interpreted as the name of the measures that will be loaded. Measures can be defined as a list of objects with the name property holding the name.[{         name: "[Measures].[_Internet Current Quarter Sales Performance Status]"     }]
    /// &#10;
    /// &#10;rows - Array 
    /// &#10;The configuration of the row axis members. An array of JavaScript objects or strings. A JavaScript objects are interpreted as rows descriptors. Strings are interpreted as the hierarchical name of the member.
    /// &#10;
...
kendo.dataviz.ui.Chart.prototype = {
    ...
    exportPDF: function(options) {
        /// <summary>
        /// Exports the chart as a PDF file. The result can be saved using kendo.saveAs.The export operation is asynchronous and returns a promise. The promise will be resolved with a PDF file encoded as a Data URI.The available configuration options can be found in the PDFOptions api.
        /// </summary>
        /// <param name="options" type="kendo.drawing.PDFOptions" >Parameters for the exported PDF file.</param>
        /// <returns type="Promise">A promise that will be resolved with a PDF file encoded as a Data URI.</returns>
    ...
    resetDrilldownLevel: function() {
        /// <summary>
        /// Sets the current drill-down level for Drilldown Charts. To return to a previous level, set the value to a number less than the current level. or To return to the root chart, set the value to 0.. Setting the value to a number greater than the current level will have no effect.
        /// </summary>
...
kendo.dataviz.ui.ChartBreadcrumb = function() { };

kendo.dataviz.ui.ChartBreadcrumb.prototype = {
...
$.fn.getKendoChartBreadcrumb = function() {
    /// <summary>
    /// Returns a reference to the kendo.dataviz.ui.ChartBreadcrumb widget, instantiated on the selector.
    /// </summary>
    /// <returns type="kendo.dataviz.ui.ChartBreadcrumb">The kendo.dataviz.ui.ChartBreadcrumb instance (if present).</returns>
};

$.fn.kendoChartBreadcrumb = function(options) {
    /// <summary>
    /// Instantiates a kendo.dataviz.ui.ChartBreadcrumb widget based the DOM elements that match the selector.
...
kendo.dataviz.ui.CircularGauge.prototype = {
...
$.fn.getKendoCircularGauge = function() {
    /// <summary>
...
$.fn.kendoCircularGauge = function(options) {
    /// <summary>
...
kendo.dataviz.ui.Sankey = function() { };

kendo.dataviz.ui.Sankey.prototype = {
    ...
    exportVisual: function() {
        ...
        /// </summary>
        /// <returns type="Group">- The exported visual.</returns>
    ...
    exportImage: function(options) {
        /// <summary>
        /// Exports the Sankey as an image. The result can be saved using kendo.saveAs.The export operation is asynchronous and returns a promise. The promise will be resolved with a PNG image encoded as a Data URI.
        /// </summary>
        /// <param name="options" type="" >Parameters for the exported image.</param>
        /// <returns type="Promise">A promise that will be resolved with a PNG image encoded as a Data URI.</returns>
    ...
    exportPDF: function(options) {
        /// <summary>
        /// Exports the Sankey as a PDF file. The result can be saved using kendo.saveAs.The export operation is asynchronous and returns a promise. The promise will be resolved with a PDF file encoded as a Data URI.The available configuration options can be found in the PDFOptions api.
        /// </summary>
        /// <param name="options" type="kendo.drawing.PDFOptions" >Parameters for the exported PDF file.</param>
        /// <returns type="Promise">A promise that will be resolved with a PDF file encoded as a Data URI.</returns>
    ...
    exportSVG: function(options) {
        /// <summary>
        /// Exports the Sankey as an SVG document. The result can be saved using kendo.saveAs.The export operation is asynchronous and returns a promise. The promise will be resolved with a SVG document encoded as a Data URI.
        /// </summary>
        /// <param name="options" type="" >Export options.</param>
        /// <returns type="Promise">A promise that will be resolved with a SVG document encoded as a Data URI.</returns>
...
$.fn.getKendoSankey = function() {
    /// <summary>
    /// Returns a reference to the kendo.dataviz.ui.Sankey widget, instantiated on the selector.
    /// </summary>
    /// <returns type="kendo.dataviz.ui.Sankey">The kendo.dataviz.ui.Sankey instance (if present).</returns>
};

$.fn.kendoSankey = function(options) {
    /// <summary>
    /// Instantiates a kendo.dataviz.ui.Sankey widget based the DOM elements that match the selector.

    /// &#10;Accepts an object with the following configuration options:
    /// &#10;
    /// &#10;data - Object (default: required)
