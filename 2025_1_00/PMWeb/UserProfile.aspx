<%@ Page Title="" Language="vb" AutoEventWireup="false" CodeBehind="UserProfile.aspx.vb" Inherits="Website.UserProfile" %>r
...
<head id="Head1" runat="server">
    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        ...
        <link href="CSS/MaterialIcons/material-icons.css" rel="stylesheet" />
        ...
        <script type="text/javascript">
            ...
            function OpenWidgetPopupForWebPage(Source, Id, Width, Height) {
                OpenPOPUp('WidgetPopup.aspx?Source=' + Source + '&Id=' + Id, 520, Height, null, null)
                return false;
            }
            function OpenPDFUploadPopup(FileName, Id, Width, Height) {
                OpenPOPUp('Home_AddPDFPopup.aspx?FileName=' + FileName + '&Id=' + Id, 400, Height, null, null)
                return false;
            }
            function OpenProjectCenterPopup() {
                OpenPOPUp('Home_ProjectCenterPopup.aspx', 500, 400, WindowCloseReport, null)
                return false;
            }
            ...
            function OpenControlsPopup() {
                ...
                if (isMobileScreen()) {
                    ...
                    WndConfigureCtrlTabs.setSize(500, 450);
...
<body>
    <form id="form1" runat="server">
        ...
        <table style="width: 100%; border-bottom: 1px solid #999;" cellpadding="0" cellspacing="0" class="ToolBar">
            <tr valign="top">
                <td valign="top">
                    <table style="width: 100% !important;" cellpadding="0" cellspacing="0" border="0">
                        <tr class="ProjectCenterToolbar">
                            <td class="ToolbarTd">
                                <telerik:RadToolBar ID="mainToolBar" runat="server" AutoPostBack="true" Width="100%" Skin="Default" CssClass="toolbar">
                                    <Items>
                                        <telerik:RadToolBarButton ValidationGroup="Users" ImageUrl="Images/ToolBar/Save.png" CommandName="Save"></telerik:RadToolBarButton>
                                    </Items>
                                </telerik:RadToolBar>
                            </td>
                        </tr>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            <td style="vertical-align: top; width: 185px">
                                ...
                                <telerik:RadTabStrip OnClientTabSelecting="onTabSelecting" ID="tbsDocument" SelectedIndex="0" runat="server" MultiPageID="mlpUserProfile" Skin="Default" EnableViewState="True" CausesValidation="False" CssClass="VerticalTabs" Orientation="VerticalLeft" Align="Left" OnClientTabSelected="OnTabSelected">
                                    <Tabs>
                            ...
                            <td class="MobileRow">
                                <telerik:RadMultiPage ID="mlpUserProfile" runat="server" SelectedIndex="0" Width="100%" CssClass="documentMultiPages">
                                            ...
                                            <div class="row">
                                                                    ...
                                                                    <table style="width: 100%;">
                                                                        <tr>
                                                                            ...
                                                                            <td class="controlWidth">
                                                                                <span id="Span1" runat="server"><%= FormatDate(PM.UserInfo.LastLoginDate) + " " + FormatTime(PM.UserInfo.LastLoginDate) %></span>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="labelWidth">
                                                                            ...
                                                                            <td class="controlWidth">
                                                                                <asp:TextBox ID="txtFirstName" MaxLength="50" runat="server" Width="99%"></asp:TextBox>
                                                                                <div>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="controlWidth">
                                                                                <asp:TextBox ID="txtLastName" MaxLength="50" runat="server" Width="99%"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="labelWidth">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="controlWidth">
                                                                                <asp:TextBox ID="txtCell" MaxLength="50" runat="server" Width="99%"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="labelWidth">
                                                                ...
                                                                <fieldset>
                                                                    ...
                                                                    <table style="width: 100%">
                                                                        <tr>
                                                                            ...
                                                                            <td class="controlWidth">
                                                                                <asp:TextBox ID="txtOldPassword" MaxLength="128" runat="server" TextMode="Password" Width="99%" onkeypress="cleanErrorMessage();"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="labelWidth">
                                                                            ...
                                                                            <td class="controlWidth">
                                                                                <asp:TextBox ID="txtPassword" MaxLength="128" runat="server" TextMode="Password" Width="99%" onkeypress="cleanErrorMessage();"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="labelWidth">
                                                                            ...
                                                                            <td class="controlWidth">
                                                                                <asp:TextBox ID="txtConfirmPassword" MaxLength="128" runat="server" TextMode="Password" Width="99%"
                                                                                ...
                                                                                <div id="ErrorMessage">
                                                                                    ...
                                                                                    <asp:Label ID="lblPasswordError" CssClass="Validator" Visible="false" runat="server"></asp:Label><br />
                                                                                </div>
                                                        ...
                                                        <tr>
                                                            <td id="tdLogout">
                                                                <fieldset>
                                                                    ...
                                                                    <table style="width: 100%">
                                                                        <tr>
                                                                            <td colspan="2" class="labelWidth">
                                                                                <asp:Label runat="server" Text="" meta:Resourcekey="lblLogoutInfo" ID="lblLogoutInformation"></asp:Label>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td></td>
                                                ...
                                                <div class="col-4">
                                                    <table class="colTable">
                                                        ...
                                                        <tr>
                                                            <td style="padding-top: 46px;" id="tdEvents">
                                                                <fieldset>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <telerik:RadAjaxPanel runat="server" ID="pnlajax" LoadingPanelID="ldpPM">
                                                        <telerik:RadGrid ID="rdgTabs" AllowMultiRowSelection="true" runat="server" SetWidth="true" AppendMenus="true" PageSize="250"
                                                            HeaderStyle-Font-Size="8" Width="200px" Height="99%" AutoGenerateColumns="False" ClientSettings-Scrolling-AllowScroll="true" ClientSettings-Scrolling-UseStaticHeaders="true"
                                                            ...
                                                            <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <telerik:GridTemplateColumn HeaderText="Tab Type" UniqueName="TabType" HeaderStyle-Width="200px"
                                                                        ...
                                                                        <ItemTemplate>
                                                                            <asp:DropDownList ID="ddlTabType" AutoPostBack="true" OnSelectedIndexChanged="ddlTabType_OnSelectedIndexChanged" runat="server" Width="100%" Style="white-space: nowrap">
                                                                                <asp:ListItem Text="PDF" Value="PDF" />
                                                                                <asp:ListItem Text="BI Report" Value="BIReport" Selected="True" />
                                                                                <asp:ListItem Text="PMWeb Report" Value="PMWebReport" />
                                                                                <asp:ListItem Text="Web Page" Value="WebPage" />
                                                                            </asp:DropDownList>
                                                                    ...
                                                                    <telerik:GridTemplateColumn HeaderText="Configure" UniqueName="Configure" HeaderStyle-Width="120px"
