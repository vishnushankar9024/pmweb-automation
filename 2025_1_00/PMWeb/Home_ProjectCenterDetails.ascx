...
<telerik:RadScriptBlock ID="RadScriptBlock1" runat="server">
    <style>
        ...
        .ProjectCenterSepcs .fldSpecs {
            border-top: 0px solid #999999;
        }

        .ProjectCenterSepcs .SpecificationPadding {
            padding-left: 0px !important;
        }

        .ProjectCenterSepcs .RadTabStrip .rtsLink.rtsSelected:after {
        ...
        .ProjectCenterSepcs .RadTabStrip .rtsLI{
            height:30px !important
        }
        .ProjectCenterSepcs .rtsLevel .rtsLink.rtsSelected{
      ...
      .ProjectCenterSepcs .rtsLI  a {padding:10px;
        ...
        .PMProjectCenter .col-4 {
            width: 400px;
            margin-top: 24px;
            order: 1;
        }

        .PMProjectCenter .col-3 {
            width: 250px;
            padding-left: 24px;
            margin-top: 24px;
            order: 2;
        ...
        .PMProjectCenter textarea {
            box-sizing: border-box;
        }

        .PMProjectCenter .col-5 {
            width: 650px;
        ...
        .ProjectCenterSepcs .PMHeader .row {
            margin-top: 0px !important;
        }

        .PMProjectCenter .ProjectCenterSepcs .row {
            margin-top: 0px !important;
        ...
        .PMProjectCenter .ProjectCenterSepcs .tbshorizantaltabs .rtsLevel.rtsLevel1 {
            width: 650px !important;
        }

        .PMProjectCenter .ProjectCenterSepcs .RadGrid.RadGrid_Default {
            width: 650px !important;
        ...
        .PMProjectCenter .ProjectCenterSepcs .RadGrid.RadGrid_Default .rgDataDiv {
    ...
    <script type="text/javascript">
        ...
        function ProgramRedirect() {
            var ddlProgramValue = $find("<%= ddlPrograms.ClientID %>").get_value();
        ...
        function LocationRedirect() {
            var ddlLocationValue = $find("<%= ddlProperties.ClientID %>").get_value();
    ...
    <div class="row">
        <div style="width: 100%">
            <table style="width: 100%" cellpadding="0" cellspacing="0" class="tblProjectCenterHeader">
                <tr>
                    <td style="width: 70%">
                        <div runat="server" id="divLocationHeader">
                            <asp:Label runat="server" ID="lblLocationHeader" Style="font-size: 24px; color: #999999;"></asp:Label><br />
                        </div>
                        <div style="padding-top: 10px;" runat="server" id="divProjectHeader">
                            <asp:Label runat="server" ID="lblProjectHeader" Style="font-size: 26px; color: #000000;"></asp:Label></div>
                    </td>
                ...
                <tr class="mobileLogo">
                    <td colspan="2" style="padding-top: 24px; text-align: center">
                        <asp:Image ID="imglogoMobile" runat="server" ImageUrl="Images/Global/WhiteDot.gif" />
                    </td>
                </tr>
            </table>
        </div>
        <div class="col-4">
            <table class="colTable">
                <tr>
                    <td class="labelWidth">
                        <asp:LinkButton ID="btnGoToProgram" OnClientClick="return ProgramRedirect();" CssClass="Link"
                            meta:Resourcekey="btnGoToProgram" runat="server" Text="Program"></asp:LinkButton>
                    </td>
                    <td class="controlWidth">
                        <telerik:RadComboBox ID="ddlPrograms" runat="server" meta:Resourcekey="ddlPrograms" Width="100%" AllowCustomText="true"
                ...
                <tr>
                    <td class="labelWidth">
                        <asp:LinkButton ID="btnGoToProperty" OnClientClick="return LocationRedirect();" CssClass="Link"
                            Text="Location" runat="server" meta:resourcekey="btnLocation"></asp:LinkButton>
                    </td>
                    <td class="controlWidth">
                        <telerik:RadComboBox ID="ddlProperties" runat="server" Width="100%" meta:Resourcekey="ddlLocation"
                ...
                <tr>
                    ...
                    <td class="controlWidth">
                        <telerik:RadComboBox ID="ddlStatuses" runat="server" Width="100%" meta:Resourcekey="ddlProjectStatus"
                ...
                <tr>
                    ...
                    <td class="controlWidth">
                        <telerik:RadComboBox ID="ddlTypes" runat="server" Width="100%" meta:Resourcekey="ddlProjectType"
                            Skin="Default" Style="font-size: 11px" AllowCustomText="true">
                            <CollapseAnimation Duration="200" Type="OutQuint" />
                        </telerik:RadComboBox>
                    </td>
                ...
                <tr>
                    <td class="labelWidth">
                        <asp:Label ID="lblStatusRevision" Text="Status" runat="server" meta:resourcekey="lblStatus"></asp:Label>
                    </td>
                    <td class="controlWidth">
                        <table id="tblStatus" runat="server" border="0" cellspacing="0" width="100%">
                            <tr>
                                ...
                                <td style="width: 50px; padding-left: 8px; text-align: right">
                                    <asp:TextBox ID="txtRevisionNumber" runat="server" CssClass="Integer" Enabled="false" Width="50px" Style="margin-left: 3px;"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td class="labelWidth">
                        <asp:Label ID="hplCurrency" Text="Currency" runat="server" meta:resourcekey="lblCurrency"></asp:Label>
                    </td>
                    <td class="controlWidth">
                ...
                <tr>
                    ...
                    <td class="controlWidth">
                        <asp:TextBox ID="txtTargetBudget" runat="server" Width="100%" CssClass="Currency"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="labelWidth">
                    ...
                    <td class="controlWidth">
                        <asp:TextBox ID="txtTargetRevenue" runat="server" Width="100%" CssClass="Currency"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="labelWidth">
            ...
            <table class="colTable" cellpadding="0" cellspacing="0">
                    ...
                    <td style="padding-bottom: 25px">
                        <div runat="server" id="divImages" class="ImagesHeaderDiv" style="color: #fff; background-color: rgb(102,102,102); width: 100%; text-align: center; height: 30px">
                            <div style="font-size: 20px; font-weight: 400; height: 30px; line-height: 30px; text-transform: uppercase">
                                <asp:Label runat="server" ID="Images" Text="Images"></asp:Label>
                            </div>
                        </div>
                ...
                <tr style="display: block;">
                    <td style="display: block;">
                        <div runat="server" id="divBudget" class="pnlStats">
                            <div style="position: relative">
                                <asp:Label runat="server" ID="lblBudgetHeader" meta:resourcekey="lblBudgetHeader"></asp:Label><i class="ellipsis"></i></div>
                            <div id="divBudgetBar" style="height: 56px; color: #fff; text-align: center;">
                                <asp:Label runat="server" ID="lblBudget" Font-Size="30px" Style="line-height: 56px;"></asp:Label></div>
                        </div>
                    </td>
                </tr>
                <tr style="display: block">
                    <td style="display: block; padding-top: 5px">
                        <div runat="server" id="divSchedule" class="pnlStats">
                            <div style="position: relative">
                                <asp:Label runat="server" ID="lblScheduleHeader" meta:resourcekey="lblScheduleHeader"></asp:Label><i class="ellipsis"></i>
                            </div>
                ...
                <tr style="display: block">
                    <td style="display: block; z-index: 9999; padding-top: 5px">
                        <div runat="server" id="divDocuments" class="pnlStats">
                            <div style="position: relative">
                                <asp:Label runat="server" ID="lblDocumentsHeader" meta:resourcekey="lblDocumentsHeader"></asp:Label><i class="ellipsis"></i>
                            </div>
