        ...
        <table style="width:100%;height: 100%; max-width: 100vw;table-layout:fixed" cellpadding="0" cellspacing="0">
            <tr>
                <td style="width:300px;height:100vh" valign="top" class="tdSidebar">
                    <div id="SideBar" class="Sidebar" style="position:relative; background-color:/*1*/#2D2D2D/*1*/ !important">
                        <div id="img_pmweb" style="text-align: center">
                            <asp:Image ID="imgLogo" Style="margin-top: 40px" runat="server" ImageUrl="CSS/Images/LoginLogo.png" class="logo" />
                        </div>
                        <div style="position:absolute;bottom:100px">
                            <div id="out_links">
                                ...
                                <table><tr><td><div class="HeaderMenuHelp1">&nbsp;</div></td><td>
