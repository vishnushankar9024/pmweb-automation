<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WBS_Import.aspx.vb" Inherits="Website.WBS_Import" %>
...
<head runat="server">
    <title>Import WBS</title>
    <script type="text/javascript">
        function OpenProgressImport() {
            OpenSmallestPopup("ImportResultsPopup.aspx?objecttype=WBS", 454, 500);
        }
    ...
    <form id="form1" runat="server">
                ...
                <div class="PMMainPage PMPopupMainPage documentSinglePage">
                            ...
                            <table class="colTable">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvSeparators" runat="server" ControlToValidate="txtSeparators"
                                            meta:resourcekey="rfvSeparator" CssClass="Validators" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                                ...
                                <br />
                                     <asp:Label runat="server" ID="lblSelectUpload" meta:resourcekey="lblSelectUpload" CssClass="IconLabelsUpload"></asp:Label><br />
                                <asp:Label runat="server" ID="lblUploadFile" meta:resourcekey="lblUploadFile" Style="display: none;" CssClass="IconLabelsUpload"></asp:Label>
                                 ...
                                 <asp:FileUpload ID="FileToUpload" runat="server" CssClass="FileToUpload Hide" Width="100%"></asp:FileUpload>
                                        <asp:Button ID="btnUpload" runat="server" CausesValidation="False" Text="Upload" style="display:none"
                                            meta:resourcekey="btnUpload" />
                                    </div>
                            </div>

                            <telerik:RadGrid ID="RDG1" Width="100%" runat="server" FitPageHeightOffset="24" Style="display: none"
                                AutoGenerateColumns="False" ShowStatusBar="True" Font-Size="8px" GridLines="None" setwidth="true">
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Import File Field" UniqueName="FieldName">
                                            <ItemTemplate>
                                              ...
                                              <%--  <asp:RangeValidator ID="cmvExcelField" meta:resourcekey="cmvExcelFields" runat="server"
                                                    CssClass="Validator" ControlToValidate="ddlExcelFields" MinimumValue="1" MaximumValue="1000000"
                                                    Type="Integer" Enabled='<%#Container.DataItem("Required")%>' ErrorMessage="Required" Display="Dynamic">
                                                </asp:RangeValidator>--%>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlExcelFields"
                                                    CssClass="Validator" InitialValue="" meta:resourcekey="cmvExcelFields" ErrorMessage="Required" ValidationGroup="Save" Enabled='<%#Container.DataItem("Required")%>'
       ...
       <%--     <asp:Panel ID="pnl2" runat="server">
                <div class="PMMainPage PMPopupMainPage">
                    <div class="row">
                        <div class="col-12">
                            <telerik:RadGrid ID="RDG3" runat="server" AllowPaging="true" PageSize="250" FitPageHeightOffset="24"
            ...
            <asp:Panel ID="pnl3" runat="server">
                <div class="PMMainPage PMPopupMainPage">
                                ...
                                <table class="colTable">
                                    <tr>
                                        <td class="NoWrap labelWidth">
                                            <asp:Label ID="lblWBS" Text="WBS" runat="server" meta:resourcekey="lblWBS"></asp:Label>
                                        </td>
                                        <td style="width: 100px">
                                            <asp:Label ID="lblTotalNumImportedWBS" Text="" runat="server"></asp:Label>&nbsp;
                                            <asp:Label ID="lblOf1" Text="Of" runat="server" meta:resourcekey="lblOf"></asp:Label>&nbsp;
                                            <asp:Label ID="lblTotalNumWBS" Text="" runat="server"></asp:Label>&nbsp;
                                        </td>
                                    </tr>
                                </table>
                            </fieldset>
                    ...
                    <div class="row RowWithNoPaddingTop">
                        <div class="col-12">
                            <telerik:RadGrid ID="RDG4" runat="server" AllowPaging="true" PageSize="250" FitPageHeightOffset="24"
                                AutoGenerateColumns="True" ShowStatusBar="True" Font-Size="8px" GridLines="None">
                                <PagerStyle Mode="NextPrevAndNumeric" AlwaysVisible="true"></PagerStyle>
                                <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
