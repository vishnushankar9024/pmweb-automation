    ...
    <tr>
        <td valign="top">
            <telerik:RadGrid ID="RDG" runat="server" AllowFilteringByColumn="true" FilterType="HeaderContext" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true"
                AutoGenerateColumns="True" ShowStatusBar="True" Font-Size="8px" PageSize="250" AllowPaging="True" Width="100%" SetWidth="true" ClientSettings-Scrolling-AllowScroll="true"
