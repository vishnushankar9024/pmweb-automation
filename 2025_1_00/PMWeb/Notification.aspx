<%@ Page Language="vb" meta:resourcekey="Page" Title="Notification" AutoEventWireup="false" CodeBehind="Notification.aspx.vb" Inherits="Website.Notication" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        ...
        @media screen and (max-width:550px) and (min-width: 320px) {
            .PMMainPage .row.JustifyContent {
                min-width: 100%;
            }

                .PMMainPage .row.JustifyContent .col-4 {
                    min-width: 100%;
                    width: 100% !important;
                }
        }
...
<telerik:RadCodeBlock ID="CodeBlock" runat="server">
    <script type="text/javascript">
        ...
        function refreshNotification() {
            //var btn = $("[id$=btnRebindNotificationGrid]")[0];
            var btn = $(window.parent.document).find("[id$=btnRebindNotificationGrid]");
            if (btn != null) {
                btn.click();
        ...
        function AddToCompanyEmail(argContactId, argContactName, argEmail, SpnClientId) {
            ...
            document.getElementById(SpnClientId).innerHTML = document.getElementById(SpnClientId).innerHTML + '<div id="divContactBox_' + tmpId + '" class="ContactBox"  ContactId="' + argContactId + '" Email="' + argEmail.replace("'", "\'") + '">' +
...
<body onload="pageload();">
    <form id="form1" runat="server">
        ...
        <telerik:RadDatePicker ID="dtpCreatedDate" Visible="false" Enabled="false" runat="server" MinDate="1901-01-01" MaxDate="9999-01-01" Width="104px" Skin="Default" EnableTyping="True">
            <DateInput ID="DateInput4" Skin="Default" runat="server"></DateInput>
        </telerik:RadDatePicker>
        <telerik:RadDatePicker ID="dtpSendDate" Visible="false" AutoPostBack="true" runat="server" MinDate="1901-01-01" MaxDate="9999-01-01" Width="104px" Skin="Default" EnableTyping="True">
        ...
        <div class="PMMainPage PMPopupMainPage">
            <div class="row documentSinglePage" style="padding-top:0px">
                <div class="col-4">
                    ...
                    <table class="colTable" border="0">
                        <tr>
                            <td class="labelWidth">
                                ...
                                <div style="float: right;">
                                    <asp:LinkButton runat="server" ID="btnFrom" CssClass="SearchButton" OnClientClick="return OpenNotificationSingleCompanyFilterPopup(this.id.replace('btnFrom', 'txtFrom'), this.id.replace('btnFrom', 'hdnFrom'), this.id.replace('btnFrom', 'hdnFromEmail'), this.id.replace('btnFrom', 'hdnFromId'), 'Contacts', 'Notification')">
                                ...
                                <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        ...
                                        <td style="text-align: right;">
                                            ...
                                            <asp:Label ID="lblSystem" CssClass="labelColor" runat="server" Text="System1" meta:resourcekey="lblSystem" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="NotificationControlWidth">
                                ...
                                <div style="" class="divContactBox" runat="server" id="dvTo">
                                    <span id="spnToCompany" runat="server" style="white-space: nowrap;display:flex;width:100%;flex-wrap:wrap"></span>
                        ...
                        <tr>
                            ...
                            <td valign="top" class="NotificationControlWidth">
                                <div class="divContactBox" runat="server" id="dvCC">
                        ...
                        <tr>
                            ...
                            <td class="NotificationControlWidth" id="tdBccbtn" runat="server">
                                <div class="divContactBox" runat="server" id="dvBcc">
                                    <span id="spnBCC" runat="server" style="white-space: nowrap;display:flex;width:100%;flex-wrap:wrap"></span>
                        ...
                        <table style="width: 100%; position: absolute !important; left: 0;" cellpadding="0" cellspacing="0" class="ToolBar ShowOnTablet">
                            <tr>
                                <td valign="middle" style="vertical-align: middle; width: 10%;" class="ToolbarTd">
                                    <telerik:RadToolBar ID="rtbDetail" runat="server" Skin="Default" Width="100%" CssClass="ShowOnTablet RadToolBar RadToolBar_Horizontal RadToolBar_Default RadToolBar_Default_Horizontal" OnClientButtonClicked="SubToolbarClick">
                                        <Items>
                                            <telerik:RadToolBarButton EnableImageSprite="true" CssClass="ToolbarCheckMark" Height="50px" CommandName="closeDetail"></telerik:RadToolBarButton>
                                            <telerik:RadToolBarButton EnableImageSprite="true" CssClass="ToolbarCancel ShowOnTablet  " Height="50px" PostBack="false" CommandName="closeDetail"></telerik:RadToolBarButton>
                                        </Items>
                                    </telerik:RadToolBar>
                                </td>
                            </tr>
                            ...
                            <div class="row JustifyContent" style="padding-top: 0;">
                                <div class="col-4 col-4-left">
                                    <table class="colTable">
                                        ...
                                        <tr>
                                            <td class="labelWidth">
                                                <asp:Label ID="lblIncludeUrl" meta:resourcekey="lblIncludeLink" runat="server" Text="Include Link"></asp:Label>
                                            </td>
                                            <td class="controlWidth">
                                ...
                                <div class="col-4 col-4-right">
                                    <table class="colTable">
                                                ...
                                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        <td style="width: 50%; padding-right: 4px;">
                                                            <telerik:RadDatePicker ID="dtpDueDate" runat="server" MinDate="1901-01-01" MaxDate="9999-01-01" Width="103px" Skin="Default" EnableTyping="True">
                                        ...
                                        <tr>
                                            ...
                                            <td class="controlWidth">
                                                <asp:CheckBox runat="server" AutoPostBack="false" CssClass="removeMargin" Checked="true" ID="chkReminder" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="labelWidth">
                                                    ...
                                                    <tr>
                                                        <td style="width: 50%; padding-right: 4px;">
                                                            <telerik:RadDatePicker ID="dtpCompletedDate" runat="server" MinDate="1901-01-01"
                                                                MaxDate="9999-01-01" Width="103px" Skin="Default" EnableTyping="True">
                ...
                <div class="col-4">
                    <div id="GridDiv" class="popup">
                        <fieldset>
                            ...
                            <table style="width: 100%; position: absolute !important; left: 0;" cellpadding="0" cellspacing="0" class="ToolBar ShowOnTablet">
                                  <tr valign="top">
                                    <td valign="top" class="ToolbarTd">
                                        <telerik:RadToolBar ID="rtbAttachments" runat="server" Skin="Default" Width="100%" CssClass="ShowOnTablet" OnClientButtonClicked="SubToolbarClick">
                                            <Items>
                                                <telerik:RadToolBarButton EnableImageSprite="true" CssClass="ToolbarCheckMark" Height="50px" CommandName="closeGrid"></telerik:RadToolBarButton>
                                                <telerik:RadToolBarButton EnableImageSprite="true" CssClass="ToolbarCancel ShowOnTablet " Height="50px" PostBack="false" CommandName="closeGrid"></telerik:RadToolBarButton>
                                            </Items>
                                        </telerik:RadToolBar>
                                    </td>
                                </tr>
                            ...
                            <div class="PMHeader">
                                <div class="row gridrow" style="padding-top: 0;">
                                    <telerik:RadGrid ID="rdgAttachToEmail" BorderStyle="None" runat="server" ClientSettings-Scrolling-AllowScroll="true" ClientSettings-Scrolling-UseStaticHeaders ="true"
                                        Height="100%" AllowPaging="false" Width="100%" AutoGenerateColumns="False" SetWidth="true"
                                        ...
                                        <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>" DataKeyNames="Id" CommandItemDisplay="None" Width="100%" InsertItemDisplay="Top"
            ...
            <div class="row">
                <telerik:RadEditor ToolsFile="~/ToolsFile.xml" DialogsScriptFile="~/JS/RadEditorDialog.js" DialogsCssFile="CSS/ControlsCSS/FormDecoratorLite.css" Width="100%" Style="box-sizing: border-box; height: 100% !important;"
                    ID="RadEditor1" Skin="Default" runat="server" OnClientLoad="OnClientLoad">
                    <Content></Content>
