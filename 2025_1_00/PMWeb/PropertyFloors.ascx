<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="PropertyFloors.ascx.vb" Inherits="Website.PropertyFloors" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %> 
<telerik:RadAjaxManagerProxy ID="AjaxManagerProxy1" runat="server">
    <AjaxSettings>
        <telerik:AjaxSetting AjaxControlID="rdgPropertyFloors">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="rdgPropertyFloors" LoadingPanelID="ldpPM" />
            </UpdatedControls>
        </telerik:AjaxSetting>  
    </AjaxSettings>
...
<div class="PMHeader">
    <div class="row">
        <div class="col-12 ResponsiveMargin">
            <telerik:RadGrid ID="rdgPropertyFloors" runat="server"   HeaderStyle-Font-Size="8" CssClass="WithoutTopBorder RDGAssetsGrid"  SetWidth="true"  ClientSettings-Scrolling-AllowScroll="true"
                Width="100%" AutoGenerateColumns="False" AllowSorting="true" ShowStatusBar="true" AllowPaging="true" PageSize="250">
