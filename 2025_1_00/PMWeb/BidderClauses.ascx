    ...
    <div class="row">
        <div class="col-6">
                ...
                <telerik:RadGrid ID="rdgClauses" runat="server"   AutoGenerateColumns="False" ShowStatusBar="True" HeaderStyle-Font-Size="8" SetWidth="true" AppendMenus = "true" FitParentContainer="true"
                                ShowGroupPanel="True" AllowMultiRowEdit="True" AllowPaging="true" PageSize="250" AllowMultiRowSelection="True" AllowSorting="True" ItemStyle-Height="20px" GridLines="None">
