               ...
               switch (Value) {
                ...
                'location=no,status=0,menubar=0,addressbar=0,resizable=1,scrollbars=1,width=820,height=500,top=' + top + ',left=' + left, 1045, 515, false);
                   ...
                   case 'New':
                       ...
                       break;
                   case 'Submit':
                       return OpenWorkflowSubmitPopup('APPaymentBatches');
                       break;
                                ...
                                <telerik:RadMenu runat="server" ID="radmen" ClickToOpen="true" CssClass="MoreMenu" OnClientItemClicked="MoreMenuClicked" OnClientItemClosing="MoreMenuClosing" OnClientItemOpening="MoreMenuOpening">
                                    <Items>
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                <telerik:RadMenuItem Text="Print" CssClass="Print" SecurityButtonType="Read" EnableImageSprite="true">
                                                    <Items>
                                                ...
                                                <telerik:RadMenuItem Text="Submit" Value="Submit" onclick="OpenWorkflowSubmitPopup('APPaymentBatches');" CssClass="Help" EnableImageSprite="true" ></telerik:RadMenuItem>
