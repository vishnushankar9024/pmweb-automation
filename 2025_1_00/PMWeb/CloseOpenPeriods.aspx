...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <telerik:RadGrid ID="rdgCloseOpenPeriods" runat="server" 
        AllowFilteringByColumn="true" PageSize="250" AllowPaging="true" HeaderStyle-Font-Size="8" ShowStatusBar="true"
        ...
        <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>" UseAllDataFields="true"
            ...
            <Columns>
                ...
                <telerik:GridTemplateColumn HeaderText="Project" UniqueName="ProjectName" Groupable="true" GroupByExpression="ProjectFullName [GridColumn_ProjectName] Group By ProjectFullName ASC"
