...
<div class="PMHeader">
    <div class="row">
        <div class="col-12 ResponsiveMargin">
            ...
            <telerik:RadGrid ID="rdgFundingDetails" AllowMultiRowSelection="true" runat="server" CssClass="WithoutTopBorder" AllowFilteringByColumn="true" FilterType="HeaderContext" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true" showfooter="true"
                ...
                <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Source" SortExpression="FundingSourceText" DataField="FundingSourceText"
                            ...
                            <EditItemTemplate>
                                <telerik:RadComboBox ID="ddlFundingSources" Width="100%" runat="server" Filter="Contains" AllowCustomText="true" height="300px"
