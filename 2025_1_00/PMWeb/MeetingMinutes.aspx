        ...
        <script type="text/javascript">
            ...
            function maintoolbarClick(value) {
                ...
                'location=no,status=0,menubar=0,addressbar=0,resizable=1,scrollbars=1,width=820,height=500,top=' + top + ',left=' + left);
                    ...
                    case 'Submit':
                        return OpenWorkflowSubmitPopup('MEETINGMINUTES');
                        break;
                    default:
            ...
            document.getElementById("ctl00_CPH1_MeetingMinuteDetails_hdMeetingMinuteDetailsId").value = args.getDataKeyValue("Id");
            }

        function AddLine() {
            document.getElementById("ctl00_CPH1_MeetingMinuteDetails_hdMeetingMinuteDetailsId").value = "";
        }
                                    ...
                                    <Items>
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem Text="Submit" Value="Submit" onclick="OpenWorkflowSubmitPopup('MEETINGMINUTES');" CssClass="Help" EnableImageSprite="true" ></telerik:RadMenuItem>
                    ...
                    <div class="row">
                        <div class="col-4 col-4-left ">
                            ...
                            <table class="colTable">
                                        ...
                                        <table id="tblStatus" runat="server" cellpadding="0" cellspacing="0" border="0" width="100%">
                                            <tr>
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="rfvStatus" ControlToValidate="ddlStatus"  InitialValue=""
                                                        runat="server" CssClass="Validator" Visible="false" Display="Dynamic"
                                ...
                                <tr>
                                    <td colspan="2">
                                        <fieldset id="fsNextMeeting" runat="server">
                                            <legend>
