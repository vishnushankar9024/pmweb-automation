            ...
            <div class="row ">
                ...
                <div class="col-12">
                    ...
                    <telerik:RadGrid ID="rdgProjects" runat="server" AutoGenerateColumns="False" FilterType="HeaderContext" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true"
                        ShowStatusBar="True" HeaderStyle-Font-Size="8" AllowFilteringByColumn="true" AllowPaging="true" PageSize="250" ClientSettings-Scrolling-AllowScroll="true" SetWidth="true" FitPageHeightOffset="24" AppendMenus="true"
