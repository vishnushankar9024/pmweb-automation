            ...
            <tr style="height:50px;">
                <td>
                 <table cellpadding="0" cellspacing="0" width="100%" style="table-layout:fixed;">
                     <tr>
                          <td style="width:50px; color:#000000 !important"><asp:Image ID="imgCaution" runat="server" ImageUrl="Images/Global/NoticeIcon.png" height="20px" Width="22px"/></td>
            <td style="color:#000000 !important"><asp:Label ID="lblCaution" meta:resourceKey="lblCaution" runat="server" Text="Your PMWeb account has been created. You will need to provide the username and the password you entered each time you log into PMWeb." ></asp:Label></td>
                     </tr>
                </table>
                </td>
...
<td>
          ...
          <td style="color:#000000 !important"><asp:Label ID="lblNote" meta:resourceKey="lblNote" runat="server" Text="Click a button below to begin applying for vendor status or to visit your account details page. Note: you can always start your application from the Account Details page." ></asp:Label></td>
                     </tr>
                </table>
                </td>
