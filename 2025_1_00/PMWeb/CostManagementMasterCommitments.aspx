        ...
        <script language="javascript" type="text/javascript">
            ...
            function maintoolbarClick(Value) {
                ...
                + "&EntityId=" + '<%=PM.CostManagement.MasterCommitmentInfo.ProgramId%>' + "&EntityType=2", 890, 430, false);
                    ...
                    case 'Submit':
                        return OpenWorkflowSubmitPopup('MASTERCOMMITMENTS');
                        break;
                    default:
                                    ...
                                    <Items>
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem Text="Submit" Value="Submit" onclick="OpenWorkflowSubmitPopup('MASTERCOMMITMENTS');" CssClass="Help" EnableImageSprite="true" ></telerik:RadMenuItem>
                    ...
                    <div class="col-4 col-4-middle">
                        <fieldset runat="server" id="fldsetMasterCommitmentRecap">
                            ...
                            <table class="colTable" runat="server" id="tblRecap">
                                ...
                                <table class="colTable" runat="server" id="TableMaster">
                                <tr>
                                        ...
                                        <table class="TableNoSpacingNoBorder">
                                            <tr>
                                                ...
                                                <td style="width: 40%; padding-left: 10px;">
                                                    <asp:TextBox ID="txtMasterValueDays" CssClass="Days" runat="server"></asp:TextBox>
                                                </td>
                                            </tr>
                                 ...
                                 <table class="colTable" runat="server" id="TableVisAll">
                                <tr>
                                    <td class="labelWidth">
                                    ...
                                    <td class="controlWidth">
                                        <table class="TableNoSpacingNoBorder" width="100%">
                                            <tr>
                                                ...
                                                <td style="width: 40%; padding-left: 10px;">
                                                    <asp:TextBox ID="txtMasterBalanceDays" runat="server" CssClass="Days"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
