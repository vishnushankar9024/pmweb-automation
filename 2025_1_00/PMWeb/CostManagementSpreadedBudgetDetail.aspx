<%@ Page Language="vb" meta:resourcekey="Page" Title="Budget Projection" AutoEventWireup="false" CodeBehind="CostManagementSpreadedBudgetDetail.aspx.vb" Inherits="Website.CostManagementSpreadedBudgetDetail" %>
                    ...
                    <div class="col-4 col-4-left">
                        <table class="colTable">
                            ...
                            <tr>
                                ...
                                <td class="controlWidth">
                                    <asp:TextBox ID="txtBudgetedAmount" CssClass="Currency" runat="server" Style="width: 100%"></asp:TextBox></td>
                            </tr>
                    ...
                    <div class="col-4 col-4-middle">
                        <table class="colTable">
                            ...
                            <tr>
                                ...
                                <td class="controlWidth">
                                    <asp:TextBox ID="txtUnitCost" CssClass="Currency" runat="server" Style="width: 100%"></asp:TextBox></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="controlWidth">
                                    <asp:TextBox ID="txtBudgetedQuantity" CssClass="Double" runat="server" Style="width: 100%" MinNumber="1"></asp:TextBox></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="controlWidth">
                                    <telerik:RadComboBox ID="ddlToPeriod" runat="server" Width="100%"
                                        Filter="Contains"
                ...
                <div class="col-12">
                            ...
                            <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Period" Groupable="false" UniqueName="Period" DataField="Period">
                                        ...
                                        <ItemTemplate>
                                            <telerik:RadComboBox ID="ddlPeriods" runat="server" Height="200px" Skin="Default" Width="100%"
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Date" DataField="EffectiveDate"
                                        SortExpression="EffectiveDate" GroupByExpression="EffectiveDate [GridColumn_EffectiveDate] Group By EffectiveDate"
                                        UniqueName="EffectiveDate">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtNewDate" Width="100%" Text='<%#FormatDate(Eval("EffectiveDate"))%>'
                    ...
                    <%#IIf(Container.DataItem("Description") = String.Empty, "&nbsp;", Container.DataItem("Description"))%>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Resource" HeaderStyle-HorizontalAlign="left" DataField="Resource"
                                        HeaderStyle-Width="170px" UniqueName="Resource" SortExpression="Resource" GroupByExpression="Resource [GridColumn_Resource] Group By Resource ASC">
                                    ...
                                    <%#IIf(Container.DataItem("Resource").ToString = String.Empty, "&nbsp;", Container.DataItem("Resource").ToString)%></span>--%>
                                        ...
                                        <ItemTemplate>
                                            <telerik:RadComboBox
                                                ID="ddlResources" runat="server" Height="200px" Skin="Default" Width="100%"
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Quantity" Groupable="false" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Right"
                                        SortExpression="Quantity" UniqueName="Quantity" DataField="Quantity">
                                        <%--  <ItemTemplate>
                    <%#FormatNumber(CDbl(Container.DataItem("Quantity")))%>
                </ItemTemplate>--%>
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtQuantity" runat="server" Width="99%" MaxLength="15" Text='<%# FormatNumber(CDbl(IIf(Eval("Quantity") Is System.DBNull.Value, 1, Eval("Quantity"))))%>'
                    ...
                    <%#FormatCurrency(CDbl(Container.DataItem("UnitCost")))%>
                                        ...
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtUnitCost" runat="server" Width="99%" MaxLength="15" Text='<%# FormatCurrency(IIf(Eval("UnitCost") Is System.DBNull.Value, 0, Eval("UnitCost")), CurrencyId:=CurrencyId)%>'
