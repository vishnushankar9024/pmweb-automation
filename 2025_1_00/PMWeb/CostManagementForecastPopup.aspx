<%@ Page meta:resourcekey="Page" Language="vb" AutoEventWireup="false" CodeBehind="CostManagementForecastPopup.aspx.vb" Inherits="Website.CostManagementForecastPopup" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function ddlField_OnClientSelectedIndexChanged(sender, eventArgs) {
            ...
            $("input[id$=txtForecastedAmount]").val(item.get_attributes().getAttribute("Amount"));
        }
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxManager ID="PMAjaxManager" runat="server" EnablePageHeadUpdate="true">
            <AjaxSettings>
                <telerik:AjaxSetting AjaxControlID="rdgForecastCosts">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="rdgForecastCosts" LoadingPanelID="ldpPM" />
                        <telerik:AjaxUpdatedControl ControlID="chrtCashFlow" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
                ...
                <td class="ToolbarTd">
                    <telerik:RadToolBar ID="mainToolBar" runat="server" Skin="Default" AutoPostBack="true" Width="100%" CssClass="popup-toolbar" OnClientButtonClicked="maintoolbarClick">
                        <Items>
                            ...
                            <telerik:RadToolBarButton IsSeparator="true" OuterCssClass="ShowOnMobile"></telerik:RadToolBarButton>
                ...
                <div class="row R3Cols">
                    <div class="col-4 col-4-left">
                        <table class="colTable">
                            <tr>
                                <td class="labelWidth">
                                    <asp:Label ID="lblField" runat="server" meta:resourcekey="lblField" Text="Field"></asp:Label>
                                </td>
                                <td class="controlWidth">
                                    <telerik:RadComboBox ID="ddlField" runat="server" Width="100%" Filter="Contains"
                            ...
                            <tr>
                                <td class="labelWidth">
                                    <asp:Label ID="lblForecastedAmount" runat="server" meta:resourcekey="lblForecastedAmount" Text="Amount"></asp:Label>
                                </td>
                                <td class="controlWidth">
                                    <asp:TextBox ID="txtForecastedAmount" CssClass="Currency" runat="server" Style="width: 100%"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="labelWidth">
                                ...
                                <td class="controlWidth">
                                    <telerik:RadComboBox ID="ddlFromPeriod" runat="server" Width="100%" Filter="Contains"
                    ...
                    <div class="col-4 col-4-middle">
                        <table class="colTable">
                            <tr>
                                <td class="labelWidth">
                                    <asp:Label ID="lblUnitCost" runat="server" meta:resourcekey="lblUnitCost" Text="Unit Cost"></asp:Label>
                                </td>
                                <td class="controlWidth">
                                    <asp:TextBox ID="txtUnitCost" CssClass="Currency" runat="server" Style="width: 100%"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="labelWidth">
                                    <asp:Label ID="lblForecastedQuantity" runat="server" meta:resourcekey="lblForecastedQuantity" Text="Quantity"></asp:Label>
                                </td>
                                <td class="controlWidth">
                                    <asp:TextBox ID="txtForecastedQuantity" MinNumber="1" CssClass="Double" runat="server" Style="width: 100%"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="labelWidth">
                                ...
                                <td class="controlWidth">
                                    <telerik:RadComboBox ID="ddlToPeriod" runat="server" Width="100%" Filter="Contains"
                                        MarkFirstMatch="true" Skin="Default" CloseDropDownOnBlur="true" NoWrap="True">
                                    </telerik:RadComboBox>
                                </td>
                            </tr>
                    ...
                    <div class="col-4 col-4-right">
                        <table class="colTable">
                            <tr>
                                ...
                                <td class="controlWidth">
                                    <telerik:RadComboBox ID="ddlCurve" runat="server" Width="100%" Filter="Contains"
                                        MarkFirstMatch="true" Skin="Default" CloseDropDownOnBlur="true" NoWrap="True">
                                    </telerik:RadComboBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="controlWidth" align="right">
                                    <asp:Button ID="btnSpread" meta:resourcekey="btnSpread" runat="server" Text="Projection" />
                                </td>
                            </tr>
                        </table>
                    </div>
        ...
        <div class="PMMainPage PMPopupMainPage documentSinglePageProjection">
            <div class="row RowWithNoPaddingTop">
                <div class="col-12">
                    <div id="divGrid" style="padding-bottom:24px;" runat="server">
                        <telerik:RadGrid ID="rdgForecastCosts" runat="server" ShowFooter="true" AllowFilteringByColumn="true" FilterType="HeaderContext" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true"
                            AutoGenerateColumns="False" ShowStatusBar="True" Font-Size="8px" PageSize="250" setwidth="true" allow-scroll="true"
                            AllowPaging="True" AllowMultiRowEdit="True" AllowMultiRowSelection="True"
                            ...
                            <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
                                ...
                                InsertItemPageIndexAction="ShowItemOnFirstPage" EditMode="InPlace" EnableHeaderContextMenu="false" AllowCustomSorting="true">
                                <Columns>
                                    <telerik:GridTemplateColumn HeaderText="Line #" HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Right" DataField="LineNumber" AllowFiltering="false"
                                        UniqueName="LineNumber" HeaderStyle-Wrap="false" Groupable="false" Reorderable="false">
                                        <ItemTemplate>
                                        ...
                                        <HeaderStyle Wrap="False" Width="106px"></HeaderStyle>

                                        <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                    </telerik:GridTemplateColumn>
                                    <telerik:GridTemplateColumn HeaderText="Period" Groupable="false" UniqueName="Period" DataField="Period">
                                        <ItemTemplate>
                                            <telerik:RadComboBox Skin="Default" Filter="Contains" MarkFirstMatch="true" AllowCustomText="true" ID="ddlPeriods" runat="server" Width="100%">
                                            </telerik:RadComboBox>
                                        </ItemTemplate>
                                        <HeaderStyle Width="220px"></HeaderStyle>

                                    </telerik:GridTemplateColumn>
                                    <telerik:GridTemplateColumn HeaderText="Description" Groupable="false" ItemStyle-Wrap="false" SortExpression="Description" DataField="Description"
                    ...
                    <%#FormatNumber(CDbl(Container.DataItem("Quantity")))%>
                                        ...
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtQuantity" runat="server" Width="99%" MaxLength="15" Text='<%# FormatNumber(Eval("Quantity")) %>'
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Unit Cost" Groupable="false" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Right" DataField="UnitCost"
                                        SortExpression="UnitCost" UniqueName="UnitCost">
                                        <%--    <ItemTemplate>
                    <%#FormatCurrency(CDbl(Container.DataItem("UnitCost")))%>
                </ItemTemplate>--%>
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtUnitCost" runat="server" Width="99%" MaxLength="15" Text='<%# FormatCurrency(Eval("UnitCost"), CurrencyId:=CurrencyId)%>'
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Total Cost" Groupable="false" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Right"
                                        SortExpression="TotalAmount" UniqueName="TotalCost" DataField="TotalCost">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtTotalAmount" runat="server" Width="99%" MaxLength="25" Text='<%# FormatCurrency(Eval("TotalAmount"), CurrencyId:=CurrencyId) %>'
                                                CssClass="Currency"></asp:TextBox>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="UOM" Groupable="false" UniqueName="UOM" SortExpression="UOM" DataField="UOM">
                                        <%--  <ItemTemplate>
                    <%#IIf(Container.DataItem("UOM") = String.Empty, "&nbsp;", Container.DataItem("UOM"))%>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Notes" DataField="Notes"
                                        SortExpression="Notes" Groupable="false" UniqueName="Notes">
                                        <%--  <ItemTemplate>
                    <%#IIf(Container.DataItem("Notes") = String.Empty, "&nbsp;", Container.DataItem("Notes"))%>
                </ItemTemplate>--%>
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtNotes" runat="server" Text='<%# Eval("Notes") %>' Width="99%"
                                                MaxLength="200"></asp:TextBox>
                                        </ItemTemplate>
                                        <HeaderStyle Width="229px"></HeaderStyle>
                                    </telerik:GridTemplateColumn>
                                </Columns>
            ...
            <%--    <asp:LinkButton ID="btnEditSelected" runat="server" CausesValidation="False" CommandName="EditRows"
                    SecurityButtonType="ItemMode_Edit" Visible='<%# rdgForecastCosts.EditIndexes.Count = 0 AND (Not rdgForecastCosts.MasterTableView.IsItemInserted) %>'>
                    ...
                    SecurityButtonType="AddEditMode_Edit" Visible='<%# rdgForecastCosts.EditIndexes.Count > 0 %>'>
                    ...
                    SecurityButtonType="AddEditMode" Visible='<%# rdgForecastCosts.EditIndexes.Count > 0 Or rdgForecastCosts.MasterTableView.IsItemInserted %>'>
                    ...
                    &nbsp;&nbsp;
                                        ...
                                        <asp:LinkButton ID="btnDelete" CausesValidation="False" OnClientClick="return ConfirmDelete()"
                                            SecurityButtonType="ItemMode_Delete" Visible='<%# rdgForecastCosts.EditIndexes.Count = 0 And (Not rdgForecastCosts.MasterTableView.IsItemInserted) %>'
                    ...
                    <div style="width: 100%; overflow: auto;" id="divChart" class="HideOnMobilePopup" runat="server">
                        <telerik:RadChart ID="chrtCashFlow" runat="server" Width="900px" Height="500px"
                            ...
                            Legend-Appearance-Dimensions-Width="500px" Skin="LightBlue">
                            <Series>
