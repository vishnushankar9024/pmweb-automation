...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH1" runat="server">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function setMenuItemsState(menuItems, treeNode) {
                ...
                if (tree.get_selectedNode().get_value().indexOf("Q_") > -1)
                    isFile = true;
                if (tree.get_selectedNode().get_value().indexOf("P_") > -1 || tree.get_selectedNode().get_value().indexOf("PC_") > -1 || tree.get_selectedNode().get_value().indexOf("C_") > -1 || tree.get_selectedNode().get_value().indexOf("T_") > -1)
                    isSystemFile = true;
                    ...
                    switch (menuItem.get_value()) {
                        ...
                        case "Delete":
                            ...
                            for (j = 0; j < nodes.length; j++) {
                                if (nodes[j].get_value().indexOf("P_") > -1 || nodes[j].get_value().indexOf("PC_") > -1 || nodes[j].get_value().indexOf("C_") > -1 || nodes[j].get_value().indexOf("T_") > -1)
                                    hideDelete = true;
   ...
   <telerik:RadAjaxManagerProxy ID="RadAjaxManagerProxy1" runat="server">
        <AjaxSettings>            
            ...
            <telerik:AjaxSetting AjaxControlID="ReportToolBar">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="ReportToolBar" />
                </UpdatedControls>
            </telerik:AjaxSetting>
    ...
    <telerik:RadSplitter ID="RadSplitter1" runat="server" Skin="Default" Width="100%" CssClass="RDSplitter" SplitBarsSize="" >
        ...
        <telerik:RadPane ID="RadContentPane" runat="server" Width="70%" Index="2" Skin="Default" CssClass="RDRightPane" OnClientResized="ClientResized">
