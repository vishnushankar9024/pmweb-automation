<%@ Page Language="vb" Title="Add Change Orders" meta:resourcekey="Page" AutoEventWireup="false" CodeBehind="RequisitionCOPopup.aspx.vb" Inherits="Website.RequisitionCOPopup" %>
...
<script language="javascript" type="text/javascript">
    ...
    function SelectAll(chk) {
        var total = 0;
        $("#rdgContractCOs").find("input[type='checkbox']").each(function () {
            this.checked = chk.checked;
        });
    }

    function SelectParent(chk) {
        var chkParent = $("#rdgContractCOs").find("input[type='checkbox']")[0];
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxManager ID="PMAjaxManager" runat="server" EnablePageHeadUpdate="true"
            ...
            <AjaxSettings>
                <telerik:AjaxSetting AjaxControlID="rdgContractCOs">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="rdgContractCOs" LoadingPanelID="ldpPM" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
            </AjaxSettings>
            ...
            <div class="row">
                <div class="col-12">
                    <table class="colTable">
                        <tr>
                            <td>
                                <telerik:RadGrid ID="rdgContractCOs" AllowMultiRowSelection="false" runat="server" SetWidth="true" ClientSettings-Scrolling-AllowScroll="true"
                                    ...
                                    <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Contract Line" UniqueName="ContractLine"
                                            ...
                                            <div style="padding: 2px">
                                                &nbsp;&nbsp;
                                                    <asp:LinkButton ID="btnRefresh" runat="server" CausesValidation="False" CommandName="Undo" CssClass="GridCmdUndo"
                                                        Visible='<%# rdgContractCOs.EditIndexes.Count = 0 And (Not rdgContractCOs.MasterTableView.IsItemInserted) %>'>
