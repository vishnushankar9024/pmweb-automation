                    ...
                    <table class="colTable" border="0">
                        ...
                        <tr>
                            ...
                            <td class="NotificationControlWidth">
                                ...
                                <div class="divContactBox" runat="server" id="dvTo">
                                    ...
                                    <div class="row gridrow" style="padding-top: 0;">
                                        <div class="col-12">
                                            <telerik:RadGrid ID="rdgAttachToEmail" BorderStyle="None" runat="server" SetWidth="true" ClientSettings-Scrolling-AllowScroll="true"
                                                ...
                                                <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>" DataKeyNames="Id" CommandItemDisplay="None" Width="100%" TableLayout="auto" InsertItemDisplay="Top"
