    ...
    <form id="form1" runat="server">
        <telerik:RadCodeBlock ID="CodeBlock" runat="server">
            <script type="text/javascript">
                let currentRadWindow = window.radWindow || window.frameElement.radWindow;

                function replaceSelection(replacement) {
                    let txtCalculation = $($get('<%= txtCalculation.ClientID %>'));
                ...
                function pageLoad() {
                    ...
                    if (window.radWindow != null) {
                        ...
                        let SenderId = qs["SenderId"];
                        SenderId = SenderId.replace("imgCalculation", "txtCalculation");
                        txtCalculation.val(currentRadWindow.BrowserWindow.document.getElementById(SenderId).value)
                    }
                    // Place the cursor at the end of the text
                    txtCalculation.selectRange(txtCalculation.val().length, txtCalculation.val().length);
                }
                ...
                function SaveClick(action) {
                    ...
                    currentRadWindow.BrowserWindow.document.getElementById(SenderId).value = txtCalculation.val();

                    let checkBoxId = SenderId.replace("txtCalculation", "chbVisible");
                    if (currentRadWindow.BrowserWindow.document.getElementById(checkBoxId)) { radWindow.BrowserWindow.document.getElementById(checkBoxId).checked = true; }
