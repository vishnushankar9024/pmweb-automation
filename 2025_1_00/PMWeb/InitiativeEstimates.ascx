    ...
    <div class="row">
        <div class="col-12">
            <telerik:RadGrid ID="rdgEstimateDetails" runat="server"  CssClass="WithoutTopBorder" AllowFilteringByColumn="true" FilterType ="HeaderContext" EnableHeaderContextMenu ="true" EnableHeaderContextFilterMenu="true"
                 AutoGenerateColumns="false" ShowStatusBar="true" Font-Size="8px" PageSize="250" setWidth="true" appendMenus="true" FitParentContainer="true"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Assembly Code" SortExpression="AssemblyCode" GroupByExpression="AssemblyCode [GridColumn_AssemblyCode],AssemblyDescription, SUM(TotalCost) TCost, MIN(AssemblyMultiplier) Qty Group By AssemblyCode"
