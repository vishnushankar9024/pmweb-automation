        ...
        <script language="javascript" type="text/javascript">
            ...
            function click_handler(sender, args) {
                ...
                switch (args.get_item().get_commandName()) {
                    ...
                    case 'Print':
                        var ProjectValue =  $("[id$=hdnProjectId]")[0].value;
                    ...
                    <div class="row">
                        <div class="col-12">
                            <table class="colTable">
                                <tr>
                                    <td>
                                        <telerik:RadGrid ID="RDG" runat="server" AutoGenerateColumns="True" ShowStatusBar="false" Font-Size="8px" PageSize="250" AllowPaging="True" SetWidth="true" AppendMenus="true" FitParentContainer="true" ClientSettings-Scrolling-AllowScroll="true"
