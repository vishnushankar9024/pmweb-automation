<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ReminderTemplate.ascx.vb" Inherits="Website.ReminderTemplate" %>
...
<style>
    div#ctl00_CPH1_ReminderTemplate1_RadEditor1 {
    ...
    <tr>
        ...
        <td style="width: 240px" class="ToolbarTd">
            <telerik:RadComboBox ID="ddlRecordType" runat="server" OnClientTextChange="LOD_DropDownTextChange"
                ...
                CausesValidation="False" Height="400px" Filter="Contains" Skin="Default" DropDownCssClass="ToolbarDropdownMessageTemplate">
    ...
    <div class="row JustifyContent R3Cols row-4-5-4">
        <div  class="col-4 col-4-left">
            <fieldset>
                ...
                <telerik:RadTreeView ID="tree" Height="518px" Width="100%" runat="server" OnClientNodeClicked="OnClientItemDoubleClicked" ShowLineImages="false">
                </telerik:RadTreeView>
            </fieldset>
        </div>
        ...
        <div  class="col-4 col-4-right">
            <fieldset>
                ...
                <telerik:RadGrid ID="rdgAttachToEmail" runat="server" Height="100%" AllowPaging="true" PageSize="250" Width="100%" SetWidth="true" ClientSettings-Scrolling-AllowScroll="true"
                    ...
                    <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>" DataKeyNames="Id" CommandItemDisplay="None" Width="100%" TableLayout="Fixed" InsertItemDisplay="Top"
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn Reorderable="false" UniqueName="TemplateColumn" Groupable="False" AllowFiltering="false" HeaderStyle-Width="48px">
                                <HeaderTemplate>
                                    <asp:CheckBox ID="chkAll" onClick="AllReminderCheckClicked(this)" runat="server" />
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:CheckBox ID="chkSelect" onClick="SelectReminderParent(this)" runat="server" />
                                </ItemTemplate>
