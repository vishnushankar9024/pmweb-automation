...
<div class="PMMainPage">
    ...
    <div class="row">
        <div class="col-12">
            <telerik:RadGrid ID="RDG" runat="server" AutoGenerateColumns="False" ShowStatusBar="True" Font-Size="8px" PageSize="250" SetWidth="true" ClientSettings-Scrolling-AllowScroll="true"
