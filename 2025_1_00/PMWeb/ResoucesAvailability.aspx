...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
  ...
  <%--  <style>
    ...
    <table class="ToolBar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr valign="top">
            <td class="ToolbarTd">
                <telerik:RadToolBar ID="mainToolBar" runat="server" Skin="Default" AutoPostBack="true" Width="100%" OnClientButtonClicked="click_handler" OnClientButtonClicking="OnClientButtonClickingHandler">
                    <Items>
                        <telerik:RadToolBarSplitButton SecurityButtonType="Read" ImageUrl="Images/ToolBar/Printer.png" ToolTip="Print" CommandName="Print"  CssClass="ToolbarPrint" EnableImageSprite="true" EnableDefaultButton="false">
                            <Buttons>
