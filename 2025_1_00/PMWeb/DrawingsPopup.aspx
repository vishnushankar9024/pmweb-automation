                    ...
                    <table class="colTable">
                        <tr>
                            ...
                            <td class="controlWidth">
                                <asp:TextBox ID="txtProject" runat="server" ReadOnly="true" MaxLength="100"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="labelWidth">
                            ...
                            <td class="controlWidth">
                                <asp:TextBox ID="txtPhase" runat="server" ReadOnly="true" MaxLength="100"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <telerik:RadGrid ID="rdgDrawingLists" runat="server" Width="100%" SetWidth="true" FitParentContainer="true" ClientSettings-Scrolling-AllowScroll="true"
                        AutoGenerateColumns="False" ShowStatusBar="True" Font-Size="8px" PageSize="250" FitPageHeightOffset="24"
