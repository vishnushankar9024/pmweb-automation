    ...
    <div class="row">
        <div class="col-12 ResponsiveMargin">
            <telerik:RadGrid ID="rdgCostCodes" runat="server" SetWidth="true" AppendMenus="true" HasPasteFromExcel="true"
                ...
                PageSize="250" AllowPaging="true" ShowFooter="false" ShowGroupPanel="True"  AllowFilteringByColumn="true" FilterType="HeaderContext" EnableHeaderContextFilterMenu="true" 
                AllowMultiRowEdit="True" AllowMultiRowSelection="true" AllowSorting="true" ItemStyle-Height="20px" UseEditFormInMobile="true" EnableHeaderContextMenu="true">
                ...
                <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="" DataField="Inactive" UniqueName="Inactive" AllowFiltering="true" DataType="System.Boolean" HeaderStyle-Width="178px" ItemStyle-Wrap="false" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true"
                        ...
                        <telerik:GridTemplateColumn HeaderText="Cost Code"  DataField="CostCode" UniqueName="CostCode" SortExpression="CostCode" Groupable="false" AllowFiltering="true"  CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true"  DataType="System.String">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Description" DataField="CostCodeDescription" SortExpression="CostCodeDescription" 
                            UniqueName="CostCodeDescription" GroupByExpression="CostCodeDescription [GridColumn_CostCodeDescription] Group By CostCodeDescription"  CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true" DataType="System.String">
                            <ItemTemplate>
                            ...
                            <EditItemTemplate>
                                ...
                                <div>
                                    <asp:RequiredFieldValidator ID="rfvDescription"
                                        runat="server" ControlToValidate="txtDescription" CssClass="Validator"
                                        ErrorMessage="Required" meta:resourcekey="rfvDescriptionRequired" Display="Dynamic" ValidationGroup="Save"> 
                                    </asp:RequiredFieldValidator>
                                </div>
                            </EditItemTemplate>
                            <HeaderStyle Width="168px"></HeaderStyle>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Notes" SortExpression="Notes" DataField="Notes" CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true" DataType="System.String" UniqueName="Notes" GroupByExpression="Notes [GridColumn_Notes] Group By Notes">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Account" UniqueName="Account" DataField="GLAccount" SortExpression="GLAccount" GroupByExpression="GLAccount [GridColumn_Account] Group By GLAccount" CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true">
                            <ItemTemplate>
                ...
                <asp:LinkButton ID="btnEditSelected" runat="server" CausesValidation="false"
                    ...
                    <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>&nbsp;&nbsp;
                            ...
                            <asp:LinkButton ID="btnSave" runat="server" ValidationGroup="Save" CausesValidation="true"
                                SecurityButtonType="AddEditMode_Add" CommandName="PerformInsert" CssClass="GridCmdPerformInsert"
                                Visible='<%# rdgCostCodes.MasterTableView.IsItemInserted %>'>
                                <span class="Icon"></span>
