spe<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="InspectionDetailsPopup.aspx.vb" Inherits="Website.InspectionDetailsPopup" %>
    ...
    <form id="form1" runat="server">
        <div>
            <telerik:RadGrid ID="rdgInspectionDetailsPopup" runat="server" SetWidth="true" AppendMenus = "true"
                Skin="Default" AutoGenerateColumns="False" ShowStatusBar="False" Font-Size="8px" PageSize="250" AllowMultiRowSelection="true"
