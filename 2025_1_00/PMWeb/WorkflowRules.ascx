...
/*            .AssetSplitterPane {
        ...
        .RDSplitter, .RDLeftPane, .RDRightPane {
            height: calc(var(--Content-height)  - 38px) !important;
        }
        .RDSplitter .ToolBarWorkflowRoles{
            top:0 !important;
        }      
        .RDLeftPane {
            background-color: #666666 !important;
...
<telerik:RadSplitter ID="RadSplitter1" runat="server" Skin="Default" Width="100%" CssClass="RDSplitter" SplitBarsSize="" >
    ...
    <telerik:RadPane ID="RadContentPane" runat="server" Width="70%" Index="2" Skin="Default" CssClass="RDRightPane" Style="margin-top: 68px;">
                            ...
                            <tr>
                                <td>
                                    <telerik:RadGrid ID="rdgRuleConditions" UseEditFormInMobile="true" runat="server" AutoGenerateColumns="False" SetWidth="true" FitParentContainer="true" Width="100%"
                                        ShowStatusBar="True" Font-Size="8px" PageSize="250" ShowFooter="false" AllowPaging="True" ShowGroupPanel="False"
                                        ...
                                        <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridTemplateColumn HeaderText="Operator" UniqueName="OperatorName">
                                                    ...
                                                    <EditItemTemplate>
                                                        <telerik:RadCombobox ID="ddlOperators" OnSelectedIndexChanged="ddlOperators_SelectedIndexChanged" AutoPostBack="true" Width="100%" runat="server" />
                                                    </EditItemTemplate>
                                                    <HeaderStyle Width="150px" />
                                                </telerik:GridTemplateColumn>
                                                <telerik:GridTemplateColumn HeaderText="Value" UniqueName="Value">
                                                    ...
                                                    <EditItemTemplate>
                                                        ...
                                                        <telerik:RadComboBox MarkFirstMatch="True" CloseDropDownOnBlur="true" Filter="Contains" AllowCustomText="False" ID="ddlItems" runat="server"
                                                            Width="100%" Height="200px" Skin="Default" OnItemsRequested="ddl_ItemsRequested" EnableLoadOnDemand="True"
                                                            ShowMoreResultsBox="true" EnableVirtualScrolling="true"  autopostback="false">
                                                        </telerik:RadComboBox>
                                                        <asp:RequiredFieldValidator ID="rfvItems" runat="server" ControlToValidate="ddlItems"
                                                            CssClass="Validator" InitialValue="" ValidationGroup="SaveConditions"
                                                            Display="Dynamic">
                                                        </asp:RequiredFieldValidator>
                                                         <telerik:RadComboBox MarkFirstMatch="True" CloseDropDownOnBlur="true" Filter="Contains" AllowCustomText="False" ID="ddlCostCodes" runat="server"
                                                            Width="100%" Height="200px" Skin="Default" OnItemsRequested="ddl_ItemsRequested" EnableLoadOnDemand="True"
                                                            ShowMoreResultsBox="true" EnableVirtualScrolling="true" AutoPostBack="false">
                                                        </telerik:RadComboBox>
