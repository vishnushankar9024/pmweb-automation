            ...
            <telerik:GridTemplateColumn HeaderText="Line #" UniqueName="Line" ItemStyle-HorizontalAlign="Right"
                ...
                <ItemTemplate>
                    <span>
                      ...
                      <asp:HiddenField runat="server" ID="IsLinkedContractDetail" Value='<%#Eval("IsLinkedContractDetail").ToString%>' />
                </ItemTemplate>
                <EditItemTemplate>
                    <span>
            ...
            <telerik:GridTemplateColumn HeaderText="Cost Code" SortExpression="CostCode"
                ...
                <EditItemTemplate>
                    <telerik:RadComboBox ID="ddlCostCodes" Width="100%" DropDownWidth="300px" runat="server"
                        ...
                        NoWrap="False" AllowCustomText="False" OnClientSelectedIndexChanged="ddlCostCodes_OnClientSelectedIndexChanged"
