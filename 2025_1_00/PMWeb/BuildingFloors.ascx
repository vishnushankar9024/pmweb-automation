<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="BuildingFloors.ascx.vb" Inherits="Website.BuildingFloors" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %> 
 <telerik:RadAjaxManagerProxy ID="AjaxManagerProxy1" runat="server">
    <AjaxSettings>
        <telerik:AjaxSetting AjaxControlID="rdgBuildingFloors">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="rdgBuildingFloors" LoadingPanelID="ldpPM" />
            </UpdatedControls>
        </telerik:AjaxSetting>  
    </AjaxSettings>
...
<div class="PMHeader">
    <div class="row">
        <div class="col-12 ResponsiveMargin">
            <telerik:RadGrid ID="rdgBuildingFloors" runat="server"   HeaderStyle-Font-Size="8" CssClass="WithoutTopBorder" SetWidth="true" ClientSettings-KeyboardNavigationSettings-AllowSubmitOnEnter="true"
                ...
                <ClientSettings  EnableRowHoverStyle="true" AllowDragToGroup="true" Resizing-AllowColumnResize="true" >
                    ...
                    <ClientEvents OnRowClick="BuildingFloorsRowClick" />
                </ClientSettings>
            </telerik:RadGrid>
