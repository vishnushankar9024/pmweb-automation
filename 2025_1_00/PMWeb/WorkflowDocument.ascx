...
<telerik:RadScriptBlock ID="rsbDocument" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        var arrCurrentStepParentIds = <%= "[" + String.Join(",", PM.Workflow.DocumentInfo.CurrentStepParentIds.Select(Function(x) x.ToString())) + "]"%>;

        function rdtStepActionsCreated(sender, eventArgs) {
            var WorkflowDocumentGrid = sender;
            var nodes = WorkflowDocumentGrid.get_dataItems();
            for (var i = 0; i < nodes.length; i++) {
                if (nodes[i].get_childItems().length != 0 && arrCurrentStepParentIds.includes(parseInt(nodes[i].get_dataKeyValue('StepId')))) {
                    nodes[i].toggleExpandCollapse();
                    nodes[i].set_clientExpanded(false);
                    if (nodes[i].get_clientExpanded() != true) {
                    }
                }
        ...
        function BuildArrayActionsSettings() {
            ...
            var arrSubject = $("[id$=hdnSubject]").val().split('$$SplitValueHere$$');
            var arrBody = $("[id$=hdnBody]").val().split('$$SplitValueHere$$');
            var arrRequireComments = $("[id$=hdnRequireComments]").val().split('$$SplitValueHere$$');
            for (var i = 0; i < arrActions.length - 1; i++) {
                arrActionsSettings.push({ 'Action': arrActions[i], 'Subject': arrSubject[i], 'Body': arrBody[i], 'RequireComments': arrRequireComments[i] });
            }
            ...
            if (sender.src.indexOf("Plus") > 0) {
                ...
                $("[id$='" + section + "']").show(200, function () {
                    ...
                    $.ajax({
                        ...
                        data: JSON.stringify({ strSection: section, blnVisible: true }),
                        dataType: "json",
                        async: true
                    });
                ...
                $("[id$='" + section + "']").hide(200, function () {
                    $.ajax({
                        ...
                        url: "AjaxService.aspx/ToggleWorkflowSections",
                        contentType: "application/json; charset=utf-8",
                        data: JSON.stringify({ strSection: section, blnVisible: false }),
                        dataType: "json",
                        async: true
                    });
                });
        ...
        function OnFileValidationFailed(sender, args) {
        ...
        function AdjustGridHeight(radWindow) {
            let gridContainer = radWindow.get_contentFrame().contentDocument.querySelector(".grid-container");
...
<style type="text/css">
    .ProjectCenterUpload.WorkflowFileUpload input.ruButton {
        height: 26px !important;
    }

    .ProjectCenterUpload.WorkflowFileUpload {
    ...
    .RadUpload.ProjectCenterUpload.WorkflowFileUpload .ruFileWrap {
        color: black;
    }

    .RadUpload.ProjectCenterUpload.WorkflowFileUpload .ruFileInput,
    .RadUpload.ProjectCenterUpload.WorkflowFileUpload .ruBrowse {
        display: none;
    }
    ...
    .RadUpload.ProjectCenterUpload.WorkflowFileUpload .ruInputs {
    ...
    .RadUpload.ProjectCenterUpload.WorkflowFileUpload {
        text-transform: none !important;
    }

    .RadUpload.ProjectCenterUpload.WorkflowFileUpload .ruFileProgressWrap {
        margin-top: 5px !important;
    }

    .RadUpload.ProjectCenterUpload.WorkflowFileUpload .ruButton {
...
<telerik:RadWindowManager ID="RadWindowManager1" runat="server">
    <Windows>
        <telerik:RadWindow ID="RadWindow1" runat="server"
            NavigateUrl="ESignAttachmentPopup.aspx"
            Width="900px"
            Height="600px"
            Modal="true"
            ...
            ReloadOnShow="true"
            Title="SELECT TO ATTACH TO EMAIL" 
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td style="padding-top: 16px; width: 50%;" class="ButtonsDesignOnMobile">
                                                    <asp:LinkButton ID="btnTeamInput" CausesValidation="false" CssClass="lnkButton" OnClientClick="javascript:return OpenTeamInputPopup();" runat="server" Width="155px">
                                                ...
                                                <td class="ButtonsDesignOnMobile" style="width: 50%;"></td>
                                            </tr>
                                        </table>
                                                ...
                                                <td>
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span style="display: inline-block; max-width: 70%; word-wrap: break-word; margin-left: 10px">
                                                                    <asp:Label ID="lblSubmitInstruction" runat="server"></asp:Label>
                                                                </span>
                                                            </td>
                                                        </tr>
                                                    </table>
                                        ...
                                        <tr>
                                            <td>
                                                <telerik:RadAsyncUpload runat="server" Width="100%" CssClass="ProjectCenterUpload" ID="rauAttachments" Skin="Default"
                                                    HideFileInput="true" MultipleFileSelection="Automatic" DropZones=".TeamDropZone" OnClientFileSelected="OnFileSelected" OnClientFileUploaded="OnFileUploaded"
                                                    OnClientFileUploadFailed="OnFileUploadFailed" OnClientFileUploadRemoved="OnFileUploadFailed" OnClientValidationFailed="OnFileValidationFailed">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <asp:Panel ID="pnlDocuSign" runat="server" Style="margin: 20px 0px 35px 24px;">
                ...
                <p />
                <asp:LinkButton runat="server" ID="btnBeginDocuSign" Width="155px" CssClass="lnkButton" Text="Begin DocuSign1" meta:resourcekey="btnBeginDocuSign">
                    <span runat="server" class="Icon btnDocuSign"></span>
                    <span runat="server">
            ...
            <asp:Label ID="lblDocuSignLoginMessage" Style="text-transform: uppercase; color: #666666;" runat="server" Text=""></asp:Label>

            <asp:Panel ID="pnlAdobSign" runat="server" Style="margin: 20px 0px 35px 24px;">
                <asp:Label runat="server" ID="lblWaitingAdobeSign" CssClass="eSignText Info" Text="Waiting for Adobe Sign1" meta:resourcekey="lblWaitingAcrobatSign"></asp:Label>
                <asp:LinkButton runat="server" ID="btnBeginAdobeSign" CssClass="lnkButton eSignButton" Text="Begin Adobe Sign1" meta:resourcekey="btnBeginAcrobatSign"></asp:LinkButton>
                <asp:LinkButton runat="server" ID="btnCancelAdobeSign" CssClass="lnkButton eSignButton" Text="Cancel Adobe Sign1" meta:resourcekey="btnCancelAcrobatSign"></asp:LinkButton>
                <asp:LinkButton runat="server" ID="btnRefreshAdobeSign" CssClass="lnkButton eSignButton" Text="Refresh Adobe Sign1" meta:resourcekey="btnRefreshAcrobatSign"></asp:LinkButton>
                <asp:Label runat="server" ID="lblAdobeSignError" CssClass="eSignText Error"></asp:Label>
            </asp:Panel>
        </div>
    </div>
    <div class="row">
                                    ...
                                    <td>
                                        <div>
                                            <telerik:RadTreeList ID="rdtStepActions" runat="server" AllowMultiItemEdit="False" EnableEmbeddedScripts="false" ExpandCollapseMode="Client"
                                                ...
                                                DataKeyNames="StepId" ClientDataKeyNames="StepId" ParentDataKeyNames="ParentId" Width="99.8%" SetWidth="true" FitParentContainer="true" HeaderStyle-HorizontalAlign="Center">
                                                <ClientSettings AllowItemsDragDrop="False" Selecting-AllowItemSelection="False">
                                                    ...
                                                    <ClientEvents OnTreeListCreated="rdtStepActionsCreated"></ClientEvents>
                                                </ClientSettings>
                                                <Columns>
                                                    ...
                                                    <telerik:TreeListTemplateColumn UniqueName="UseAdobeSign" HeaderText="AdobeSign1" HeaderStyle-Width="100px" meta:resourcekey="GC_AcrobatSign"
                                                        ItemStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:Image ID="imgAdobeSign" runat="server" />&nbsp;
                                                        </ItemTemplate>
                                                        <EditItemTemplate></EditItemTemplate>
                                                    </telerik:TreeListTemplateColumn>
                                                </Columns>
