...
<%@ Register Src="ngDocChecklists.ascx" TagName="DocumentCheckList" TagPrefix="uc2" %>
            ...
            function maintoolbarClick(Value) {
                ...
                + "&EntityId=" + '<%= PM.CostManagement.ForecastInfo.ProjectId%>' + "&EntityType=0", 890, 430, false);
                    ...
                    case 'New':
                        ...
                        break;
                    case 'Submit':
                        return OpenWorkflowSubmitPopup('COSTMANAGEMENT_FORECAST');
                        break;
                ...
                <telerik:RadToolBar ID="mainToolBar" runat="server" Skin="Default" AutoPostBack="true"
                    ...
                    <Items>
                                    ...
                                    <Items>
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem Text="Submit" Value="Submit" onclick="OpenWorkflowSubmitPopup('COSTMANAGEMENT_FORECAST');" CssClass="Help" EnableImageSprite="true" ></telerik:RadMenuItem>
                        ...
                        <telerik:RadToolBarButton SecurityButtonType="Edit" ImageUrl="Images/ToolBar/Post.png"
                            CommandName="Post" AccessKey="p" ToolTip="Post" Value="Post" CausesValidation="false" CssClass="ToolbarInActive HideOnMobileToolbar">
                        </telerik:RadToolBarButton>
