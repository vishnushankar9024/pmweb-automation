    ...
    <div class="row">
        <div class="col-12 ResponsiveMargin">
            <telerik:RadGrid ID="rdgAssetTypeWorkOrder" runat="server"   HeaderStyle-Font-Size="8"  CssClass="WithoutTopBorder"
                Width="100%" AutoGenerateColumns="False" AllowSorting="true" ShowStatusBar="false" ShowGroupPanel="true" AllowPaging="true" PageSize="250" SetWidth="true" AppendMenus = "true" ClientSettings-Scrolling-AllowScroll="true" >
