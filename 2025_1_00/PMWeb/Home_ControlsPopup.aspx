<%@ Page Language="vb" meta:resourcekey="Page" AutoEventWireup="false" CodeBehind="Home_ControlsPopup.aspx.vb" Inherits="Website.Home_ControlsPopup" %>
...
<body>
    <script type="text/javascript">
        ...
        function OpenWidgetPopup(Source, Width, Height) {
            ...
            if (Source == "News") {
                OpenNewsPOPUp('WidgetPopup.aspx?Source=' + Source + '&PopupId=' + PopupId, Width, Height, null, null)
            } else {
        ...
        function OpenRegionsWeatherPopup(Width, Height) {
            ...
            var qs = getQueryStrings();
            var PopupId = qs["PopupId"];
            OpenSmallPOPUpParent('RegionsWeatherPopup.aspx?PopupId=' + PopupId, Width, 450, null, null)
            ActivatePopup()
            return false;
        }
        ...
        function OpenBackgroundImagePopup(Width, Height) {
            ...
            var qs = getQueryStrings();
            var PopupId = qs["PopupId"];
            OpenPOPUpParent('Home_UploadBackgroundImage.aspx?PopupId=' + PopupId, Width, Height, null, null)
            ActivatePopup()
            return false;
        }
        ...
        function OpenNewsPOPUp(URL, Width, Height, AddClose, gridId) {
            var browserWidth = $telerik.$(window.parent).width();
            var browserHeight = $telerik.$(window.parent).height();
            var wnd = window.parent.radopen(URL);
        ...
        function OpenPOPUpSecondParent(URL, Width, Height, AddClose, gridId) {
    ...
    <form id="form1" runat="server">
        ...
        <telerik:RadGrid ID="rdgWidgets" runat="server" HeaderStyle-Font-Size="8" Width="100%" AutoGenerateColumns="False" AllowMultiRowEdit="True" SetWidth="true" AppendMenus="true"
            AllowMultiRowSelection="true" AllowSorting="true" ShowStatusBar="true" FitPageHeightOffset="1" ClientSettings-Scrolling-AllowScroll="true" Style="margin-top: 50px;">
