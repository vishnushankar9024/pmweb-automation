        ...
        <div class="col-8">
            <asp:Panel ID="pnlLinkedWorkOrders" runat="server">
                <telerik:RadGrid ID="rdgLinkedWorkOrders" runat="server" SetWidth="true" ClientSettings-Scrolling-AllowScroll="true"
                    Width="100%" AutoGenerateColumns="False" AllowPaging="true" PageSize="250" AllowMultiRowEdit="True" AllowMultiRowSelection="true" AllowSorting="false" ShowStatusBar="true">
