    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        ...
        <script type="text/javascript">
            ...
            function displaySelectedFileName(sender, eventArgs) {
                var SaveAndExit = $find("mainToolBar").findButtonByCommandName("SaveAndExit");
                ...
                if (value !== fileName) {
                    if (document.querySelector("#trAttributesInfo")) {
                        document.querySelector("#trAttributesInfo").style.display = 'none';
                    }
                    if (document.querySelector("#trAttributeDetails"))
                        document.querySelector("#trAttributeDetails").style.display = 'none';
                    document.querySelector(".trValidator").style.display = 'table-row'
                    document.querySelector('#lblResult').innerHTML = "File name and extension must match"
                }
                else {
                    SaveAndExit.set_enabled(true);
                    if (document.querySelector("#trAttributesInfo")) {
                        document.querySelector("#trAttributesInfo").style.display = 'block';
                    }
                    if (document.querySelector("#trAttributeDetails"))
                        document.querySelector("#trAttributeDetails").style.display = 'block';
                    document.querySelector(".trValidator").style.display = 'none'
                    document.querySelector('#lblResult').innerHTML = ""
            ...
            function deactivatesaveAndExitButton() {
                var SaveAndExit = $find("mainToolBar").findButtonByCommandName("SaveAndExit");
                SaveAndExit.set_enabled(false);
            }

            function DeactivateCheckButton() {
                var btnCheck = window.parent.document.querySelector("#ctl00_CPH1_DetailPane1_btnCheck");
                btnCheck.classList.remove("active");
                //$(window.parent.document).find('[id$=btnRefreshWithoutDetailsPane]')[0].click();
            }

            function DeactivateToolbarCheckButton() {
                //var btnCheckIn = window.parent.$find('ctl00_CPH1_mainToolBar').findButtonByCommandName("CheckIn");
                ////btnCheckIn._element.querySelector('a').classList.remove('active');
                //btnCheckIn.set_visible(false);

                var btnFinisheCheckIn = window.parent.$("[id$=btnFinisheCheckIn]");
                btnFinisheCheckIn.click();
            }
            ...
            <tr>
                <td class="ToolbarTd">
                    <telerik:RadToolBar ID="mainToolBar" runat="server" Skin="Default" AutoPostBack="true">
                        <Items>
                            <telerik:RadToolBarButton CausesValidation="true" ValidationGroup="Save" meta:resourcekey="RadToolBarButton_SaveAndExit" EnableImageSprite="true" CssClass="ToolbarSaveAndExit"
                ...
                <td style="padding-right: 24px">
                    <asp:Button ID="btnCancelCheckOut" runat="server" Text="Or Cancel Checkout" meta:resourcekey="btnCancelCheckOut" />
                </td>
            </tr>
        </table>
        <div class="PMMainPage PMPopupMainPage documentSinglePage">
            ...
            <asp:Panel ID="pnlSingleFile" runat="Server">
                ...
                <table class="colTable">
                    ...
                    <tr id="trAttributesInfo" runat="server" style="display: none">
                        <td>
                    ...
                    <tr id="trFileUpload" runat="server" style="width: 100%">
                        <td style="width: 100%">
                            ...
                            <%--<telerik:RadUpload ID="TelerikFileUpload" ControlObjectsVisibility="none" runat="server" MaxFileInputsCount="1" Style="box-sizing: border-box;"
                                InitialFileInputsCount="1" Skin="Default" InputSize="45" CssClass="ProjectCenterUpload" Localization-Select="DROP A FILE HERE OR CLICK TO ADD" meta:Resourcekey="Uploader_Select_Files" OnClientFileSelected="displaySelectedFileName" />--%>
                            <telerik:RadAsyncUpload ID="TelerikFileUpload" ControlObjectsVisibility="none" runat="server" MaxFileInputsCount="1" Style="box-sizing: border-box;"
                                InitialFileInputsCount="1" Skin="Default" InputSize="45" CssClass="ProjectCenterUpload" Localization-Select="DROP A FILE HERE OR CLICK TO ADD" meta:Resourcekey="Uploader_Select_Files" OnClientFileSelected="displaySelectedFileName" OnClientFileUploadFailed="onUploadFailed" Width="100%"

                            OnClientFileUploaded="onFileUploaded" OnClientAdded="added"
                            MultipleFileSelection="Disabled" OnClientValidationFailed="ClientValidationFailed"/>
                        </td>
                ...
                <table class="colTable">
                    ...
                    <tr class="trValidator">
                        <td class="labelWidth labelWidth_CheckIn"></td>
                        <td class="controlWidth">
                ...
                <table class="colTable" style="padding-top: 19px">
                    ...
                    <tr id="trAttributeDetails" runat="server" style="display: none">
