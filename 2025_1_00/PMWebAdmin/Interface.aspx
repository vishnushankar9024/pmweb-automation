...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <asp:Panel ID="pnlColors" runat="server">
                        <table class="colTable" cellpadding="0" cellspacing="0">
                            ...
                            <tr style="display:none;">
                             ...
                             <tr style="display:none;">
                                <td class="labelWidth">
                                    <asp:Label ID="lblColor5" Text="Color 5" runat="server"></asp:Label>
                                </td>
                                <td class="controlWidth">
                                    <div id="divColor5" runat="server" class="colorDiv" onclick="OpenPalette(this);">
                                    </div>
                                        <telerik:RadColorPicker ShowIcon="true" ID="rcpColor5" runat="server" OnClientColorChange="HandleColorChanged" CssClass="NewColorPicker"  KeepInScreenBounds="true"
                                               PaletteModes="WebPalette" Preset ="Default" EnableCustomColor="true" RenderMode="Lightweight" />
                                </td>
                            </tr>
                            <tr>
                    ...
                    <table class="colTable" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td style="padding-top:5px" class="controlWidth">
                                ...
                                <asp:Image ID="imgDefaultLogo" Style="background-color:white !important" padding="5px" ClientIDMode="Static"  Width="100%" runat="server" alt="" />
    ...
    <script type="text/javascript">
        ...
        function UseDefaultLogo() {
            ...
            image.src = "CSS/Images/largemenuicon.png";
        ...
        function HandleColorChanged(sender, eventArgs) {
            ...
            if (id == "ctl00_ContentPlaceHolder1_rcpColor1" && document.getElementById("imgDefaultLogo").src.indexOf("largemenuicon.png") >= 0) {
                document.getElementById("imgDefaultLogo").style.backgroundColor = currColor;
            }
        }
