...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMain" runat="server">
    ...
    <div class="box box-color box-bordered">
        <div class="box-content nopadding" style="margin-top: 20px;">
            ...
            <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" CssClass="outerMultiPage">
                <telerik:RadPageView runat="server" ID="RadPageView1">
                    <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid1" GridLines="None" runat="server" AllowAutomaticDeletes="True"
                        ...
                        <MasterTableView CommandItemDisplay="Top" DataKeyNames="RowNumber,Revison"
                            ...
                            <CommandItemSettings
                                ExportToPdfImageUrl="App_Themes/Site/img/export-pdf.jpg" ShowExportToPdfButton="false"
                            ...
                            <DetailTables>
                                <telerik:GridTableView HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" CssClass="detail_table" Width="100%" runat="server" CommandItemDisplay="None" Name="Revisons" CommandItemSettings-ShowAddNewRecordButton="false" CommandItemSettings-ShowRefreshButton="false" AllowFilteringByColumn="false" RetainExpandStateOnRebind="false">
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn UniqueName="HMC_HFD_PMC_Comments" DataField="HMC_HFD_PMC_Comments" HeaderText="Client / Consultant Comments" HeaderStyle-Width="100" ReadOnly="true">
                                            <ItemTemplate>
                                        ...
                                        <telerik:GridBoundColumn UniqueName="Response" DataField="Response" HeaderText="Consultant / Contractor Comments" HeaderStyle-Width="100" ReadOnly="true">
                                            <HeaderStyle Width="100px"></HeaderStyle>
                                        </telerik:GridBoundColumn>
                            ...
                            <Columns>
                                ...
                                <telerik:GridTemplateColumn UniqueName="HMC_HFD_PMC_Comments" DataField="HMC_HFD_PMC_Comments" HeaderText="Client / Consultant Comments" HeaderStyle-Width="350px" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true">
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn UniqueName="Response" DataField="Response" HeaderText="Consultant / Contractor Response" HeaderStyle-Width="350px" CurrentFilterFunction="Contains" AutoPostBackOnFilter="true">
                                    <ItemTemplate>
                ...
                <telerik:RadPageView runat="server" ID="RadPageView2">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <iframe src="pdf-annotation-drawing-markup/index.html" style="width:100%;min-height:700px;"></iframe>
            ...
            <asp:SqlDataSource ID="sqlDataSourceAssessment" runat="server" ConnectionString="<%$ ConnectionStrings:Connection %>"
                ProviderName="System.Data.SqlClient" SelectCommand="SELECT -1 AS Id, '' AS Assess_Code UNION ALL SELECT Id, SUBSTRING(Description, 0, 2) AS Assess_Code FROM PMWeb_ListValues WHERE ListId=20223"></asp:SqlDataSource>
            <asp:SqlDataSource ID="sqlStatus" runat="server" ConnectionString="<%$ ConnectionStrings:Connection %>"
                ProviderName="System.Data.SqlClient" SelectCommand="SELECT -1 AS Id, '' AS Description UNION ALL SELECT Id, Description FROM PMWeb_ListValues WHERE ListId=20159 ORDER BY Description DESC"></asp:SqlDataSource>
        </div>
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="hmcCommentsModalLabel">Consultants Comments</h5>
    ...
    <div class="modal fade" id="hmcCommentsRevisionModal" tabindex="-1" role="dialog" aria-labelledby="hmcCommentsRevisionModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="hmcCommentsRevisionModalLabel">Consultants Comments</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <div class="modal fade" id="hmcNewRowCommentsModal" tabindex="-1" role="dialog" aria-labelledby="hmcNewRowCommentsModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="hmcNewRowCommentsModalLabel">Consultants Comments</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
