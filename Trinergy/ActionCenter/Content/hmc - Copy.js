    ...
    Init: function () {
        ...
        if (customFormId != 'Select Custom Form ...' && customFormId != '' && typeof (customFormId) != 'undefined') {
            $.ajax({
                ...
                url: 'https://pmweb.hamad.qa/PMWebhelper/PMWebWorkflowButtons/GetGenerateButtons/?customformId=' + global.CustomFormId + '&UserId=' + global.User.Id,
                dataType: "html",
                type: "GET",
                contentType: 'application/json;charset=utf-8',
                async: true,
                    ...
                    $('<button />', {}).text('Yes')
                        .click(function () {
                            ...
                            $.ajax({
                                ...
                                url: 'https://pmweb.hamad.qa/PMWebhelper/PMWebWorkflowButtons/DoButtonAction/?CustomFormId=' + global.CustomFormId + '&MapFormId=' + button.Func + '&userid=' + global.User.Id,
                                dataType: "html",
                                type: "GET",
                                contentType: 'application/json;charset=utf-8',
                                async: true,
