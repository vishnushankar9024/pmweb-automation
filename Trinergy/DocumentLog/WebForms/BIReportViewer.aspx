...
<%--    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%"  Height="100%" AsyncRendering="false" SizeToReportContent="true" ShowParameterPrompts="false">
	                    ...
	                    <rsweb:ReportViewer ID="rptViewer1" runat="server" Width="100%" Height="100%" AsyncRendering="false" KeepSessionAlive="true" 
                  ShowParameterPrompts="false" SizeToReportContent="true" ></rsweb:ReportViewer>
