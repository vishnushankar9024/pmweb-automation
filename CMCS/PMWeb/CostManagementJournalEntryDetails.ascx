    ...
    <div class="row">
        <div class="col-12 ResponsiveMargin">
            <telerik:RadGrid ID="rdgJournalEntryDetails" runat="server" AllowFilteringByColumn="true" HasCostCodePoup="true"
                ...
                PageSize="250" AllowPaging="true" ShowFooter="true" ShowGroupPanel="True" FilterType="HeaderContext"
                EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true" AllowMultiRowEdit="True"
                AllowMultiRowSelection="true" AllowSorting="true" ItemStyle-Height="20px" UseEditFormInMobile="true" HasPasteFromExcel="true">
                ...
                <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="110px" UniqueName="ProjectName" ItemStyle-Wrap="false" HeaderText="Project11" AllowFiltering="True"
                            ...
                            <EditItemTemplate>
                                ...
                                <asp:RequiredFieldValidator ID="rfvProjects" runat="server" ControlToValidate="ddlProjects"
                                    ...
                                    Display="Dynamic" ForeColor="" ValidationGroup="SaveDetails"></asp:RequiredFieldValidator>
                            </EditItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Cost Code*" SortExpression="CostCode" UniqueName="CostCode" DataField="CostCode"
                            ...
                            <EditItemTemplate>
                                <telerik:RadComboBox ID="ddlCostCodes" runat="server" Width="100%"
                                    ...
                                    OnItemsRequested="ddl_ItemsRequested" ValidationGroup="SaveDetails"
                                ...
                                <div>
                                    ...
                                    <asp:CustomValidator ID="csvCostCodes" runat="server" ControlToValidate="ddlCostCodes"
                                        ClientValidationFunction="ValidateCombo" ValidationGroup="SaveDetails" Display="Dynamic"
                            ...
                            <EditItemTemplate>
                                ...
                                <div>
                                    ...
                                    <asp:CompareValidator ID="cmpWorksheetColumns" runat="server" ControlToValidate="ddlWorksheetColumns"
                                        ...
                                        Display="Dynamic" ForeColor="" Operator="GreaterThan" meta:resourcekey="cmpWorksheetColumns" ValidationGroup="SaveDetails"></asp:CompareValidator>
                                </div>
                            </EditItemTemplate>
                            <HeaderStyle Width="200px"></HeaderStyle>
                        </telerik:GridTemplateColumn>
                    ...
                    <CommandItemTemplate>
                        <div style="padding: 2px">
                            ...
                            <asp:LinkButton ID="btnUpdateEdited" runat="server" ValidationGroup="SaveDetails"
                            ...
                            <asp:LinkButton ID="btnSave" runat="server" ValidationGroup="SaveDetails"
                ...
                <ValidationSettings ValidationGroup="SaveDetails" EnableValidation="true" CommandsToValidate="PerformInsert,UpdateEdited" />
            </telerik:RadGrid>
