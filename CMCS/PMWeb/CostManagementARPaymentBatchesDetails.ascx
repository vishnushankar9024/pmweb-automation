    ...
    <div class="row">
        <div class="col-12 ResponsiveMargin">
            <telerik:RadGrid ID="rdgARPayments" GroupingEnabled="true" runat="server" AutoGenerateColumns="False" AllowFilteringByColumn="true"
                ...
                PageSize="250" AllowPaging="true" ShowGroupPanel="True" AllowSorting="true" ShowStatusBar="true" ShowFooter="true" UseEditFormInMobile="true">
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="110px" UniqueName="CostCode" ItemStyle-Wrap="false" HeaderText="Cost Code" DataField="CostCode"
                            ...
                            <EditItemTemplate>
                                <telerik:RadComboBox ID="ddlCostCode" runat="server" Width="100%" DropDownWidth="300px"
                                    ...
                                    NoWrap="True" AllowCustomText="false" ValidationGroup="SaveDetails" Style="font-size: 11px" Height="250px"
            ...
            <span class="Icon"></span>
                    ...
                    <CommandItemTemplate>
                        <div style="padding: 2px">
                            ...
                            <asp:LinkButton ID="btnUpdateEdited" runat="server" SecurityButtonType="AddEditMode_Edit" ValidationGroup="SaveDetails" CommandName="UpdateEdited" CssClass="GridCmdUpdateEdited"
                            ...
                            <asp:LinkButton ID="btnSave" runat="server" ValidationGroup="SaveDetails" SecurityButtonType="AddEditMode_Add" CommandName="PerformInsert" CssClass="GridCmdPerformInsert"
                ...
                <ValidationSettings ValidationGroup="SaveDetails" EnableValidation="true" CommandsToValidate="UpdateEdited,PerformInsert" />
            </telerik:RadGrid>
        </div>
    </div>
</div>
