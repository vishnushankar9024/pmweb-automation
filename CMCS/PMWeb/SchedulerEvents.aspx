                ...
                <div class="col-8">
                    <fieldset>
                        ...
                        <telerik:RadGrid ID="rdgSchedulerEvents" AllowMultiRowSelection="true" runat="server" AppendMenus="true" FitParentContainer="true"
                            ...
                            Height="99%" AutoGenerateColumns="False" AllowSorting="true" AllowMultiRowEdit="true" ShowStatusBar="true" CssClass="LightWeight" allowscroll="true" AllowPaging="True" PageSize="250">
