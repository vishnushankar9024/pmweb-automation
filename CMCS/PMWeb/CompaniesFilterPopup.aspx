    ...
    <form id="form1" runat="server">
        <script type="text/javascript">
            ...
            function RowClick(sender, eventArgs) {
                ...
                if (querySt('Source') == 'Notification' || querySt('Source') == 'AddMembers') {
                    ...
                    <div class="row">
                        <div class="col-12">
                            <telerik:RadGrid ID="rdgContacts" AllowMultiRowSelection="true" runat="server" HeaderStyle-Font-Size="8" FilterType="HeaderContext" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true" allow-scroll="true" SetWidth="true" AppendMenus="true"
                                Width="200px" AutoGenerateColumns="True" AllowFilteringByColumn="true" AllowSorting="true" ShowGroupPanel="True" AllowMultiRowEdit="true" ShowStatusBar="true" AllowPaging="True" PageSize="250" FitPageHeightOffset="5">
                                                    ...
                                                    <table class="TableNoSpacingNoBorder">
                                                        <tr class="ToolBarTreePane">
                                                            ...
                                                            <td class="controlWidth" style="background: #EDEDED !important; padding-bottom: 0px !important;">
                                                                <telerik:RadComboBox ID="ddlSpecGroup" runat="server" Filter="Contains" MarkFirstMatch="true" Style="width: 240px !important;" AutoPostBack="true" AllowCustomText="true"
