...
<%@ Register Src="ngDocClauses.ascx" TagName="DocumentClauses" TagPrefix="uc11" %>
...
<%@ Register Src="ngDocCollaborate.ascx" TagName="DocumentTeam" TagPrefix="uc18" %>
    ...
    <telerik:RadCodeBlock ID="radCode1" runat="server">
        ...
        <script type="text/javascript">
            ...
            function maintoolbarClick(Value) {
                var HasMergeTemplate = '<%= PM.PortfolioPlanning.BudgetInitiativeInfo.HasMergeTemplate%>';
                ...
                switch (Value) {
                     case 'ViewTemplates':
                        if (HasMergeTemplate == 'True') {
                            OpenPOPUp("MergeTemplatePopup.aspx?ObjectType=BUDGETINITIATIVES&Id=" +
                                    '<%=PM.PortfolioPlanning.BudgetInitiativeInfo.Id%>' + "&Description="
                            + Description
                            + "&RecordDescription=" + RecordDescription
                            + "&EntityId=" + '<%=PM.PortfolioPlanning.BudgetInitiativeInfo.TemplateId%>' + "&EntityType=0", 1045, 515, false);
                        }
                        break;
                    ...
                    case 'GenerateContracts':
                        OpenPOPUp('GenerateContractsFromInitiative.aspx', 890, 500, true)
                    ...
                    case 'Submit':
                        return OpenWorkflowSubmitPopup('BUDGETINITIATIVES');
                        break;
                    ...
                    <Items>
                                            ...
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem EnableImageSprite="true" Value="Generate" CssClass="Generate">
                                                    <Items>
                                                        ...
                                                        <telerik:RadMenuItem Text="Generate Contracts" Value="GenerateContracts"></telerik:RadMenuItem>
                                                        <telerik:RadMenuItem Text="Generate Project Records" Value="GenerateProjectRecords"></telerik:RadMenuItem>
                                                    </Items>
                                                </telerik:RadMenuItem>
                                                           <telerik:RadMenuItem Text="Active" EnableImageSprite="true" Value="Active" CssClass="ActiveLocation" visible="true"></telerik:RadMenuItem>
                                               ...
                                               <telerik:RadMenuItem Text="Submit" Value="Submit" onclick="OpenWorkflowSubmitPopup('BUDGETINITIATIVES');" CssClass="Help" EnableImageSprite="true" ></telerik:RadMenuItem>
                        ...
                        <telerik:RadToolBarSplitButton EnableDefaultButton="false" PostBack="false" CommandName="Generate" OuterCssClass="HideOnMobileToolbar" CssClass="ToolbarGenerate"
                            ...
                            <Buttons>
                                ...
                                <telerik:RadToolBarButton PostBack="false" CommandName="GenerateContracts" ImageUrl="Images/ToolBar/PMWebW.gif">
                                </telerik:RadToolBarButton>
                            ...
                            <table class="colTable">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlProgram" Filter="Contains" MarkFirstMatch="true" AllowCustomText="true"
                                         ...
                                         <asp:RequiredFieldValidator ID="rfvProgram" Visible="false" runat="server" ControlToValidate="ddlProgram" Display="Dynamic" ForeColor=""
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlTypes" runat="server" Skin="Default" CloseDropDownOnBlur="true"
                                         ...
                                         <asp:RequiredFieldValidator ID="rfvType" Visible="false" runat="server" ControlToValidate="ddlTypes" Display="Dynamic" ForeColor=""
                                            CssClass="Validator" InitialValue="" ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>" ValidationGroup="Save">
                                        </asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <asp:TextBox runat="server" MaxLength="50" ID="txtAbbreviation" Text=""></asp:TextBox>
                                         <asp:RequiredFieldValidator ID="rfvAbbreviation" runat="server" ValidationGroup="Save" ControlToValidate="txtAbbreviation" 
                                            CssClass="Validator" Visible="false" Display="Dynamic" ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>">
                                        </asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvPBS" runat="server" ControlToValidate="ddlPBS"
                                            CssClass="Validator" InitialValue="" ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>" ValidationGroup="Save"
                                            Display="Dynamic" ForeColor="">
                                        </asp:RequiredFieldValidator>
                                        <asp:CustomValidator ID="csvPBS" runat="server" ControlToValidate="ddlPBS" ValidationGroup="Save"
                                            ClientValidationFunction="ValidateCombo" Display="Dynamic" CssClass="Validator" ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>">
                                        </asp:CustomValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="NoWrap labelWidth">
                                        <asp:Label ID="lblBudgetYear" runat="server" Text="Funding Year" ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>"></asp:Label>
                                    </td>
                                    <td class="controlWidth">
                                        <telerik:RadNumericTextBox ID="rntBudgetYear" ShowSpinButtons="true" IncrementSettings-InterceptArrowKeys="true"
                                         ...
                                         <asp:RequiredFieldValidator ID="rfvBudgetYear" runat="server" ControlToValidate="rntBudgetYear"
                                            CssClass="Validator" InitialValue="" ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>" ValidationGroup="Save"
                                            Display="Dynamic" ForeColor="">
                                        </asp:RequiredFieldValidator>
                                        <asp:CustomValidator ID="csvBudgetYear" runat="server" ControlToValidate="ddlPBS" ValidationGroup="rntBudgetYear"
                                            ClientValidationFunction="ValidateCombo" Display="Dynamic" CssClass="Validator" ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>">
                                        </asp:CustomValidator>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        ...
                                        <asp:CustomValidator ID="csvPriority" runat="server" ControlToValidate="ddlPriority" ValidationGroup="Save"
                                            ClientValidationFunction="ValidateCombo" Display="Dynamic" CssClass="Validator" ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>">
                                        </asp:CustomValidator>
                                    </td>
                                </tr>
                            ...
                            <table class="colTable"  id="trResponsive">
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <span runat="server" id="rmd_dtpStart" style="display: block">
                                         ...
                                         <asp:RequiredFieldValidator ID="rfvStart" Visible="false" runat="server" ControlToValidate="dtpStart" Display="Dynamic" ForeColor=""
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <span runat="server" id="rmd_dtpFinish" style="display: block">
                                          ...
                                          <asp:RequiredFieldValidator ID="rfvFinish" Visible="false" runat="server" ControlToValidate="dtpFinish" Display="Dynamic" ForeColor=""
                                            CssClass="Validator"  ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>" ValidationGroup="Save">
                                        </asp:RequiredFieldValidator>
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlSponsor" runat="server" Skin="Default" CloseDropDownOnBlur="true" DropDownWidth="385px"
                                         ...
                                         <asp:RequiredFieldValidator ID="rfvSponsor" runat="server" ControlToValidate="ddlSponsor"
                                            CssClass="Validator" InitialValue="" ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>" ValidationGroup="Save"
                                            Display="Dynamic" ForeColor="">
                                        </asp:RequiredFieldValidator>
                                        <asp:CustomValidator ID="csvSponsor" runat="server" ControlToValidate="ddlSponsor" ValidationGroup="Save"
                                            ClientValidationFunction="ValidateCombo" Display="Dynamic" CssClass="Validator"  ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>">
                                        </asp:CustomValidator>
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlFundingSource" runat="server" Skin="Default" CloseDropDownOnBlur="true"
                                            Filter="Contains" MarkFirstMatch="true" NoWrap="true" AllowCustomText="true"
                                            EnableLoadOnDemand="true" OnItemsRequested="ddl_ItemsRequested" ShowMoreResultsBox="True" EnableVirtualScrolling="True"
                                            Height="300px" CausesValidation="False">
                                        </telerik:RadComboBox>
                                        ...
                                        <asp:CustomValidator ID="csvFundingSource" runat="server" ControlToValidate="ddlFundingSource" ValidationGroup="Save"
                                            ClientValidationFunction="ValidateCombo" Display="Dynamic" CssClass="Validator"  ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>">
                                        </asp:CustomValidator>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        ...
                                        <asp:CustomValidator ID="csvProjectManager" runat="server" ControlToValidate="ddlProjectManager" ValidationGroup="Save"
                                            ClientValidationFunction="ValidateCombo" Display="Dynamic" CssClass="Validator"  ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>">
                                        </asp:CustomValidator>
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <asp:TextBox runat="server" MaxLength="4000" TextMode="MultiLine" ID="txtScope" Width="100%" Style="box-sizing: border-box;"></asp:TextBox>
                                         <asp:RequiredFieldValidator ID="rfvscope" runat="server" ControlToValidate="txtScope"
                                            CssClass="Validator" InitialValue=""  ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>" ValidationGroup="Save"
                                            Display="Dynamic" ForeColor="">
                                        </asp:RequiredFieldValidator>
                                  ...
                                  <tr>
                                    <td class="NoWrap labelWidth">
                                        <asp:Label ID="lblWorkflowCalendar" runat="server" meta:Resourcekey="lblWorkflowCalendar"
                                            Text="Workflow Calendar"></asp:Label>
                                    </td>
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlWorkflowCalendar" runat="server" Skin="Default" CloseDropDownOnBlur="true"
                                            Filter="Contains" MarkFirstMatch="true" NoWrap="true" AllowCustomText="true"
                                            EnableLoadOnDemand="true" OnItemsRequested="ddl_ItemsRequested" ShowMoreResultsBox="True" EnableVirtualScrolling="True"
                                            Height="300px" CausesValidation="False">
                                        </telerik:RadComboBox>
