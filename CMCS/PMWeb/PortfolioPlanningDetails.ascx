    ...
    <div class="row">
        <div class="col-12 ResponsiveMargin">
            <telerik:RadGrid ID="rdgPortfolioPlanningDetails" runat="server" AutoGenerateColumns="False" ShowStatusBar="False" CssClass="WithoutTopBorder" SetWidth="true" AppendMenus="true" UseEditFormInMobile="true"
                Font-Size="8px" PageSize="250" ShowFooter="true" AllowPaging="True" ShowGroupPanel="True" AllowMultiRowEdit="true" AllowMultiRowSelection="True" AllowSorting="True" GridLines="None" HasPasteFromExcel="true">
