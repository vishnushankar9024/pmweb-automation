...
<%@ Register Src="ngDocChecklists.ascx" TagName="DocumentCheckList" TagPrefix="uc9" %>
<%@ Register Src="ngDocClauses.ascx" TagName="DocumentClauses" TagPrefix="uc10" %>
        ...
        <script type="text/javascript">
            ...
            function maintoolbarClick(Value) {
                ...
                switch (Value) {
                    ...
                    case 'Submit':
                        return OpenWorkflowSubmitPopup('DAILYREPORT');
                        break;
                    default:
                        break;
                }
            ...
            function UpdatePanelSettings(sender) {
                $.ajax({
                    type: "POST",
                    url: "AjaxService.aspx/UpdateDailyRportsPanelSettings",
                    contentType: "application/json; charset=utf-8",
                    data: JSON.stringify({ Width: sender._width }),
                    dataType: "json",
                    async: true
                });
            }
                                                ...
                                                <Items>
                                                    <telerik:RadMenuItem CssClass="menuMore">
                                                        ...
                                                        <telerik:RadMenuItem Text="Show Linked PMWeb View Templates" Value="ViewTemplates"></telerik:RadMenuItem>
                                                           ...
                                                           <telerik:RadMenuItem Text="Submit" Value="Submit" onclick="OpenWorkflowSubmitPopup('DAILYREPORT');" CssClass="Help" EnableImageSprite="true" ></telerik:RadMenuItem>
                                        ...
                                        <table class="colTable">
                                            <tr>
                                                ...
                                                <td class="controlWidth">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="rfvConditions" runat="server" ControlToValidate="ddlConditions" InitialValue=""
                                            ...
                                            <tr>
                                                ...
                                                <td class="controlWidth" width="100%" cellpadding="0" cellspacing="0">
                                              
                                                        
                                                        
                                                                <asp:TextBox ID="txtTemperature" runat="server" CssClass="Double" Width="49%" MaxLength="15"></asp:TextBox>
                                                                ...
                                                                <asp:RadioButtonList ID="rblFrequency" AutoPostBack="False" style="width: 50%; padding-left: 20px;display: inline;vertical-align: middle;"
                                                                    CssClass="RadioCss RadioPadding" runat="server" RepeatLayout="Table" RepeatColumns="2" RepeatDirection="Horizontal" >
                                                                    <asp:ListItem Selected="True" Text="F" Value="0" style="margin-right:6px;" ></asp:ListItem>
                                            ...
                                            <tr>
                                                ...
                                                <td class="controlWidth" width="100%" cellpadding="0" cellspacing="0">
                                                                ...
                                                                <asp:TextBox ID="txtPrecip" runat="server" CssClass="Double"  Width="49%" MaxLength="15"  style="padding-left: 20px;display: inline;"></asp:TextBox>
                                                                <asp:RequiredFieldValidator ID="rfvPrecipAmount" ControlToValidate="txtPrecip"
                                                                    runat="server" CssClass="Validator" Visible="false" Display="Dynamic"
                                                                    ValidationGroup="Save" ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>"></asp:RequiredFieldValidator>
                                                           
                                                                <telerik:RadComboBox ID="ddlUOM" runat="server" Skin="Default" AllowCustomText="true" Filter="Contains"  style="width: 48% !important; padding-left: 0px;" RepeatLayout="Table"></telerik:RadComboBox>
                                ...
                                <tr runat="server" id="trNewButtons">
                                    ...
                                    <td>
                                        <table cellspacing="0" cellpadding="0" border="0" style="width: 100%;">
                                            <tr>
                                                <td id="tdNewTimesheet"  style="width: 50%; padding-left: 2px; padding-right: 2px;" runat="server">
                                                ...
                                                <td id="tdNewProduction" runat="server" style="width: 50%; padding-left: 2px; padding-right: 2px">
                        ...
                        <div class="col-4 col-4-middle">
                            ...
                            <fieldset runat="server" id="fsIncidents">
                                ...
                                <telerik:RadGrid ID="rdgIncidents" AllowMultiRowSelection="true" runat="server" AllowMultiRowEdit="false" CssClass="LightWeight"
                                    ...
                                    AutoGenerateColumns="False" AllowSorting="true" ShowStatusBar="true" PageSize="250"
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Company/Contact" HeaderStyle-Width="250px" ItemStyle-HorizontalAlign="Right"
                                                ...
                                                <EditItemTemplate>
                                                    <div style="white-space: nowrap">
                                                        <telerik:RadComboBox ID="ddlAssignTo" runat="server" Filter="Contains" MarkFirstMatch="True" 
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Notes" UniqueName="Notes" ItemStyle-Wrap="false"
                                                ...
                                                <EditItemTemplate>
                                                    ...
                                                    <asp:LinkButton runat="server" ID="imgNotes" OnClientClick="return OpenNoteDetailPopup(this.id.replace('imgNotes','txtNote'))"
                                                        CssClass="SearchButton">
                                                                                                        <span class="Icon"></span>
                                                    </asp:LinkButton>
                                                </EditItemTemplate>
