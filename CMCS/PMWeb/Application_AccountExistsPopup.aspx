...
@media screen and (min-width:320px) and (max-width:860px) {
    ...
    <table cellpadding="0" cellspacing="0" width="95%" style="table-layout:fixed;" class="tblMargin">
        ...
        <tr>
            <td style="padding-left:50px;padding-top:30px;padding-bottom:10px;color:black !important;"><asp:Label ID="lblTypePassword" meta:resourceKey="lblTypePassword" runat="server" Text="Type your password." ></asp:Label></td>
        </tr>
