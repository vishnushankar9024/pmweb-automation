            ...
            <fieldset runat="server" id="fldTitle">
                ...
                <div>
                    <telerik:RadGrid ID="rdg" runat="server" Skin="Default" AutoGenerateColumns="False" ShowStatusBar="True" Font-Size="8px" AllowMultiRowEdit="True" AllowMultiRowSelection="True"
                        ClientSettings-Scrolling-AllowScroll="true" SetWidth="true" AppendMenus="true" AllowSorting="true"
                        GridLines="None" AllowPaging="true" PageSize="250" PagerStyle-AlwaysVisible="true" UseEditFormInMobile="true">
