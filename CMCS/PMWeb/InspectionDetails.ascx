    ...
    <div class="row">
        <div class="col-12 ResponsiveMargin">
            <telerik:radgrid id="rdgInspectionDetails" runat="server"  FilterType="HeaderContext" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true"
                ...
                PageSize="250" AllowPaging="true" ShowFooter="true" ShowGroupPanel="True"  HasPasteFromExcel="true" Width="100%"  setwidth="true"
                ...
                <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="60px"  AllowFiltering="false" DataField="RowNumber"
                            HeaderStyle-Wrap="false" Groupable="false" Reorderable="True" UniqueName="RowNumber">
                            <ItemTemplate>
                            ...
                            <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                                ...
                                                <telerik:GridTemplateColumn  SortExpression="AttachmentTotal" UniqueName="AttachmentTotal"
                        ...
                        <telerik:GridTemplateColumn AllowFiltering="true"
                            CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType" DataField="Asset" UniqueName="Asset"
                        ...
                        <telerik:GridTemplateColumn SortExpression="AssetType" DataField="AssetType" AllowFiltering="true" UniqueName="AssetType"
        ...
        <telerik:RadComboBox ID="ddlAssetType" runat="server" Width="100%" OnSelectedIndexChanged="ddlAssetType_SelectedIndexChanged"
                        ...
                        <telerik:GridTemplateColumn SortExpression="Condition" DataField="Condition" UniqueName="Condition"
