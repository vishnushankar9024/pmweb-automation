...
<![if !IE]>
    <style type="text/css">
        ...
        .rcbSlide .ToolbarDropdownGroups {
            display: none;
            position: fixed;
            overflow: hidden;
            top: 108px !important;
...
<asp:Panel ID="pnlGroups" runat="server">
    <table style="width: 100%; padding: 0px;" cellpadding="0" cellspacing="0">
        <tr class="ToolBar GroupsToolbarOnHomePage" style="margin-top: 38px;">
            <td style="width: 240px" class="ToolbarTd ShowDropDown">
                <telerik:RadComboBox ID="ddlGroups" runat="server" NoWrap="True" OnClientTextChange="LOD_DropDownTextChange" OnItemsRequested="ddl_ItemsRequested"
                    ...
                    Width="240px" EnableVirtualScrolling="True" ShowMoreResultsBox="True" EnableLoadOnDemand="true" OnSelectedIndexChanged="ddlGroups_SelectedIndexChanged" DropDownCssClass="ToolbarDropdownGroups">
                    <CollapseAnimation Type="OutQuint" Duration="150"></CollapseAnimation>
                </telerik:RadComboBox>
            </td>
            <td valign="middle" style="vertical-align: middle; width: 70%" class="ToolbarTd">
                <telerik:RadToolBar ID="mainToolBar" runat="server" Skin="Default" AutoPostBack="true" CssClass="popup-toolbar" OnClientButtonClicked="mainToolBar_ButtonClick">
                    <Items>
                        ...
                        <telerik:RadToolBarSplitButton ImageUrl="Images/ToolBar/NewDoc.png" CommandName="New" 
                            ...
                            <Buttons>
                                ...
                                <telerik:RadToolBarButton Width="150px" ImageUrl="Images/Global/AddLine.png"
                                    CommandName="Copy" Value="CopyGroup"  ValidationGroup="Save">
                                </telerik:RadToolBarButton>
                            </Buttons>
    ...
    <asp:Panel ID="pnlRights" runat="server" Width="100%">
        <div class="PMMainPage">
            <div class="row row-8-4 marginBottomOnMobile">
                    ...
                    <table class="colTable">
                        <tr>
                            ...
                            <td class="controlWidth">
                                ...
                                <asp:RequiredFieldValidator ID="rfvGroup" meta:Resourcekey="rfvGroupRequired" runat="server"
                                    ControlToValidate="txtGroup" CssClass="Validator"
                        ...
                        <tr>
                            ...
                            <td class="controlWidth">
                                ...
                                <asp:RequiredFieldValidator ID="rfvDescription" meta:resourcekey="rfvDescriptionRequired"
                        ...
                        <tr>
                            <td colspan="2">
                                <telerik:RadGrid ID="rdgMiscellaneousPermission" runat="server" AutoGenerateColumns="False" ShowStatusBar="True" Font-Size="8px"
                ...
                <div class="col-8 " style="overflow:auto; margin-bottom:24px; height:auto !important">
                    <telerik:RadGrid ID="rdgRights" runat="server" Width="802px" ClientSettings-Scrolling-ScrollHeight="570px" ClientSettings-Scrolling-UseStaticHeaders="true" ClientSettings-Scrolling-AllowScroll="true"
