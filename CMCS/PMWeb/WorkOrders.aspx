...
<%@ Register Src="ngDocSpecs.ascx" TagName="DocumentSpecifications" TagPrefix="uc16" %>
...
<%@ Register Src="ngDocNotifications.ascx" TagName="NotificationLog" TagPrefix="uc10" %>
...
<%@ Register Src="ngDocClauses.ascx" TagName="DocumentClauses" TagPrefix="uc15" %>
            ...
            function maintoolbarClick(Value) {
                ...
                'location=no,status=0,menubar=0,addressbar=0,resizable=1,scrollbars=1,width=800,height=500,top=' + top + ',left=' + left);
                    ...
                    case 'Print':
                        ...
                        break;
                    case 'Submit':
                        return OpenWorkflowSubmitPopup('WORKORDER');
                        break;
                                    ...
                                    <Items>
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem Text="Submit" Value="Submit" onclick="OpenWorkflowSubmitPopup('WORKORDER');" CssClass="Help" EnableImageSprite="true" ></telerik:RadMenuItem>
