...
function ComboCheckAll(chk, comboId, hdnSelectedValuesId) {
    ...
    if (String(chk.id).includes("ProjectExplorer")) {
        SelectedItems = document.querySelectorAll(".SelectedItemClass");
        if (chk.checked) {
            ...
            chk.parentElement.parentElement.parentElement.classList.add("SelectedItemClass");    
        }
        else {
            combo.set_text("");
            combo.set_value("");
            ...
            chk.parentElement.parentElement.parentElement.classList.remove("SelectedItemClass");
...
function ComboCheckParent(chk, comboId, hdnSelectedValuesId) {
    ...
    if (String(chk.id).includes("ProjectExplorer")) {
        ...
        chk.parentElement.parentElement.parentElement.classList.remove("SelectedItemClass")
        if (chk.checked) {
            chk.parentElement.parentElement.classList.add("SelectedItemClass");
        }
        else {
            chk.parentElement.parentElement.classList.remove("SelectedItemClass");
        }
