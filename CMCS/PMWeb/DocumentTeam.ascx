    ...
    <AjaxSettings>
        ...
        <telerik:AjaxSetting AjaxControlID="btnRefreshGrids">
            <UpdatedControls>
                ...
                <telerik:AjaxUpdatedControl ControlID="rdgTeamLog" />
                <telerik:AjaxUpdatedControl ControlID="rdgTeamInput" />
                <telerik:AjaxUpdatedControl ControlID="tblTeamActions" />
            </UpdatedControls>
        </telerik:AjaxSetting>
...
<telerik:RadScriptBlock ID="rsbDocument" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function SetTeamSections() {
            SetTeamSection('tblTeamActions', 'True');
            SetTeamSection('tblLog', 'True');
            SetTeamSection('tblTeamInput', 'True');
        }
            ...
            <table class="TableNoSpacingNoBorder" style="width:100%;table-layout:fixed;">
                <tr>
                    <td valign="middle" style="padding: 5px 0px 5px 5px; margin-bottom: 5px; overflow-x: hidden !important;">
                        <img id="tblTeamActionsimg" alt="" src="CSS/Images/ResponsiveIcons/MinusWorkflow.png" onclick="return ToggleTeamSection(this,'tblTeamActions');" height="12" style="cursor:pointer !important;" />
    ...
    <div class="row">
        <div class="col-12">
            <table class="TableNoSpacingNoBorder" style="width:100%;table-layout:fixed;">
                ...
                <tr>
                    <td valign="middle" style="padding: 5px 0px 5px 5px; margin-bottom: 5px; overflow-x: hidden !important;">
                        <img id="tblLogimg" alt="" src="CSS/Images/ResponsiveIcons/MinusWorkflow.png" onclick="return ToggleTeamSection(this,'tblLog');" height="12" style="cursor:pointer !important;" />
                        <span style="color: #999999; text-transform: uppercase;">
    ...
    <div class="row">
        <div class="col-12">
            <table class="TableNoSpacingNoBorder" style="width:100%;table-layout:fixed;">
                <tr>
                    <td valign="middle" style="padding: 5px 0px 5px 5px; margin-bottom: 5px; overflow-x: hidden !important;">
                        <img id="tblTeamInputimg" alt="" src="CSS/Images/ResponsiveIcons/MinusWorkflow.png" onclick="return ToggleTeamSection(this,'tblTeamInput');" height="12" style="cursor:pointer !important;" />
                        <span style="color: #999999; text-transform: uppercase;">
                ...
                <asp:Button runat="server" ID="btnRefreshGrids" CssClass="Hide" />
                <asp:Button runat="server" ID="btnClosedTeamDisplay" CssClass="Hide" />
            </table>
        </div>
    </div>
</div>
