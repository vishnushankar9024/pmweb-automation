...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .customToolbarClass .rtsLevel.rtsLevel1 {
            width: 100% !important;
        }
...
<body>
    ...
    <asp:LinkButton runat="server" CssClass="closepopup closesize" ID="btnCloseProfilePopup" OnClientClick="window.close()">
        ...
        <telerik:RadTabStrip OnClientTabSelecting="onTabSelecting" ID="tbsDocument" SelectedIndex="1" CssClass="documentTabs customToolbarClass"
                    ...
                    <div class="row">
                        <div class="col-12 ResponsiveMargin">
                            <telerik:RadGrid ID="rdgUsers" AllowMultiRowSelection="true" runat="server" FilterType="HeaderContext" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true"
                                ...
                                ShowStatusBar="true" AllowPaging="True" PageSize="250">
                                <PagerStyle Mode="NextPrevAndNumeric" AlwaysVisible="true" />
                                <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
