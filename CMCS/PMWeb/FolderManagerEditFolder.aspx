    ...
    <form id="form1" runat="server">
        ...
        <telerik:radtabstrip id="tbsDocument" runat="server" causesvalidation="False" enableviewstate="True"
            ...
            <Tabs>
                ...
                <telerik:RadTab Text="Layouts" Value="Layouts" />
            </Tabs>
        </telerik:radtabstrip>
        <telerik:radmultipage id="mlpFolderManager" runat="server" meta:resourcekey="mlpFolderManagerResource1" 
            renderselectedpageonly="True" selectedindex="0" cssclass="documentMultiPages ">
                        ...
                        <div class="col-4 col-4-left">
                            <table class="colTable">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <asp:TextBox ID="txtFolderName" runat="server" Width="100%" MaxLength="200"></asp:TextBox>
            ...
            <telerik:RadPageView ID="pvLayout" runat="server" style="height:calc(100vh - 168px);">
                <iframe src="" id="LayoutFrame" width="100%" frameborder="0" runat="server" ></iframe>
            </telerik:RadPageView>
