<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/PmMaster.Master"
    CodeBehind="PortfolioGenerateRecords.aspx.vb" Inherits="Website.PortfolioGenerateRecords" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <asp:Panel ID="pnlMain" runat="server">
        <table border="0">
            <tr>
                <td valign="top" style="width: 350px; padding-right: 10px">
                    <fieldset>
                        <legend>
                            <asp:Label ID="lblFrom" runat="server" Text="From11" meta:ResourceKey="lblFrom"></asp:Label></legend>
                        <div style="overflow: auto; width: 330px; border: 1px solid gray; border-width: 1px 1px 1px 1px; height: 610px">
                    ...
                    <table border="0">
                        <tr>
                            <td style="padding-top: 0;" valign="top">
                                <fieldset>
                                    <legend>
                                        <asp:Label ID="lblMap" runat="server" Text="Map" meta:ResourceKey="lblMap"></asp:Label></legend>
                                    <asp:TextBox ID="txtMap" runat="server" Width="495px" Enabled="false" CssClass="Disabled"></asp:TextBox>
                                </fieldset>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <fieldset>
                                    ...
                                    <telerik:RadGrid ID="rdgMapping" runat="server" AutoGenerateColumns="False" AllowSorting="true"
                                        HeaderStyle-Font-Size="8" ShowStatusBar="true" PageSize="250" ShowFooter="false">
                ...
                <td style="width: 300px; padding-top: 0;" valign="top">
                    <fieldset style="height: 615px">
                        <legend>
                            <asp:Label ID="lblOptions" runat="server" Text="Options11" meta:ResourceKey="lblOptions"></asp:Label></legend>
                        <table style="padding-top: 0;">
                            ...
                            <tr>
                                <td colspan="2">
                                    <fieldset>
                                        <legend>
                                            <asp:Label ID="lblSendLineItems" runat="server" Text="Send Line Items11" meta:ResourceKey="lblSendLineItems"></asp:Label></legend>
                                        <table width="100%">
                                            <tr>
                                                <td>
                                                    <asp:RadioButton ID="rdbSelectedComponents" Text="Selected Components11" meta:resourcekey="rdbSelectedComponents" CssClass="RadioCss" runat="server" GroupName="components" Checked="true" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:RadioButton ID="rdbAllComponents" Text="All Components11" meta:resourcekey="rdbAllComponents" CssClass="RadioCss" runat="server" GroupName="components" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:RadioButton ID="rdbNoComponents" Text="No Components11" meta:resourcekey="rdbNoComponents" CssClass="RadioCss" runat="server" GroupName="components" />
                                                </td>
                                            </tr>
                                        </table>
                                    </fieldset>
