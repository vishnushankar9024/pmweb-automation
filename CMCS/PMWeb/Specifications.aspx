...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        <script type="text/javascript">        
            var ChangedNodeValue = null;
            var InitialNodeValue = null;
            function rdvOccupantNodeClicking(sender, args, stop) {
                var comboboxid = sender.get_id().substring(0, sender.get_id().lastIndexOf("_ddlTypes")) + "_ddlTypes";
                var NodeValueId = comboboxid.replace('ddlTypes', 'hdnNodeValue');
                InitialNodeValue = document.getElementById(NodeValueId).value;      
                var comboBox = $find(sender.get_id().substring(0, sender.get_id().lastIndexOf('_ddlTypes') + 9));
                    ...
                    ChangedNodeValue = strValue.split(" ")[0];
            ...
            function OpenConfirmSpecificationPopup(Action) {
                ...
                if (Action == "Delete") {
                    ...
                    if (InitialNodeValue !== ChangedNodeValue && ChangedNodeValue !== null) {
                       
                        OpenConfirmationpopup()
                    }
                    else {
                        document.getElementById($("[id$=btnUpdateEditedSpecs]")[0].id).click();

                    }
                    InitialNodeValue = null;
                    ChangedNodeValue = null;
            ...
            function OpenConfirmationpopup(){
                ...
                var wnd = window.radopen("ConfirmDeleteSpecificationPopup.aspx", 'welcome')
    ...
    <div class="PMHeader">
            <div class="row" >
                <div  class="col-12 ResponsiveMargin" style="margin :24px;width :95%" >
                    <fieldset>
                        <legend>
                            <asp:Label ID="lblDefineTabs" runat="server" meta:resourcekey="lblDefineTabs" Text="Define Tabs"></asp:Label>
                        </legend>
                        <telerik:RadGrid ID="rdgSpecificationGroups" AllowMultiRowSelection="true" runat="server" UseEditFormInMobile="true" ActiveItemStyle-Wrap="true" wrap="true"
                            ...
                            PageSize="250" AllowPaging="True">
                            <PagerStyle Mode="NextPrevAndNumeric" AlwaysVisible="true" Width="10%" />
                            <MasterTableView DataKeyNames="Id" ClientDataKeyNames="Id" CommandItemDisplay="Top" EditMode="InPlace" AutoGenerateColumns ="false" >
                                <Columns>
                                    <telerik:GridTemplateColumn HeaderText="Sort Order" UniqueName="SortOrder" HeaderStyle-Wrap="false" SortExpression="SortOrder" ItemStyle-Wrap="true"
                                        AllowFiltering="false" GroupByExpression="SortOrder [GridColumn_SortOrder] Group By SortOrder ASC" ItemStyle-Width="10%" HeaderStyle-Width ="10%">
                                        <ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Name" UniqueName="SpecGroup" HeaderStyle-HorizontalAlign="Center" ItemStyle-Wrap="true"
                                        SortExpression="Name" GroupByExpression="Name [GridColumn_SpecGroup] Group By Name ASC" ItemStyle-Width="21%" HeaderStyle-Width ="21%">
                                        <ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Visible"
                                        UniqueName="Visible"  ItemStyle-Wrap="true"
                                        ItemStyle-HorizontalAlign="Center" HeaderStyle-Wrap="false" ItemStyle-Width="7%" HeaderStyle-Width ="7%">
                                        <ItemTemplate>
                                     ...
                                     <telerik:GridTemplateColumn HeaderText="UOM"
                                        UniqueName="UOM" ItemStyle-Wrap="true"
                                        ItemStyle-HorizontalAlign="Center" HeaderStyle-Wrap="false" ItemStyle-Width="7%" HeaderStyle-Width ="7%" >
                                        <ItemTemplate>
                                            <img src="Images/Global/<%#CStr(IIf(CBool(Eval("UOMVisible")) = CBool(1), "checked.png", "unchecked.png"))%>"
                                                alt="" />
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:CheckBox ID="chbUOMVisible" Checked='<%# CBool(IIf(Eval("UOMVisible") Is System.DBNull.Value, 1, Eval("UOMVisible")))%>'
                                                runat="server" />
                                        </EditItemTemplate>
                                    </telerik:GridTemplateColumn>

                                    <telerik:GridTemplateColumn HeaderText="Notes" UniqueName="Notes" HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign ="Left" ItemStyle-VerticalAlign ="Top" 
                                         ItemStyle-Width="55%" HeaderStyle-Width ="55%" >
                                        <ItemTemplate>
                                             <asp:Label runat="server" ID="lblNotes" CssClass="labelWrapping" Text='<%#Container.DataItem("Notes").ToString%>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtNotes" CssClass="txtareasWrapping"  runat="server" Text='<%#Eval("Notes")%>' Width="100%" TextMode ="MultiLine" ></asp:TextBox>
                                        </EditItemTemplate>                                                                         
                                    </telerik:GridTemplateColumn>
                    ...
                    <fieldset style="margin-top :24px;">
                        <legend>
                            <asp:Label ID="lblDefineFields" runat="server" meta:resourcekey="lblDefineFields" Text="DefineCustomFields"></asp:Label>
                        </legend>
                        <telerik:RadGrid ID="rdgSpecificationTemplate" AllowMultiRowSelection="true" runat="server" SetWidth="true" AppendMenus="true" FitParentContainer="true"
                            HeaderStyle-Font-Size="8" Width="100%" PageSize="250" AllowPaging="True" AllowMultiRowEdit="True" UseEditFormInMobile="true" FitPageHeightOffset="24"
                            ...
                            <MasterTableView DataKeyNames="Id" ClientDataKeyNames="Id" CommandItemDisplay="Top"
                                ...
                                <Columns>
                                    <telerik:GridTemplateColumn HeaderText="Line Number" UniqueName="FieldsSortOrder" HeaderStyle-Wrap="false" SortExpression="FieldsSortOrder"
                                        AllowFiltering="false" GroupByExpression="SortOrder [GridColumn_FieldsSortOrder] Group By FieldsSortOrder ASC" HeaderStyle-Width ="10%" ItemStyle-Width="10%" ItemStyle-HorizontalAlign ="right">
                                        <ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Tab" UniqueName="Tab" meta:Resourcekey="GridColumn_Tab"
                                        HeaderStyle-HorizontalAlign="Center" SortExpression="Tab" HeaderStyle-Width ="21%" ItemStyle-Width="21%">
                                        <ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Spec*" meta:Resourcekey="GridColumn_Spec"
                                        UniqueName="Spec" HeaderStyle-HorizontalAlign="Center" SortExpression="Name" HeaderStyle-Width ="34%" ItemStyle-Width="34%">
                                        <ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="UOM" UniqueName="UOM" meta:Resourcekey="GridColumn_UOM"
                                        HeaderStyle-HorizontalAlign="Center" SortExpression="UOM" HeaderStyle-Width ="15%" ItemStyle-Width="15%">
                                        <ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Type" UniqueName="Type" meta:Resourcekey="GridColumn_Type"
                                        HeaderStyle-HorizontalAlign="Center" SortExpression="Type"  HeaderStyle-Width ="18%" ItemStyle-Width="18%">
                                        <ItemTemplate>
                                        ...
                                        <EditItemTemplate>
                                            ...
                                            <asp:HiddenField ID="hdnNodeValue" Value='<%# Eval("FieldTypeId") %>' runat="server" />
                                        </EditItemTemplate>
                                        <HeaderStyle Wrap="False" ></HeaderStyle>
                                    </telerik:GridTemplateColumn>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Required" UniqueName="Required" meta:Resourcekey="GridColumn_Required"
                                        HeaderStyle-HorizontalAlign="Center" SortExpression="Type"  HeaderStyle-Width ="7%" ItemStyle-Width="7%">
                                        <ItemTemplate>
                                ...
                                <CommandItemTemplate>
                                    <div style="padding: 2px">
                                        ...
                                        <asp:LinkButton ID="btnOpenUpdatePopup" runat="server"  CssClass="GridCmdUpdateEdited"
                                            SecurityButtonType="AddEditMode_Edit" ValidationGroup="specTemplate" OnClientClick="javascript:return OpenConfirmSpecificationPopup('Update');"
                                           Visible='<%# rdgSpecificationTemplate.EditIndexes.Count > 0 %>' meta:resourcekey="btnUpdateEditedResource1" >
                                            <span class="Icon"></span>
                                            <asp:Label ID="lblUpdateRecords" runat="server" Text="Update records" meta:resourcekey="lblUpdateRecordsResource1"></asp:Label>
                                            &nbsp;&nbsp;
                                        </asp:LinkButton>
                                          <asp:LinkButton ID="btnUpdateEditedSpecs" runat="server" CommandName="UpdateEdited" CssClass="GridCmdUpdateEdited"
                                        ...
                                        <asp:LinkButton ID="btnCancel" runat="server" CausesValidation="False"
                                            CommandName="CancelAll" CssClass="GridCmdCancelAll" OnClientClick="ClearNodeValue();"
                                        ...
                                        <asp:LinkButton ID="btnAdd" runat="server" CausesValidation="False" SecurityButtonType="ItemMode_Add"
                                            ...
                                            <asp:Label ID="lblAddLine" runat="server" Text="Add line"></asp:Label>
                                              ...
                                              <asp:LinkButton ID="btnOpenDeletPopup" CausesValidation="False" OnClientClick="javascript:return OpenConfirmSpecificationPopup('Delete');" SecurityButtonType="ItemMode_Delete"
                                            Visible='<%# rdgSpecificationTemplate.EditIndexes.Count = 0 And (Not rdgSpecificationTemplate.MasterTableView.IsItemInserted) %>'
                                            runat="server"  CssClass="GridCmdDeleteRows">
                                            <span class="Icon"></span>
                                            <asp:Label ID="lblDeleteSelectedLines" runat="server"
                                                Text="Delete" meta:resourcekey="lblDeleteSelectedLinesResource1"></asp:Label>
                                        </asp:LinkButton>

                                        <asp:LinkButton ID="btnDeleteSpecs" CausesValidation="False"  SecurityButtonType="ItemMode_Delete"
                                            Visible="False"
                                            runat="server" CommandName="DeleteRows" CssClass="GridCmdDeleteRows DeleteSpecs">
