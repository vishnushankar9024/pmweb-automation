    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        ...
        <script type="text/javascript">
            ...
            function lbtSaveAndClose_OnClientClick() {
                ...
                else if (Source == 'DocumentAttachment') {
                    window.parent.document.querySelector(".LoadAttachment").click();
                    var wnd = window.GetRadWindow();
                    wnd.Close();
                }

            }
            function lbtSave_OnClientClick() {
                var Source = '<%=QueryStringSource%>';
                var from = '<%=QueryStringFrom%>';
                if (Source == 'PMWebViewer') {
                    var grid = $find("<%=rdgLinkedRecords.ClientID %>");
...
<body>
    ...
    <asp:LinkButton runat="server" CssClass="closepopup closesize" ID="btnCloseProfilePopup" OnClientClick="window.close()">
        ...
        <div style="height: 100%">
            <table border="0" width="100%" cellpadding="0" cellspacing="0" class="ToolBar" runat="server" id="ToolBar">
                <tr>
                    <td class="ToolbarTd">
        ...
        <telerik:RadSplitter ID="RadSplitter1" runat="server" Orientation="vertical" Skin="Default" OnClientLoad="RadSplitterClientLoad" CssClass="documentSplitter"
            ...
            <telerik:RadPane ID="rpLinkedRecords" runat="server" CssClass="NormalWhiteBack SplitterPanePopup" Width="420px" 
                Height="590px">
