        ...
        <div class="row">
            <div class="col-12 ResponsiveMargin">
                <telerik:RadGrid ID="rdgSubmittals" runat="server" FilterType="HeaderContext" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true"
                    AutoGenerateColumns="False" ShowStatusBar="False" Font-Size="8px" PageSize="250" CssClass="WithoutTopBorder"
                    ...
                    <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
                        ...
                        &nbsp;</span>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Sent"
                                ...
                                <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                <EditItemTemplate>
                                    <telerik:RadDatePicker ID="dtpSentDate" runat="server" MinDate="1901-01-01" MaxDate="2100-01-01"
                                        Width="100%" Skin="Default"
                                        EnableTyping="True">
                            ...
                            <telerik:GridTemplateColumn HeaderText="Return Due" SortExpression="ReturnDueDate" GroupByExpression="ReturnDueDate [GridColumn_ReturnDueDate] Group By ReturnDueDate"
                                ...
                                <ItemStyle HorizontalAlign="Right"></ItemStyle>
                                <EditItemTemplate>
                                  <telerik:RadDatePicker ID="dtpReturnDueDate" runat="server" MinDate="1901-01-01" MaxDate="2100-01-01"
                                        Width="100%" Skin="Default"
                                        EnableTyping="True">
                            ...
                            <telerik:GridTemplateColumn HeaderText="Returned Date" CurrentFilterFunction="EqualTo" AutoPostBackOnFilter="true"
                                ...
                                <EditItemTemplate>
                                   <telerik:RadDatePicker ID="dtpReturnedDate" runat="server" MinDate="1901-01-01" MaxDate="2100-01-01"
                                        Width="100%" Skin="Default"
                                        EnableTyping="True">
                            ...
                            <telerik:GridTemplateColumn HeaderText="Forward Due" CurrentFilterFunction="EqualTo" AutoPostBackOnFilter="true"
                                ...
                                <EditItemTemplate>
                                    <telerik:RadDatePicker ID="dtpForwardDueDate" runat="server" MinDate="1901-01-01" MaxDate="2100-01-01"
                                        Width="100%" Skin="Default"
                                        EnableTyping="True">
                            ...
                            <telerik:GridTemplateColumn HeaderText="Forwarded Date" CurrentFilterFunction="EqualTo" AutoPostBackOnFilter="true"
                                ...
                                <EditItemTemplate>
                                   <telerik:RadDatePicker ID="dtpForwardeDate" runat="server" MinDate="1901-01-01" MaxDate="2100-01-01"
                                        Width="100%" Skin="Default"
                                        EnableTyping="True">
                                        <DateInput ID="DateInput7" LabelCssClass="radLabelCss_Office2007" Skin="Default"
                                            runat="server">
                                        </DateInput>
                                        <Calendar ID="Calendar7" Skin="Default" runat="server">
                                        </Calendar>
                                    </telerik:RadDatePicker>
                                </EditItemTemplate>
                                <HeaderStyle Wrap="False" Width="110px"></HeaderStyle>
