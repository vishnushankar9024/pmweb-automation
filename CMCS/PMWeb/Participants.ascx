...
<telerik:RadAjaxPanel ID="pnlParticipants" runat="server" style="width:402px;">
    <telerik:RadGrid ID="rdgParticipants" runat="server" CssClass="LightWeight" SetWidth="true" AppendMenus="true" FitParentContainer="true"
        ...
        AllowPaging="True" PageSize="250" ShowGroupPanel="False" AllowMultiRowEdit="true" AllowMultiRowSelection="true"
        ...
        <MasterTableView DataKeyNames="Id" CommandItemDisplay="Top" InsertItemDisplay="Top"
            ...
            <Columns>
                <telerik:GridTemplateColumn HeaderText="Contact" ItemStyle-HorizontalAlign="Right"
                    HeaderStyle-Wrap="false" Groupable="false" UniqueName="Contact" Reorderable="false" ItemStyle-Width="325px">
                    <ItemTemplate>
                    ...
                    <HeaderStyle Wrap="False" Width="325px"></HeaderStyle>
                    <ItemStyle HorizontalAlign="Left" Wrap="False"></ItemStyle>
                </telerik:GridTemplateColumn>
                <telerik:GridTemplateColumn UniqueName="Present" HeaderText="Present" ItemStyle-HorizontalAlign="Right"
                    HeaderStyle-Wrap="false" Groupable="false" Reorderable="false" ItemStyle-Width="75px">
                    <ItemTemplate>
