<%@ Page meta:resourcekey="Page" Language="vb" AutoEventWireup="false" CodeBehind="LeaseChargesDetailsPopup.aspx.vb" Inherits="Website.LeaseChargesDetailsPopup" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="PMMainPage PMPopupMainPage documentSinglePage" style="padding: 0px;margin-bottom:0 !important">
            <div class="row" style="padding-top: 0px;">
                <telerik:RadGrid ID="rdgLeaseCharges" runat="server" AutoGenerateColumns="False" ShowStatusBar="True" HeaderStyle-Font-Size="8" SetWidth="true" ClientSettings-Scrolling-AllowScroll="true"
                    ShowGroupPanel="False" AllowMultiRowEdit="False" AllowMultiRowSelection="False" AllowSorting="False" ItemStyle-Height="20px" GridLines="None" Width="100%">
                    ...
                    <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>" DataKeyNames="Id" CommandItemDisplay="None"
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderStyle-Width="70px" HeaderText="Charge ID*" ItemStyle-Wrap="false" UniqueName="ChargeID" DataField="ChargeID" Groupable="false">
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderStyle-Width="100px" ItemStyle-Wrap="false" HeaderText="Type" UniqueName="Type" DataField="Type" Groupable="false">
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderStyle-Width="120px" HeaderText="Description" ItemStyle-Wrap="false" UniqueName="Description" DataField="Description" Groupable="false">
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderStyle-Width="90px" ItemStyle-Wrap="false" HeaderText="Post Every" UniqueName="PostEvery" DataField="PostEvery" Groupable="false">
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderStyle-Width="70px" ItemStyle-Wrap="false" HeaderText="Est." UniqueName="Est" DataField="Est" Groupable="false">
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderStyle-Width="100px" HeaderText="Amount" ItemStyle-Wrap="false" UniqueName="Amount" DataField="Amount" Groupable="false" ItemStyle-HorizontalAlign="Right">
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderStyle-Width="100px" HeaderText="Annualized" ItemStyle-Wrap="false" UniqueName="Annualized" DataField="Annualized" Groupable="false" ItemStyle-HorizontalAlign="Right">
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderStyle-Width="100px" ItemStyle-Wrap="false" HeaderText="Cost Code" UniqueName="CostCode" DataField="CostCode" Groupable="false">
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderStyle-Width="200px" HeaderText="Notes" ItemStyle-Wrap="false" UniqueName="Notes" DataField="Notes" Groupable="false">
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderStyle-Width="70px" ItemStyle-Wrap="false" HeaderText="Inactive" UniqueName="Inactive" DataField="Inactive" Groupable="false">
                                <ItemTemplate>
        ...
        <div class="PMMainPage PMPopupMainPage">
            <div class="row">
                <div class="col-6">
                    <div class="col-150">
                        <asp:RadioButtonList ID="rdbLeaseChargeDetails" Enabled="true" AutoPostBack="true" runat="server" RepeatDirection="Vertical" CssClass="RadioCss RadioPadding">
                    ...
                    <div class="col-4" style="float: left;">
                        <table id="tblEsc" runat="server" style="width: 100%" class="colTable">
                            <tr>
                                    ...
                                    <table width="100%" class="TableNoSpacingNoBorder">
                                        <tr>
                                            <td style="width:182px;">
                                                <telerik:RadComboBox ID="ddlIndex" runat="server"
                                                    Skin="Default" Style="font-size: 11px" Width="100%"
                                                    AutoPostBack="True" NoWrap="true" CausesValidation="False" Height="300px"
                                                    ShowMoreResultsBox="True" EnableLoadOnDemand="true" EnableItemCaching="true"
                                                    EnableVirtualScrolling="True" OnItemsRequested="ddl_ItemsRequested">
                                                </telerik:RadComboBox>
                                            </td>
                                            <td style="padding-left: 8px;width:50px">
                                                <asp:TextBox ID="txtIndex" runat="server" CssClass="Percent" Width="100%"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                        ...
                                        <tr>
                                            <td style="width:182px;">
                                                <telerik:RadComboBox ID="ddlNextIndex" AllowCustomText="true" Filter="Contains" runat="server"
                                                    Skin="Default" Width="100%" Enabled="false"
                                                    AutoPostBack="True" NoWrap="true" CausesValidation="False" Height="300px"
                                            ...
                                            <td style="padding-left: 8px;width:50px">
                                                <asp:TextBox ID="txtNextIndex" Enabled="false" runat="server" CssClass="Double" Width="100%"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td class="controlWidth">
                                    <table width="100%" class="TableNoSpacingNoBorder">
                                        <tr>
                                            ...
                                            <td style="padding-left: 8px;width:50px">
                                                <asp:TextBox ID="txtPreviousIndex" Enabled="false" runat="server" CssClass="Double" Width="100%"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td class="controlWidth">
                                    <table width="100%" class="TableNoSpacingNoBorder">
                                        <tr>
                                            ...
                                            <td style="padding-left: 8px;width:50px">
                                                <asp:TextBox ID="txtPercentageOfIndexChange" runat="server" CssClass="Percent" MaxNumber="100" MinNumber="0" Width="100%"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="controlWidth">
                                    <table width="100%" class="TableNoSpacingNoBorder">
                                        <tr>
                                            <td style="width:182px;">
                                                <asp:CheckBox CssClass="mobile-switch" ID="chkNoLowerThreshold" AutoPostBack="false" runat="server" Text="No Lower Threshold" meta:resourcekey="chkNoLowerThreshold" />
                                            </td>
                                            <td style="padding-left: 8px;width:50px">
                                                <asp:TextBox ID="txtLowerThreshold" CssClass="Currency" runat="server" Width="100%"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="controlWidth">
                                    <table width="100%" class="TableNoSpacingNoBorder">
                                        <tr>
                                            <td style="width:182px;">
                                                <asp:CheckBox CssClass="mobile-switch" ID="chkNoUpperThreshold" AutoPostBack="false" runat="server" Text="No Upper Threshold" meta:resourcekey="chkNoUpperThreshold" />
                                            </td>
                                            <td style="padding-left: 8px;width:50px">
                                                <asp:TextBox ID="txtUpperThreshold" CssClass="Currency" runat="server" Width="100%"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td class="labelWidth" style="width: 160px !important;">
                                    <asp:Label runat="server" ID="lblChkNewLine" Text="New Line" meta:resourcekey="chkNewLine"></asp:Label>
                                </td>
                                <td class="controlWidth">
                                    <table width="100%" class="TableNoSpacingNoBorder">
                                        <tr>
                                            <td style="width:182px;">
                                                <asp:CheckBox ID="chkNewLine" runat="server" CssClass="mobile-switch" />
                                            </td>
                                            <td style="padding-left: 8px;width:50px"></td>
                            ...
                            <tr runat="server" visible="false">
                                ...
                                <td class="controlWidth">
                                    <table width="100%" class="TableNoSpacingNoBorder">
                                        <tr>
                                            <td style="width:182px;">
                                                <asp:CheckBox CssClass="mobile-switch" ID="chkNoRoundToNearest" Visible="false" AutoPostBack="false" runat="server" Text="No Rounding" meta:resourcekey="chkNoRoundToNearest" />
                                            </td>
                                            <td style="padding-left: 8px;width:50px">
                                                <asp:TextBox ID="txtRoundToNearest" Visible="false" CssClass="Currency" runat="server" Width="100%"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td class="controlWidth">
                                    <table width="100%" class="TableNoSpacingNoBorder">
                                        <tr>
                                            <td style="width:182px;"></td>
                                            <td style="padding-left: 8px;width:50px">
                                                <asp:CheckBox CssClass="mobile-switch" ID="chkReconcil" Visible="false" runat="server" Text="Reconcil" meta:resourcekey="chkReconcil" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                        ...
                        <table id="tblOverage" style="width: 100%" runat="server" class="colTable">
                            <tr>
                                <td>
                                    <telerik:RadGrid ID="rdgOverage" runat="server" AutoGenerateColumns="False" ShowStatusBar="False" HeaderStyle-Font-Size="8" SetWidth="true" ClientSettings-Scrolling-AllowScroll="true"
                                        ShowGroupPanel="False" AllowMultiRowEdit="true" PageSize="250" AllowPaging="False" AllowMultiRowSelection="true" AllowSorting="False" ItemStyle-Height="20px" GridLines="None" FitPageHeightOffset="24">
                                        <HeaderContextMenu EnableViewState="false"></HeaderContextMenu>
                        ...
                        <table border="0" id="tblRecovery" runat="server" style="width: 100%" class="colTable">
                            <tr>
                                <td class="labelWidth" style="width: 160px !important;">
                                ...
                                <td class="controlWidth">
                                    <table width="100%" class="TableNoSpacingNoBorder">
                                        <tr>
                                            ...
                                            <td style="width:50px;">
                                                <asp:TextBox ID="txtProrationMethod" runat="server" CssClass="Percent" MaxNumber="100" MinNumber="0" Width="100%"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="controlWidth">
                                    <table width="100%" class="TableNoSpacingNoBorder">
                                        <tr>
                                            <td style="width:182px;padding-right:8px"></td>
                                            <td style="width:50px;">
                                                <asp:TextBox ID="txtPercentageFactor" runat="server" CssClass="Percent" MaxNumber="100" MinNumber="0" Width="100%"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="controlWidth">
                                    <table width="100%" class="TableNoSpacingNoBorder">
                                        <tr>
                                            <td style="width:182px;padding-right:8px">
                                                <asp:CheckBox CssClass="mobile-switch" ID="chkRecoveryNoLowerThreshold" runat="server" Text="No Lower Threshold" meta:resourcekey="chkNoLowerThreshold" />
                                            </td>
                                            <td style="width:50px;">
                                                <asp:TextBox ID="txtRecoveryLowerThreshold" CssClass="Currency" runat="server" Width="100%"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="controlWidth">
                                    <table width="100%" class="TableNoSpacingNoBorder">
                                        <tr>
                                            <td style="width:182px;padding-right:8px">
                                                <asp:CheckBox CssClass="mobile-switch" ID="chkRecoveryNoUpperThreshold" runat="server" Text="No Upper Threshold" meta:resourcekey="chkNoUpperThreshold" />
                                            </td>
                                            <td style="width:50px;">
                                                <asp:TextBox ID="txtRecoveryUpperThreshold" CssClass="Currency" runat="server" Width="100%"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="controlWidth">
                                    <table width="100%" class="TableNoSpacingNoBorder">
                                        <tr>
                                            <td style="width:182px;padding-right:8px">
                                                <asp:CheckBox CssClass="mobile-switch" ID="chkRecoveryNoRoundToNearest" Visible="false" runat="server" Text="No Rounding" meta:resourcekey="chkNoRoundToNearest" />
                                            </td>
                                            <td style="width:50px;" >
                                                <asp:TextBox ID="txtRecoveryRoundToNearest" Visible="false" CssClass="Currency" runat="server" Width="100%"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                        ...
                                        <tr>
                                            <td style="width:182px;padding-right:8px">
                                                ...
                                                <%--   <telerik:RadComboBox ID="ddlReqCodes" Runat="server"  AllowCustomText="false"
                                                        Skin="Default" Width="100%" DropDownWidth="300px" AutoPostBack="false" NoWrap="true"
                                                        height="250px" CausesValidation="False">
                                ...
                                <td class="controlWidth">
                                    <table width="100%" class="TableNoSpacingNoBorder">
                                        <tr>
                                            <td style="width:182px;padding-right:8px"></td>
                                            <td style="width:50px;">
                                                <asp:CheckBox CssClass="mobile-switch" ID="chkRecoveryReconcil" Visible="false" runat="server" Text="Reconcil" meta:resourcekey="chkReconcil" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
        ...
        <%--      <asp:Label ID="lblEscalation" runat="server" meta:resourcekey="lblEscalation" Text="Escalation"></asp:Label>
        <asp:Label ID="lblOverage" runat="server" meta:resourcekey="lblOverage" Text="Overage"></asp:Label>
        <asp:Label ID="lblRecovery" runat="server" meta:resourcekey="lblRecovery" Text="Recovery"></asp:Label>--%>
