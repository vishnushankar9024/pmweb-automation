...
<table cellpadding="0" cellspacing="0" id="tblValues" runat="server" width="100%"
    ...
    <tr id="trEditMode" runat="server">
        ...
        <td id="tdOptions" runat="server" style="border-width: 0px" class="NoWrap">
            ...
            <telerik:RadTextBox ID="txtMemo" MaxLength="4000" Width="80%" TextMode="MultiLine" Height="14px" runat="server" Visible="false"></telerik:RadTextBox>
                <asp:LinkButton runat="server" ID="imgMemo" Visible="false" CssClass="SearchButton" OnClientClick="return OpenNoteDetailPopup(this.id.replace('imgMemo','txtMemo'))" >
