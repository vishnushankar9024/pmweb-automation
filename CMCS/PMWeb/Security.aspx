...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH1" runat="server">
   ...
   <iframe runat="server" id="ngFrame"  width="100%" style="height: Calc(100vh - 146px); padding: 0px; margin: 0px;border:0;z-index:7000; position:relative; background-color: white"></iframe>
