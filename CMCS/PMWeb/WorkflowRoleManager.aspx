...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <telerik:RadCodeBlock runat="server" ID="c1">
        <script type="text/javascript" language="javascript">
            ...
            function ToggleAssetMenu() {
                ...
                if (tdAssetMenu.style.display == 'none') {
                    ...
                    btnToggleAssetMenu.className = 'AsserExplorerbutton HideAssetMenu '
                    ...
                    btnToggleAssetMenu.className = 'AsserExplorerbutton ShowAssetMenu '
        ...
        <style type="text/css">
            .DeleteRoleAssignment .Icon {
    background-image: url('Css/Images/ResponsiveIcons/NewClearIconAssignment.png') !important;
   ...
   /*                       .divContentHolder {
    padding-top: 115px;
            ...
            .rdtRoleManager .rtlDataDiv{
                box-sizing: border-box;
               height: calc(var(--Content-height) - 3px ) !important;
            }

            /*@media screen and (max-width: 843px) and (min-width: 320px){
                .rdtRoleManager div.rtlDataDiv{
...
.RadTreeList .rtlCancel {
    ...
    <table class="TableNoSpacingNoBorder RoleManagerTable">
        <tr>
            <td valign="top" id="tdAssetMenu" runat="server" class="MenuWidth">
                                    ...
                                    <tr>
                                        <td style="max-width: 400px; border: 1px solid #999999">
                                            <telerik:RadTabStrip ID="rtsUsers" runat="server" Skin="Vista" MultiPageID="RadMultiPage1"
                                                SelectedIndex="0" ShowBaseLine="true" BorderWidth="0" BorderStyle="Solid" BorderColor="#999999" Width="100%" CssClass="colortabs mainHomeTabsROLES documentTabs borderstyle">
                                                <Tabs>
            ...
            <td id="tdAssetExplorerBar" runat="server" class="" style="border: 1px solid gray;background-color: #ffffff !important">
                <input id="btnToggle" runat="server" class="AsserExplorerbutton" type="button" value=" " onclick="ToggleAssetMenu();" />
            </td>
            <td valign="top" class="RightTd">
                <table cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
                    <tr class=" ToolbarPositionOnMobile" style="display:none;">
                        ...
                        <td style="width: 240px !important;">
                            <telerik:RadComboBox ID="ddlEntities" runat="server" Width="240px" AutoPostBack="True" AllowCustomText="true"
                                ...
                                EnableVirtualScrolling="True" OnItemsRequested="ddl_ItemsRequested" EmptyMessage="Select Level..." DropDownCssClass="ToolbarDropdown">
                ...
                <div class="PMHeader" style="margin-top: 0px;">
                    <div class="row">
                        <div class="col-12">
                    ...
                    <div class="row">
                        <telerik:RadTreeList ID="rdtRolesByEntity" runat="server" AllowMultiItemEdit="True" 
                            ...
                            ShowTreeLines="False" EditMode="InPlace" BackColor="#999999" BorderColor="#666666" BorderWidth="1" DataKeyNames="Id" 
                            ClientDataKeyNames="Id" Width="100%">
                            <ClientSettings AllowItemsDragDrop="false">
                                <Selecting AllowItemSelection="True"></Selecting>
                                <Scrolling AllowScroll="true" UseStaticHeaders="false" />
