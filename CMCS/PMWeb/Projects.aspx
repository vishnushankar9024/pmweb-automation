...
<%@ Register Src="ngDocNotifications.ascx" TagName="NotificationLog" TagPrefix="uc18" %>
                ...
                var top = (screen.height - 500) / 2;
                        OpenPOPUp("Notification.aspx?ObjectType=PROJECT&Id=" +
                                Id + "&Description="
                                                ...
                                                + "&EntityId=" + Id + "&EntityType=0", "Notification",
    ...
    <div id="trMplDetails" runat="server">
        <telerik:RadMultiPage ID="mlpProjects" runat="server" SelectedIndex="1" Width="100%" RenderSelectedPageOnly="true" CssClass="documentMultiPages">
            ...
            <telerik:RadPageView ID="pvNotificationLog" runat="server">
                <uc18:NotificationLog ID="NotificationLog1" runat="server" />
            </telerik:RadPageView>
