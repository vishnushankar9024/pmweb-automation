<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="StageRating.ascx.vb" Inherits="Website.StageRating" %>
...
<telerik:radgrid id="rdgRating" runat="server"    CssClass="WithoutTopBorder" AllowFilteringByColumn="true" FilterType ="HeaderContext" EnableHeaderContextMenu ="true" EnableHeaderContextFilterMenu="true"
    ...
    gridlines="None" PageSize="250"  AllowPaging="True" ShowGroupPanel="True">
       <PagerStyle Mode="NextPrevAndNumeric" AlwaysVisible="true" />
                ...
                <telerik:GridTemplateColumn HeaderText="User" UniqueName="User"  DataField="User"
                ...
                <telerik:GridTemplateColumn HeaderText="Use" UniqueName="Use"  DataField="Use" DataType="System.Boolean"
