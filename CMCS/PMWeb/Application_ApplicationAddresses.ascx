...
<telerik:RadAjaxManagerProxy ID="RadAjaxManagerProx1" runat="server">
  <AjaxSettings>
        <telerik:AjaxSetting AjaxControlID="fldAddresses">
            <UpdatedControls> 
                <telerik:AjaxUpdatedControl ControlID="fldAddresses" LoadingPanelID="ldpPM"/>
            </UpdatedControls>                    
        </telerik:AjaxSetting>                     
    </AjaxSettings>
</telerik:RadAjaxManagerProxy>
<div id="divAddresses">
<fieldset id="fldAddresses" runat="server">
...
<Columns>    
    ...
    <telerik:GridTemplateColumn HeaderStyle-Width="100px"  ItemStyle-Wrap="false"  HeaderText="State" UniqueName="StateName">
        <ItemTemplate> 
