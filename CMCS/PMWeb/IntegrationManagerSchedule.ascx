                            ...
                            <table class="colTable">
                                <tr>
                                    ...
                                    <td class="controlWidth" style="width: 240px !important">
                                        <span runat="server" id="rmd_dtpDailyStartDate">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <span runat="server" id="rmd_dtpDailyEndDate">
                        ...
                        <asp:Panel ID="pnlWeekly" runat="server">
                            <table class="colTable">
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <span runat="server" id="rmd_dtpWeeklyStartDate">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <span runat="server" id="rmd_dtpWeeklyEndDate">
                        ...
                        <asp:Panel ID="pnlMonthly" runat="server">
                            <table class="colTable">
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <span runat="server" id="rmd_dtpMonthlyStartDate">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth" >
                                         <span runat="server" id="rmd_dtpMonthlyEndDate">
