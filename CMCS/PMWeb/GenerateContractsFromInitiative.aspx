<%@ Page Language="vb" AutoEventWireup="false" meta:Resourcekey="Page" Title="Generate Contracts" CodeBehind="GenerateContractsFromInitiative.aspx.vb" Inherits="Website.GenerateContractsFromInitiative" %>
...
<script language="javascript" type="text/javascript">
    ...
    function SelectAll(chk) {
        $("#rdgContractInitiativeDetails").find("input[type='checkbox']").each(function () {
    ...
    function SelectParent(chk) {
        var chkPArent = $("#rdgContractInitiativeDetails").find("input[type='checkbox']")[0];
...
<body style="background: White !important;">
    <form id="form1" runat="server">
        ...
        <telerik:radajaxmanager id="PMAjaxManager" runat="server" defaultloadingpanelid="ldpEstimateContracts">
            <AjaxSettings>
                <telerik:AjaxSetting AjaxControlID="mainToolBar">
                   ...
                   <telerik:AjaxSetting AjaxControlID="mainToolBar">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="rdgContractInitiativeDetails" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
                <telerik:AjaxSetting AjaxControlID="rdgContractInitiativeDetails">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="rdgContractInitiativeDetails" />
        ...
        <div class="PMMainPage PMPopupMainPage documentSinglePage">
                ...
                <div class="col-4">
                    <telerik:radajaxpanel id="pnlDetailPane" runat="server" width="100%" horizontalalign="NotSet">
                        <table class="colTable">
                            ...
                            <tr>
                                <td class="labelWidth">
                                    <asp:Label ID="lblInitiative" runat="server" meta:resourcekey="lblInitiative" Text="Initiative"></asp:Label>
                                </td>
                                <td class="controlWidth">
                            ...
                            <tr>
                                <td class="labelWidth">
                                    <asp:Label ID="lblBuyoutTotal" runat="server" meta:resourcekey="lblBuyoutTotal" Text="Buyout Total"></asp:Label>
                                </td>
                                <td class="controlWidth">
            ...
            <div class="row">
                <div class="col-12">
                    <telerik:radgrid id="rdgContractInitiativeDetails" runat="server" setwidth="true" fitparentcontainer="true" clientsettings-scrolling-allowscroll="true"
                                ...
                                <telerik:GridTemplateColumn HeaderText="Company" UniqueName="Company">
                                    <ItemTemplate>
                                        <telerik:RadComboBox ID="ddlCompanies" runat="server" Width="100%"  Filter="Contains"
                                            ...
                                            OnItemsRequested="ddl_ItemsRequested" OnSelectedIndexChanged="ddlCompanies_SelectedIndexChanged"
                                    ...
                                    <tr>
                                        <td>&nbsp;&nbsp;
                                            <asp:LinkButton ID="btnRefresh" runat="server" CausesValidation="False" CommandName="Undo" CssClass="GridCmdUndo"
                                                Visible='<%# rdgContractInitiativeDetails.EditIndexes.Count = 0 And (Not rdgContractInitiativeDetails.MasterTableView.IsItemInserted) %>'>
