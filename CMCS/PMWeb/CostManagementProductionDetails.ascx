        ...
        <div class="col-12 ResponsiveMargin">
            <telerik:RadGrid ID="rdgProductionDetails" runat="server" AllowFilteringByColumn="true" FilterType="HeaderContext"
                ...
                <span class="Icon"></span>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Total Converted" Visible="true" UniqueName="TotalConverted" ItemStyle-HorizontalAlign="Right"  GroupByExpression="TotalConverted [GridColumn_TotalConverted] Group By TotalConverted ASC"
