<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Home_PortfolioOverView.ascx.vb" Inherits="Website.Home_PortfolioOverView" %>
...
<telerik:RadAjaxManagerProxy ID="RadAjaxManager1" runat="server">
    ...
    <telerik:radgrid id="rdgMultipleProjects" visible ="false" runat="server" AllowFilteringByColumn="true" FilterType ="HeaderContext" EnableHeaderContextMenu ="true" EnableHeaderContextFilterMenu="true"
         AutoGenerateColumns="False" ShowStatusBar="True" font-size="8px" PageSize="250" EnableAutoScroll="true" EnableScreenBoundaryDetection="true" 
        ShowFooter="true" AllowPaging="True" ShowGroupPanel="True" AllowSorting="True" 
        GridLines="None" CssClass="WithoutTopBorder">
        ...
        <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>" ShowGroupFooter="true" 
            ...
            TableLayout="Fixed">
            <Columns> 
                <telerik:GridTemplateColumn HeaderText="Project Name" UniqueName="ProjectName" DataField="ProjectName"
                    SortExpression="ProjectName"  GroupByExpression="ProjectName [GridColumn_ProjectName] Group By ProjectName ASC">
                    <ItemTemplate>
                        <asp:HyperLink ID="hliProjectName" runat="server" CssClass="NoWrap"
                            Text='<%#IIf(Container.DataItem("ProjectName") = String.Empty, "&nbsp;", Container.DataItem("ProjectName"))%>'
                ...
                <telerik:GridTemplateColumn HeaderText="Project Executive" UniqueName="ProjectExecutive" DataField="ProjectExecutive"
                    SortExpression="ProjectExecutive" GroupByExpression="ProjectExecutive [GridColumn_ProjectExecutive]  Group By ProjectExecutive ASC">
                ...
                <telerik:GridTemplateColumn HeaderText="Project Type" UniqueName="ProjectType" SortExpression="ProjectType" DataField="ProjectType"
                    GroupByExpression="ProjectType [GridColumn_ProjectType]  Group By ProjectType ASC">
                    <ItemTemplate>
...
<%--                    <FooterTemplate>
                        <asp:Label ID="lblTotalOriginalBudget" runat="server"></asp:Label>
                    </FooterTemplate>--%>
...
<%--                    <FooterTemplate>
                        <asp:Label ID="lblTotalBudgetChanges" runat="server"></asp:Label>
                    </FooterTemplate>--%>
                    <FooterStyle HorizontalAlign="Right" />
                    <ItemStyle HorizontalAlign="Right" BackColor="#edf8fe" BorderColor="#9ab5d0"></ItemStyle>
                    <HeaderStyle Width="95px"></HeaderStyle>
...
<%--                    <FooterTemplate>
                        <asp:Label ID="lblTotalAnticipatedBudget" runat="server"></asp:Label>
                    </FooterTemplate>--%>
                    <FooterStyle HorizontalAlign="Right" />
                    <ItemStyle HorizontalAlign="Right" BackColor="#edf8fe" BorderColor="#9ab5d0"></ItemStyle>
...
<%--                    <FooterTemplate>
                        <asp:Label ID="lblTotalOriginalCosts" runat="server"></asp:Label>
                    </FooterTemplate> --%>
                    <FooterStyle HorizontalAlign="Right" />
                    <ItemStyle HorizontalAlign="Right" BackColor="#edf8fe" BorderColor="#9ab5d0"></ItemStyle>
                    <HeaderStyle Width="95px"></HeaderStyle>
...
<%--                    <FooterTemplate>
                        <asp:Label ID="lblTotalCostsRevisions" runat="server"></asp:Label>
                    </FooterTemplate>--%>
                    <FooterStyle HorizontalAlign="Right" />
                    <ItemStyle HorizontalAlign="Right" BackColor="#edf8fe" BorderColor="#9ab5d0"></ItemStyle>
                    <HeaderStyle Width="95px"></HeaderStyle>
...
<%--                    <FooterTemplate>
                        <asp:Label ID="lblNonCommitmentCosts" runat="server"></asp:Label>
                    </FooterTemplate>--%>
                    <FooterStyle HorizontalAlign="Right" />
                    <ItemStyle HorizontalAlign="Right" BackColor="#edf8fe" BorderColor="#9ab5d0"></ItemStyle>
...
<%--                    <FooterTemplate>
                        <asp:Label ID="lblTotalForecasts" runat="server"></asp:Label>
                    </FooterTemplate>--%>
                    <FooterStyle HorizontalAlign="Right" />
                    <ItemStyle HorizontalAlign="Right" BackColor="#edf8fe" BorderColor="#9ab5d0"></ItemStyle>
                    <HeaderStyle Width="95px"></HeaderStyle>
...
<%--                    <FooterTemplate>
                        <asp:Label ID="lblTotalAnticipatedCost" runat="server"></asp:Label>
                    </FooterTemplate>--%>
                    <FooterStyle HorizontalAlign="Right" />
                    <ItemStyle HorizontalAlign="Right" BackColor="#edf8fe" BorderColor="#9ab5d0"></ItemStyle>
                    <HeaderStyle Width="95px"></HeaderStyle>
...
<%--                    <FooterTemplate>
             ...
             <%--   <telerik:GridTemplateColumn HeaderText="Forecasts Variance" UniqueName="ForecastsVariance" DataField="ForecastsVariance" Aggregate="Sum" FooterAggregateFormatString="{0:N}"
                    ...
                    <FooterTemplate>
                        <asp:Label ID="lblTotalForecastsVariance" runat="server"></asp:Label>
                    </FooterTemplate>
                    <FooterStyle HorizontalAlign="Right" />
                    <ItemStyle HorizontalAlign="Right" BackColor="#edf8fe" BorderColor="#9ab5d0"></ItemStyle>
                    <HeaderStyle Width="115px"></HeaderStyle>
...
<%--                    <FooterTemplate>
                        <asp:Label ID="lblTotalActualCosts" runat="server"></asp:Label>
                    </FooterTemplate>--%>
                    <FooterStyle HorizontalAlign="Right" />
                    <ItemStyle HorizontalAlign="Right" BackColor="#edf8fe" BorderColor="#9ab5d0"></ItemStyle>
                    <HeaderStyle Width="100px"></HeaderStyle>
...
<%--                    <FooterTemplate>
                        <asp:Label ID="lblTotalCostPctComplete" runat="server"></asp:Label>
                    </FooterTemplate>--%>
                    <FooterStyle HorizontalAlign="Right" />
                    <ItemStyle HorizontalAlign="Right" BackColor="#edf8fe" BorderColor="#9ab5d0"></ItemStyle>
                    <HeaderStyle Width="100px"></HeaderStyle>
...
<%--                    <FooterTemplate>
                        <asp:Label ID="lblTotalPhysicalPctComplete" runat="server"></asp:Label>
                    </FooterTemplate>--%>
                    <FooterStyle HorizontalAlign="Right" />
                    <HeaderStyle Width="100px"></HeaderStyle>
                 ...
                 <table style="padding: 0px; border:0px transparent none; height:30px;" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="padding-left:5px;" class="NoWrap">
                            <b><asp:Label ID="lblProgram" Text="Program" runat="server" meta:ResourceKey="lblProgram" class="Menufixedwidth"></asp:Label></b>
                             &nbsp;&nbsp;
                        ...
                        <td style="padding-left:10px;" class="NoWrap">
                            <b><asp:Label ID="lblProject" Text="Project" meta:ResourceKey="lblProject" runat="server" class="Menufixedwidth"></asp:Label></b>
                            &nbsp;&nbsp;
                        ...
                        <td style="padding-left:10px;" class="NoWrap">
                            <b><asp:Label ID="lblCurrency" Text="Currency" runat="server" meta:ResourceKey="lblCurrency" class="Menufixedwidth"></asp:Label></b>
                            &nbsp;&nbsp;
                        ...
                        <td style="padding-left:10px;line-height: 21px;">
                            <asp:LinkButton ID="btnRefresh" runat="server" CausesValidation="False" CommandName="RebindGrid" CssClass="GridCmdRebindGrid MenuAlignWithCombo" 
                        ...
                        <td style="padding-left: 10px;">
                            <telerik:RadMenu ID="rdmLayouts" Style="float: none; display: inline-block; vertical-align: middle;" SecurityButtonType="ItemMode" EnableRoundedCorners="true" EnableAutoScroll="true"
                                ...
                                runat="server" EnableSelection="true" CssClass="trvContextMenu bringToBack MenuAlignWithCombo"
