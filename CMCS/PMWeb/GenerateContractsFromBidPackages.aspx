<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GenerateContractsFromBidPackages.aspx.vb"
    Inherits="Website.GenerateContractsFromBidPackages" Culture="auto" meta:resourcekey="Page"
    UICulture="auto" %>
...
<script language="javascript" type="text/javascript">
    ...
    function SelectAll(chk) {
        var i = 0;
        $("#rdgContractsBidPackages").find("input[type='checkbox']").each(function () {
            if (i != 0)
    ...
    function SelectParent(chk) {
        var chkParent = $("#rdgContractsBidPackages").find("input[type='checkbox']")[1];
...
<body style="background: White !important;">
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxManager ID="PMAjaxManager" runat="server" DefaultLoadingPanelID="ldpBidPackagesContracts">
            <AjaxSettings>
                <telerik:AjaxSetting AjaxControlID="rdgContractsBidPackages">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="rdgContractsBidPackages" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
            </AjaxSettings>
            <AjaxSettings>
        ...
        <telerik:RadAjaxLoadingPanel ID="ldpBidPackagesContracts" runat="server" Skin="Default" />
                    ...
                    <telerik:RadToolBar ID="mainToolBar" OnClientButtonClicked="CheckClose" Width="100%" runat="server" Skin="Default" AutoPostBack="true">
                        <Items>
                            <telerik:RadToolBarButton EnableImageSprite="true" CssClass="ToolbarGenerate" PostBack="true"
                                CommandName="GenerateContract" AccessKey="s" Value="GenerateContract">
            ...
            <div class="PMMainPage PMPopupMainPage documentSinglePage">
                <div class="row">
                    <div class="col-4 col-4-left">
                        <fieldset>
                            <legend>                              
                                <asp:Label runat="server" ID="lblProcurementTitle" meta:resourcekey="lblProcurementTitle"></asp:Label>
                            </legend>
                            <table class="colTable">
                                ...
                                <tr>
                                    <td class="labelWidth">
                                        <asp:Label ID="lblProcurement" runat="server" meta:resourcekey="lblProcurement"></asp:Label>
                                    </td>
                                    <td class="controlWidth">
                                ...
                                <tr>
                                    <td class="labelWidth">
                                        <asp:Label ID="lblBidCategory" runat="server" meta:resourcekey="lblBidCategory"></asp:Label>
                                    </td>
                                    <td class="controlWidth">
                                ...
                                <tr>
                                    <td class="labelWidth">
                                        <asp:Label ID="lblAwardedBidder" runat="server" meta:resourcekey="lblAwardedBidder"></asp:Label>
                                    </td>
                                    <td class="controlWidth">
                    ...
                    <div class="col-4 col-4-right">
                        <fieldset>
                            <legend>                           
                                <asp:Label runat="server" ID="lblContract" meta:resourcekey="lblContract"></asp:Label>
                            </legend>
                            <table class="colTable">
                                <tr>
                                    <td class="labelWidth">
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox runat="server" ID="ddlContractType">
                                        </telerik:RadComboBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="labelWidth">
                                        <asp:Label ID="lblDecription" runat="server" meta:resourcekey="lblDescription"></asp:Label>
                                    </td>
                                    <td class="controlWidth">
                                        <asp:TextBox runat="server" ID="txtContractDescription" MaxLength="500"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="labelWidth">
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox runat="server" ID="ddlContractCategory">
                                        </telerik:RadComboBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="labelWidth">
                                        <asp:Label ID="lblCopy" meta:resourcekey="lblCopy" runat="server"></asp:Label>
                                    </td>
                                    <td class="controlWidth">
                                        <div class="row">
                                            <div class="col-4">
        ...
        <div class="PMMainPage PMPopupMainPage documentSinglePage">
            <div class="row">
                <div class="col-4">
                    <asp:RadioButtonList ID="rdbQuantityAndCosts" Enabled="true" AutoPostBack="true" runat="server" CssClass="RadioCss RadioPadding">
                        <asp:ListItem meta:resourcekey="rdbOnlineBid" Value="OnlineBid" Selected="True"></asp:ListItem>
                        <asp:ListItem meta:resourcekey="rdbProcurement" Value="Procurement"></asp:ListItem>
                    </asp:RadioButtonList>
            ...
            <div class="row">
                <div class="col-12">
                    <telerik:RadGrid ID="rdgContractsBidPackages" runat="server" FilterType="HeaderContext" EnableHeaderContextMenu="true" AppendMenus="true"
                                ...
                                <div style="padding: 2px">
                                    &nbsp;&nbsp;
                                                <asp:LinkButton ID="btnRefresh" runat="server" CausesValidation="False" CommandName="Undo" CssClass="GridCmdUndo"
                                                    Visible='<%# rdgContractsBidPackages.EditIndexes.Count = 0 And (Not rdgContractsBidPackages.MasterTableView.IsItemInserted) %>'>
