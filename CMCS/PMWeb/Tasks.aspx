    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function ClickOutside(event) {
                ...
                while (element) {
                    if (element.classList != null && element.classList != undefined && element.classList.length > 0 && (element.classList[0].indexOf('ModulesParentDiv') >= 0 || element.classList[0].indexOf('ModulesTabletd') >= 0 || element.classList[0].indexOf('flyoutPopup') >= 0 || element.classList[0].indexOf('rcbSlide') >= 0)) {
                        found = true;
                        break;
                    }
