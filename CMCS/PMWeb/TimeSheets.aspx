...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        ...
        function clickGenerateHiddenBtn() {
            let btn = window.$('[id$=hdnGeneratebtn]')[0];
            btn.click();
        }
        ...
        function CheckToDate(sender, args) {
            ...
            function Details_ddlCostCodes_OnClientSelectedIndexChanged(sender, eventArgs) {
                if (AutoFill == 'True') {
            ...
            function Details_ResetCombos(combobox, eventArgs) {
                var item = eventArgs.get_item();
                                    ...
                                    <Items>
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem Text="Generate Next" Value="GenerateNext" Enabled="false" OnClick="clickGenerateHiddenBtn();"></telerik:RadMenuItem>                                                
    ...
    <telerik:RadMultiPage ID="mlpTimeSheet" runat="server" SelectedIndex="0" Width="100%" CssClass="documentMultiPages"
        ...
        <telerik:RadPageView ID="pvNotificationLog" runat="server">
         ...
         <asp:Button id="hdnGeneratebtn" runat="server" style="display:none;" OnClick="btnGenerateNext_Click" />
</asp:Content>
