...
<telerik:RadGrid ID="rdgAdvancedSearch" runat="server" AllowMultiRowSelection="true" AutoGenerateColumns="false" CssClass="rdgDocumentManager" Visible="true"
    ...
    ShowStatusBar="false" PageSize="250" AllowPaging="false" ClientSettings-Scrolling-AllowScroll="true" MasterTableView-AllowPaging="true" MasterTableView-PageSize="250"
