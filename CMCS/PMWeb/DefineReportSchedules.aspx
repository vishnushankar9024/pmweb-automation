...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <telerik:RadGrid ID="rdgReportSchedules" runat="server" ShowGroupPanel="True" setwidth="true" Width="100%" 
        HeaderStyle-Font-Size="8" AutoGenerateColumns="False" ShowStatusBar="true" GridLines="None" AllowFilteringByColumn="true"
        PageSize="250" AllowPaging="True" AllowMultiRowEdit="True" AllowMultiRowSelection="true" FilterType="HeaderContext" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true">
