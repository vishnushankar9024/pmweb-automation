...
<telerik:RadCodeBlock ID="CodeBlock" runat="server">
    ...
    <style>
        ...
        .customAssetExplorerVerticalSplitter{
...
<div class="PMHeader">
    <div class="row">
        <div class="col-12 ResponsiveMargin">
            <telerik:RadSplitter ID="RadSplitter1" runat="server" Width="100%" Height="100%" Skin="Default" CssClass="AssetExplorerVerticalSplitter customAssetExplorerVerticalSplitter" SplitBarsSize="" OnClientLoad="onResized">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <telerik:RadGrid ID="rdgPunchListDetails" runat="server" Width="100%" ClientSettings-Scrolling-AllowScroll="true" SetWidth="true" AppendMenus="true"
                                    AutoGenerateColumns="False" ShowStatusBar="False" Font-Size="8px" PageSize="250" UseEditFormInMobile="true"
