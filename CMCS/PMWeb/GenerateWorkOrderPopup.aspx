                        ...
                        <tr>
                            <td style="padding-left: 24px; padding-top: 5px">
                                <table>
                                    <tr>
                                        <td>
                                            <asp:RadioButton ID="rdbSelectedComponents" Text="SELECTED ASSETS" CssClass="RadioCss"
                                                meta:resourcekey="rdbSelectedAssets" runat="server" GroupName="components" Checked="true" />
                                            <br />
                                            <br />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:RadioButton ID="rdbAllComponents" Text="ALL ASSETS" CssClass="RadioCss"
                                                meta:resourcekey="rdbAllAssets" runat="server" GroupName="components" />
                                            <br />
                                            <br />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:RadioButton ID="rdbNoComponents" Text="NO ASSETS " CssClass="RadioCss"
                                                meta:resourcekey="rdbNoAssets" runat="server" GroupName="components" />
                                            <br />
                                            <br />
                                        </td>
                                    </tr>
