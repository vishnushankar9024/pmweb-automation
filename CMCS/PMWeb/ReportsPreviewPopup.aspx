...
<script type="text/javascript">
    ...
    function OpenEmailPopup() {
        ...
        var wnd = window.radopen('ReportEmailPopup.aspx?EntityId=' + EntityId,'')
        if (isMobileScreen()) {
...
<body>
    ...
    <asp:LinkButton runat="server" CssClass="closepopup closesize" ID="btnCloseProfilePopup" OnClientClick="window.close()">
        ...
        <div class="PMMainPage PMPopupMainPage" id="divReports" runat="server" style="margin-bottom: 0 !important;">
