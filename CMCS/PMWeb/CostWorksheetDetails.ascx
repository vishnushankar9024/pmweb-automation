    ...
    <div class="row">
        <div class="col-12">
            <telerik:RadGrid ID="rdgCostWS" runat="server" CssClass="WithoutTopBorder " FilterType="HeaderContext" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true"
                ...
                ShowFooter="True" ShowGroupPanel="True" PageSize="250" AllowMultiRowSelection="True" EnableGroupsExpandAll="true" EnableHierarchyExpandAll="true" ClientSettings-Scrolling-ScrollHeight="300px"
