...
<div class="PMHeader">
    <div class="row">
        <div class="col-12 ResponsiveMargin">
            <telerik:RadGrid ID="rdgPropertyBuildings" runat="server"   HeaderStyle-Font-Size="8" CssClass="WithoutTopBorder RDGAssetsGrid"
                 AutoGenerateColumns="False" AllowSorting="true" ShowStatusBar="true" AllowPaging="true" PageSize="250" SetWidth="true"  ClientSettings-Scrolling-AllowScroll="true" >
