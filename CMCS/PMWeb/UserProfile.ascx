  ...
  <%--      <telerik:AjaxSetting AjaxControlID="ddlSummarizeEvery">
        ...
        <telerik:AjaxSetting AjaxControlID="btnRefreshUserImage">
          ...
          <telerik:AjaxSetting AjaxControlID="mainToolBar">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="mlpUserProfile" LoadingPanelID="ldpPMProf" />
                    <telerik:AjaxUpdatedControl ControlID="tbsDocument" />
                    <telerik:AjaxUpdatedControl ControlID="mainToolBar" />
                </UpdatedControls>
          </telerik:AjaxSetting>
          <telerik:AjaxSetting AjaxControlID="mlpUserProfile">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="mlpUserProfile" LoadingPanelID="ldpPMProf" />
                    <telerik:AjaxUpdatedControl ControlID="tbsDocument" />
                </UpdatedControls>
...
<telerik:RadAjaxLoadingPanel ID="ldpPMProf" runat="server" />
...
<div class="PMSettings">
    <div class="col-2">
        ...
        <telerik:RadTabStrip ID="tbsDocument"  SelectedIndex="0" AutoPostBack="true"
            runat="server" MultiPageID="mlpUserProfile" Skin="Default" ScrollButtonsPosition="Left" CssClass="UserProfileTabs TitleToolbarTop" Orientation="HorizontalTop" Align="Center"
            EnableViewState="True" ScrollChildren="true" CausesValidation="False">
            <Tabs>
                <telerik:RadTab Value="UserProfileSettings" meta:resourcekey="tab_UserProfileSettings" Text="User Settings" Selected="True" PostBack="true"  />
                <telerik:RadTab Value="PageSettings" meta:resourcekey="tab_PageSettings" Text="Home Page Settings" PostBack="true"  />
                <telerik:RadTab meta:resourcekey="tab_Delegate" Value="Delegates" Text="Delegate1" PostBack="true" />
            </Tabs>
        </telerik:RadTabStrip>
    </div>
    <div class="col-10" style="flex:auto">
        <telerik:RadMultiPage ID="mlpUserProfile" runat="server" SelectedIndex="0" Width="100%" CssClass="documentMultiPagesUserProfile" RenderSelectedPageOnly="True">
                    ...
                    <div class="row">
                        <div class="col-4 col-4-left">
                            <table class="TableNoSpacingNoBorder">
                                <tr>
                                    <td>
                                        <fieldset>
                                            <legend><asp:Label ID="lblProfile" meta:resourceKey="lblProfile" runat="server" Text="PROFILE"></asp:Label></legend>
                                                ...
                                                <tr>
                                                    <td class="labelWidth">
                                                        ...
                                                        <div style="float:left">
                                                            <asp:Label runat="server" meta:resourcekey="lblImage" ID="lblImage" Text="Image"></asp:Label>
                                                        </div>
                                ...
                                <tr>
                                    <td>
                                        <fieldset>
                                            <legend><asp:Label Text="login" ID="lblLogin" runat="server" meta:resourcekey="lblLogin"></asp:Label></legend>
                                            <table class="colTable">
                                                <tr>
                                                    <td class="labelWidth">
                                                    ...
                                                    <td class="controlWidth" style="position:relative">
                                                        <asp:TextBox ID="txtOldPassword" autocomplete="off" MaxLength="128" runat="server" Width="100%" TextMode="Password" onkeypress="cleanErrorMessage();"  onfocus="this.removeAttribute('readonly');"></asp:TextBox>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="controlWidth" style="position:relative">
                                                        <asp:TextBox ID="txtPassword" MaxLength="128" autocomplete="off" runat="server" Width="100%" TextMode="Password" onkeypress="cleanErrorMessage();" onfocus="this.removeAttribute('readonly');"></asp:TextBox>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="controlWidth" style="position:relative">
                                                        <asp:TextBox ID="txtConfirmPassword" autocomplete="off" MaxLength="128" Width="100%" runat="server" TextMode="Password"
                                                            onkeypress="cleanErrorMessage();" onfocus="this.removeAttribute('readonly');"></asp:TextBox>
                                ...
                                <tr>
                                    <td id="tdLogout">
                                        <fieldset>
                                            <legend>  <asp:Label runat="server"  Text="logout" meta:Resourcekey="lblLogout" ID="lblLogout"></asp:Label></legend>
                                            <table class="colTable">
                                                <tr>
                                                    <td>
                        ...
                        <div class="col-4 col-4-middle">
                            <table class="TableNoSpacingNoBorder">
                                <tr>
                                    <td>
                                        <fieldset>
                                            <legend> <asp:Label ID="lblOptions" runat="server" meta:resourcekey="lblOptions"></asp:Label></legend>
                                            <table class="colTable">
                        ...
                        <tr>
                                    <td style=" padding-bottom: 5px;" id="tdEvents">
                                        <fieldset>
                                            <legend> <asp:Label runat="server" ID="lblEvents" Text="Summarize Every" meta:Resourcekey="lblEvents"></asp:Label></legend>
            ...
            <telerik:RadPageView ID="pvHomePageSettings" runat="server">
                <div class="PMHeader">
                    <div class="row">
                        <div class="col-12">
                            <telerik:RadAjaxPanel runat="server" ID="pnlajax" LoadingPanelID="ldpPM" EnableAJAX="false">
