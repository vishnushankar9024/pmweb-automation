...
.Default .reTool.reSplitButton, .Default .reTool.reSplitButton:hover {
                    ...
                    <telerik:RadMultiPage runat="server" ID="RMP" SelectedIndex="0"
                        ...
                        <telerik:RadPageView runat="server" ID="RP1">
                            <asp:Panel ID="pnlEditor" runat="server">
                                <telerik:RadEditor ID="edtMergeTemplate" DialogsScriptFile="~/JS/RadEditorDialog.js" runat="server" Style="height: 100% !important" CssClass="WithoutTopBorder" DialogsCssFile="CSS/ControlsCSS/FormDecoratorLite.css" EnableTrackChanges ="true"
                                    Skin="Default"
                                    Width="100%">
                                    <Tools>
