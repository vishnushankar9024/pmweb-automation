            ...
            function maintoolbarClick(Value) {
                ...
                switch (Value) {
                    ...
                    case 'GenerateContracts':
                        ...
                        break;
                    case 'GenerateProjectContracts':
                        OpenPOPUp('GenerateProjectContracts.aspx', 880, 500, false);
                        break;
                    ...
                    <Items>
                        ...
                        <telerik:RadToolBarSplitButton CommandName="Generate" EnableImageSprite="true" EnableDefaultButton="false" PostBack="false" OuterCssClass="HideOnMobileToolbar" CssClass="ToolbarGenerate" ToolTip="Generate">
                            <Buttons>
                                ...
                                <telerik:RadToolBarButton PostBack="false" CommandName="GenerateProjectContracts" Text="Generate Contracts"></telerik:RadToolBarButton>  
                                            ...
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem Text="Generate" Value="Generate" CssClass="Generate" EnableImageSprite="true">
                                                    <Items>
                                                        ...
                                                        <telerik:RadMenuItem Text="Generate Contracts" Value="GenerateProjectContracts"></telerik:RadMenuItem>
                                                    </Items>
                                                </telerik:RadMenuItem>
                            ...
                            <fieldset id ="flsRecap" runat="server">
                                ...
                                <table id="tblEstimate2" class="colTable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="controlWidth">
                                            <asp:TextBox AutoPostBack="true" ID="txtEstimateUnits" MaxLength="15" runat="server" CssClass="PositiveDouble"></asp:TextBox>
                                             <asp:RequiredFieldValidator ID="rfvtxtEstimateUnits" ControlToValidate="txtEstimateUnits"
                                                        runat="server" CssClass="Validator" Visible="false" Display="Dynamic"
                                                        ValidationGroup="Save" ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>">
                                                    </asp:RequiredFieldValidator>
