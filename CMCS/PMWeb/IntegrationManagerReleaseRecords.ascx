    ...
    <div class="row">
        <div class="col-12 ResponsiveMargin">
            <telerik:RadGrid ID="rdgReleaseRecords" runat="server" SetWidth="true" ClientSettings-Scrolling-AllowScroll="true"
                AutoGenerateColumns="False" ShowStatusBar="True" Font-Size="8px" PageSize="250" AppendMenus="true"
                            ...
                            <telerik:RadComboBox ID="ddlProjects" runat="server" OnItemsRequested="ddl_ItemsRequested" Style="padding-left: 80px;"
                                ...
                                Height="400px" EnableLoadOnDemand="true" ShowMoreResultsBox="True" EnableVirtualScrolling="True">
                                    ...
                                    <td>
                                        ...
                                        &nbsp;&nbsp;
                            <telerik:RadComboBox ID="ddlRecordType" runat="server" Style="padding-left: 80px;" OnSelectedIndexChanged="ddlRecordType_SelectedIndexChanged"
                                Skin="Default" CloseDropDownOnBlur="true" AllowCustomText="true" Filter="Contains" MarkFirstMatch="true"
