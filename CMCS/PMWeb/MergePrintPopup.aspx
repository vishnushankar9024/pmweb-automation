...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
       ...
       .PopupToolbarPaddingTop  .RadEditor.chi {
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadCodeBlock ID="CodeBlock" runat="server">
         ...
         function DownloadAndRefresh(url) {
             ...
             let btn = curWindow.$('[id$=hdnAttachmentsbtn]')[0];
             btn.click();
         }
    ...
    <asp:LinkButton runat="server" CssClass="closepopup closesize" ID="btnCloseProfilePopup" OnClientClick="window.close()">
        ...
        <table cellspacing="0" cellpadding="0" width="100%" class="ToolBar" id="ToolBar" runat="server">
            <tr>
                <td class="ToolbarTd">
