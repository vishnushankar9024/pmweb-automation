...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="PMMainPage PMPopupMainPage documentSinglePage">
            ...
            <div class="row">
                <div class="col-12">
                    <telerik:RadGrid ID="rdgCommitmentCOs" AllowMultiRowSelection="false" AllowFilteringByColumn="True" runat="server" SetWidth="true" ClientSettings-Scrolling-AllowScroll="true"
                        ShowGroupPanel="true" HeaderStyle-Font-Size="8" FitPageHeightOffset="24"
                        AutoGenerateColumns="False" AllowSorting="true" ShowStatusBar="true" AllowPaging="true" AutoPostBackOnFilter="true"
                        PageSize="250">
                        ...
                        <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
                            ...
                            <Columns>
                                <telerik:GridTemplateColumn HeaderText="Select" UniqueName="MasterSelect" AllowFiltering="false"
                                    ...
                                    <ItemTemplate>
                                        <asp:CheckBox ID="chkIsIncluded" runat="server" Checked='<%#CBool(Eval("Included"))%>'
                                ...
                                <telerik:GridTemplateColumn HeaderText="CO #" UniqueName="CONumber" DataField="CONumber" CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType"  AutoPostBackOnFilter="true"
                                ...
                                <telerik:GridTemplateColumn HeaderText="CE #" UniqueName="CENumber" DataField="CENumber" CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType"  AutoPostBackOnFilter="true"
                                ...
                                <telerik:GridTemplateColumn HeaderText="Description" UniqueName="Description" DataField="Description" CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType"  AutoPostBackOnFilter="true"
                                ...
                                <telerik:GridTemplateColumn HeaderText="UOM" UniqueName="UOM" DataField="UOM" CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true"
                                    Groupable="false" Reorderable="false">
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn HeaderText="Cost Type" UniqueName="CostType" DataField="CostType"  CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true"
                                    Groupable="false" Reorderable="false">
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn HeaderText="Quantity" UniqueName="Quantity" DataField="Quantity"  CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" 
                                    Groupable="false" Reorderable="false">
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn HeaderText="UnitCost" UniqueName="UnitCost" DataField="UnitCost"  CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" 
                                    Groupable="false" Reorderable="false">
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn HeaderText="Amount" UniqueName="Amount"  DataField="Amount" CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" 
                                    Groupable="false" Reorderable="false">
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn HeaderText="Period" UniqueName="Period"  DataField="Period" CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true"
                                ...
                                <telerik:GridTemplateColumn HeaderText="Commitment Line" UniqueName="ContractLine" DataField="ContractLine"  CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true"
