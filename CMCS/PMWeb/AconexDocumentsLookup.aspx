<%@ Page meta:resourcekey="Page" Language="vb" AutoEventWireup="false" CodeBehind="AconexDocumentsLookup.aspx.vb"
    Inherits="Website.AconexDocumentsPopup" %>
...
<body>
    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        <script type="text/javascript" src= "JS/Aconex/Aconex.js?rnd=<%= PM.cssRnd  %>"></script>
        ...
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="trvProjects" >
                <UpdatedControls>
                    ...
                    <telerik:AjaxUpdatedControl ControlID="rdgDocuments" LoadingPanelID="ldpFileUpload" />
            ...
            <telerik:AjaxSetting AjaxControlID="rdgDocuments">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="rdgDocuments" LoadingPanelID="ldpFileUpload" />
            ...
            <telerik:RadSplitter ID="RadSplitter1" runat="server" Skin="Default" Width="100%"
                ...
                <telerik:RadPane ID="treeFoldersAndFilesPane" runat="server" Width="200" Height="100%"
                    ...
                    <table width="100%" class="NormalWhiteBack" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td class="Padding7">
                                <telerik:RadTreeView ID="trvProjects" OnClientDoubleClick="OnClientDoubleClick_FillDocuments"
                ...
                <telerik:RadPane ID="RadContentPane" runat="server">
                    <table cellpadding="0" cellspacing="0" width="99%">
                        <tr>
                            <td class="Top">
                                <telerik:RadGrid ID="rdgDocuments" runat="server" AllowMultiRowSelection="False"
                                    AutoGenerateColumns="False" GridLines="None" HeaderStyle-Font-Size="8" ShowStatusBar="True"
                                    Skin="Default" Width="99%" PageSize="250" AllowPaging="True" ShowGroupPanel="true" AllowSorting="True" AllowFilteringByColumn="true"  FilterType ="HeaderContext" EnableHeaderContextMenu ="true" EnableHeaderContextFilterMenu="true">
                                    <HeaderStyle Font-Size="8pt" />
                                    <ClientSettings Selecting-AllowRowSelect="true" ClientEvents-OnRowDblClick="LookupDocument_RowDblClick_SelectDocument">
                                    ...
                                    <MasterTableView CommandItemDisplay="Top" TableLayout="Fixed">
                                        <CommandItemTemplate>
                                            <asp:LinkButton ID="btnRefresh" runat="server" CausesValidation="false" CommandName="RebindGrid" CssClass="GridCmdRebindGrid" 
                                                Visible="<%# rdgDocuments.EditIndexes.Count = 0 AND (Not rdgDocuments.MasterTableView.IsItemInserted) %>">
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Document #" HeaderStyle-Width="115px" Display="True" 
                                        ...
                                        <NoRecordsTemplate>
                                            <table style="height: 200px; width: 100%">
                                                <tr>
                                                    <td class="Top Center">
                                                        <asp:Label runat="server" ID="lblNoDocumentsToDisplay" Text="No Files to display."
                                                            meta:resourcekey="lblNoDocumentsToDisplay"></asp:Label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </NoRecordsTemplate>
