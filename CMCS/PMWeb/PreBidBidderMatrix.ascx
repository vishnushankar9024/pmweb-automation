...
<div class="PMHeader">
    ...
    <telerik:RadGrid ID="rdgBidderMatrix" Width="100%" runat="server" UseEditFormInMobile="true"  AutoGenerateColumns="False" AllowPaging="True" PageSize="250" HeaderStyle-Font-Size="8" AllowMultiRowEdit="true" AllowMultiRowSelection="true" ShowGroupPanel="True" AllowSorting="true" CssClass="WithoutTopBorder" AllowFilteringByColumn="true" FilterType ="HeaderContext" EnableHeaderContextMenu ="true" EnableHeaderContextFilterMenu="true">
