        ...
        <script language="javascript" type="text/javascript">
            ...
            function onClientContextMenuItemClicking(sender, args) {
                ...
                switch (menuItem.get_value()) {
                    ...
                    case "AddStage":
                        treeNode.expand();
                        window.setTimeout(function () { addGroupNode(); }, 400);
                        args.set_cancel(true);
                        break;
                    case "AddActivity":
                        treeNode.expand();
                        window.setTimeout(function () { addActivity(); }, 400);
                        args.set_cancel(true);
                        break;
                    case "Delete":
            ...
            function fixSplitterSiz1e(isRail) {
...
1
    ...
    <style type="text/css">
        ...
        .RDSplitter,.RDLeftPane,.RDRightPane{
          height: calc(var(--Content-height) - 50px) !important;
        }
    </style>
    ...
    <div id="maindiv" runat="server" >
        <telerik:RadSplitter ID="RadSplitter1" runat="server" Skin="Default" Width="100%" CssClass="RDSplitter" SplitBarsSize="" >
            <telerik:RadPane ID="treeGroupsAndItemsPane" runat="server" Width="30%" CssClass="RDLeftPane" Style="position: fixed; background-color: #666 !important; height: 100% !important; top: 0;"
            ...
            <telerik:RadPane ID="RadContentPane" runat="server" Width="70%" Index="2" CssClass="RDRightPane" Skin="Default" >
                                ...
                                <fieldset>
                                    ...
                                    <table class="colTable">
                                        <tr>
                                            ...
                                            <td class="controlWidth">
                                                ...
                                                <asp:RequiredFieldValidator ID="rfvStage" runat="server" ValidationGroup="Save" ControlToValidate="txtStageDescription"
                                                    CssClass="Validator" Display="Dynamic" meta:resourcekey="rfvStageRequired"
                                        ...
                                        <tr>
                                            ...
                                            <td class="controlWidth">
                                                <telerik:RadComboBox ID="ddlGateKeeper" runat="server" DropDownWidth="463px"
                                        ...
                                        <tr>
                                            ...
                                            <td class="controlWidth">
                                                <telerik:RadComboBox ID="ddlStageDuration" runat="server" Skin="Default" AllowCustomText="true"  Filter="Contains" MarkFirstMatch="true">
                                                    <Items>
                                    ...
                                    <table class="colTable">
                                        <tr>
                                            ...
                                            <td class="controlWidth">
                                                ...
                                                <asp:RequiredFieldValidator ID="rfvActivity" runat="server" ValidationGroup="Save" ControlToValidate="txtActivityDescription"
                                                    CssClass="Validator" Display="Dynamic" meta:resourcekey="rfvActivityRequired" Text="Required"
                                                    ForeColor=""></asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
