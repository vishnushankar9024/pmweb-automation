...
<telerik:RadCodeBlock ID="CodeBlock" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function SearchOnEnterKeyPress(e, button) {
    ...
    <style type="text/css">
        ...
        .customTextColor .rtsSelected .rtsOut {
          position:relative;
        }
             .WorkflowRoleCss .rtsSelected:after {
                 position: absolute;
                 content: " ";
                 width: 100%;
                 height: 2px;
              ...
              .WorkflowRoleCss .rtsLI:hover::after {
                     content: "";
                     position: absolute;
                     width: 100%;
                     height: 2px;
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="ToolBarWorkflowRoles SmallToolbar" style="background-color: RGB(237,237,237) !important; margin-top:38px">
    <tr>
                ...
                <Items>
                    ...
                    <telerik:RadToolBarSplitButton ImageUrl="Images/ToolBar/NewDoc.png" CommandName="NewInitiative"
                        ...
                        <Buttons>
                            ...
                            <telerik:RadToolBarButton ImageUrl="Images/Global/AddLine.png" SecurityButtonType="Copy" CommandName="Copy" ValidationGroup="Save">
                            </telerik:RadToolBarButton>
                        </Buttons>
                            ...
                            <tr>
                                <td style="padding: 13px; max-width: 400px; width: 100% !important; background-color: #EDEDED; border: 1px solid #999999; border-bottom: none;">
                                    <table cellpadding="0" cellspacing="0" style="width: 100%" border="0">
                                        <tr>
                                            <td>
                                                <telerik:RadTextBox runat="server" ID="txtUser" AutoPostBack="false" meta:resourcekey="txtUsers" Width="100%"></telerik:RadTextBox>
                                            </td>
                                            <td style="width: 30px; padding-left: 10px;">
                                                <asp:LinkButton runat="server" ID="btnSearch" CssClass="LoopButton" Width="30px" AutoPostBack="false">
                                                                        <span class="Icon"></span>
                                                </asp:LinkButton>
                                            </td>
                                        </tr>
                            ...
                            <tr>
                                <td style="max-width: 400px;">
                                    <telerik:RadTabStrip ID="rtsBranches" runat="server" MultiPageID="RadMultiPage1"
                                        SelectedIndex="0" ShowBaseLine="true" BorderWidth="0" CssClass="colortabs WorkflowRoleCss customTextColor">
                                        <Tabs>
                                            <telerik:RadTab Text="Roles" Value="Roles" SelectedCssClass="customTextColor">
                                                <TabTemplate>
                                                    <asp:Label runat="server" ID="lblRolesName" meta:Resourcekey="RadTab_Roles" SelectedCssClass="customTextColor"></asp:Label>
                                                </TabTemplate>
                                            </telerik:RadTab>
                                            ...
                                            <telerik:RadTab Text="Branch Rules" Value="BranchRules" SelectedCssClass="customTextColor">
                                                <TabTemplate>
                                                    <asp:Label runat="server" ID="lblBranchRulesName" meta:Resourcekey="RadTab_BranchRules" SelectedCssClass="customTextColor"></asp:Label>
                                                </TabTemplate>
                                            </telerik:RadTab>
                                        </Tabs>
                                    </telerik:RadTabStrip>
                                        ...
                                        <div style="min-height: 298px; max-height: 298px; overflow: auto;">
                                            <telerik:RadTreeList ID="rdtSteps" runat="server" AllowMultiItemEdit="True" SetWidth="true" FitParentContainer="true"
                                                ...
                                                <Columns>
                                                    ...
                                                    <telerik:TreeListTemplateColumn UniqueName="UseAdobeSign" HeaderText="Acrobat Sign Step1" HeaderStyle-Width="90px" ItemStyle-HorizontalAlign="Center"
                                                        meta:resourcekey="AcrobatSign">
                                                        <ItemTemplate>
                                                            <img src="Images/Global/<%#CStr(IIf(CBool(Eval("UseAdobeSign")), "checked.png", "unchecked.png"))%>"
                                                                alt="" />
                                                        </ItemTemplate>
                                                    </telerik:TreeListTemplateColumn>
                                                </Columns>
