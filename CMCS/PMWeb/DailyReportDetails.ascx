...
<telerik:RadCodeBlock ID="CodeBlock" runat="server">
    <style>
        ...
        .RDSplitter,.RDLeftPane,.RDRightPane{
          height: calc(var(--Content-height) - 50px - 38px - 1px) !important;
        }
        .RDSplitter {
                        ...
                        <div class="row">
                            <div class="col-12">
                                <telerik:RadGrid ID="rdgOnSite" AllowMultiRowSelection="true" runat="server" AllowMultiRowEdit="true" AllowFilteringByColumn="true"
                                    ...
                                    AutoGenerateColumns="False" AllowSorting="true" ShowStatusBar="true" PageSize="250" UseEditFormInMobile="true" SetWidth="true" ClientSettings-Scrolling-AllowScroll="true" AppendMenus="true"
