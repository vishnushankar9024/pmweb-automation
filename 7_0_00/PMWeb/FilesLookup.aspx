    ...
    <form id="form1" runat="server">
        ...
        <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            ...
            <script language="javascript" type="text/javascript">
                ...
                function RequestStart(sender, args){
                    ...
                    if (args.EventTarget.indexOf("btnUpload") >= 0 || args.EventTarget.indexOf("btnUploadFile") >= 0) {
                ...
                function ShowImage(src) {
                    ...
                    $('<img src="' + src + '" style="border-width:0px;height:320px;width:370px;" >').prependTo(".Masterfader");
                    var flyout = $(".RotatorPopup")[0]
                    var flyoutBackdrop = $('#flyoutBackdrop')[0]
                ...
                function appendDropEvent(){
                    ...
                    dropZone.addEventListener('drop',async function(event) {
                        ...
                        var inputfile = document.querySelector("#inputFiles");
        ...
        <div class="CloseProfilePopup">
                ...
                <asp:Panel ID="pnlFolder" runat="server" Visible="true" Style="height: auto; width: 100%; position: relative">
                    ...
                    <div class="PMMainPage" style="height: calc(100vh - 121px); padding: 0 24px;">
                            ...
                            <div class="col-8" id="filesGridPane" runat="server" style="height: 100%">
                                <div class="Js-DropZone" id="dropZone" runat="server">
                                    ...
                                    <asp:Panel runat="server" ID="mainContent" Style="height: 100%; overflow-y: auto; overflow-x: auto;">
                                        <telerik:RadGrid ID="rdgFiles" runat="server" AllowMultiRowSelection="true" AutoGenerateColumns="false" CssClass="rdgDocumentManager rgHeaderRightBorder"
                                            ...
                                            EnableHeaderContextMenu="false" EnableHeaderContextFilterMenu="false" Height="100%" FitPageHeightOffset="5">
                                            ...
                                            <ItemStyle HorizontalAlign="Left" />
                                                    ...
                                                    <telerik:GridTemplateColumn HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center" HeaderText="Action" EnableHeaderContextMenu="false"
                                                        ItemStyle-HorizontalAlign="Center" Resizable="true" UniqueName="Action" AllowSorting="false" HeaderStyle-Width="30px" Reorderable="false">
                                                        <ItemTemplate>
                                                    ...
                                                    <telerik:GridTemplateColumn HeaderText="Document #" EnableHeaderContextMenu="false" UniqueName="Id" SortExpression="Id" Groupable="False"
                                        ...
                                        <HeaderStyle Width="150px"></HeaderStyle>
                                            ...
                                            <ClientSettings Scrolling-SaveScrollPosition="true" Selecting-AllowRowSelect="true" AllowRowsDragDrop="false" ClientEvents-OnRowContextMenu="rdgFiles_OnRowContextMenu"
                                                ClientEvents-OnRowClick="OnFilesRowClick" ClientEvents-OnRowSelecting="rdgFilesRowSelecting" ClientEvents-OnRowDeselected="rdgFilesRowDeSelected">
                ...
                <asp:FileUpload ID="inputFolder" CssClass="Hide" allowdirs directory oninput="upload(event)" onchange="uploadFolder(event)" EnableViewState="true" runat="server" name="FolderUpload" webkitdirectory AllowMultiple="true" />
                <asp:Panel ID="pnlRoot" runat="server" Visible="false" Style="margin-top: 55px;">
