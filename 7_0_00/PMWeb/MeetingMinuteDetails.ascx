    ...
    <div class="row">
        <div class="col-12 ResponsiveMargin">
            <telerik:RadGrid ID="rdgMeetingMinutes" runat="server" EnableEmbeddedSkins="false" CssClass="WithoutTopBorder"
                ...
                EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true" UseEditFormInMobile="true" HasPasteFromExcel="true">
                    ...
                    <CommandItemTemplate>
                        <div style="padding: 2px">
                            ...
                            <asp:LinkButton ID="btnExportExcel" runat="server"
                                ...
                                Visible='<%# rdgMeetingMinutes.EditIndexes.Count = 0 And (Not rdgMeetingMinutes.MasterTableView.IsItemInserted) %>'>
                                <span class="Icon"></span>
