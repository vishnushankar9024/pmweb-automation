                ...
                <div class="col-8">
                    <table class="colTable">
                        ...
                        <tr>
                            ...
                            <td class="controllWidth">
                                <div style="width: calc(100% - 2px) !important; min-height: 30px; background-color: #ededed;" class="AllLightBlueBorder" id="dvTo">
                                    <span id="spnTo" runat="server" style="white-space: nowrap;display:flex;width:100%;flex-wrap:wrap"></span>
                                </div>
                        ...
                        <tr>
                            ...
                            <td class="controllWidth">
                                <div style="width: calc(100% - 2px) !important; min-height: 30px; background-color: #ededed;" class="AllLightBlueBorder" id="dvCC">
