                    ...
                    <table class="colTable">
                        <tr>
                            ...
                            <td class="controlWidth">
                                <div style="width: calc(100% - 2px); min-height: 30px; background-color: #ededed;" class="AllLightBlueBorder" id="dvTo">
                        ...
                        <tr>
                            ...
                            <td class="controlWidth">
                                <div style="width:calc(100% - 2px); min-height: 30px; background-color: #ededed;" class="AllLightBlueBorder" id="dvCC">
