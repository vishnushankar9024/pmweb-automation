...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
            ...
            function maintoolbarClick(Value) {
                ...
                'location=no,status=0,menubar=0,addressbar=0,resizable=1,scrollbars=1,width=820,height=500,top=' + top + ',left=' + left, 1045, 515, false);
                    ...
                    case 'New':
                        ...
                        break;
                        case 'Submit':
                            return OpenWorkflowSubmitPopup('PROGRESSINVOICES');
                            break;
    ...
    <table style="width: 100% !important;" cellpadding="0" cellspacing="0" border="0">
        <tr class="ToolBar LargeToolBar">
            <td class="ToolbarTd">
                <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=80">
            ...
            <td class="ToolbarTd HideOnMobileToolbar showOnIpad">
                <telerik:radcombobox id="ddlProgressInvoice" runat="server" filter="Contains" markfirstmatch="true" autopostback="false"
                    ...
                    height="260px" causesvalidation="False" dropdowncssclass="ddlTreeviewTemplate ToolbarDropdown">
                    <Items>
                                    ...
                                    <Items>
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem Text="Submit" Value="Submit" onclick="OpenWorkflowSubmitPopup('PROGRESSINVOICES');" CssClass="Help" EnableImageSprite="true" ></telerik:RadMenuItem>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <fieldset runat="server" id="fldOnlineInvoice">
                                            ...
                                            CssClass="Validator" InitialValue="" ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>" ValidationGroup="Save"
                                            Display="Dynamic" ForeColor="" Visible="false"></asp:RequiredFieldValidator>
                                                        <asp:CustomValidator ID="csvInvoiceType" runat="server" Visible="false"
                                                            ...
                                                            ForeColor="" Operator="GreaterThan" ValidationGroup="Save" ValueToCompare="0"></asp:CustomValidator>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="labelWidth">
                        ...
                        <div class="col-4 col-4-middle">
                            <table class="colTable">
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlCostPeriod" Filter="Contains" MarkFirstMatch="true" runat="server" Width="100%" Skin="Default" AllowCustomText="true"></telerik:RadComboBox>
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlCategory" runat="server" Filter="Contains" MarkFirstMatch="true" Width="100%" Skin="Default" AllowCustomText="true"></telerik:RadComboBox>
