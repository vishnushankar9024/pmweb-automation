<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="CustomTableDesigner.ascx.vb" Inherits="Website.CustomTableDesigner1" %>
...
<telerik:RadAjaxLoadingPanel ID="ldpPM" runat="server" Skin="Default" />
            ...
            <telerik:RadGrid ID="rdgCustomTable" runat="server" SetWidth="true" ClientSettings-Scrolling-AllowScroll="true" AppendMenus="true"
                Skin="Default" AutoGenerateColumns="False" ShowStatusBar="False" Font-Size="8px" PageSize="10"
                AllowPaging="True" AllowMultiRowEdit="False" AllowMultiRowSelection="False"
                AllowSorting="True" GridLines="None" ShowGroupPanel="false" GroupingEnabled="false"
                width="100%" UseEditFormInMobile="true">
                    ...
                    <CommandItemTemplate>
                        <div style="padding: 2px">
                            ...
                            <asp:LinkButton ID="btnEditSelected" runat="server" CausesValidation="False" CommandName="EditRows" CssClass="GridCmdEditRows"
                                ...
                                Visible='<%# rdgCustomTable.EditIndexes.Count = 0 And (Not rdgCustomTable.MasterTableView.IsItemInserted) %>'
                            ...
                            <asp:LinkButton ID="btnUpdateEdited" runat="server" CausesValidation="True" ValidationGroup="DSave" CommandName="UpdateEdited"
                                ...
                                Visible='<%# rdgCustomTable.EditIndexes.Count > 0 %>' meta:resourcekey="btnUpdateEditedResource1">
                                <span class="Icon"></span>
                            ...
                            <asp:LinkButton ID="btnSave" runat="server" CausesValidation="True" ValidationGroup="DSave" CommandName="PerformInsert"
                                ...
                                Visible='<%# rdgCustomTable.MasterTableView.IsItemInserted %>' meta:resourcekey="btnSaveResource1">
                                <span class="Icon"></span>
                            ...
                            <asp:LinkButton ID="btnCancel" runat="server" CausesValidation="False" CommandName="CancelAll" CssClass="GridCmdCancelAll"
                                ...
                                Visible='<%# rdgCustomTable.EditIndexes.Count > 0 Or rdgCustomTable.MasterTableView.IsItemInserted %>'
