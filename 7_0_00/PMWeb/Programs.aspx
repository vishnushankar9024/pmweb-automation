...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <table class="ToolBar SmallToolbar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=148">
                    ...
                    <div class="row JustifyContent R3Cols">
                        <div class="col-4 col-4-left">
                            <table class="colTable">
                                ...
                                <tr>
                                    <td class="labelWidth">
                                        <asp:Label ID="lblProgramManager1" meta:Resourcekey="lblManagerProgram" runat="server" Text="Program Manager11"></asp:Label>
                                    </td>
                                    <td class="controlWidth">
