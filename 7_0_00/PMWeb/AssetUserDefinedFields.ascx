<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="AssetUserDefinedFields.ascx.vb" Inherits="Website.AssetUserDefinedFields" %>
...
<div style="width: 100%;">
    ...
    <asp:CheckBox ID="chkData" Visible="false" runat="server" />
    ...
    <telerik:RadComboBox ID="ddlData" runat="server" AutoPostBack="False" Skin="Default"
        DropDownWidth="250px" EmptyMessage="Select..."
