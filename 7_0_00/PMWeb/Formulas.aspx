        ...
        <script type="text/javascript">
            ...
            function maintoolbarClick(value) {
                ...
                switch (value) {
                       ...
                       <%-- if (HasReports == 'True') {
                            OpenPOPUp("ReportsPreviewPopup.aspx?ObjectType=FORMULA&Id=" +
            ...
            //    var btnEditSelectedId = 'ctl00_CPH1_rdgFormulaDetails_ctl00_ctl02_ctl00_btnEditSelected';
            //    var btnUpdateEditedId = 'ctl00_CPH1_rdgFormulaDetails_ctl00_ctl02_ctl00_btnUpdateEdited';
                ...
                <table style="width: 100% !important;" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        ...
                        <td style="width: 240px" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                            <telerik:RadComboBox ID="ddlFormulas" runat="server" OnClientTextChange="LOD_DropDownTextChange"
                                LoadingMessage="<%$ Resources:PMWeb, Loading %>" Skin="Default" Width="240px"
                                AutoPostBack="True" AllowCustomText="True" CausesValidation="False" Height="400px" CheckForDirt="True"
                                NoWrap="True" meta:resourcekey="ddlFormulas" ShowMoreResultsBox="True" EnableLoadOnDemand="true"
