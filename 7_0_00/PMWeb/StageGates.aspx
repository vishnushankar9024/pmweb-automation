...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH1" runat="server">
            ...
            function maintoolbarClick(Value) {
                ...
                switch (Value) {
                    ...
                    case 'Print':
                        ...
                        break;
                    case 'Submit':
                        return OpenWorkflowSubmitPopup('STAGEGATE');
                        break;
                    default:
    ...
    <table class="ToolBar LargeToolBar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=177">
                                    ...
                                    <Items>
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem Text="Submit" Value="Submit" onclick="OpenWorkflowSubmitPopup('STAGEGATE');" CssClass="Help" EnableImageSprite="true" ></telerik:RadMenuItem>
                        ...
                        <div class="col-4 col-4-left ">
                            <table class="colTable">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlGateKeeper" runat="server" DropDownWidth="400px"
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlDuration" runat="server" Skin="Default" Style="font-size: 11px;"  Filter="Contains" MarkFirstMatch="true"  AllowCustomText="true">
                                            <Items>
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlTask" runat="server" Filter="Contains"
                                            MarkFirstMatch="true" Skin="Default" CloseDropDownOnBlur="true" EnableItemCaching="true" DropDownWidth="463px"
