...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <table class="ToolBar colTable">
                                <tr>
                                     <td valign="middle" style="padding-left:24px" class="ToolbarTd">
                                        <telerik:RadToolBar ID="mainToolBar" runat="server" Skin="Default" AutoPostBack="True">
                                            <Items>
                                                <telerik:RadToolBarButton SecurityButtonType="Read" CommandName="SearchItems" ImageUrl="Images/ToolBar/lookup.png"
                                                    Value="Search" NavigateUrl="SearchDocument.aspx?O=3&ModuleId=7" CausesValidation="false">
                                                </telerik:RadToolBarButton>
                                            </Items>
                                        </telerik:RadToolBar>
                                    </td>
                                    <td style="padding-left:24px;width:160px;">
                                        <asp:Label ID="lblTitle" runat="server" Text="Search Items" meta:resourcekey="lblTitle"></asp:Label>
                                    </td>
