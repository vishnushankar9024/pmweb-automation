        ...
        <tr>
            <td>
                <table style="width: 100%;" cellpadding="0" cellspacing="0">
                    <tr>
                        <td class="ToolbarTd">
                            <asp:Label ID="lblAdjustment" meta:Resourcekey="lblAdjustment" runat="server" Text="Adjustments"></asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <td>
                <div class="PMHeader">
                    <div class="row documentSinglePage">
                        <div>
                            <table id="tblMain" runat="server" border="0">
                                <tr>
                                    <td>--%>
                                        <telerik:RadGrid ID="rdgAdjustments" runat="server" HeaderStyle-Font-Size="8" UseEditFormInMobile="true" CssClass="TopMarginWhenMobileMenuShown"
