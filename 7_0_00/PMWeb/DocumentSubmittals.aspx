...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        <script type="text/javascript">
            ...
            function maintoolbarClick(Value) {
                ...
                'location=no,status=0,menubar=0,addressbar=0,resizable=1,scrollbars=1,width=820,height=500,top=' + top + ',left=' + left);
                    ...
                    case 'ViewPMWebReports':
                        ...
                        break;
                    case 'SubmitWorkflow':
                        return OpenWorkflowSubmitPopup('SUBMITTALS');
                    case 'New':
            ...
            function confirmSend(sender, args) {
                var lblCopyToSubmittalSet = $("span[id$=lblCopyToSubmittalSet]");
                //return radconfirm(unescape(lblCopyToSubmittalSet.html()), 400, 250, null, "Copy to submital set");
                message = unescape(lblCopyToSubmittalSet.html());
                radconfirm(message, function (arg) { if (arg) { $("[id$=btnSend]").click(); } }, 400, 300, null, "Copy to submital set");
                return false;
            }
    ...
    <table class="ToolBar LargeToolBar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=151">
            ...
            <td style="vertical-align: middle; width: 70%" class="ToolbarTd">
                <telerik:RadToolBar ID="mainToolBar" runat="server" AutoPostBack="True">
                    <Items>
                                    ...
                                    <Items>
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem Text="Submit Workflow" Value="SubmitWorkflow" onclick="OpenWorkflowSubmitPopup('SUBMITTALS');" CssClass="Help" EnableImageSprite="true" ></telerik:RadMenuItem>
                       ...
                       <telerik:RadToolBarButton ID="btnSubmitWorkflow" PostBack="false" runat="server" CssClass="lnkButtonBar ToolbarSubmit" OuterCssClass="HideOnMobileToolbar" Value="SubmitWorkflow"
                             meta:resourcekey="btnSubmit" CommandName="SubmitWorkflow" ImageUrl="Images/ToolBar/PMWebW.gif" ValidationGroup="Save">
                        </telerik:RadToolBarButton>
                    </Items>
                </telerik:RadToolBar>
            </td>
                ...
                <div class="PMMainPage">
                    <div class="row JustifyContent R3Cols">
                        <div class="col-4 col-4-left ">
                            <table class="colTable">
                                ...
                                <tr>
                                    <td class="labelWidth">
                                        <div style="float: left;">
                                            <asp:Label ID="lblSetNum" meta:resourcekey="lblSetNumb" runat="server" Text="Linked Set"></asp:Label>
                                        </div>
                                        <div style="float: right;">
                                            <asp:LinkButton runat="server" ID="imgSetNum" CssClass="SearchButton">
                                                                            <span class="Icon"></span>
                                            </asp:LinkButton>
                                        </div>
                                    </td>
                        ...
                        <div class="col-4 col-4-right">
                            ...
                            <asp:Button ID="btnSend" CssClass="Hide" runat="server"></asp:Button>
                        </div>
                    </div>
                </div>
