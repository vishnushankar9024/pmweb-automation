<%@ Page meta:resourcekey="Page" Language="vb" AutoEventWireup="false" CodeBehind="SelectAPPaymentsPopup.aspx.vb" Inherits="Website.SelectAPPaymentsPopup" %>
...
<body>
    <form id="form1" runat="server">
                    ...
                    <td class="ToolbarTd">
                        <telerik:RadToolBar ID="mainToolBar" runat="server" Skin="Default" AutoPostBack="true" Width="150px" CssClass="popup-toolbar" OnClientButtonClicked="maintoolbarClick">
                            <Items>
                                ...
                                <telerik:RadToolBarButton EnableImageSprite="true" CssClass="ToolbarSaveAndExit" CommandName="SaveExit" ValidationGroup="Save"></telerik:RadToolBarButton>
        ...
        <telerik:RadSplitter ID="RadSplitter1" runat="server" Skin="Default" Width="100%" CssClass="documentSplitter"
            ...
            <telerik:RadPane ID="rpnAPPaymentsTree" runat="server" Width="420px" CssClass="NormalWhiteBack SplitterPanePopup" OnClientExpanded="ClientResized"
            ...
            <telerik:RadSplitBar ID="Splitter" runat="server" EnableEmbeddedBaseStylesheet="False" CollapseMode="Forward"
                Index="1" Skin="" />
            <telerik:RadPane ID="rpnAPPaymentsGrid" runat="server" EnableEmbeddedBaseStylesheet="False" CssClass="fullWidthPane OverflowHidden" OnClientResized="ClientResized"
                Index="2" Skin="">
                    ...
                    <div class="row RowWithNoPaddingTop">
                        <div class="col-12">
                            <telerik:RadGrid ID="rdgAPPayments" runat="server" AutoGenerateColumns="False" ShowStatusBar="True" HeaderStyle-Font-Size="8" Width="100%" SetWidth="true"
                                ...
                                ClientSettings-Scrolling-AllowScroll="true" ItemStyle-Height="20px" GridLines="None">
                                ...
                                <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>" DataKeyNames="Id" CommandItemDisplay="Top"
                                    ...
                                    <Columns>
                                        <telerik:GridTemplateColumn HeaderText="Program" ItemStyle-Wrap="false" UniqueName="ProgramName" Groupable="false" SortExpression="ProgramName">
                                            <ItemTemplate>
                                        ...
                                        <telerik:GridTemplateColumn ItemStyle-Wrap="false" HeaderText="Project" UniqueName="ProjectFullName" Groupable="false" SortExpression="ProjectFullName">
                                            <ItemTemplate>
                                        ...
                                        <telerik:GridTemplateColumn ItemStyle-Wrap="false" HeaderText="Company" UniqueName="Company" Groupable="false" SortExpression="Company">
                                            <ItemTemplate>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Payment ID" ItemStyle-Wrap="false" UniqueName="RecordNumber" Groupable="false" SortExpression="RecordNumber">
                                            <ItemTemplate>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Payment" ItemStyle-Wrap="false" UniqueName="Description" Groupable="false" SortExpression="Description">
                                            <ItemTemplate>
