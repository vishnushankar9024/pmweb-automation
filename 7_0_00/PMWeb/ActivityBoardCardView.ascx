...
<div class="Js-DropZone" id="dropZone" runat="server">
    <div id="MainBoard" runat="server" style="padding-left: 16px;padding-top:66px;padding-bottom:36px;white-space: nowrap;display: flex;background-color:inherit;min-height: 100%;min-width: 100%;box-sizing: border-box;">
    </div>
</div>
