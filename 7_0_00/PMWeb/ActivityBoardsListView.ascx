...
<div class="ActivityBoardLV" id="ActivityBoardLV">
    ...
    <div class="Js-DropZone" id="dropZone" runat="server">
        <div class="PMMainPage" style="height: calc(100vh - 88px); background-color: white; margin-top: 26px;">
            <div class="row row-8-4-fit8">
                <div class="col-8" style="height: calc(100vh - 112px); background-color: white;">
                ...
                <div class="col-4" id="DetailsPane" style="overflow: auto; background: white; height: calc(100vh - 112px); width: 399px; display: none;">
