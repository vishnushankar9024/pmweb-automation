        ...
        <script type="text/javascript">
            ...
            function UpdateDisplayedColumn(sender, inspectionDetailId) {
              $.ajax({
                  ...
                  contentType: "application/json; charset=utf-8",
                  data: "{'IsChecked':'" + sender.checked + "','inspectionDetailId':'" + inspectionDetailId + "' }",
                  dataType: "json",
                  async: true
              });
            }
                ...
                <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td class="ToolbarTd Hide">
                            <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="InspectionTypes.aspx">
