...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
        ...
        function maintoolbarClick(Value) {
            switch (Value) {
                ...
                case 'New':
                    ...
                    break;
                case 'Submit':
                    return OpenWorkflowSubmitPopup('MOVEMANAGEMENT');
                    break;
                default:
    ...
    <table class="ToolBar SmallToolbar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=159">
                                    ...
                                    <Items>
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem Text="Submit" Value="Submit" onclick="OpenWorkflowSubmitPopup('MOVEMANAGEMENT');" CssClass="Help" EnableImageSprite="true" ></telerik:RadMenuItem>
