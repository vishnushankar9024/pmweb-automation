...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <telerik:RadCodeBlock runat="server" ID="cdt">
        <script type="text/javascript">
            function maintoolbarClick(value) {
                ...
                switch (value) {
                    //case 'Import':
                    //    OpenPOPUp('ImportPopup.aspx?SourceId=SUBMITTALITEMS', 710, 590, false);
    ...
    <table class="ToolBar SmallToolbar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=169">
            ...
            <td style="width: 240px" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                <telerik:RadComboBox ID="ddlSubmittalsItem" runat="server"
                    ...
                    ShowMoreResultsBox="True" EnableLoadOnDemand="true" meta:resourcekey="ddlSubmittalsItem"
                ...
                <telerik:RadToolBar ID="mainToolBar" runat="server" Skin="Default" AutoPostBack="True">
                    <Items>
                        <%--<telerik:RadToolBarButton SecurityButtonType="Read" CommandName="Search" ImageUrl="Images/ToolBar/lookup.png"
                                        Value="Search" NavigateUrl="SearchDocument.aspx?O=169" CausesValidation="false">
                        ...
                        <telerik:RadToolBarButton PostBack="false" CommandName="MobileMenu" Value="MobileMenu" ImageUrl="Images/ToolBar/PMWebW.gif">
                                    ...
                                    <Items>
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                ...
                                                <%--<telerik:RadMenuItem EnableImageSprite="true" Text="Import" CssClass="Import">
                                                    <Items>
                         ...
                         <%--<telerik:RadToolBarButton SecurityButtonType="Add" ImageUrl="Images/ToolBar/DeleteDoc.png" CommandName="Import" PostBack="false"  OuterCssClass="HideOnMobileToolbar">
                        </telerik:RadToolBarButton>--%>
                    ...
                    <div class="row">
                        <div class="col-4 col-4-left ">
                            <table class="colTable">
                                        ...
                                        <table id="tblStatus" runat="server" border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                ...
                                                <td style="width: 50px; padding-left: 8px;">
                                                    <asp:TextBox runat="server" ID="txtRevision" CssClass="Right" ReadOnly="true" Width="100%"
                                                        Text=""></asp:TextBox>
                                                </td>
                                            </tr>
                                ...
                                <%-- <tr>
                                                        <td class="labelWidth">
                                                            <asp:Label ID="lblStatus" runat="server" Text="<%$ Resources:ProjectManagement, Label_Status %>"></asp:Label>
                                                        </td>
                                                        <td class="controlWidth">
                                                            <table width="100%">
                                                                <tr>
                                                                    <td width="*">
                                                                        <telerik:RadComboBox ID="ddlStatus" runat="server" Width="100px" Skin="Default" Style="font-size: 11px"
