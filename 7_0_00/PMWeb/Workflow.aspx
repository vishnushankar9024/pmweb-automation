...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <style type="text/css">
        ...
        .WorkflowTabsOnMobile.RadTabStrip .rtsLI {
            width: 25% !important;
        }
    ...
    <table style="width: 100% !important;" cellpadding="0" cellspacing="0">
        <tr id="trProjectsDetails" runat="server">
            <td>
                <telerik:RadTabStrip OnClientTabSelecting="onTabSelecting" ID="tbsWorkflow" SelectedIndex="0" Style="margin-top: 30px; position: fixed; z-index: 999; padding-top: 5px;"
                    ...
                    OnTabClick="tbsProjects_TabClick" Width="100%" EnableViewState="true" ShowBaseLine="True" CssClass="WorkflowTabsOnMobile">
                    <Tabs>
                        <telerik:RadTab Value="Roles" Selected="True" PageViewID="0" TabIndex="0" meta:resourcekey="tab_Roles" CssClass="colortabs" />
                        <telerik:RadTab Value="BusinessProcesses" PageViewID="1" TabIndex="1" meta:resourcekey="tab_BusinessProcesses" CssClass="colortabs" />
                        <telerik:RadTab Value="Assignments" runat="server" PageViewID="2" TabIndex="2" meta:resourcekey="tab_Assignments" CssClass="colortabs" />
                        <telerik:RadTab Value="APMRules" runat="server" PageViewID="3" TabIndex="3" meta:resourcekey="tab_APMRules" CssClass="colortabs" />
                    </Tabs>
                </telerik:RadTabStrip>
            </td>
        </tr>
