...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <table style="width: 100%;" cellpadding="0" cellspacing="0" class="ToolBar SmallToolbar">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=3">
            ...
            <td style="width: 240px" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                <telerik:RadComboBox ID="ddlItems" runat="server" OnClientTextChange="LOD_DropDownTextChange"
                    ...
                    OnItemsRequested="ddlItems_ItemsRequested" meta:resourcekey="ddlItems" DropDownCssClass="ToolbarDropdown">
