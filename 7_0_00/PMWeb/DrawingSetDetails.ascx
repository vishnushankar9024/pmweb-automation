                ...
                <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Location11" GroupByExpression="ProjectLocation [GridColumn_ProjectLocation] Group By ProjectLocation ASC"
                            ...
                            <EditItemTemplate>
                                <telerik:RadComboBox ID="ddlProjectLocations" runat="server" Width="100%" AllowCustomText="true" Filter="Contains" MarkFirstMatch="true">
                                </telerik:RadComboBox>
                            </EditItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Status" SortExpression="Status" DataField="Status"
                            ...
                            <EditItemTemplate>
                                ...
                                <telerik:RadComboBox ID="ddlStatus" runat="server" Filter="Contains" MarkFirstMatch="true" AllowCustomText="true" DropDownWidth="300px" Skin="Default" Style="font-size: 11px" Width="100%">
                                </telerik:RadComboBox>
                            </EditItemTemplate>
                            <HeaderStyle Wrap="False" Width="100px"></HeaderStyle>
                            <ItemStyle HorizontalAlign="Left"></ItemStyle>
