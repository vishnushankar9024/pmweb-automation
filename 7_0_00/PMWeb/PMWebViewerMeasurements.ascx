                    ...
                    <asp:Panel ID="pnlEditScale" runat="server" Style="font-size: 10px;margin-right: 8px;margin-left: 8px;">
                        ...
                        <table border="0" width="100%" class="colTable">
                            ...
                            <tr>
                                ...
                                <td class="controlWidth">
                                    <telerik:RadComboBox ID="ddlLengthUOM1" runat="server"  Height="150px" Skin="Default" DropDownWidth="120px" AllowCustomText="True"
                            ...
                            <tr>
                                ...
                                <td class="controlWidth">
                                    <telerik:RadComboBox ID="ddlAreaUOM1" runat="server"  Height="150px" Skin="Default" DropDownWidth="120px" AllowCustomText="True"
                                        LoadingMessage="<%$ Resources:PMWeb, Loading %>" Filter="Contains" MarkFirstMatch="true">
                                    </telerik:RadComboBox>
                                </td>
                            </tr>
