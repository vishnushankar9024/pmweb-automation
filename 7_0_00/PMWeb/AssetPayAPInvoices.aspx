<%@ Page meta:resourcekey="Page" Language="vb" AutoEventWireup="false" CodeBehind="AssetPayAPInvoices.aspx.vb" Inherits="Website.AssetPayAPInvoices" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="PMMainPage PMPopupMainPage documentSinglePage">
            <div class="row">
                ...
                <%-- <td valign="top">
                                <fieldset style="width:245px; height:60px; margin:0px; padding:0px"><legend><asp:Label ID="lblOption" runat="server" meta:resourcekey="lblOption" Text="Option"></asp:Label></legend>
                                      <table> 
                                        <tr>
                                            <td style="height:20px" valign="bottom" > 
                                                 <asp:CheckBox ID="chkPaidInFull" runat="server" Text="Mark Paid In Full When Using Auto Apply" 
            ...
            <div class="row">
                <div class="col-12">
                    <telerik:RadGrid ID="rdgPayAPInvoices" runat="server" AutoGenerateColumns="False" FilterType="HeaderContext" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true"
                        ShowStatusBar="True" HeaderStyle-Font-Size="8" AllowFilteringByColumn="true" SetWidth="true" AppendMenus="true" FitPageHeightOffset="24" ClientSettings-Scrolling-AllowScroll="true"
                        ...
                        <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>" DataKeyNames="Id" CommandItemDisplay="Top"
                            ...
                            <Columns>
                                ...
                                <telerik:GridTemplateColumn HeaderText="Program" HeaderStyle-Width="100px" ItemStyle-Wrap="false" DataField="Program" UniqueName="Program" SortExpression="Program" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType" GroupByExpression="Program [GridColumn_Program] Group By Program ASC">
                                    <ItemTemplate>
                                        <span><%# IIf(Container.DataItem("Program").ToString = String.Empty, "&nbsp;", Container.DataItem("Program").ToString)%></span>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>

                                <telerik:GridTemplateColumn ItemStyle-Wrap="false" HeaderText="Location" HeaderStyle-Width="100px" DataField="Location" UniqueName="Location" SortExpression="Location" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType" GroupByExpression="Location [GridColumn_Location] Group By Location ASC">
                                    <ItemTemplate>
                                        <span><%# IIf(Container.DataItem("Location").ToString = String.Empty, "&nbsp;", Container.DataItem("Location").ToString)%></span>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>

                                <telerik:GridTemplateColumn ItemStyle-Wrap="false" HeaderText="Company" HeaderStyle-Width="100px" DataField="Company" UniqueName="Company" SortExpression="Company" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType" GroupByExpression="Company [GridColumn_Company] Group By Company ASC">
                                    <ItemTemplate>
                                        <span><%# IIf(Container.DataItem("Company").ToString = String.Empty, "&nbsp;", Container.DataItem("Company").ToString)%></span>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>

                                <telerik:GridTemplateColumn HeaderText="RecordId" ItemStyle-Wrap="false" UniqueName="RecordId" DataField="RecordId" HeaderStyle-Width="100px" SortExpression="RecordId" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType" GroupByExpression="RecordId [GridColumn_RecordId] Group By RecordId ASC">
                                    <ItemTemplate>
                                        <span id="spnRecordId" runat="server"><%# IIf(Container.DataItem("RecordId") = 0, "&nbsp;", Container.DataItem("RecordId"))%></span>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>

                                <telerik:GridTemplateColumn HeaderText="Description" ItemStyle-Wrap="false" UniqueName="Description" HeaderStyle-Width="100px" DataField="Description" SortExpression="Description" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType" GroupByExpression="Description [GridColumn_Description] Group By Description ASC">
                                    <ItemTemplate>
                                        <span><%# IIf(Container.DataItem("Description") = String.Empty, "&nbsp;", Container.DataItem("Description"))%></span>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>

                                <telerik:GridTemplateColumn HeaderText="Invoice #" ItemStyle-Wrap="false" UniqueName="InvoiceNumber" HeaderStyle-Width="100px" DataField="InvoiceNumber" SortExpression="InvoiceNumber" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType" GroupByExpression="InvoiceNumber [GridColumn_InvoiceNumber] Group By InvoiceNumber ASC">
                                    <ItemTemplate>
                                        <span><%# IIf(Container.DataItem("InvoiceNumber") = String.Empty, "&nbsp;", Container.DataItem("InvoiceNumber"))%></span>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>

                                <telerik:GridTemplateColumn HeaderText="Invoice Due" ItemStyle-Wrap="false" UniqueName="InvoiceDue" HeaderStyle-Width="100px" DataField="InvoiceDue" SortExpression="InvoiceDue" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType" GroupByExpression="InvoiceDue [GridColumn_InvoiceDue] Group By InvoiceDue ASC">
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn HeaderText="Open Balance" ItemStyle-Wrap="false" UniqueName="OpenBalance" HeaderStyle-Width="100px" DataField="OpenBalance" SortExpression="OpenBalance" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType" GroupByExpression="OpenBalance [GridColumn_OpenBalance] Group By OpenBalance ASC">
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn HeaderText="%1" ItemStyle-Wrap="false" UniqueName="Percentage" CurrentFilterFunction="Contains" DataField="PctApplied" AutoPostBackOnFilter="true" FilterListOptions="VaryByDataType" Groupable="false" HeaderStyle-Width="100px" SortExpression="">
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn HeaderText="Applied" ItemStyle-Wrap="false" UniqueName="Applied" CurrentFilterFunction="Contains" DataField="AppliedAmount" AutoPostBackOnFilter="true" FilterListOptions="VaryByDataType" HeaderStyle-Width="100px" Groupable="false" SortExpression="">
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn HeaderText="Paid In Full" UniqueName="PaidInFull" CurrentFilterFunction="Contains" DataField="AppliedInFull" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true" HeaderStyle-Width="70px" ItemStyle-HorizontalAlign="Left" Groupable="false">
                                    <ItemTemplate>
