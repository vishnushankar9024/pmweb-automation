<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="CostManagementFundingRecordDetails.ascx.vb" Inherits="Website.CostManagementFundingRecordDetails" %>
...
<div class="PMHeader">
    <div class="row">
        <div class="col-12 ResponsiveMargin">
            ...
            <telerik:RadGrid ID="rdgFundingDetails" AllowMultiRowSelection="true" runat="server" CssClass="WithoutTopBorder" AllowFilteringByColumn="true" FilterType="HeaderContext" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true"
                HeaderStyle-Font-Size="8" ShowGroupPanel="true"
                AutoGenerateColumns="False" AllowSorting="true" AllowMultiRowEdit="true " ShowStatusBar="true"
                AllowPaging="true" PageSize="25" UseEditFormInMobile="true">
                ...
                <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Line #" HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Right"
                            UniqueName="LineNumber" HeaderStyle-Wrap="false" Groupable="false" Reorderable="true" DataField="LineNumber" AllowFiltering="false">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Year" SortExpression="Year" DataField="Year"
                            UniqueName="Year" GroupByExpression="Year [GridColumn_Year] Group By Year">
                            <ItemTemplate>
                                <span>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Project" SortExpression="ProjectFullName" DataField="ProjectFullName"
                            UniqueName="ProjectFullName" GroupByExpression="ProjectFullName [GridColumn_ProjectFullName] Group By ProjectFullName ASC" DataType="System.String">
                            <ItemTemplate>
                            ...
                            <EditItemTemplate>
                                <telerik:RadComboBox ID="ddlProjects" Width="100%" DropDownWidth="300px" runat="server" Filter="Contains" MarkFirstMatch="true" Skin="Default"
                        ...
                        <telerik:GridTemplateColumn HeaderText="Source" SortExpression="FundingSourceText" DataField="FundingSourceText"
                            ...
                            <EditItemTemplate>
                                <telerik:RadComboBox ID="ddlFundingSources" Width="100%" runat="server" Filter="Contains" AllowCustomText="true" Height="250px"
                        ...
                        <telerik:GridTemplateColumn HeaderText="Funded" HeaderStyle-Width="150px"
                            ...
                            UniqueName="OriginalFunding" DataField="OriginalFunding" DataType="System.String">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Period" SortExpression="Period" UniqueName="Period" DataField="Period"
                            ...
                            <EditItemTemplate>
                                <telerik:RadComboBox ID="ddlPeriods" Width="100%" DropDownWidth="200px" runat="server" Height="300px" Filter="Contains" MarkFirstMatch="true" Skin="Default"
                                    CloseDropDownOnBlur="true" NoWrap="False" AllowCustomText="true"
                        ...
                        <telerik:GridTemplateColumn HeaderText="Task" UniqueName="Task" DataField="TaskName" SortExpression="TaskName"
                            GroupByExpression="TaskName [GridColumn_Task] Group By TaskName ASC">
                            <ItemTemplate>
                            ...
                            <EditItemTemplate>
                                <telerik:RadComboBox ID="ddlTasks" runat="server" Width="100%" DropDownWidth="465px" Filter="Contains"
                                    MarkFirstMatch="true" Skin="Default" CloseDropDownOnBlur="true" NoWrap="True" AllowCustomText="true"
                        ...
                        <telerik:GridTemplateColumn HeaderText="Notes" SortExpression="Notes" DataField="Notes"
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="txtNotes" runat="server" Text='<%# Eval("Notes") %>' Width="80%" MaxLength="4000" TextMode="MultiLine"></asp:TextBox>
                ...
                <span class="Icon"></span>
                    ...
                    <span class="Icon"></span>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Closed" HeaderStyle-Width="55px" ItemStyle-Wrap="false" DataField="Closed"
                            SortExpression="Closed" Groupable="false" UniqueName="Closed">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Funding<br/> Ldgr Id"
                            UniqueName="FundingLedgerId" Groupable="false" DataField="FundingLedgerId">
                            <ItemTemplate>
                                &nbsp;
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="txtFundingLedgerId" runat="server" Text=''
                ...
                <ClientSettings EnableRowHoverStyle="true" AllowColumnsReorder="true" ColumnsReorderMethod="Reorder" AllowDragToGroup="True" AllowRowsDragDrop="False">
