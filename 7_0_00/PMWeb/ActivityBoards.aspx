...
<%--                    if (args.get_item().get_value() == "Activate") {
    ...
    <table style="width: 100%;" cellpadding="0" cellspacing="0" class="ToolBar LargeToolBar">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=297">
            ...
            <td style="width: 240px" class="ToolbarTd HideOnMobileToolbar ShowDropDown showOnIpad">
                <telerik:RadComboBox ID="ddlActivityBoards" runat="server" OnClientTextChange="LOD_DropDownTextChange" NoWrap="True"
                    ...
                    meta:resourcekey="ddlActivityBoards" ShowMoreResultsBox="True" EnableLoadOnDemand="true" OnItemsRequested="ddl_ItemsRequested" DropDownCssClass="ToolbarDropdown">
                                    ...
                                    <Items>
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem Text="Filter Tasks" Value="FilterTasks" CssClass="FilterTasks" SecurityButtonType="Read" EnableImageSprite="true"></telerik:RadMenuItem>
