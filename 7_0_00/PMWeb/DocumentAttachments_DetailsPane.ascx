    ...
    <div class="row" id="divImgDisplay" runat="server">
        <div class="col-12">
            <div style="padding: 0 40px">
                <asp:Image ID="imgDisplay" CssClass="imgDisplay" runat="server" Visible="false" />
            </div>
        </div>
    </div>
    <div class="row" visible="true">
        <div class="col-12" style="display: flex; justify-content: space-between">
            <asp:LinkButton ID="btnPMWebWordView" Visible="false" CssClass="Folder" runat="server" meta:resourcekey="btnView" OnClientClick="MergePrintPopupt()">
