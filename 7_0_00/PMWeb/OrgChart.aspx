...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH1" runat="server">
            ...
            function maintoolbarClick(Value) {
                switch (Value) {
                    ...
                    case 'ViewPMWebReports':
                        ...
                        break;
                    case 'Submit':
                        return OpenWorkflowSubmitPopup('RESOURCES_ORGCHART');
                        break;
                }
            }
    ...
    <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0" class="ToolBar SmallToolbar">
        <tr>
            <td class="ToolbarTd">
                <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=290">
                                    ...
                                    <Items>
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem Text="Submit" Value="Submit" onclick="OpenWorkflowSubmitPopup('RESOURCES_ORGCHART');" CssClass="Help" EnableImageSprite="true" ></telerik:RadMenuItem>
                                ...
                                <tr id="trProgram" runat="server">
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlPrograms" AllowCustomText="true" runat="server" AutoPostBack="true"
                                            ...
                                            ShowMoreResultsBox="True" OnItemsRequested="ddl_ItemsRequested" SkipValue="0"
                                ...
                                <tr id="trProject" runat="server">
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlProjects" Width="100%" UseProjectFilter="1" runat="server" meta:resourcekey="ddlProjects"
                                            ...
                                            ShowMoreResultsBox="True" EnableVirtualScrolling="True" OnItemsRequested="ddl_ItemsRequested" SkipValue="0">
