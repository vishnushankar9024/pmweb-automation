...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <table class="ToolBar SmallToolbar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=58">
            ...
            <td style="width: 240px !important;" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                <telerik:RadComboBox ID="ddlInventories" runat="server" OnClientTextChange="LOD_DropDownTextChange" Width="240px"
                    ...
                    EnableVirtualScrolling="True" OnItemsRequested="ddl_ItemsRequested" CausesValidation="False" AutoPostBack="False" DropDownCssClass="ToolbarDropdown">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlInventoryLocationType" runat="server" Filter="Contains"
                                            ...
                                            NoWrap="true" CausesValidation="False" AutoPostBack="False" EnableLoadOnDemand="true">
                                            <CollapseAnimation Type="OutQuint" Duration="150"></CollapseAnimation>
                                        </telerik:RadComboBox>
                                    </td>
                                </tr>
