        ...
        <tr  valign="top">
            <td valign="top">
                <table style="width: 100% !important;" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td class="ToolbarTd">
                            <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=195">
                        ...
                        <td style="width: 240px" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                            <telerik:RadComboBox ID="ddlScoring" runat="server" meta:resourcekey="ddlScoring" OnClientTextChange="LOD_DropDownTextChange" 
                                Skin="Default" Width="240px" AutoPostBack="True" NoWrap="True" AllowCustomText="True" EmptyMessage="Select a Scoring.."
                                CausesValidation="False" Height="400px" LoadingMessage="<%$ Resources:PMWeb, Loading %>" EnableVirtualScrolling="True"
                                ShowMoreResultsBox="True" EnableLoadOnDemand="true" CheckForDirt="True" OnItemsRequested="ddl_ItemsRequested" DropDownCssClass="ToolbarDropdown">
