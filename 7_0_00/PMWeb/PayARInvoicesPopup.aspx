<%@ Page meta:resourcekey="Page" Language="vb" AutoEventWireup="false" CodeBehind="PayARInvoicesPopup.aspx.vb" Inherits="Website.PayARInvoicesPopup" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="PMMainPage PMPopupMainPage documentSinglePage">
            ...
            <div class="row">
                <div class="col-12">
                     <telerik:RadGrid ID="rdgPayARInvoices" runat="server" AutoGenerateColumns="False" SetWidth="true" ClientSettings-Scrolling-AllowScroll="true" AppendMenus="true" FitPageHeightOffset="24"
                                    ...
                                    <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>" DataKeyNames="Id" CommandItemDisplay="Top"
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Program1" DataField="Program" HeaderStyle-Width="110px" ItemStyle-Wrap="false" UniqueName="Program" CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true" SortExpression="Program" GroupByExpression="Program [GridColumn_Program] Group By Program ASC">
                                                <ItemTemplate>
                                                    <span><%# IIf(Container.DataItem("Program").ToString = String.Empty, "&nbsp;", Container.DataItem("Program").ToString)%></span>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>

                                            <telerik:GridTemplateColumn ItemStyle-Wrap="false" DataField="Project" HeaderText="Project1" HeaderStyle-Width="110px" UniqueName="Project" CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true" SortExpression="Project" GroupByExpression="Project [GridColumn_Project] Group By Project ASC">
                                                <ItemTemplate>
                                                    <span><%# IIf(Container.DataItem("Project").ToString = String.Empty, "&nbsp;", Container.DataItem("Project").ToString)%></span>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>

                                            <telerik:GridTemplateColumn ItemStyle-Wrap="false" DataField="Company" HeaderText="Company1" HeaderStyle-Width="110px" UniqueName="Company" SortExpression="Company" CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true" GroupByExpression="Company [GridColumn_Company] Group By Company ASC">
                                                <ItemTemplate>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="RecordId1111" DataField="RecordId" ItemStyle-Wrap="false" UniqueName="RecordId" HeaderStyle-Width="110px" SortExpression="RecordId" CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true" GroupByExpression="RecordId [GridColumn_RecordId] Group By RecordId ASC">
                                                <ItemTemplate>
                                                    <span id="spnRecordId" runat="server"><%# IIf(Container.DataItem("RecordId") = 0, "&nbsp;", Container.DataItem("RecordId"))%></span>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>

                                            <telerik:GridTemplateColumn HeaderText="Description1" DataField="Description" ItemStyle-Wrap="false" UniqueName="Description" HeaderStyle-Width="110px" SortExpression="Description" CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true" GroupByExpression="Description [GridColumn_Description] Group By Description ASC">
                                                <ItemTemplate>
                                                    <span><%# IIf(Container.DataItem("Description") = String.Empty, "&nbsp;", Container.DataItem("Description"))%></span>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>

                                            <telerik:GridTemplateColumn HeaderText="Invoice #1" DataField="InvoiceNumber" ItemStyle-Wrap="false" UniqueName="InvoiceNumber" HeaderStyle-Width="110px" SortExpression="InvoiceNumber" CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true" GroupByExpression="InvoiceNumber [GridColumn_InvoiceNumber] Group By InvoiceNumber ASC">
                                                <ItemTemplate>
                                                    <span><%# IIf(Container.DataItem("InvoiceNumber") = String.Empty, "&nbsp;", Container.DataItem("InvoiceNumber"))%></span>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>

                                            <telerik:GridTemplateColumn HeaderText="Invoice Due1" DataField="InvoiceDue" ItemStyle-Wrap="false" UniqueName="InvoiceDue" HeaderStyle-Width="110px" SortExpression="InvoiceDue" CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true" GroupByExpression="InvoiceDue [GridColumn_InvoiceDue] Group By InvoiceDue ASC">
                                                <ItemTemplate>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Open Balance1" DataField="OpenBalance" ItemStyle-Wrap="false" UniqueName="OpenBalance" HeaderStyle-Width="110px" SortExpression="OpenBalance" CurrentFilterFunction="EqualTo" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true" GroupByExpression="OpenBalance [GridColumn_OpenBalance] Group By OpenBalance ASC">
                                                <ItemTemplate>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Paid In Full1" DataField="AppliedInFull" UniqueName="PaidInFull" HeaderStyle-Width="70px" CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true" ItemStyle-HorizontalAlign="Left" Groupable="false">
                                                <ItemTemplate>
