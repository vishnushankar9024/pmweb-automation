...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <table class="ToolBar SmallToolbar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr>
            <td class="ToolbarTd">
                <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=76">
            ...
            <td style="width: 240px" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                <telerik:RadComboBox ID="ddlRisks" runat="server" AllowCustomText="" EnableLoadOnDemand="true"
                    OnClientTextChange="LOD_DropDownTextChange" OnClientSelectedIndexChanging="MainDropDown_SelectedIndexChanging"
                    AutoPostBack="false" NoWrap="true" Height="400px" CausesValidation="False" Width="100%" ShowMoreResultsBox="True"
