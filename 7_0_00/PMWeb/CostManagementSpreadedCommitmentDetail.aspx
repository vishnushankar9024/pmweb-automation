<%@ Page Language="vb" meta:resourcekey="Page" Title="Commitment Projection" AutoEventWireup="false" CodeBehind="CostManagementSpreadedCommitmentDetail.aspx.vb" Inherits="Website.CostManagementSpreadedCommitmentDetail" %>
...
<body>
    <form id="form1" runat="server">
                    ...
                    <div class="col-4 col-4-left">
                        <table class="colTable">
                            ...
                            <tr>
                                ...
                                <td class="controlWidth">
                                    <telerik:RadComboBox ID="ddlFromPeriod" runat="server" Width="100%" Filter="Contains" AllowCustomText="true"
                ...
                <div class="col-12">
                    <div id="divGrid" style="padding-bottom: 24px;" runat="server">
                        <telerik:RadGrid ID="rdgBudgetCosts" runat="server" Skin="Default" ShowFooter="true" AllowFilteringByColumn="true" FilterType="HeaderContext" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true"
                            AutoGenerateColumns="False" ShowStatusBar="True" Font-Size="8px" PageSize="15" setwidth="true"
                            ...
                            <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Period" UniqueName="Period" DataField="Period">
                                        ...
                                        <ItemTemplate>
                                            <telerik:RadComboBox
                                                ID="ddlPeriods" runat="server" Height="200px" Skin="Default" Width="100%" DropDownWidth="150px"
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Description" ItemStyle-Wrap="false" SortExpression="Description" DataField="Description"
        ...
        <%#IIf(Container.DataItem("Description") = String.Empty, "&nbsp;", Container.DataItem("Description"))%>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Quantity" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Right"
        ...
        <%#FormatNumber(CDbl(Container.DataItem("Quantity")))%>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Unit Cost" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Right"
                                        SortExpression="UnitCost" UniqueName="UnitCost" DataField="UnitCost">
                                        <%--    <ItemTemplate>
        <%#FormatCurrency(CDbl(Container.DataItem("UnitCost")))%>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Total Cost" HeaderStyle-Width="80px" ItemStyle-HorizontalAlign="Right" DataField="TotalAmount"
                                        SortExpression="TotalAmount" UniqueName="TotalCost">
                                        <ItemTemplate>
