            ...
            <tr>
                <td align="left">
                    <telerik:radtoolbar id="mainToolBar" runat="server" skin="Default" autopostback="true" height="50px" width="100%" cssclass="popup-toolbar" onclientbuttonclicked="maintoolbarClick">
                        <Items>
                            <telerik:RadToolBarButton EnableImageSprite="true" Height="50px" CssClass="ToolbarSave" CommandName="Save" Value="Save"></telerik:RadToolBarButton>
                            <telerik:RadToolBarButton EnableImageSprite="true" Height="50px" CssClass="ToolbarSaveAndExit" CommandName="SaveAndExit" Value="SaveAndExit"></telerik:RadToolBarButton>
                            <telerik:RadToolBarButton EnableImageSprite="true" Height="50px" CssClass="ToolbarRemoveResources" CommandName="RemoveResources" Value="RemoveResources" Visible="false"></telerik:RadToolBarButton>
                                ...
                                <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>" DataKeyNames="IndexId" CommandItemDisplay="Top"
                                    ...
                                    <Columns>
                                        <telerik:GridTemplateColumn ItemStyle-Wrap="false" HeaderText="Resource" UniqueName="Resource" Groupable="false" HeaderStyle-Width="400px">
                                            <ItemTemplate>
                                                <span><%#IIf(Container.DataItem("Resource").ToString = String.Empty, "&nbsp;", IIf(Source <> "Schedules", Container.DataItem("Resource").ToString, Container.DataItem("Resource").ToString + " (Assigned to " + Container.DataItem("AssignedToCount").ToString + ")"))%></span>
                                            </ItemTemplate>
