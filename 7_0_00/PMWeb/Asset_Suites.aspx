...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH1" runat="server">
            ...
            function maintoolbarClick(Value) {
                ...
                switch (Value) {
                    ...
                    case 'New':
                        ...
                        break;
                    case 'Submit':
                        return OpenWorkflowSubmitPopup('ASSET_SUITES');
                        break;
    ...
    <table class="ToolBar LargeToolBar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=202">
                    ...
                    <Items>
                        ...
                        <telerik:RadToolBarSplitButton ImageUrl="Images/ToolBar/NewDoc.png" CommandName="New"
                            ...
                            <Buttons>
                                ...
                                <telerik:RadToolBarButton SecurityButtonType="Copy" CommandName="Copy" Value="CopyRecord" ImageUrl="Images/ToolBar/CopyRecord.png" ValidationGroup="Save"></telerik:RadToolBarButton>
                            </Buttons>
                        ...
                        <telerik:RadToolBarSplitButton ImageUrl="Images/ToolBar/Printer.png" CommandName="Print" SecurityButtonType="Read"
                            ...
                            <Buttons>
                                <telerik:RadToolBarButton PostBack="false" Width="170px" ImageUrl="Images/ToolBar/PMWebW.gif" CommandName="BIReporting"></telerik:RadToolBarButton>
                                    ...
                                    <Items>
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem Text="Submit" Value="Submit" onclick="OpenWorkflowSubmitPopup('ASSET_SUITES');" CssClass="Help" EnableImageSprite="true" ></telerik:RadMenuItem>
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvLocation" runat="server" ControlToValidate="ddlProperties"
                                            CssClass="Validator" InitialValue="" meta:resourcekey="rfvLocationRequired"
                                        ...
                                        <asp:CustomValidator ID="csvLocation" runat="server" ControlToValidate="ddlProperties"
                                            ...
                                            CssClass="Validator" meta:resourcekey="rfvLocationRequired">
                                        </asp:CustomValidator>
                                    </td>
                                </tr>
                                <tr>
