...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <table style="width: 100%;" cellpadding="0" cellspacing="0" class="ToolBar SmallToolbar">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=246">
                ...
                <div class="row row-6-5">
                    <div class="col-6">
                        <table class="colTable" style="width: 400px;">
                            <tr>
                                <td class="labelWidth">
                                    <asp:Label ID="lblMapID" Text="Map ID*" runat="server" meta:resourcekey="lblIDMap"></asp:Label>
                                </td>
                            ...
                            <tr>
                                <td class="labelWidth">
                                    <asp:Label ID="lblDescription" Text="Descriptio*n" runat="server" meta:resourcekey="lblDescriptionRequired"></asp:Label>
                                </td>
                                <td class="controlWidth">
                            ...
                            <tr>
                                <td class="labelWidth">
                                    <asp:Label ID="lblFrom" Text="From*" runat="server" meta:resourcekey="lblFromRequired"></asp:Label>
                                </td>
                                <td class="controlWidth">
                            ...
                            <tr>
                                <td class="labelWidth">
                                    <asp:Label ID="lblTo" Text="To*" runat="server" meta:resourcekey="lblToRequired"></asp:Label>
                                </td>
                                <td class="controlWidth">
