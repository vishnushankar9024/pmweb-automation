...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
            ...
            function maintoolbarClick(Value) {
                ...
                'location=no,status=0,menubar=0,addressbar=0,resizable=1,scrollbars=1,width=820,height=500,top=' + top + ',left=' + left);
                    ...
                    case 'New':
                        ...
                        break;
                    case 'Submit':
                        return OpenWorkflowSubmitPopup('RESERVATIONREQUEST');
                        break;
                    default:
    ...
    <table class="ToolBar SmallToolbar" style="width: 100%;" cellpadding="0" cellspacing="0">
                    <tr>
                        <td class="ToolbarTd">
                            <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=160">
                        ...
                        <td style="width: 240px !important;" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                            <telerik:RadComboBox ID="ddlreservation" runat="server" OnClientTextChange="LOD_DropDownTextChange" OnItemsRequested="ddl_ItemsRequested"
                                ...
                                EnableLoadOnDemand="true" ShowMoreResultsBox="True" OnClientSelectedIndexChanging="MainDropDown_SelectedIndexChanging" DropDownCssClass="ToolbarDropdown">
                            </telerik:RadComboBox>
                        </td>
                                                ...
                                                <Items>
                                                    <telerik:RadMenuItem CssClass="menuMore">
                                                        <Items>
                                                            ...
                                                            <telerik:RadMenuItem Text="Submit" Value="Submit" onclick="OpenWorkflowSubmitPopup('RESERVATIONREQUEST');" CssClass="Help" EnableImageSprite="true" ></telerik:RadMenuItem>
