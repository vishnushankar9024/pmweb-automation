...
<div class="PMHeader">
    ...
    PageSize="25" UseEditFormInMobile="true">
    ...
    <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
        ...
        <Columns>
            ...
            <telerik:GridTemplateColumn HeaderText="Amount" UniqueName="ThisAuthorization"
                SortExpression="ThisAuthorization" DataField="ThisAuthorization"
                GroupByExpression="ThisAuthorization [GridColumn_ThisAuthorization] Group By ThisAuthorization ASC">
                <ItemTemplate>
                    <%#FormatCurrency(Container.DataItem("ThisAuthorization"), CurrencyId:=Eval("CurrencyId"))%>
                </ItemTemplate>
                <HeaderStyle Width="70px"></HeaderStyle>
