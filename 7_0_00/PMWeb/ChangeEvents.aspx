...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function maintoolbarClick(Value) {
                ...
                + "&EntityId=" + '<%=PM.CostManagement.ChangeEventInfo.ProjectId%>' + "&EntityType=0", 890, 430, false);
                    ...
                    case 'Submit':
                        return OpenWorkflowSubmitPopup('CHANGEEVENT');
                        break;
    ...
    <table class="ToolBar SmallToolbar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr>
            <td class="ToolbarTd">
                <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=53">
                                    ...
                                    <Items>
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem Text="Submit" Value="Submit" onclick="OpenWorkflowSubmitPopup('CHANGEEVENT');" CssClass="Help" EnableImageSprite="true" ></telerik:RadMenuItem>
                        ...
                        <div class="col-4 col-4-left ">
                            ...
                            <table class="colTable">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlCauses" runat="server" Skin="Default" AllowCustomText="true"
                            ...
                            <fieldset style="width: 100%;" runat="server" id="fldsetRecap">
                                ...
                                <table class="colTable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="controlWidth">
                                            <asp:TextBox ID="txtDays" CssClass="Days" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </fieldset>
                            <fieldset style="width: 300px; text-align: left; display: none">
                                ...
                                <table class="colTable">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-left: 10px;">
                                            <asp:TextBox ID="txtCORDays" runat="server" CssClass="Days" Width="100%"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </fieldset>
