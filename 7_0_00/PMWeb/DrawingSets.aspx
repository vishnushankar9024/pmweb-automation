<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/PmMaster.Master"
    CodeBehind="DrawingSets.aspx.vb" Inherits="Website.DrawingSets" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<%@ Register Src="DrawingSetDetails.ascx" TagName="DrawingSetDetails" TagPrefix="uc1" %>
...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        <script type="text/javascript">
            ...
            function maintoolbarClick(Value) {
                var HasMergeTemplate = '<%= PM.Document.DrawingSetsInfo.HasMergeTemplate%>';
                var HasReports = '<%= PM.Document.DrawingSetsInfo.HasReports%>';
                var RecordDescription = '<%=JSEscape(PM.Document.DrawingSetsInfo.RecordDescription)%>';
                var Description = '<%=JSEscape(PM.Document.DrawingSetsInfo.Description)%>';
                var Id = '<%= PM.Document.DrawingSetsInfo.Id%>';
                var HasPMWebReports = '<%= PM.QueryBuilderPermissionController.HasReports("DrawingSets")%>';
                switch (Value) {
                    case 'ViewTemplates':
                        if (HasMergeTemplate == 'True') {
                            OpenPOPUp("MergeTemplatePopup.aspx?ObjectType=DrawingSets&Id=" +
                                '<%= PM.Document.DrawingSetsInfo.Id%>' + "&Description="
                            + Description
                            + "&RecordDescription=" + RecordDescription
                            + "&EntityId=" + '<%=PM.Document.DrawingSetsInfo.ProjectId%>' + "&EntityType=0", 1045, 515, false);
                        }
                        break;
                    case 'Notification':
                        if (Id == 0) break;
                        ...
                        OpenPOPUp("Notification.aspx?ObjectType=DrawingSets&Id=" +
                               '<%= PM.Document.DrawingSetsInfo.Id%>' + "&Description="
                            + Description
                            + "&RecordDescription=" + RecordDescription
                            + "&EntityId=" + '<%=PM.Document.DrawingSetsInfo.ProjectId%>' + "&EntityType=0", "Notification",
                'location=no,status=0,menubar=0,addressbar=0,resizable=1,scrollbars=1,width=820,height=500,top=' + top + ',left=' + left);
                        break;

                    case 'ViewReports':
                        if (HasReports == 'True') {
                            OpenPOPUp("ReportsPreviewPopup.aspx?ObjectType=DrawingSets&Id=" +
                                '<%= PM.Document.DrawingSetsInfo.Id%>'
                            + "&RecordDescription=" + RecordDescription
                            + "&EntityId=" + '<%=PM.Document.DrawingSetsInfo.ProjectId%>' + "&EntityType=0", 890, 430, false);
                        }
                        break;
                    ...
                    case 'ViewPMWebReports':
                        ...
                        if (HasPMWebReports == 'True' && Id > 0) {
                            OpenPOPUp("PMWebReports.aspx?ObjectType=DrawingSets&Id=" + Id
                        + "&EntityId=" + '<%=PM.Document.DrawingSetsInfo.ProjectId%>' + "&EntityType=0",
                    'welcome', 'location=0,status=0,menubar=1,addressbar=0,resizable=1,scrollbars=1,width=890,height=430,top=' + top + ',left=' + left);
                        }
                        break;

                    case 'Submit':
                        return OpenWorkflowSubmitPopup('DrawingSets');
                        break;
                    case 'New':
                        window.location = "DrawingSets.aspx";
                        break;
            ...
            function OpenTransmittalsPopup() {
                ...
                var wnd = window.radopen('TransmittalsPopup.aspx?ObjectType=DrawingSets&RecordId=' + Id + '&Description=' + Description);
                if (isMobileScreen()) {
    ...
    <telerik:RadAjaxManagerProxy ID="AjaxManagerProxy1" runat="server">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="mlpDrawingSets">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="mlpDrawingSets" LoadingPanelID="ldpPM" />
        ...
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="ddlPhase">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="txtDrawingSetsNum" LoadingPanelID="ldpPM" />
    ...
    <table class="ToolBar SmallToolbar meetingMinutesToolbar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=91">
            ...
            <td style="width: 240px" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                <telerik:RadComboBox ID="ddlDrawingSets" runat="server" OnClientTextChange="LOD_DropDownTextChange"
                    ...
                    ShowMoreResultsBox="True" EnableLoadOnDemand="true" meta:resourcekey="ddlDrawingSets"
                ...
                <telerik:RadToolBar ID="mainToolBar" runat="server" Skin="Default" AutoPostBack="True">
                    <Items>
                        ...
                        <telerik:RadToolBarButton SecurityButtonType="Edit" ImageUrl="Images/ToolBar/Save.png"
                            CommandName="Save" AccessKey="s" CausesValidation="true" ValidationGroup="Save">
                        </telerik:RadToolBarButton>
                        ...
                        <telerik:RadToolBarSplitButton ImageUrl="Images/ToolBar/NewDoc.png" CommandName="New"
                            ...
                            <Buttons>
                                <telerik:RadToolBarButton SecurityButtonType="Add" Width="150px" ImageUrl="Images/ToolBar/NewDoc.png"
                                    CommandName="New" PostBack="false" AccessKey="n" CausesValidation="false">
                                </telerik:RadToolBarButton>
                        ...
                        <telerik:RadToolBarButton SecurityButtonType="Add" Visible="false" CommandName="Generate" ImageUrl="Images/ToolBar/Generate.png">
                        </telerik:RadToolBarButton>
                                    ...
                                    <Items>
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem Text="Recent" Value="Recent" onclick="OpenRecentDocumentsPopup('DrawingSets');" CssClass="Help" EnableImageSprite="true" OuterCssClass="Recent"></telerik:RadMenuItem>
                                                <telerik:RadMenuItem Text="Submit" Value="Submit" onclick="OpenWorkflowSubmitPopup('DrawingSets');" CssClass="Help" EnableImageSprite="true" ></telerik:RadMenuItem>
    ...
    <telerik:RadTabStrip OnClientTabSelecting="onTabSelecting" ID="tbsDocument" SelectedIndex="0" CssClass="documentTabs"
        runat="server" MultiPageID="mlpDrawingSets" Skin="Default" Width="100%" EnableViewState="True"
        ScrollChildren="true" ScrollButtonsPosition="Left" CausesValidation="False">
        <Tabs>
    ...
    <telerik:RadMultiPage ID="mlpDrawingSets" runat="server" SelectedIndex="0" Width="100%" CssClass="documentMultiPages"
        RenderSelectedPageOnly="True">
        <telerik:RadPageView ID="pvHeader" runat="server" Selected="True">
            <telerik:RadAjaxPanel ID="RadAjaxPanel1" LoadingPanelID="ldpPM" runat="server" Width="100%" HorizontalAlign="NotSet" EnableAJAX="false">
                    ...
                    <div class="row">
                        <div class="col-4 col-4-left">
                            <table class="colTable">
                                ...
                                <tr>
                                    <td class="labelWidth">
                                        <asp:Label ID="lblDrawingSetNum" meta:resourcekey="lblDrawingSetNum" runat="server" Text="Set # *"></asp:Label>
                                    </td>
                                    <td class="controlWidth">
                                        <asp:TextBox ID="txtDrawingSetsNum" runat="server" MaxLength="13"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvRecordNumber" ControlToValidate="txtDrawingSetsNum" ValidationGroup="Save"
                                        ...
                                        <asp:Label ID="lblDrawingSetsNumUnique" meta:resourcekey="lblDrawingSetsNumUnique" runat="server" Text="<br>Set # should be unique by Project & Phase." CssClass="Validator" Visible="false"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="labelWidth">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <table id="tblStatus" runat="server" cellpadding="0" cellspacing="0" style="width: 100%">
                                            <tr>
                                                <td>
                                                ...
                                                <td style="width: 50px; padding-left: 8px; text-align: right">
                                                    <asp:TextBox ID="txtRevision" CssClass="PositiveInteger" Width="100%" runat="server" MaxLength="9"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <span runat="server" id="rmd_dtpDocumentDate" style="display: block">
                                            <telerik:RadDatePicker ID="dtpDocumentDate" runat="server" MinDate="1901-01-01"
                                                ...
                                                <DateInput ID="DateInput1" LabelCssClass="radLabelCss_Office2007" Skin="Default" Width="99%" ReadOnly="true" runat="server"></DateInput>
                                            </telerik:RadDatePicker>
                                        </span>
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlFromContact" runat="server" Width="100%" DropDownWidth="385px"
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlCSICode" runat="server" Filter="Contains" MarkFirstMatch="True"
                                            ...
                                            CausesValidation="False" Height="340px" meta:resourcekey="ddlCSICode"
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlCSIDivision" runat="server" Filter="Contains" MarkFirstMatch="True"
                                            Skin="Default" Width="100%" AutoPostBack="false" NoWrap="True" AllowCustomText="True"
                                            CausesValidation="False" Height="340px" meta:resourcekey="ddlCSIDivision"
                                            CloseDropDownOnBlur="true" EnableItemCaching="false"
                                            EnableLoadOnDemand="True" ShowMoreResultsBox="true" EnableVirtualScrolling="true"
                                ...
                                <%--<td align="right">
                                                    <asp:Button ID="btnGenerate" Visible="false"  runat="server" Text="Generate" />
                                                </td>--%>
                                <tr>
                                    <td class="labelWidth">
        ...
        <telerik:RadPageView ID="pvDetails" runat="server" CssClass="ShowInHeaderWhenFit Responsive">
            <uc1:DrawingSetDetails ID="DrawingSetDetails" runat="server" />
        </telerik:RadPageView>
