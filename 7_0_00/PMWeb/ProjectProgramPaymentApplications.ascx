<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ProjectProgramPaymentApplications.ascx.vb" Inherits="Website.ProjectProgramPaymentApplications" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<telerik:RadAjaxManagerProxy ID="RadAjaxManager1" runat="server">
    <AjaxSettings>
        <telerik:AjaxSetting AjaxControlID="tbsVerticalPayments">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="mlpPayments" LoadingPanelID="ldpPM" />
                <telerik:AjaxUpdatedControl ControlID="tbsVerticalPayments" />
                <telerik:AjaxUpdatedControl ControlID="rdgAPPaymentApplication" LoadingPanelID="ldpPM" />
                <telerik:AjaxUpdatedControl ControlID="rdgARPaymentApplication" LoadingPanelID="ldpPM" />
            </UpdatedControls>
        </telerik:AjaxSetting>
        <%--<telerik:AjaxSetting AjaxControlID="mlpPayments">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="mlpPayments" LoadingPanelID="ldpPM" />
                <telerik:AjaxUpdatedControl ControlID="tbsVerticalPayments" />
                <telerik:AjaxUpdatedControl ControlID="rdgAPPaymentApplication" LoadingPanelID="ldpPM" />
        ...
        <telerik:AjaxSetting AjaxControlID="tbsHorizontalPayments">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="mlpPayments" LoadingPanelID="ldpPM" />
                <telerik:AjaxUpdatedControl ControlID="tbsHorizontalPayments" />
                <telerik:AjaxUpdatedControl ControlID="rdgAPPaymentApplication" LoadingPanelID="ldpPM" />
                <telerik:AjaxUpdatedControl ControlID="rdgARPaymentApplication" LoadingPanelID="ldpPM" />
            </UpdatedControls>
        </telerik:AjaxSetting>
    ...
    <AjaxSettings>
        <telerik:AjaxSetting AjaxControlID="rdgARPaymentApplication">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="rdgARPaymentApplication" LoadingPanelID="ldpPM" />
            </UpdatedControls>
        </telerik:AjaxSetting>
...
<div class="PMHeader" style="padding-top: 0px">
    <div class="row">
        <div class="col-2">
            <telerik:RadTabStrip ID="tbsVerticalPayments" CssClass="tbsSpecPC tbsFolderManagerSpecs tbsDocSpec" Height="100%" 
                runat="server" Skin="Default" Orientation="VerticalLeft" Width="100%" MultiPageID="mlpPayments"
                EnableViewState="True" ScrollChildren="true" ScrollButtonsPosition="Left" CausesValidation="False">
                <Tabs>
                    <telerik:RadTab Text="ApPayments1" Value="ApPayments" Selected="true" meta:resourcekey="lblApPayments"></telerik:RadTab>
                    <telerik:RadTab Text="ArPayments2" Value="ArPayments" meta:resourcekey="lblArPayments"/>
                </Tabs>
            </telerik:RadTabStrip>
            <telerik:RadTabStrip ID="tbsHorizontalPayments"  
                runat="server" Skin="Default"  ScrollButtonsPosition="Left" CssClass="tbshorizantaltabs"
                EnableViewState="True" ScrollChildren="true"  CausesValidation="False" MultiPageID="mlpPayments">
                <Tabs>
                    <telerik:RadTab Text="ApPayments1" Value="ApPayments" Selected="true" meta:resourcekey="lblApPayments"></telerik:RadTab>
                    <telerik:RadTab Text="ArPayments2" Value="ArPayments" meta:resourcekey="lblArPayments"/>
                </Tabs>
        ...
        <div class="col-10 SpecificationPadding">
            <telerik:RadMultiPage ID="mlpPayments" runat="server" SelectedIndex="0" Width="100%" RenderSelectedPageOnly="True" BorderWidth="0">
                <telerik:RadPageView ID="pvApPayments" runat="server" Selected="True">
                    <telerik:RadGrid ID="rdgAPPaymentApplication" Width="100%" runat="server" AutoGenerateColumns="False" ShowFooter="true" UseEditFormInMobile="true"
                        AllowPaging="True" PageSize="20" HeaderStyle-Font-Size="8" AllowMultiRowEdit="true" AllowMultiRowSelection="true" ShowGroupPanel="True"
                        AllowFilteringByColumn="true" AllowSorting="true" FilterType="HeaderContext" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true">
                        ...
                        <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>" DataKeyNames="Id" CommandItemDisplay="Top" Width="100%" TableLayout="Fixed" InsertItemDisplay="Top"
                            ...
                            <Columns>
                                ...
                                <telerik:GridTemplateColumn HeaderStyle-Width="110px" UniqueName="RecordNumber" ItemStyle-Wrap="false" HeaderText="ID" Groupable="true" Reorderable="true" DataField="RecordNumber"
                                ...
                                <telerik:GridTemplateColumn HeaderStyle-Width="110px" DataField="Status" UniqueName="Status" ItemStyle-Wrap="false" HeaderText="Status" Groupable="true" Reorderable="true"
                                    ...
                                    <EditItemTemplate>
                                        <div style="width: 100%; white-space: nowrap">
                                            ...
                                            <asp:LinkButton runat="server" ID="imgfilter" CssClass="SearchButton"
                                                OnClientClick="return OpenCompanyFilterPopupProjectNotRequired(this.id.replace('imgfilter','HiddenField1'),this.id.replace('imgfilter','ddlCompanies'),'Companies')">
                                ...
                                <telerik:GridTemplateColumn HeaderStyle-Width="110px" DataField="CostCode" UniqueName="CostCode" ItemStyle-Wrap="false" HeaderText="Cost Code" Groupable="true" Reorderable="true"
                                    ...
                                    <EditItemTemplate>
                                        <telerik:RadComboBox ID="ddlCostCode" runat="server" Width="100%"
                                ...
                                <telerik:GridTemplateColumn HeaderStyle-Width="70px" DataField="AppliedInFull" DataType="System.Boolean" ItemStyle-Wrap="false" HeaderText="Applied In Full" UniqueName="AppliedInFull" SortExpression="AppliedInFull" GroupByExpression="AppliedInFull [GridColumn_AppliedInFull] Group By AppliedInFull ASC">
                                    ...
                                    <EditItemTemplate>
                                        <asp:CheckBox ID="chbAppliedInFull" runat="server" />
                                    </EditItemTemplate>
                            ...
                            <CommandItemTemplate>
                                <div style="padding: 2px">
                                    ...
                                    <asp:LinkButton ID="btnApplyPayments" runat="server" CausesValidation="False" SecurityButtonType="ItemMode_Add" CssClass="GridCmdApplyPayments"
                                        CommandName="ApplyPayments" OnClientClick="return OpenApplyAPPaymentsPopup();"
                ...
                <telerik:RadPageView ID="pvArPayments" runat="server">
                    <telerik:RadGrid ID="rdgARPaymentApplication" Width="100%" runat="server" AutoGenerateColumns="False" ShowFooter="true" AllowPaging="True" PageSize="20"
                        HeaderStyle-Font-Size="8" AllowMultiRowEdit="true" AllowMultiRowSelection="true" ShowGroupPanel="True" AllowFilteringByColumn="true"
                        AllowSorting="true" FilterType="HeaderContext" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true" UseEditFormInMobile="true">
                        <PagerStyle Mode="NextPrevAndNumeric" AlwaysVisible="true" />
                        <GroupPanel Text="Group by"></GroupPanel>
                        ...
                        <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>" DataKeyNames="Id" CommandItemDisplay="Top" Width="100%" TableLayout="Fixed" InsertItemDisplay="Top"
                            ...
                            <CommandItemTemplate>
                                <div style="padding: 2px">
                                    <asp:LinkButton ID="btnSave" runat="server" CommandName="PerformInsert" CausesValidation="false" CssClass="GridCmdPerformInsert"
                                        SecurityButtonType="AddEditMode_Add" Visible='<%# rdgARPaymentApplication.MasterTableView.IsItemInserted %>'>
                                        <span class="Icon"></span>
                                        <asp:Label ID="lblSave" runat="server"></asp:Label>
                                        &nbsp;&nbsp;
                                    </asp:LinkButton>
                                    <asp:LinkButton ID="btnCancel" runat="server" CausesValidation="False" CommandName="CancelAll" CssClass="GridCmdCancelAll"
                                        SecurityButtonType="AddEditMode" Visible='<%#  rdgARPaymentApplication.MasterTableView.IsItemInserted %>'>
                                        <span class="Icon"></span>
                                        <asp:Label ID="lblCancel" runat="server"></asp:Label>
                                        &nbsp;&nbsp;
                                    </asp:LinkButton>
                                    <asp:LinkButton ID="btnAdd" runat="server" CausesValidation="False" CommandName="InitNewRow" CssClass="GridCmdInitNewRow"
                                        SecurityButtonType="ItemMode_Add" Visible='<%#  (Not rdgARPaymentApplication.MasterTableView.IsItemInserted) %>'>
                                        <span class="Icon"></span>
                                        <asp:Label ID="lblAddLine" runat="server"></asp:Label>
                                        &nbsp;&nbsp;
                                    </asp:LinkButton>
                                    <asp:LinkButton ID="btnApplyPayments" runat="server" CausesValidation="False" SecurityButtonType="ItemMode_Add" CssClass="GridCmdApplyPayments"
                                        CommandName="ApplyPayments" OnClientClick="return OpenApplyARPaymentsPopup();"
                                        Visible='<%# rdgARPaymentApplication.EditIndexes.Count = 0 AND (Not rdgARPaymentApplication.MasterTableView.IsItemInserted) %>' meta:resourcekey="btnApplyPayments">
                                        <span class="Icon"></span>
                                        <asp:Label ID="Label4" runat="server" meta:resourcekey="lblApplyPaymentsResource1" Text="Apply Payments"></asp:Label>
                                        &nbsp;&nbsp;
                                    </asp:LinkButton>
                                    <asp:LinkButton ID="btnRefresh" runat="server" CausesValidation="False" CommandName="RebindGrid" CssClass="GridCmdRebindGrid"
                                        Visible='<%#  (Not rdgARPaymentApplication.MasterTableView.IsItemInserted) %>'
                                        meta:resourcekey="btnRefreshResource1" SecurityButtonType="ItemMode">
                                        <span class="Icon"></span>
                                        <asp:Label ID="lblRefresh" runat="server" Text="Refresh" meta:resourcekey="lblRefreshResource1"></asp:Label>
                                        &nbsp;&nbsp;
...
<%--<table cellpadding="0" cellspacing="0" width="100%">
    <tr>
        <td>
            <fieldset id="fldAPPayments" runat="server">
                <legend>
                    <asp:Label ID="lblApPayments" runat="server" meta:resourcekey="lblApPayments" Text="A/P Payments" Style="margin-left: 10px;"></asp:Label></legend>
    ...
    <tr>
        <td>
            <fieldset id="fldARPayments" runat="server">
                <legend>
                    <asp:Label ID="lblArPayments" runat="server" meta:resourcekey="lblArPayments" Text="A/R Payments" Style="margin-left: 10px;"></asp:Label></legend>
