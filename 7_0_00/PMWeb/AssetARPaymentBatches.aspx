...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH1" runat="server">
            ...
            function maintoolbarClick(Value) {
                ...
                switch (Value) {
                    ...
                    case 'New':
                        ...
                        break;
                    case 'Submit':
                        return OpenWorkflowSubmitPopup('ARTENANTPAYMENTBATCHES');
                        break;
                    default:
                        break;
                }
    ...
    <table class="ToolBar SmallToolbar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=218">
                                    ...
                                    <Items>
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem Text="Submit" Value="Submit" onclick="OpenWorkflowSubmitPopup('ARTENANTPAYMENTBATCHES');" CssClass="Help" EnableImageSprite="true" ></telerik:RadMenuItem>
