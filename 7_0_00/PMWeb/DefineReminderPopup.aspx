...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function SetControlColor(Id,DateType) {
      
            var control = $(window.parent.document).find("input[id$=" + Id + "_dateInput]");
            if (control.length == 0) {
                var control = $(window.parent.document).find("input[id$=" + Id +"]");
            }
            if (DateType=="Future") {                   
                control.css("background-color", "#CCFFCC");
                control.hover(function () { $(this).css("background-color", "#CCFFCC"); }, function () { $(this).css("background-color", "#CCFFCC"); });
                control.focus(function () { $(this).css("background-color", "#CCFFCC"); });
                control.blur(function () { $(this).css("background-color", "#CCFFCC"); });
            } else {
                control.css("background-color", "#ffffff");
                control.hover(function () { $(this).css("background-color", "#ffffff"); }, function () { $(this).css("background-color", "#ffffff"); });
                control.focus(function () { $(this).css("background-color", "#ffffff"); });
                control.blur(function () { $(this).css("background-color", "#ffffff"); });
                }
            }
                ...
                <td class="ToolbarTd">
                    <telerik:RadToolBar ID="mainToolBar" OnClientButtonClicked="clickOnToolbar" runat="server" Skin="Default" AutoPostBack="true"
                        ...
                        <Items>
                            ...
                            <telerik:RadToolBarButton CommandName="Cancel" EnableImageSprite="true" PostBack="false" CssClass="ToolbarCancel">
                            </telerik:RadToolBarButton>
                        </Items>
                    </telerik:RadToolBar>
                </td>
                ...
                <div class="row">
                        ...
                        <fieldset>
                            ...
                            <table class="colTable">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <div style="width: 100%; min-height: 70px;overflow-x:auto; padding-right: 2px; box-sizing: border-box;"
                    ...
                    <div class="col-4 col-4-right">
                        ...
                        <asp:Button ID="btnCheckReminderDate" runat="server" CssClass="Hide"
                            Text="" />
                      <telerik:RadDatePicker runat="server" CssClass="Hide" ID="RadDatePicker"> </telerik:RadDatePicker>
                    </div>
                </div>
            </div>
