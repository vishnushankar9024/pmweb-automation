<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/PmMaster.Master" CodeBehind="CostManagementARPayments.aspx.vb" Inherits="Website.CostManagementARPayments" %>
...
<%@ Register Src="~/CostManagementARPaymentLedger.ascx" TagName="ARPaymentLedger" TagPrefix="uc2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        ...
        <script type="text/javascript">
            ...
            function OpenPreviewConversion() {
                var RecordCurrencyId = '<%=PM.CostManagement.ARPaymentsInfo.CurrencyId%>';
                return OpenPOPUp("ConversionRatePopup.aspx?ObjectType=ARPayments&Id=" +
                                     '<%= PM.CostManagement.ARPaymentsInfo.Id%>'
                          + "&ProjectId=" + '<%=PM.CostManagement.ARPaymentsInfo.ProjectId%>' + "&RecordCurrencyId=" + RecordCurrencyId, 920, 415, false);
            }
            ...
            function maintoolbarClick(Value) {
                ...
                var HasMergeTemplate = '<%= PM.CostManagement.ARPaymentsInfo.HasMergeTemplate%>';
                var RecordDescription = '<%=JSEscape(PM.CostManagement.ARPaymentsInfo.RecordNumber & " - " & PM.CostManagement.ARPaymentsInfo.Description)%>';
                var Description = '<%=JSEscape(PM.CostManagement.ARPaymentsInfo.Description)%>';
                var Id = '<%= PM.CostManagement.ARPaymentsInfo.Id%>';
                var HasPMWebReports = '<%= PM.QueryBuilderPermissionController.HasReports("ARPayments")%>';
                var HasReports = '<%= PM.CostManagement.ARPaymentsInfo.HasReports%>';
                switch (Value) {
                    case 'Notification':
                        if (Id == 0) break;
                        var left = (screen.width - 900) / 2;
                        var top = (screen.height - 500) / 2;
                        OpenPOPUp("Notification.aspx?ObjectType=ARPayments&Id=" +
                     '<%= PM.CostManagement.ARPaymentsInfo.Id%>' + "&Description="
                            + Description
                            + "&RecordDescription=" + RecordDescription
                            + "&EntityId=" + '<%=PM.CostManagement.ARPaymentsInfo.ProjectId%>' + "&EntityType=0", "Notification",
                'location=no,status=0,menubar=0,addressbar=0,resizable=1,scrollbars=1,width=820,height=500,top=' + top + ',left=' + left, 1045, 515, false);
                    ...
                    case 'ViewTemplates':
                        if (HasMergeTemplate == 'True') {
                            OpenPOPUp("MergeTemplatePopup.aspx?ObjectType=ARPayments&Id=" +
                                '<%= PM.CostManagement.ARPaymentsInfo.Id%>' + "&Description="
                            + Description
                            + "&RecordDescription=" + RecordDescription
                            + "&EntityId=" + '<%=PM.CostManagement.ARPaymentsInfo.ProjectId%>' + "&EntityType=0", 1045, 515, false);
                        }
                        break;
                    ...
                    case 'ViewPMWebReports':
                        ...
                        if (HasPMWebReports == 'True' && Id > 0) {
                            OpenPOPUp("PMWebReports.aspx?ObjectType=ARPayments&Id=" + Id
                            + "&EntityId=" + '<%=PM.CostManagement.ARPaymentsInfo.ProjectId%>' + "&EntityType=0",
                    ...
                    case 'ViewReports':
                        if (HasReports == 'True') {
                            OpenPOPUp("ReportsPreviewPopup.aspx?ObjectType=ARPayments&Id=" +
                                '<%= PM.CostManagement.ARPaymentsInfo.Id%>'
                            + "&RecordDescription=" + RecordDescription
                            + "&EntityId=" + '<%=PM.CostManagement.ARPaymentsInfo.ProjectId%>' + "&EntityType=0", 890, 430, false);
                        }
                        break;
                    ...
                    case 'New':
                        window.location = "CostManagementARPayments.aspx";
                        break;

                    case 'Submit':
                        return OpenWorkflowSubmitPopup('ARPayments');
                        break;
    ...
    <telerik:RadAjaxManagerProxy ID="AjaxManagerProxy1" runat="server">
        <AjaxSettings>  
            <telerik:AjaxSetting AjaxControlID="mlpARPayment">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="mlpARPayment" LoadingPanelID="ldpPM" />
    ...
    <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0">
        <tr class="ToolBar SmallToolbar">
            <td class="ToolbarTd">
                <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=201">
            ...
            <td style="width: 240px !important;" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                <telerik:RadComboBox ID="ddlARPayments" runat="server" AllowCustomText="true" Skin="Default"
                    Height="250px" OnClientTextChange="LOD_DropDownTextChange" EmptyMessage="Select a Payment..." OnClientSelectedIndexChanging="MainDropDown_SelectedIndexChanging"
                    Width="240px" AutoPostBack="false" NoWrap="true" CausesValidation="False" meta:Resourcekey="ddlARPayments"
                                    ...
                                    <Items>
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem Text="Recent" Value="Recent" onclick="OpenRecentDocumentsPopup('ARPayments');" CssClass="Help" EnableImageSprite="true" OuterCssClass="Recent"></telerik:RadMenuItem>
                                                <telerik:RadMenuItem Text="Submit" Value="Submit" onclick="OpenWorkflowSubmitPopup('ARPayments');" CssClass="Help" EnableImageSprite="true" ></telerik:RadMenuItem>
    ...
    <telerik:RadTabStrip ID="tbsDocument" SelectedIndex="1" OnClientTabSelecting="onTabSelecting" ScrollChildren="true" ScrollButtonsPosition="Left" CssClass="documentTabs"
        runat="server" MultiPageID="mlpARPayment" Skin="Default"
    ...
    <telerik:RadMultiPage ID="mlpARPayment" runat="server" SelectedIndex="0" Width="100%" RenderSelectedPageOnly="true" CssClass="documentMultiPages">
                    ...
                    <div class="row JustifyContent R3Cols">
                        <div class="col-4 col-4-left">
                            <table class="colTable">
                                ...
                                <tr>
                                    <td class="labelWidth">
                                        <asp:HyperLink runat="server" CssClass="Link" ID="hliARContract" meta:Resourcekey="lblARContract" Text="Contract"></asp:HyperLink>
                                    </td>
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlARContract" Filter="Contains" MarkFirstMatch="true" AllowCustomText="true"
                                            runat="server" AutoPostBack="true" Skin="Default" NoWrap="true" Width="100%"
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvContract" runat="server" ControlToValidate="ddlARContract"
                                        ...
                                        <asp:CustomValidator ID="csvContract" runat="server" ControlToValidate="ddlARContract"
                                ...
                                <tr>
                                    <td class="labelWidth">
                                        <asp:HyperLink runat="server" CssClass="Link" ID="hliRequisition" meta:Resourcekey="lblRequisition" Text="Requisition"></asp:HyperLink>
                                    </td>
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlRequisition" Filter="Contains" MarkFirstMatch="true" AllowCustomText="true"
                                            runat="server" AutoPostBack="true" Skin="Default" NoWrap="true" Width="100%"
                                            Height="200px" ShowMoreResultsBox="True" OnItemsRequested="ddl_ItemsRequested" EnableVirtualScrolling="True" EnableLoadOnDemand="true">
                                        </telerik:RadComboBox>
                                        <asp:RequiredFieldValidator ID="rfvRequisition" runat="server" ControlToValidate="ddlRequisition"
                                            CssClass="Validator" InitialValue="" ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>" ValidationGroup="Save"
                                            Display="Dynamic" ForeColor="" Visible="false"></asp:RequiredFieldValidator>
                                        <asp:CustomValidator ID="csvRequisition" runat="server" ControlToValidate="ddlRequisition"
                                            ClientValidationFunction="ValidateCombo" Display="Dynamic" ValidationGroup="Save"
                                            CssClass="Validator" Visible="false" ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>">
                                        </asp:CustomValidator>
                                    </td>
                                    ...
                                    <td class="labelWidth">
                                        ...
                                        <div style="float: right">
                                            ...
                                            <asp:LinkButton runat="server" ID="imgfilter1" CssClass="SearchButton"
                                                OnClientClick="return OpenCompanyFilterPopupProjectNotRequired1(this.id.replace('imgfilter1','HiddenField1'),this.id.replace('imgfilter1','ddlCompanies'),'Companies')">
                                                                            <span class="Icon"></span>
                                            </asp:LinkButton>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlType" CausesValidation="False" AutoPostBack="false" AllowCustomText="true" Filter="Contains" runat="server" Width="100%" Skin="Default"></telerik:RadComboBox>
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth chkBox">
                                        <%-- <asp:CheckBox ID="" runat="server" ClientIDMode="Static"  />--%>
                                        <input type="checkbox" runat="server" id="chkAppliedInFull" clientidmode="Static" />
                        ...
                        <div class="col-4 col-4-middle">
                            ...
                            <table runat="server" id="tblmain" class="colTable">
                                ...
                                <tr>
                                    <td class="labelWidth">
                                        <asp:HyperLink ID="hplCostCode" runat="server" meta:Resourcekey="lblCostCode" CssClass="Link"></asp:HyperLink>
                                    </td>
                                    <td class="controlWidth">
        ...
        <telerik:RadPageView ID="pvLedger" runat="server" CssClass="ShowInHeaderWhenFit Responsive">
            <uc2:ARPaymentLedger ID="ARPaymentLedger1" runat="server" />
        </telerik:RadPageView>
