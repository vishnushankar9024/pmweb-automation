...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
	<!--<link rel="stylesheet" href="https://kendo.cdn.telerik.com/2024.4.1112/styles/kendo.default-v2.min.css" />
    <script src="https://code.jquery.com/jquery-3.7.0.min.js"></script>
    <script src="https://kendo.cdn.telerik.com/2024.4.1112/js/kendo.all.min.js"></script> -->
	
	<!--<link rel="stylesheet" href="https://kendo.cdn.telerik.com/2024.4.1112/styles/kendo.default-v2.min.css" />-->
			<!--<script src="https://code.jquery.com/jquery-3.7.0.min.js"></script>		
		<script src="Custom/Js/kendo-ui-license.js"></script>		
        <script src="Custom/Js/Kendo/js/kendo.all.min.js"></script> -->
		<!--<script src="https://code.jquery.com/jquery-3.7.0.min.js"></script>
   ...
   document.addEventListener("DOMContentLoaded", function () {
    ...
    if (submitBIDButton) {
        ...
        newButton.innerHTML = 'Bidder URL'; // Define the content of the new button
        ...
        <script type="text/javascript">
            function GenerateCounter() {
                ...
                if (hdnCounterSeconds.value != "") {
                    //  var myDate = new Date(hdnBidDueYear.value, hdnBidDueMonth.value - 1, hdnBidueDay.value, hdnBidDueHours.value, hdnBidDueMinute.value);
...
iframe {
    ...
    <table style="width: 100%;" cellpadding="0" cellspacing="0" class="ToolBar LargeToolBar">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=95">
            ...
            <td style="width: 240px" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                <telerik:RadComboBox ID="ddlBidders" runat="server" Filter="Contains" MarkFirstMatch="true" meta:resourcekey="ddlBidders"
                    Skin="Metro" AllowCustomText="true" EmptyMessage="Select Bid..." OnClientSelectedIndexChanging="MainDropDown_SelectedIndexChanging"
            ...
            <td valign="middle" style="vertical-align: middle;" class="ToolbarTd">
                <telerik:RadToolBar ID="mainToolBar" runat="server" AutoPostBack="true" OnClientButtonClicked="click_handler">
                    <Items>
                        ...
                        <%--                                    <telerik:RadToolBarButton SecurityButtonType="Read" CommandName="Search" ImageUrl="Images/ToolBar/lookup.png" Value="Search" NavigateUrl="SearchDocument.aspx?O=95" CausesValidation="false"></telerik:RadToolBarButton>--%>
                        ...
                        <telerik:RadToolBarButton Value="chklock" ToolTip="Lock" CommandName="IsLocked" ImageUrl="Images/ToolBar/Active.png">
                        </telerik:RadToolBarButton>
                        <telerik:RadToolBarButton PostBack="false" CommandName="MobileMenu" Value="MobileMenu" Text="More" ImageUrl="Images/ToolBar/PMWebW.gif" ToolTip="moremenu">
                            <ItemTemplate>
                        ...
                        <div class="col-4 col-4-left">
                            <table class="colTable" id="tblInfo">
								...
								<td class="labelWidth">
									...
									<asp:LinkButton runat="server" CssClass="Link" ID="lblCustomUrl" OnClientClick="return ebConfirm(this, event, 'click');" oncontextmenu="handleRightClick(this, event)" Text="Bidder URL"></asp:LinkButton>
								</td>
								<td class="controlWidth">
...
<div id="kendoPopupWindow" style="display:none;">
    <iframe id="kendoPopupIframe" src="" frameborder="0" style="width:100%; height:100%;"></iframe>
</div>
