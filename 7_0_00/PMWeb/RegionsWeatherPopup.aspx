<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="RegionsWeatherPopup.aspx.vb" Inherits="Website.RegionsWeatherPopup" %>
                                    ...
                                    <tr>
                                        <td>
                                            <telerik:RadGrid ID="rdgRegionsWeather" AllowMultiRowSelection="true" runat="server" SetWidth="true" ClientSettings-Scrolling-AllowScroll="true"
                                                HeaderStyle-Font-Size="8" Width="100%" Height="190px" AutoGenerateColumns="False"  FitPageHeightOffset="5"
                                                AllowSorting="true" AllowMultiRowEdit="true" ShowStatusBar="true">
