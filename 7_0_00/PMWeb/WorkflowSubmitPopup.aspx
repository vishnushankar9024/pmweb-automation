                                    ...
                                    <table class="TableNoSpacingNoBorder" style="width: 100%; height:calc(100vh - 374px);">
                                        <tr>
                                            <td id="tdUploadOption" runat="server" class="rutd">
                                                <telerik:RadAsyncUpload runat="server" CssClass="BigUpload viewAttachmentUpload" Skin="Default" ID="rauAttachment" OnClientFileUploadFailed="onDocFileUploadFailed" Style="height: 50px !important; box-sizing: border-box"
