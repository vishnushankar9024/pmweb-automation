...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <table class="ToolBar LargeToolBar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=49">
                                    ...
                                    <Items>
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                ...
                                                <%--<telerik:RadMenuItem EnableImageSprite="true" Text="Submit" Value="Submit" onclick="OpenWorkflowSubmitPopup('ASSET_TENANTREQUEST');" CssClass="Submit" PostBack="true"></telerik:RadMenuItem>--%>
