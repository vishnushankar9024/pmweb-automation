        ...
        <script type="text/javascript">
            ...
            function UpdateUserColor(sender) {
                ...
                $.ajax({
                    ...
                    data: "{'Color':'" + sender.get_selectedColor() + "'}",
                    dataType: "json",
                    async: true
                });
            ...
            function clickAddAssetButton(wnd) {
                ...
                function ConfirmUpdateAsset() {
                    ...
                    //return
                    //confirm('If you continue condition data from this record will be copied to all linked assets.\n This process cannot be undone.' + '\n' + '\n' + 'Do you wish to continue? ');
                }
        ...
        <tr valign="top">
            <td valign="top">
                <table style="width: 100% !important;" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td class="ToolbarTd">
                            <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=294">
                     ...
                     <asp:Button runat="server" ID="" CssClass="lnkButtonBar ToolbarNew HideOnMobileToolbar" OnClientClick="return ConfirmUpdateAsset();" Text="Update Asset"></asp:Button>
                            </div>--%>
                        </td>
