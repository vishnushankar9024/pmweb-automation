...
<telerik:RadAjaxManagerProxy ID="RadAjaxManagerProx1" runat="server">
  <AjaxSettings>
        <telerik:AjaxSetting AjaxControlID="fldContacts">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="fldContacts" LoadingPanelID="ldpPM"/>
            </UpdatedControls>                    
        </telerik:AjaxSetting>
...
<div id="divContacts">
<fieldset style="width:100%;" runat="server" id="fldContacts">
