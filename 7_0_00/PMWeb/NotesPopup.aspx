...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetText() {
            var txtNotes = window.parent.$("[id$=" + querySt('txtNotesId') + "]")[0];
            if (txtNotes != null) {
                var currenttxtNotes = document.getElementById('txtNotes')
...
<body>
    ...
    <asp:LinkButton runat="server" CssClass="closepopup closesize" ID="btnCloseProfilePopup" OnClientClick="window.close()">
        ...
        <div class="PMMainPage PMPopupMainPage documentSinglePage" style="margin-bottom: 0 !important;" runat="server" id="divNotes">
            <div class="row">
                <div class="col-12">
