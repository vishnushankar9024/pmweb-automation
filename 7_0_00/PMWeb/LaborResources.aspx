...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <table class="ToolBar SmallToolbar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=283">
                        ...
                        <telerik:RadToolBarSplitButton ImageUrl="Images/ToolBar/NewDoc.png" CommandName="New"
                            ...
                            <Buttons>
                                ...
                                <telerik:RadToolBarButton SecurityButtonType="Copy" PostBack="true" CommandName="Copy" Width="150px"
                                    ImageUrl="Images/ToolBar/Revision.png"  ValidationGroup="Save">
                                </telerik:RadToolBarButton>
                            </Buttons>
                        ...
                        <div class="col-4 col-4-left">
                            <table class="colTable">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlClassifications" runat="server" Height="200px" Skin="Default" Width="100%"
                                            CloseDropDownOnBlur="true" meta:resourcekey="ddlClassifications" NoWrap="False" OnClientLoad="loadText">
                                            <HeaderTemplate>
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlPayTypes" runat="server" Height="200px" Skin="Default" Width="100%"
                                            CloseDropDownOnBlur="true" meta:resourcekey="ddlPayTypes" NoWrap="False" OnClientLoad="loadPayTypeText">
                                            <HeaderTemplate>
                                                <table style="width: 235px" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td style="width: 50px;">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <asp:TextBox ID="txtDefaultCost" MaxLength="500" runat="server" CssClass="Currency"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="labelWidth">
                        ...
                        <div class="col-4 col-4-middle">
                            <table class="colTable">
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                         <span runat="server" id="rmd_dtpHireDate" style="display: block">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                         <span runat="server" id="rmd_dtpTerminatonDate" style="display: block">
