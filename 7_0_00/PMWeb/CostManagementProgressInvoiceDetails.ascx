    ...
    <div class="row">
        <div class="col-12 ResponsiveMargin">
            <telerik:RadGrid ID="rdg1" AllowMultiRowSelection="true" runat="server" ShowGroupPanel="true"
                ...
                PageSize="10" AllowFilteringByColumn="true" FilterType="HeaderContext" EnableHeaderContextMenu="true"
                ...
                <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
                    ...
                    <span class="Icon"></span>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Location" GroupByExpression="Location [GridColumn_Location] Group By Location ASC"
                            ...
                            <EditItemTemplate>
                                <telerik:radcombobox ID="ddlLocation" runat="server" Width="100%" AllowCustomText="true">
                                </telerik:radcombobox>
                            </EditItemTemplate>
