<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/PmMaster.Master" CodeBehind="CostManagementARPaymentBatches.aspx.vb" Inherits="Website.CostManagementARPaymentBatches" %>

<%@ Register Src="CostManagementARPaymentBatchesDetails.ascx" TagName="CostManagementARPaymentBatchesDetails" TagPrefix="uc1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        ...
        <script type="text/javascript">
            ...
            function OpenPreviewConversion() {
                var RecordCurrencyId = '<%=PM.CostManagement.ARPaymentBatchesInfo.CurrencyId%>';
                return OpenPOPUp("ConversionRatePopup.aspx?ObjectType=ARPaymentBatches&Id=" +
                                    '<%= PM.CostManagement.ARPaymentBatchesInfo.Id%>'
                          + "&ProjectId=" + '<%=PM.CostManagement.ARPaymentBatchesInfo.ProjectId%>' + "&RecordCurrencyId=" + RecordCurrencyId, 920, 415, false);
            }
            ...
            function maintoolbarClick(Value) {
                var HasMergeTemplate = '<%= PM.CostManagement.ARPaymentBatchesInfo.HasMergeTemplate%>';
                var RecordDescription = '<%=JSEscape(PM.CostManagement.ARPaymentBatchesInfo.RecordNumber & " - " & PM.CostManagement.ARPaymentBatchesInfo.Description)%>';
                var Description = '<%=JSEscape(PM.CostManagement.ARPaymentBatchesInfo.Description)%>';
                var Id = '<%= PM.CostManagement.ARPaymentBatchesInfo.Id%>';
                var HasPMWebReports = '<%= PM.QueryBuilderPermissionController.HasReports("ARPaymentBatches")%>';
                var HasReports = '<%= PM.CostManagement.ARPaymentBatchesInfo.HasReports%>';
                switch (Value) {
                    case 'Notification':
                        if (Id == 0) break;
                        var left = (screen.width - 900) / 2;
                        var top = (screen.height - 500) / 2;
                        OpenPOPUp("Notification.aspx?ObjectType=ARPaymentBatches&Id=" +
                  '<%= PM.CostManagement.ARPaymentBatchesInfo.Id%>' + "&Description="
                            + Description
                            + "&RecordDescription=" + RecordDescription
                            + "&EntityId=" + '<%=PM.CostManagement.ARPaymentBatchesInfo.ProjectId%>' + "&EntityType=0", "Notification",
                'location=no,status=0,menubar=0,addressbar=0,resizable=1,scrollbars=1,width=820,height=500,top=' + top + ',left=' + left, 1045, 515, false);
                    ...
                    case 'ViewTemplates':
                        if (HasMergeTemplate == 'True') {
                            OpenPOPUp("MergeTemplatePopup.aspx?ObjectType=ARPaymentBatches&Id=" +
                             '<%= PM.CostManagement.ARPaymentBatchesInfo.Id%>' + "&Description="
                            + Description
                            + "&RecordDescription=" + RecordDescription
                            + "&EntityId=" + '<%=PM.CostManagement.ARPaymentBatchesInfo.ProjectId%>' + "&EntityType=0", 1045, 515, false);
                        }
                        break;
                    ...
                    case 'Print':
                        if (HasReports == 'True') {
                            OpenPOPUp("ReportsPreviewPopup.aspx?ObjectType=ARPaymentBatches&Id=" +
                             '<%= PM.CostManagement.ARPaymentBatchesInfo.Id%>'
                            + "&RecordDescription=" + RecordDescription
                            + "&EntityId=" + '<%=PM.CostManagement.ARPaymentBatchesInfo.ProjectId%>' + "&EntityType=0", 890, 430, false);
                        } else {
                            window.location = "ReportManager.aspx?ModuleId=" + Global_CurrentModuleId;
                            args.set_cancel(true);
                        }
                    ...
                    case 'ViewPMWebReports':
                        ...
                        if (HasPMWebReports == 'True' && Id > 0) {
                            OpenPOPUp("PMWebReports.aspx?ObjectType=ARPaymentBatches&Id=" + Id
                         + "&EntityId=" + '<%=PM.CostManagement.ARPaymentBatchesInfo.ProjectId%>' + "&EntityType=0",
                    ...
                    case 'New':
                        window.location = "CostManagementARPaymentBatches.aspx";
                        break;
                    case 'Submit':
                        return OpenWorkflowSubmitPopup('ARPaymentBatches');
                        break;
    ...
    <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0" class="ToolBar SmallToolbar">
        <tr>
            <td class="ToolbarTd">
                <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=203">
            ...
            <td style="width: 240px !important;" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                <telerik:RadComboBox ID="ddlARPaymentBatches" runat="server" AllowCustomText="true" Skin="Default"
                    ...
                    Width="240px" AutoPostBack="false" NoWrap="true" CausesValidation="False" meta:Resourcekey="ddlARPaymentBatches"
                ...
                <telerik:RadToolBar ID="mainToolBar" OnClientButtonClicked="click_handler" runat="server" Skin="Default" AutoPostBack="true">
                    <Items>
                        <%--<telerik:RadToolBarButton SecurityButtonType="Read" CommandName="Search" ImageUrl="Images/ToolBar/lookup.png"
                                        Value="Search" NavigateUrl="SearchDocument.aspx?O=203" CausesValidation="false">
                                    ...
                                    <Items>
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem Text="Recent" Value="Recent" onclick="OpenRecentDocumentsPopup('ARPaymentBatches');" CssClass="Help" EnableImageSprite="true" OuterCssClass="Recent"></telerik:RadMenuItem>
                                                <telerik:RadMenuItem Text="Submit" Value="Submit" onclick="OpenWorkflowSubmitPopup('ARPaymentBatches');" CssClass="Help" EnableImageSprite="true" ></telerik:RadMenuItem>
    ...
    <telerik:RadMultiPage ID="mlpPayment" runat="server" SelectedIndex="0" Width="100%" RenderSelectedPageOnly="true" CssClass="documentMultiPages">
                ...
                <div class="PMMainPage">
                    <div class="row JustifyContent R3Cols">
                        <div class="col-4 col-4-left">
                            <table class="colTable">
                                ...
                                <tr>
                                    <td class="labelWidth">
                                        ...
                                        <div style="float: right">
                                            <asp:LinkButton runat="server" ID="imgfilter1" CssClass="SearchButton" OnClientClick="return OpenCompanyFilterPopupProjectNotRequired1(this.id.replace('imgfilter1','HiddenField2'),this.id.replace('imgfilter1','ddlCompanies'),'Companies')">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <table id="tblStatus" runat="server" cellpadding="0" cellspacing="0" border="0" width="100%">
                                          ...
                                          <asp:RequiredFieldValidator ID="rfvRevisionNumber" runat="server" ValidationGroup="Save" ControlToValidate="txtRevisionNumber"
                                                        CssClass="Validator" Display="Dynamic" ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>"
                                                        ForeColor=""></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="controlWidth chkBox" style="position: relative;">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <asp:Label ID="lblHidenRows" runat="server" Text="Some of the detail lines are hidden for security reasons." Visible="false"
                                            CssClass="Validator" meta:resourcekey="lblHidenRows"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                            <fieldset runat="server" id="fldMemoFields">
                                <legend>
                                    <asp:Label ID="lblMemoFields" runat="server" meta:resourcekey="lblMemoFields" Text="Memo Fields"></asp:Label>
                                </legend>
                                <table class="colTable">
                                    <tr>
                                        <td class="labelWidth">
                                        ...
                                        <td class="controlWidth">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvPaymentMemoTotal" runat="server" ValidationGroup="Save" ControlToValidate="txtPaymentMemoTotal"
                                                CssClass="Validator" Display="Dynamic" ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>"
                                                ForeColor=""></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="controlWidth">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvPaymentDate" runat="server" ValidationGroup="Save" ControlToValidate="rdpInvoiceDate"
                                                CssClass="Validator" Display="Dynamic" ErrorMessage="<%$ Resources:PMWeb, WarningMsg_RequiredFields%>"
                                                ForeColor=""></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                        ...
                        <div class="col-4 col-4-middle">
                            ...
                            <table class="colTable" runat="server" id="tblCost">
                                <tr>
                                    <td>
                                        <fieldset runat="server" id="fldPaymentRecap">
                                            <legend>
                                                <asp:Label ID="lblRecap" runat="server" meta:resourcekey="lblRecap" Text="Payment Recap"></asp:Label></legend>
                                            <table class="colTable">
                                                <tr>
                                                    <td class="labelWidth">
        ...
        <telerik:RadPageView ID="pvDetails" runat="server" CssClass="ShowInHeaderWhenFit Responsive">
            <uc1:CostManagementARPaymentBatchesDetails ID="CostManagementARPaymentBatchesDetails1"
                runat="server" />
        </telerik:RadPageView>
