...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <table class="ToolBar SmallToolbar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=105">
            ...
            <td class="ToolbarTd HideOnMobileToolbar showOnIpad" style="width:240px;">
                <telerik:RadComboBox ID="ddlProductions" runat="server" Filter="Contains" MarkFirstMatch="true" DropDownCssClass="ddlTreeviewTemplate ToolbarDropdown"
                    Skin="Default" CloseDropDownOnBlur="true" Width="240px" AutoPostBack="false" 
                    NoWrap="true" OnClientDropDownOpened="OnClientDropDownOpenedHandler"
                    ...
                    <ItemTemplate>
                        <div id="div1">
                            <telerik:RadTreeView ID="rdvProductions" Skin="Default" runat="server"
                                Height="250px" MultipleSelect="false" ShowLineImages="false" OnClientNodeClicking="MainTree_NodeClicking"
                                OnNodeExpand="rdvProductions_NodeExpand"
                                OnNodeDataBound="rdvProductions_NodeDataBound">
                            </telerik:RadTreeView>
                        </div>
                    </ItemTemplate>
                </telerik:RadComboBox>
                ...
                <telerik:RadToolBar ID="mainToolBar" runat="server" Skin="Default" AutoPostBack="true" OnClientButtonClicked="click_handler">
                    <Items>
                        <%--<telerik:RadToolBarButton SecurityButtonType="Read" CommandName="Search" ImageUrl="Images/ToolBar/lookup.png"
                                        Value="Search" NavigateUrl="SearchDocument.aspx?O=105" CausesValidation="false">
                    ...
                    <div class="row JustifyContent R3Cols">
                        <div class="col-4 col-4-left ">
                          ...
                          <%--      <tr>
                                    ...
                                    <td class="controlWidth">
                                        <asp:Button ID="btnCreateNext" runat="server" meta:ResourceKey="btnCreateNext" Text="Create Next"
                                            Visible="false" OnClientClick="DisablebtnCreateNext(this)" ValidationGroup="Save" />
                                    </td>
                                </tr>--%>
                                <tr>
                                    <td class="labelWidth">
...
<%--<asp:DropDownList ID="ddlTypes" runat="server" Width="250px"></asp:DropDownList>
                                            <asp:CompareValidator ID="cmvType" runat="server" Visible="false"
                                                ControlToValidate="ddlTypes" CssClass="Validator" Display="Dynamic" ErrorMessage="<%$Resources:PMWeb, WarningMsg_Required %>"
                                                ForeColor="" Operator="GreaterThan" ValidationGroup="Save" ValueToCompare="0"></asp:CompareValidator>
                                            <asp:CompareValidator ID="cmpddlTypes" runat="server" 
                                            ControlToValidate="ddlTypes" CssClass="Validator" Display="Dynamic" 
