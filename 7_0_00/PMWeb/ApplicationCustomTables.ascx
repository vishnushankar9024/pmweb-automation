<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ApplicationCustomTables.ascx.vb" Inherits="Website.ApplicationCustomTables" %>
<telerik:RadAjaxManagerProxy ID="PmAjaxManagerProxy1" runat="server">
    <AjaxSettings>
        
        <telerik:AjaxSetting AjaxControlID="fldTitle">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="fldTitle" LoadingPanelID="ldpPM" />
            </UpdatedControls>
        </telerik:AjaxSetting> 
  ...
  <telerik:RadGrid ID="rdg" runat="server" ClientSettings-Scrolling-AllowScroll="true" ClientSettings-Scrolling-UseStaticHeaders="true" SetWidth="true" AppendMenus="true"
                    EnableEmbeddedSkins="True" Skin="Default" AutoGenerateColumns="False" ShowStatusBar="True" Font-Size="8px" AllowMultiRowEdit="True" AllowMultiRowSelection="True"
                     GridLines="None" >
