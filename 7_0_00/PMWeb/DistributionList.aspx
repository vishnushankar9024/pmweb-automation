...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <table class="ToolBar SmallToolbar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr>
            <td class="ToolbarTd">
                <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=180">
            ...
            <td style="width: 240px" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                ...
                <telerik:RadComboBox ID="ddlDistrbutionList" runat="server" OnClientTextChange="LOD_DropDownTextChange"
                    ...
                    EnableVirtualScrolling="True" OnItemsRequested="ddl_ItemsRequested" DropDownCssClass="ToolbarDropdown" meta:Resourcekey="ddlDistrbutionList">
                </telerik:RadComboBox>
            </td>
