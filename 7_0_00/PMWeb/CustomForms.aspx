    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        <script type="text/javascript">
            ...
            <%--$(document).ready(function () {
                $("[id$=btnSearchDocument]").attr("href","SearchDocument.aspx?C=" + "<%=PM.Workflow.CustomFormInfo.CustomFormTypeId%>")
            })--%>
        ...
        <tr valign="top">
            <td valign="top">
                <table style="width: 100% !important;" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td class="ToolbarTd">
                            <%-- Navigate Url provided on document ready --%>
                            <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage">
