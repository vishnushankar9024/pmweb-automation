<%@ Page Language="vb" meta:resourcekey="Page" AutoEventWireup="false" CodeBehind="Home_UploadBackgroundImage.aspx.vb" Inherits="Website.Home_UploadBackgroundImage" %>
                            ...
                            <tr>
                                <td>
                                    <telerik:RadAsyncUpload runat="server" RenderMode="Native" CssClass="BigUpload" Skin="Default" ID="rauBackgroundImage" OnClientFileUploadFailed="onDocFileUploadFailed" Width="310px"
                                        OnClientFileSelected="onDocFileSelected" OnClientFileUploading="onDocFileUploading" OnClientFileUploaded="onDocFileUploaded" OnClientAdded="addedDocFile" HideFileInput="true" style="text-align:center;height:40px;line-height:40px;"
