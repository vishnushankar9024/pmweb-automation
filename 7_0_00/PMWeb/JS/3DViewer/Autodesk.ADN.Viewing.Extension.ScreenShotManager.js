    ...
    baseId)
  {
      ...
      var html = [
        ...
        '<div class="row">',
          ...
          '<div>',
            ...
            '<br>',
            '<br>',
             '<button class="btn btn-info" id="' + item.AttachBtnId + '" style="font-size:11px; width:85px">',
              'Attach To PMWeb',
            '</button>',
             '<br>',
             '<br>',
             '<button class="btn btn-sm btn-danger" id="' + item.deleteBtnId + '" style="font-size:11px; width:90px">',
    ...
    $('#' + baseId + 'screenshotBtn').click(function() {
      ...
      viewer.getScreenShot(
        ...
        // return false added by nem the screen was becoming white after screenshotBtn clicked
      return false;
    });


    // pato add another handler for the button
  };
