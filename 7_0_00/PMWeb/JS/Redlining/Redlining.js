...
function UpdatePanelSettings(sender) {
    $.ajax({
        ...
        data: "{'isPinned':'" + sender.get_docked() + "', 'Width':" + sender.get_width() + ", 'PMWebViewerRightPaneWidth': " + PMWebViewerRightPaneWidth + ", 'PMWebViewerRightPaneHeight': " + PMWebViewerRightPaneHeight + " }",
        dataType: "json",
        async: true
    });
