...
function IsMouseOverEditor(events) {
    ...
    while (parentNode != null) {
        if (parentNode.id)
            if (parentNode.id == 'ctl00_CPH1_ReminderTemplate1_pnlEditor')
                return parentNode;
...
function pasteTextInEditor(text) {
    editor = $find("ctl00_CPH1_ReminderTemplate1_RadEditor1");
...
function OnClientLoad(editor) {
    ...
    var tree = $find("ctl00_CPH1_ReminderTemplate1_tree");
...
function AllReminderCheckClicked(iObj) {
...
function SelectReminderParent(chk) {
...
function CheckReminderParentBox() {
