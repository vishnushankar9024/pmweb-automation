...
function FormatNumbers() {
    ...
    $("input.Double").numeric({ AllowNegative: true, DecimalCharacter: Global_DecimalCharacter, DecimalPrecision: Global_DecimalPrecision, DecimalSeparator: Global_DecimalSeparator }).blur(function (e) { $(this).val(CDbl($(this).val(), $(this))); });
    ...
    $("input.Days").numeric({ DecimalCharacter: Global_DecimalCharacter, DecimalPrecision: Global_DecimalPrecision, DecimalSeparator: Global_DecimalSeparator }).blur(function (e) {
        if ($(this).val() % 1 == 0) {
            $(this).val(parseInt($(this).val()))
        }
    });
