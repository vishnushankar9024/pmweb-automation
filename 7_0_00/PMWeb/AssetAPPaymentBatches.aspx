<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/PmMaster.Master" CodeBehind="AssetAPPaymentBatches.aspx.vb" Inherits="Website.AssetAPPaymentBatches" %>

<%@ Register Src="AssetApPaymentbatcheDetail.ascx" TagName="AssetApPaymentbatcheDetail" TagPrefix="uc1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        ...
        <script type="text/javascript">
            ...
            function maintoolbarClick(Value) {
                var HasMergeTemplate = '<%= PM.Asset.AssetAPPaymentBatcheInfo.HasMergeTemplate%>';
                var RecordDescription = '<%=JSEscape(PM.Asset.AssetAPPaymentBatcheInfo.RecordNumber & " - " & PM.Asset.AssetAPPaymentBatcheInfo.Description)%>';
                var Description = '<%=JSEscape(PM.Asset.AssetAPPaymentBatcheInfo.Description)%>';
                var Id = '<%= PM.Asset.AssetAPPaymentBatcheInfo.Id%>';
                var HasPMWebReports = '<%= PM.QueryBuilderPermissionController.HasReports("APTENANTPAYMENTBATCHES")%>';
                var HasReports = '<%= PM.Asset.AssetAPPaymentBatcheInfo.HasReports%>';
                switch (Value) {
                    case 'Notification':
                        if (Id == 0) break;
                        var left = (screen.width - 900) / 2;
                        var top = (screen.height - 500) / 2;
                        OpenPOPUp("Notification.aspx?ObjectType=APTENANTPAYMENTBATCHES&Id=" +
                                     '<%= PM.Asset.AssetAPPaymentBatcheInfo.Id%>' + "&Description="
                            + Description
                            + "&RecordDescription=" + RecordDescription
                            + "&EntityId=" + '<%=PM.Asset.AssetAPPaymentBatcheInfo.LocationId%>' + "&EntityType=0", "Notification",
                    ...
                    case 'ViewTemplates':
                        if (HasMergeTemplate == 'True') {
                            OpenPOPUp("MergeTemplatePopup.aspx?ObjectType=APTENANTPAYMENTBATCHES&Id=" +
                             '<%= PM.Asset.AssetAPPaymentBatcheInfo.Id%>' + "&Description="
                            + Description
                            + "&RecordDescription=" + RecordDescription
                            + "&EntityId=" + '<%=PM.Asset.AssetAPPaymentBatcheInfo.LocationId%>' + "&EntityType=0", 1045, 515, false);
                        }
                        break;
                    ...
                    case 'ViewPMWebReports':
                        ...
                        if (HasPMWebReports == 'True' && Id > 0) {
                            OpenPOPUp("PMWebReports.aspx?ObjectType=APTENANTPAYMENTBATCHES&Id=" + Id
                         + "&EntityId=" + '<%=PM.Asset.AssetAPPaymentBatcheInfo.LocationId%>' + "&EntityType=0",
                    ...
                    case 'Print':
                        if (HasReports == 'True') {
                            OpenPOPUp("ReportsPreviewPopup.aspx?ObjectType=APTENANTPAYMENTBATCHES&Id=" +
                             '<%= PM.Asset.AssetAPPaymentBatcheInfo.Id%>'
                            + "&RecordDescription=" + RecordDescription
                            + "&EntityId=" + '<%=PM.Asset.AssetAPPaymentBatcheInfo.LocationId%>' + "&EntityType=0", 890, 430, false);
                        } else {
                            window.location = "ReportManager.aspx?ModuleId=" + Global_CurrentModuleId;
                            args.set_cancel(true);
                        }
                    ...
                    case 'ViewReports':
                        ...
                        break;
                    case 'New':
                        window.location = "AssetAPPaymentBatches.aspx";
                        break;
                    case 'Submit':
                        return OpenWorkflowSubmitPopup('APTENANTPAYMENTBATCHES');
                        break;
                    default:
                        break;
                }
    ...
    <table class="ToolBar SmallToolbar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=216">
            ...
            <td style="width: 240px" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                <telerik:RadComboBox ID="ddlPaymentBatches" runat="server" AllowCustomText="true" Skin="Default"
                    ...
                    Width="100%" AutoPostBack="False" OnClientSelectedIndexChanging="MainDropDown_SelectedIndexChanging"
                    NoWrap="true" CausesValidation="False" meta:Resourcekey="ddlPaymentBatches"
                ...
                <telerik:RadToolBar ID="mainToolBar" OnClientButtonClicked="click_handler" runat="server" Skin="Default" AutoPostBack="true">
                    <Items>
                        <%--   <telerik:RadToolBarButton SecurityButtonType="Read" CommandName="Search" ImageUrl="Images/ToolBar/lookup.png"
                                        Value="Search" NavigateUrl="SearchDocument.aspx?O=216" CausesValidation="false">
                                    ...
                                    <Items>
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem Text="Recent" Value="Recent" onclick="OpenRecentDocumentsPopup('APTENANTPAYMENTBATCHES');" CssClass="Help" EnableImageSprite="true" OuterCssClass="Recent"></telerik:RadMenuItem>
                                                <telerik:RadMenuItem Text="Submit" Value="Submit" onclick="OpenWorkflowSubmitPopup('APTENANTPAYMENTBATCHES');" CssClass="Help" EnableImageSprite="true" ></telerik:RadMenuItem>
    ...
    <telerik:RadMultiPage ID="mlpPayment" runat="server" SelectedIndex="0" Width="100%" RenderSelectedPageOnly="true" CssClass="documentMultiPages">
                        ...
                        <div class="col-4 col-4-left">
                            ...
                            <table class="colTable">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlLocations" runat="server" AutoPostBack="True" CausesValidation="False"
                                            CloseDropDownOnBlur="true" Height="300px" meta:Resourcekey="ddlLocations"
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <asp:TextBox ID="txtCode" runat="server" MaxLength="30" Width="100%"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvCode" runat="server" ValidationGroup="Save" ControlToValidate="txtCode"
                                            CssClass="Validator" Display="Dynamic" meta:Resourcekey="rfvCodeRequired"
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <asp:TextBox runat="server" ID="txtDescription" MaxLength="500" Width="100%" Text=""></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="labelWidth">
                                    ...
                                    <td class="controlWidth">
                                        <asp:TextBox runat="server" ID="txtCurrency" Enabled="false" Width="100%" Text=""></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="labelWidth">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <asp:Label ID="lblHidenRows" runat="server" Text="Some of the detail lines are hidden for security reasons." Visible="false" CssClass="Validator" meta:resourcekey="lblHidenRows">
                                        </asp:Label>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <fieldset style="width: 100%;" runat="server" id="fldMemoFields">
                                ...
                                <table class="colTable">
                                    <tr>
                                        ...
                                        <td class="controlWidth">
                                            <asp:TextBox ID="txtPaymentMemoTotal" CssClass="Currency" runat="server" Width="100%"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td class="controlWidth">
                                            <asp:TextBox ID="txtPaymentNumber" runat="server" MaxLength="300" Width="100%"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td class="controlWidth">
                                            <telerik:RadComboBox Height="200px" ID="ddlType"  AllowCustomText="true" Filter="Contains" runat="server" Width="100%" Skin="Default" Style="font-size: 11px"></telerik:RadComboBox>
                                    ...
                                    <tr>
                                        ...
                                        <td class="controlWidth">
                                            <telerik:RadComboBox ID="ddlCategory" Height="200px" AllowCustomText="true" Filter="Contains" runat="server" Width="100%" Skin="Default" Style="font-size: 11px"></telerik:RadComboBox>
                                    ...
                                    <tr>
                                        ...
                                        <td class="controlWidth">
                                            <asp:TextBox ID="txtReference" MaxLength="255" runat="server" Width="100%"></asp:TextBox>
                            ...
                            <fieldset id="fldPaymentRecap" runat="server">
                                ...
                                <table class="colTable">
                                    <tr>
                                        ...
                                        <td class="controlWidth">
                                            <asp:TextBox ID="txtPaymentAmount" CssClass="Currency" ReadOnly="true" runat="server" Width="100%"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="labelWidth">
                                        ...
                                        <td class="controlWidth">
                                            <asp:TextBox ID="txtApplied" CssClass="Currency" ReadOnly="true" runat="server" Width="100%"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="labelWidth">
                                        ...
                                        <td class="controlWidth">
                                            <asp:TextBox ID="txtUnapplied" CssClass="Currency" ReadOnly="true" runat="server" Width="100%"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="labelWidth">
                                        ...
                                        <td class="controlWidth">
                                            <asp:TextBox ID="txtPosted" CssClass="Currency" ReadOnly="true" runat="server" Width="100%"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="labelWidth">
                                        ...
                                        <td class="controlWidth">
                                            <asp:TextBox ID="txtUnposted" CssClass="Currency" ReadOnly="true" runat="server" Width="100%"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </fieldset>
        ...
        <telerik:RadPageView ID="pvDetails" runat="server" CssClass="ShowInHeaderWhenFit Responsive">
            <uc1:AssetApPaymentbatcheDetail ID="AssetApPaymentbatcheDetail1" runat="server" />
        </telerik:RadPageView>
