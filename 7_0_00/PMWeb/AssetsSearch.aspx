...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <telerik:RadTabStrip OnClientTabSelecting="onTabSelecting" ID="tbsDocument" SelectedIndex="0" style="padding-top:5px"
    ...
    <telerik:RadMultiPage ID="mlpAssets" runat="server" SelectedIndex="0" CssClass="documentSinglePageWithoutToolbar"
        ...
        <telerik:RadPageView ID="pvBuildings" runat="server">
            <div class="PMMainPage">
                ...
                SetWidth="true" AppendMenus="true" PageSize="10" AllowPaging="true" ShowGroupPanel="true" AllowSorting="true" AutoGenerateColumns="False" ShowStatusBar="True" Font-Size="8px" GridLines="None">
        ...
        <telerik:RadPageView ID="pvSpaces" runat="server">
               <div class="PMMainPage">
                ...
                SetWidth="true" AppendMenus="true" PageSize="10" AllowPaging="true" AllowFilteringByColumn="true" ShowGroupPanel="true" AllowSorting="true" AutoGenerateColumns="False" ShowStatusBar="True" Font-Size="8px" GridLines="None">
                <PagerStyle Mode="NextPrevAndNumeric" AlwaysVisible="true"></PagerStyle>
                <ClientSettings>
                    <Selecting EnableDragToSelectRows="False" />
                </ClientSettings>
                    ...
                    <div class="row">
                        <div class="col-12">
                                <telerik:RadGrid ID="rdgEquipments" AllowFilteringByColumn="true" runat="server" FilterType="HeaderContext" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true" ClientSettings-Scrolling-AllowScroll="true"
                                            SetWidth="true" Width="100%" AppendMenus="true" PageSize="10" AllowPaging="true" ShowGroupPanel="true" AllowSorting="true" AutoGenerateColumns="False" ShowStatusBar="True" GridLines="None">
                                            <PagerStyle Mode="NextPrevAndNumeric" AlwaysVisible="true"></PagerStyle>
                                            <ClientSettings EnableRowHoverStyle="True">
                                                <Selecting EnableDragToSelectRows="False" />
                                            </ClientSettings>
