...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div  id="PMMainPage" class="PMMainPage PMPopupMainPage documentSinglePage" style="margin-bottom: 0px;" runat="server"  >
            <div class="row row-8-4">
                        ...
                        <tr>
                            ...
                            <td class="controlWidth">
                                ...
                                <asp:RequiredFieldValidator ID="rfvUsername" runat="server" ControlToValidate="txtLayoutName"
                                    CssClass="Validator" ErrorMessage="<br/>Enter LayoutName" Display="Dynamic" ForeColor=""
                ...
                <div class="col-8">
                    <telerik:RadGrid runat="server" ID="rdgLayoutGrid" AutoGenerateColumns="False" ShowStatusBar="True" SetWidth="true" AppendMenus="true" FitParentContainer="true" Style="max-width: 645px;"
                        Font-Size="8px" ShowGroupPanel="False" AllowMultiRowEdit="True" AllowMultiRowSelection="True" AllowSorting="False" GridLines="None" UseEditFormInMobile="true" FitPageHeightOffset="24">
