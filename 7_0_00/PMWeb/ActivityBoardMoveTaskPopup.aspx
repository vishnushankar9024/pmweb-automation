<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ActivityBoardMoveTaskPopup.aspx.vb" Inherits="Website.ActivityBoardMoveTaskPopup"
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxManager ID="PMAjaxManager" runat="server">
            <AjaxSettings>
                <%--<telerik:AjaxSetting AjaxControlID="moveTable">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="moveTable" LoadingPanelID="ldpActivity" />
                    </UpdatedControls>
                </telerik:AjaxSetting>--%>
            </AjaxSettings>
    ...
    <asp:LinkButton runat="server" CssClass="closepopup closesize" ID="btnCloseProfilePopup" OnClientClick="window.close()">
        ...
        <div class="PMMainPage PMPopupMainPage documentSinglePage R24SidePadding TitleToolbarTop">
            <div class="row">
                <div class="col-4">
                    <table class="colTable" id="moveTable" runat="server">
                        <tr>
                            <td class="labelWidth" style="width: 160px !important;">
                                <asp:Label ID="lblBoard" runat="server" Text="Board" meta:resourcekey="lblBoard"></asp:Label>
                            </td>
                        ...
                        <tr>
                            <td class="labelWidth" style="width: 160px !important;">
                                <asp:Label ID="lblColumn" runat="server" Text="Column" meta:resourcekey="lblColumn"></asp:Label>
                            </td>
                            <td class="controlWidth">
                    ...
                    <fieldset>
                        <legend class="legend">
                            <asp:Label runat="server" ID="lblMove" Text="Move" meta:Resourcekey="lblMove"></asp:Label>
                        </legend>
