...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <table style="width: 100%;" cellpadding="0" cellspacing="0" class="ToolBar LargeToolBar">
        <tr valign="top">
                        ...
                        <td class="ToolbarTd">
                            <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=4">
                        ...
                        <td style="width: 240px" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                            <telerik:RadComboBox ID="ddlAssemblies" runat="server" Skin="Default" OnClientTextChange="LOD_DropDownTextChange"
                                ...
                                OnItemsRequested="ddlAssemblies_ItemsRequested" CheckForDirt="True" DropDownCssClass="ToolbarDropdown">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="controlWidth">
                                                            <telerik:RadComboBox ID="ddlAssemblyGroup" runat="server" OnClientLoad="comboLoad" DropDownCssClass="ddlTreeviewTemplate"
                                                                Width="100%" Skin="Default" AllowCustomText="true" OnClientDropDownOpened="OnClientDropDownOpenedHandler" Height="300px"
