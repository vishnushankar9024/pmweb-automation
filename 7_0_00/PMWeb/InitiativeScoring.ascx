<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="InitiativeScoring.ascx.vb" Inherits="Website.InitiativeScoring" %>
...
<telerik:RadGrid ID="rdgScoring"  runat="server" SetWidth="true" AppendMenus = "true" 
        ...
        <ClientSettings AllowColumnHide="true" AllowColumnsReorder="true" Scrolling-AllowScroll="true"
