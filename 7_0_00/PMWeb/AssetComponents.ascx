...
<div class="PMHeader">
    <div class="row">
        <div class="col-12" id="tblComponents" runat="server">
            <telerik:RadGrid ID="rdgEquComponents" runat="server" CssClass="WithoutTopBorder" AllowFilteringByColumn="true" FilterType="HeaderContext" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true"
                AutoGenerateColumns="False" ShowStatusBar="false" Font-Size="8px" PageSize="15" setWidth="true" appendMenus="true" allow-scroll="true"
