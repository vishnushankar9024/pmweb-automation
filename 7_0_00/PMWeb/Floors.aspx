...
<asp:Content ID="C1" ContentPlaceHolderID="ACPH1" runat="server">
    ...
    <table class="ToolBar SmallToolbar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=16">
    ...
    <telerik:RadMultiPage ID="mlpFloors" runat="server" SelectedIndex="0" RenderSelectedPageOnly="true" Width="100%">
                        ...
                        <div class="col-4 col-4-left">
                            <table class="colTable">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <asp:TextBox runat="server" ID="txtCode" MaxLength="50" ValidationGroup="Save"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlComponentType" runat="server" Style="font-size: 11px" AllowCustomText="true">
                            ...
                            <fieldset style="width: 100%">
                                ...
                                <table class="colTable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="controlWidth">
                                            <telerik:RadComboBox ID="ddlCountries" runat="server" AllowCustomText="true"
