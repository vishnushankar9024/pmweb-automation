...
<%--<%@ Register Src="DocumentInspections.ascx" TagName="DocumentInspection" TagPrefix="uc12" %>--%>
                ...
                switch (Value) {
                    ...
                    case 'ViewReports':
                        ...
                        if (HasReports == 'True') {
                            ...
                            window.open("ReportsPreviewPopup.aspx?ObjectType=SPACE&Id=" +
                                Id
        ...
        <tr>
            <td>
                ...
                <table class="ToolBar SmallToolbar" style="width: 100%;" cellpadding="0" cellspacing="0" border="0">
                    <tr valign="top">
                        <td class="ToolbarTd">
                            <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=17">
                        ...
                        <td style="width: 240px !important;" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                            <telerik:RadComboBox ID="ddlSpaces" runat="server" CloseDropDownOnBlur="true"
                                EmptyMessage="Select Space..." Width="240px" AutoPostBack="False" NoWrap="true"
                                CausesValidation="False" Height="400px"
                                ShowMoreResultsBox="True" EnableLoadOnDemand="true" OnClientTextChange="LOD_DropDownTextChange" OnClientSelectedIndexChanging="MainDropDown_SelectedIndexChanging"
                            ...
                            <telerik:RadToolBar ID="mainToolBar" runat="server" AutoPostBack="true">
                                <Items>
                                    <%--<telerik:RadToolBarButton SecurityButtonType="Read" CommandName="Search" ImageUrl="Images/ToolBar/lookup.png"
                                        Value="Search" NavigateUrl="SearchDocument.aspx?O=17" CausesValidation="false"> </telerik:RadToolBarButton>--%>
                                    ...
                                    <%--<telerik:RadToolBarSplitButton ImageUrl="Images/ToolBar/NewDoc.png" CommandName="New"
                                        ...
                                        <Buttons>
                                            <telerik:RadToolBarButton SecurityButtonType="Add" ImageUrl="Images/ToolBar/NewDoc.png"
                                                CommandName="New" AccessKey="n" CausesValidation="false" Width="120px">
                                            </telerik:RadToolBarButton>
                                        </Buttons>
                    ...
                    <div class="row JustifyContent R3Cols">
                        <div class="col-4 col-4-left">
                            <table class="colTable">
                                ...
                                <tr>
                                    <td class="labelWidth">
                                        <asp:Label ID="lblConditionDate" runat="server" meta:resourcekey="lblConditionDate" Text="Condition Date"></asp:Label>
                                    </td>
                                    <td class="controlWidth">
