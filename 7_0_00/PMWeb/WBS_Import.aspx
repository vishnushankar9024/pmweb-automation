    ...
    <form id="form1" runat="server">
       ...
       <%--     <asp:Panel ID="pnl2" runat="server">
                <div class="PMMainPage PMPopupMainPage">
                    <div class="row">
                        <div class="col-12">
                            <telerik:RadGrid ID="RDG3" runat="server" AllowPaging="true" PageSize="20" FitPageHeightOffset="24"
            ...
            <asp:Panel ID="pnl3" runat="server">
                <div class="PMMainPage PMPopupMainPage">
                    ...
                    <div class="row RowWithNoPaddingTop">
                        <div class="col-12">
                            <telerik:RadGrid ID="RDG4" runat="server" AllowPaging="true" PageSize="10" FitPageHeightOffset="24"
                                AutoGenerateColumns="True" ShowStatusBar="True" Font-Size="8px" GridLines="None">
                                <PagerStyle Mode="NextPrevAndNumeric" AlwaysVisible="true"></PagerStyle>
                                <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
