...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH1" runat="server">
            ...
            function maintoolbarClick(Value) {
                ...
                switch (Value) {
                    case 'ViewTemplates':
                        ...
                        break;
                    case 'BIReporting':
                        window.location = window.location = "ReportManager.aspx?ModuleId=" + Global_CurrentModuleId;
                        break;
                    case 'Print':
                        if (HasReports == 'True') {
    ...
    <table class="ToolBar SmallToolbar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=285">
                    ...
                    <Items>
                        ...
                        <telerik:RadToolBarSplitButton ImageUrl="Images/ToolBar/NewDoc.png" CommandName="NewInitiative"
                            ...
                            <Buttons>
                                ...
                                <telerik:RadToolBarButton SecurityButtonType="Copy" PostBack="true" CommandName="Copy" ImageUrl="Images/ToolBar/Revision.png" ValidationGroup="Save">
                                </telerik:RadToolBarButton>
                        ...
                        <telerik:RadToolBarSplitButton EnableImageSprite="true" CommandName="Print" SecurityButtonType="Read"
                            ...
                            <Buttons>
                                <telerik:RadToolBarButton PostBack="false" Width="150px" CommandName="BIReporting" EnableImageSprite="true" CssClass="ToolbarButtonViewReports">
                                </telerik:RadToolBarButton>
                                ...
                                <tr runat="server" id="trProgram">
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlPrograms" AllowCustomText="true" runat="server" AutoPostBack="true"
                                            ...
                                            EnableVirtualScrolling="True" SkipValue="0">
                                        </telerik:RadComboBox>
                        ...
                        <div class="col-4 col-4-middle">
                            <table class="colTable">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlSkills" runat="server" AllowCustomText="True" Width="100%">
                                            <ItemTemplate>
                                ...
                                <tr>
                                    <td class="labelWidth">
                                        <telerik:RadComboBox ID="ddlRateBasis" runat="server" meta:resourcekey="ddlRateBasis"></telerik:RadComboBox>
                                    </td>
                                    <td class="controlWidth">
                                ...
                                <tr>
                                    <td>
                                        <asp:CompareValidator meta:resourcekey="cmpstartTofinsh" ID="cmpFromToDates" runat="server" Style="margin-bottom: 5px;"
                                            ...
                                            ErrorMessage="Start date must be before or equal to Finish date" Display="Dynamic" ClientValidationFunction="ValidateCombinedDate"
