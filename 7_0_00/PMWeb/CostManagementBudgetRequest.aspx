...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function maintoolbarClick(Value) {
                ...
                case 'ViewPMWebReports':
                    ...
                    case 'Submit':
                        return OpenWorkflowSubmitPopup('BUDGETREQUEST');
                        break;
    ...
    <table class="ToolBar SmallToolbar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=93">
            ...
            <td style="width: 240px" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                <telerik:RadComboBox ID="ddlBudgetRequest" runat="server" EnableVirtualScrolling="True" OnItemsRequested="ddl_ItemsRequested"
                    ...
                    CausesValidation="False" Height="400px" OnClientTextChange="LOD_DropDownTextChange" EnableLoadOnDemand="true" DropDownCssClass="ToolbarDropdown">
                </telerik:RadComboBox>
            </td>
                                    ...
                                    <Items>
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem Text="Submit" Value="Submit" onclick="OpenWorkflowSubmitPopup('BUDGETREQUEST');" CssClass="Help" EnableImageSprite="true" ></telerik:RadMenuItem>                                                
                                ...
                                <tr id="trvoid" runat="server">
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlProgram" Filter="Contains" MarkFirstMatch="true" AllowCustomText="true"
                                            runat="server" AutoPostBack="true" Skin="Default" NoWrap="true" EnableLoadOnDemand="true" SkipValue="0"
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlProjects" UseProjectFilter="1" runat="server" AutoPostBack="True" CausesValidation="False"
                                            CloseDropDownOnBlur="true" Height="300px" SkipValue="0"
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvType" runat="server" ControlToValidate="ddlType" ValidationGroup="Save"
                                            CssClass="Validator" InitialValue="" ErrorMessage="<%$ Resources:PMWeb, WarningMsg_FieldsRequired%>"
