...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <telerik:RadAjaxManagerProxy ID="AjaxManagerProxy1" runat="server">
        ...
        <telerik:AjaxSetting AjaxControlID="ddlProperties">
            <UpdatedControls>
                ...
                <telerik:AjaxUpdatedControl ControlID="txtTransmittalNumber" />
    ...
    <table class="ToolBar SmallToolbar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:HyperLink runat="server" ID="btnSearchDocument" CssClass="lnkPage" NavigateUrl="SearchDocument.aspx?O=96">
            ...
            <td style="width: 240px" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                <telerik:RadComboBox ID="ddlTransmittal" runat="server" OnClientTextChange="LOD_DropDownTextChange"
                        ...
                        <div class="col-4 col-4-left">
                            <table class="colTable">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <%--   <span runat="server" id="rmd_txtShippedDate" style="display: block">
                                                        <asp:TextBox ID="txtShippedDate" onclick="showDatePopup(this, event);" onfocus="showDatePopup(this, event);"
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <%--<span runat="server" id="rmd_txtDueDate" style="display: block">
                                                        <asp:TextBox ID="txtDueDate" onclick="showDatePopup(this, event);" onfocus="showDatePopup(this, event);"
                                                            onblur="parseDate(this, event);" runat="server"></asp:TextBox></span>--%>
                                        <span runat="server" id="rmd_txtDueDate" style="display: block">
