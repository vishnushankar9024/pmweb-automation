    ...
    <div class="row">
        <div class="col-12 ResponsiveMargin">
            <telerik:RadGrid ID="rdgCostWorksheetColumns" runat="server" SetWidth="true" AppendMenus="true" 
                ...
                PageSize="25" AllowPaging="true" ShowFooter="False" ShowGroupPanel="False" Width="100%" ClientSettings-Scrolling-AllowScroll="true"
                            ...
                            <EditItemTemplate>
                                ...
                                <div>
                                    <asp:CustomValidator runat="server" ID="cvSystemField" CssClass="Validator"
                                        ClientValidationFunction="CheckSystemField" meta:resourcekey="cvSystemField" ErrorMessage="Enter a system field" Display="Dynamic" ValidationGroup="CostWorksheetColumns" />
                                </div>
                            </EditItemTemplate>
                            ...
                            <EditItemTemplate>
                                ...
                                <div>
                                    <asp:RequiredFieldValidator ID="rfvColumnName"
                                        ...
                                        ErrorMessage="Enter the column name" meta:resourcekey="rfvColumnName" Display="Dynamic" ValidationGroup="CostWorksheetColumns">
                            ...
                            <EditItemTemplate>
                                ...
                                <div>
                                    <asp:RequiredFieldValidator ID="rfvColumnSize"
                                        ...
                                        ErrorMessage="Enter the column size" meta:resourcekey="rfvColumnSize" Display="Dynamic" ValidationGroup="CostWorksheetColumns">
                                    </asp:RequiredFieldValidator>
                                </div>
                            </EditItemTemplate>
