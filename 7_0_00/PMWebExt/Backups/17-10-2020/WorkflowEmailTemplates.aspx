...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    <style>
        ...
        iframe#ctl00_CPH1_RadEditor1_contentIframe {
            height: 440px !important;
        }

            iframe#ctl00_CPH1_RadEditor1_contentIframe.reHtmlMode {
                height: 0 !important;
            }
...
"ff" : (document.selection ? "ie" : false));
    ...
    <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0">
        <tr class="ToolBar">
            <%-- <td class="ToolbarTd" style="width: 10%; padding-left: 5px; min-width:100px;">
                <div>
                    <b>
                        <asp:Label ID="lblRecordType" Text="Record Type" Style="white-space: no-wrap" meta:resourcekey="lblRecordType" runat="server"></asp:Label></b>
                </div>
            </td>--%>
            <td style="width: 240px" class="ToolbarTd">
                <telerik:RadComboBox ID="ddlRecordTypes" runat="server" Skin="Default" Width="240px"
                    AutoPostBack="True" NoWrap="True" AllowCustomText="True" CausesValidation="False"
                    Height="400px" LoadingMessage="<%$ Resources:PMWeb, Loading %>" CheckForDirt="True"
                    meta:resourcekey="ddlTemplates" Filter="Contains" EnableVirtualScrolling="True">
                ...
                <div class="col-4 col-4-left">
                    <fieldset>
                        ...
                        <telerik:RadGrid ID="rdgAttachToEmail" runat="server"
                            Height="100%" AllowPaging="true" PageSize="10" Width="100%" AutoGenerateColumns="False" FitParentContainer="true"
