...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
            ...
            <%--<telerik:AjaxSetting AjaxControlID="ddlProject">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="ddlPhase" LoadingPanelID="ldpPM" />
                     ...
                     <telerik:AjaxUpdatedControl ControlID="lblProjectError" /> 
                </UpdatedControls>
            </telerik:AjaxSetting>--%>
        ...
        <tr valign="top">
            <td valign="top">
                <table style="width: 100% !important;" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td class="ToolbarTd">
                            <asp:LinkButton runat="server" ID="btnSearchDocument" PostBackUrl="SearchDocument.aspx?O=90">
                        ...
                        <td style="width: 240px" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                            <telerik:RadComboBox ID="ddlDrawingLists" runat="server" OnClientTextChange="LOD_DropDownTextChange"
                                ...
                                ShowMoreResultsBox="True" EnableLoadOnDemand="true" meta:resourcekey="ddlDrawingLists"
                            ...
                            <telerik:RadToolBar ID="mainToolBar" runat="server" Skin="Default" AutoPostBack="True">
                                <Items>
                                    ...
                                    <telerik:RadToolBarSplitButton CommandName="Generate" PostBack="false" ImageUrl="Images/ToolBar/Generate.png"
                                     ...
                                     <telerik:RadToolBarButton SecurityButtonType="Add" OuterCssClass="HideOnMobileToolbar" PostBack="false" ImageUrl="Images/ToolBar/DeleteDoc.png"
                                    ...
                                    <%-- <telerik:RadToolBarSplitButton Text="Assign" CommandName="Assign" PostBack="false" SecurityButtonType="Calendar"
                                                    EnableDefaultButton="false" DropDownWidth="300px" Value="CalendarSplit">
                                                    <Buttons>
    ...
    <telerik:RadTabStrip OnClientTabSelecting="onTabSelecting" ID="tbsDocument" SelectedIndex="0" ScrollChildren="true" ScrollButtonsPosition="Left" CssClass="documentTabs"
        ...
        <Tabs>
            ...
            <%-- <telerik:RadTab Value="Packages" Text="Packages" />--%>
    ...
    <telerik:RadMultiPage ID="mlpDrawingLists" runat="server" SelectedIndex="0" Width="100%" CssClass="documentMultiPages"
                                            ...
                                            <tr>
                                                <td>
                                                    <telerik:RadComboBox ID="ddlFromContact" runat="server"
                                                        ...
                                                        <ItemTemplate>
                                                            <table style="width: 200px" cellspacing="0" cellpadding="2">
                                                                <tr>
                                                                    <td style="width: 100px;">
        ...
        <%--     <telerik:RadPageView ID="pvPackages" runat="server" Visible="False">
                                            </telerik:RadPageView>--%>
