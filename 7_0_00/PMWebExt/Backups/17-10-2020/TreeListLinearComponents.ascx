<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="TreeListLinearComponents.ascx.vb" Inherits="Website.TreeListLinearComponents" %>
    ...
    <div class="row">
        <div class="col-12">   
            <telerik:RadTreeList ID="rdtComponents" runat="server" AllowMultiItemEdit="True"  AllowPaging="true" PageSize="250" CssClass="StepsTreeStyle"
                                    ...
                                    AllowMultiItemSelection="True" AllowLoadOnDemand="true" ParentDataKeyNames="GuidId" 
                                    ShowTreeLines="False" EditMode="InPlace" DataKeyNames="GuidId" AlternatingItemStyle-BackColor ="#FFFFFF"
