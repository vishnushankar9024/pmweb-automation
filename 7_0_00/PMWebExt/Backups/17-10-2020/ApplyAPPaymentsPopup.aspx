<%@ Page meta:resourcekey="Page" Language="vb" AutoEventWireup="false" CodeBehind="ApplyAPPaymentsPopup.aspx.vb" Inherits="Website.ApplyAPPaymentsPopup" %>
...
<telerik:RadCodeBlock ID="CodeBlock" runat="server">
    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
            var tds = document.querySelectorAll('.labelWidth');
            var arrTd = Array.prototype.slice.call(tds);
            for (var i = 0; i < arrTd.length; i++) {
                if (arrTd[i].innerHTML.trim() === "" || arrTd[i].innerHTML === null || typeof (arrTd[i].innerHTML) === undefined)
        ...
        window.onresize = function () {
            ...
            if (document.querySelector('.PMMainPage').clientWidth > 880) { document.querySelector('.col-4-middle').style.left = "24px" }
            else {
                document.querySelector('.col-4-middle').style.left = "0px"
            }
        }
    </script>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="PMMainPage PMPopupMainPage documentSinglePage" style="margin-bottom:0">
            <div class="row">
                    ...
                    <table class="colTable">
                        ...
                        <tr>
                            ...
                            <td class="controlWidth">
                                <asp:TextBox ID="txtProject" runat="server" Enabled="false" Width="100%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="labelWidth">
                                <asp:Label ID="lblAPContract" runat="server" Text="A/P Contract" meta:Resourcekey="lblAPContract"></asp:Label>
                            </td>
                            <td class="controlWidth">
                                <asp:TextBox ID="txtAPContract" Enabled="false" runat="server" Width="100%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="labelWidth">
                ...
                <div class="col-4 col-4-right">
                    <table class="colTable">
                        <tr>
                            <td class="labelWidth" style="width:160px !important">
                                <asp:Label ID="lblCPPAppliedAmount" runat="server" Text="Applied Amount" meta:Resourcekey="lblAppliedAmount"></asp:Label>
                            ...
                            <td class="controlWidth">
                                ...
                                <asp:TextBox ID="txtCPPAppliedAmount" Enabled="false" Width="100%" CssClass="Currency" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="labelWidth">
            ...
            <div class="row">
                <div class="col-12">
                    <telerik:RadGrid ID="rdgApplyAPPayments" runat="server" AutoGenerateColumns="False" ShowStatusBar="True" HeaderStyle-Font-Size="8" Width="100%"
                        FilterType="HeaderContext" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true"
                        ShowGroupPanel="true" AllowMultiRowEdit="false" AllowFilteringByColumn="true" AllowMultiRowSelection="True" AllowSorting="true"
                        ItemStyle-Height="20px" GridLines="None" AllowPaging="false" clientsettings-allowscroll="true" setwidth="true" AppendMenus="true" FitParentContainer="true">
                        <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>" DataKeyNames="Id" CommandItemDisplay="Top"
                            ...
                            <Columns>
                                ...
                                <telerik:GridTemplateColumn ItemStyle-Wrap="false" HeaderStyle-Width="100px" HeaderText="Project" UniqueName="ProjectFullName"
                                ...
                                <telerik:GridTemplateColumn HeaderText="%" HeaderStyle-Width="60px" ItemStyle-Wrap="false" UniqueName="Percent" Groupable="false"
                                ...
                                <telerik:GridTemplateColumn HeaderText="Applied Amount" HeaderStyle-Width="90px" ItemStyle-Wrap="false" UniqueName="AppliedAmount"
                                    DataField="AppliedAmount" CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true"
                                    Groupable="false" SortExpression="">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtApplied" Width="99%" CssClass="Currency" Text='<%#FormatCurrency(Eval("AppliedAmount")) %>' runat="server"></asp:TextBox>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>

                                <telerik:GridTemplateColumn HeaderText="Applied In Full" HeaderStyle-Width="120px" UniqueName="AppliedInFull"
                                    DataField="AppliedInFull" CurrentFilterFunction="Contains" FilterListOptions="VaryByDataType" AutoPostBackOnFilter="true"
                                    ItemStyle-HorizontalAlign="Left" SortExpression="AppliedInFull" GroupByExpression="AppliedInFull [GridColumn_AppliedInFull] Group By AppliedInFull ASC">
                                    <ItemTemplate>
                                        <asp:CheckBox ID="chkSelect" Checked='<%# CBool(IIf(Eval("AppliedInFull") Is System.DBNull.Value, 0, Eval("AppliedInFull")))%>' runat="server" />
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
