                            ...
                            <tr>
                                ...
                                <td class="controlWidth">
                                    <table width="100%" class="TableNoSpacingNoBorder">
                                        <tr>
                                            <td width="60%">
                                                <asp:TextBox ID="txtCreatedByUser" ReadOnly="True" disabled="disabled" runat="server"></asp:TextBox>
                                            </td>
                            ...
                            <tr>
                                ...
                                <td class="controlWidth">
                                    <table width="100%" class="TableNoSpacingNoBorder" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td width="60%">
                                                <asp:TextBox ID="txtEditedByUser" ReadOnly="True" disabled="disabled" runat="server"></asp:TextBox>
                                            </td>
                                            <td width="40%" style="padding-left: 10px;">
