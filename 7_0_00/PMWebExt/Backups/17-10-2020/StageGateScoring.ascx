<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="StageGateScoring.ascx.vb" Inherits="Website.StageGateScoring" %>
          ...
          <telerik:GridTemplateColumn HeaderText="Weighted Score" SortExpression="WeightedScore" UniqueName="WeightedScore"
            ...
            <CommandItemTemplate> 
                <div style="padding:2px">
                    ...
                    <asp:LinkButton ID="btnAddScoring" runat="server" CausesValidation="False" SecurityButtonType="ItemMode_Add" CommandName="AddScoring"  CssClass="GridCmdAddScoring"  OnClientClick="return OpenSelectScoringPopup();"
