    ...
    <div class="col-4">
        ...
        <asp:Panel ID="pnlCustomFields" runat="server" Width="100%">
            <fieldset>
                ...
                <telerik:RadGrid ID="rdgCustomFormFields" runat="server" ShowHeader="false" SetWidth="true" ClientSettings-Scrolling-AllowScroll="true"
                    AutoGenerateColumns="False" ShowStatusBar="false" GridLines="None" Width="100%">
