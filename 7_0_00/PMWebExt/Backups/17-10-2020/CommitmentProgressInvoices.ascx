<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="CommitmentProgressInvoices.ascx.vb" Inherits="Website.CommitmentProgressInvoices" %>
...
<telerik:RadAjaxManagerProxy ID="RadAjaxManager1" runat="server">
    ...
    <telerik:RadGrid Id="rdgInvoices" AllowMultiRowSelection="false" runat="server"  CssClass="WithoutTopBorder" AllowFilteringByColumn="true" FilterType ="HeaderContext" EnableHeaderContextMenu ="true" EnableHeaderContextFilterMenu="true"
                         ...
                         AutoGenerateColumns="False"     AllowSorting="true" ShowStatusBar="false" AllowPaging="true"
                         PageSize="15">
                        ...
                        <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
                            ...
                            NavigateUrl='<%# "~/CostManagementProgressInvoices.aspx?Id=" & CStr(Container.DataItem("Id"))%>'></asp:HyperLink>
                                 </ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Invoice Type" UniqueName="InvoiceType" SortExpression ="InvoiceType" DataField="InvoiceType"
                            ...
                            <CommandItemTemplate>
                                <div style="padding: 2px">
                                    <b><asp:Label ID="lblDisplay" meta:Resourcekey="lblDisplay" Text="Display" runat="server"></asp:Label></b>
                                        ...
                                        <telerik:RadComboBox ID="ddlStatus" width="150px" DropDownWidh="150px" height="150px" runat="server"
