...
<script type="text/javascript">
    ...
    function OpenDocuSignPOPUp(URL) {
    ...
    function onCommentChange(txt) {
        var lbtComment = document.getElementById(txt.id.substring(txt.id.lastIndexOf('_'), txt.id.lenght - 1) + '_lbtApproverComment');
        if (txt.value === '') {
            lbtComment.setAttribute('disabled', 'disabled');
        }
        else {
            lbtComment.removeAttribute('disabled');
        }
    }
                                ...
                                <tr>
                                    <td colspan="6" wrap="false" style="padding: 0px !important; text-align: left">
                                        <asp:Panel ID="pnlWorkflowAction" runat="server">
                                         ...
                                         <asp:LinkButton runat ="server" ID ="lbtnBeginDocuSign" meta:resourcekey="lbtnBeginDocuSign" Text="BEGIN DOCUSIGN11"></asp:LinkButton>
                                        <asp:Label runat="server" Id="lblDocuSignMessage" style="margin-left: 4px;" Text ="DocuSign11"  meta:resourceKey="lblDocuSignMessage"></asp:Label> 
                                        <asp:LinkButton runat ="server" ID ="lbtnCancelDocuSign" CommandName="CancelDocuSign"  meta:resourcekey="lbtnCancelDocuSign" Text="CANCEL DOCUSIGN11"></asp:LinkButton>
                                    </td>
                                </tr>
                            </table>
                    </div>
