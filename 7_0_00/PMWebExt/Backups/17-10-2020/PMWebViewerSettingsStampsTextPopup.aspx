...
<body>
    <form id="form1" runat="server">
        ...
        <div class="PMMainPage PMPopupMainPage documentSinglePage">
            <div class="row">
                <div class="col-12">
                    <telerik:RadGrid ID="rdgStampText" runat="server" CssClass="ResponsiveMargin" AllowMultiRowEdit="true" AllowPaging="true" PageSize="10" SetWidth="true" ClientSettings-Scrolling-AllowScroll="true"
