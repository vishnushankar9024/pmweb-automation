...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        <script type="text/javascript">
            ...
            function maintoolbarClick(Value) {
                ...
                switch (Value) {
                    case 'Print':
                        OpenReportViewerPOPUp("PrintPreview.aspx?ReportId=125&Param=BidderId$ProcurementId&Values=" + '<%= PM.Estimate.BidderInfo.Id%>' + "$" + '<%=PM.Estimate.BidderInfo.ProcurementId%>');
    ...
    <table style="width: 100%;" cellpadding="0" cellspacing="0" class="ToolBar LargeToolBar">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:LinkButton runat="server" ID="btnSearchDocument" PostBackUrl="SearchDocument.aspx?O=95">
