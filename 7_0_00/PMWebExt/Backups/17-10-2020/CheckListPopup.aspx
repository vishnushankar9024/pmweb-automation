...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadSplitter ID="RadSplitter1" runat="server" Skin="Default" Width="100%" CssClass="documentSplitter"
            ...
            <telerik:RadPane ID="rpnResourceTree" runat="server" Width="420px" CssClass="NormalWhiteBack SplitterPanePopup height" EnableEmbeddedBaseStylesheet="False" Index="0" Skin="" OnClientExpanded="ClientResized" OnClientCollapsed="PaneCollapsed">
            ...
            <telerik:RadPane ID="rpnResourceGrid" runat="server" EnableEmbeddedBaseStylesheet="False" CssClass="fullWidthPane OverflowHidden height" OnClientResized="ClientResized"
                Index="2" Skin="">
