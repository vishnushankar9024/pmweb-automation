                                ...
                                <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn UniqueName="Value" HeaderText="Value" HeaderStyle-Width="150px" SortExpression="AttributeValue">
                                            ...
                                            <EditItemTemplate>
                                                <telerik:RadComboBox ID="ddlValues" runat="server" Filter="Contains" MarkFirstMatch="true" DropDownWidth="300px"
                                                    LoadingMessage="<%$ Resources:PMWeb, Loading %>" NoWrap="True" Skin="Default" Width="100%" AllowCustomText="True"
