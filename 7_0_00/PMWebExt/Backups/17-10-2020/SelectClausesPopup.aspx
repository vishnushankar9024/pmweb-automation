                            ...
                            <div class="col-4 col-4-left">
                                <table class="colTable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="controlWidth">
                                            <telerik:RadComboBox ID="ddlCategory" Filter="Contains" MarkFirstMatch="true" AllowCustomText="true" runat="server" Width="100%"></telerik:RadComboBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="labelWidth">
                                        ...
                                        <td class="controlWidth">
                                            <telerik:RadComboBox ID="ddlType" Filter="Contains" MarkFirstMatch="true" AllowCustomText="true" runat="server" Width="100%"></telerik:RadComboBox>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            <div class="col-4 col-4-right">
                                <table class="colTable">
                                    <tr>
                                        ...
                                        <td class="controlWidth">
                                            <telerik:RadComboBox ID="ddlResponsible" Filter="Contains" MarkFirstMatch="true" AllowCustomText="true" runat="server" Width="100%"></telerik:RadComboBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="labelWidth">
