...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <table class="ToolBar LargeToolBar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:LinkButton runat="server" ID="btnSearchDocument" PostBackUrl="SearchDocument.aspx?O=223">
            ...
            <td style="width: 240px;" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                <telerik:RadComboBox ID="ddlOnlineChangeRequests" runat="server" AllowCustomText="true"
            ...
            <td valign="middle" style="vertical-align: middle;" class="ToolbarTd">
                <telerik:RadToolBar ID="mainToolBar" runat="server" AutoPostBack="true">
                    ...
                    <Items>
                        <%--<telerik:RadToolBarButton SecurityButtonType="Read" CommandName="Search" ImageUrl="Images/ToolBar/lookup.png" Value="Search" NavigateUrl="SearchDocument.aspx?O=223" CausesValidation="false"></telerik:RadToolBarButton>--%>
                        ...
                        <%--<telerik:RadToolBarButton SecurityButtonType="CreateRevision" CommandName="CreateRevision" Value="CreateRevision" ImageUrl="Images/ToolBar/Revision.png"></telerik:RadToolBarButton>--%>
                        ...
                        <telerik:RadToolBarButton CssClass="lnkButtonBar" ValidationGroup="Save" PostBack="true" Value="Submit" CommandName="Submit" Text="Submit"
                                    ...
                                    <Items>
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem EnableImageSprite="true" Text="Submit" Value="Submit" CssClass="Submit" PostBack="true"></telerik:RadMenuItem>
                                            ...
                                            <table class="TableNoSpacingNoBorder">
                                                <tr>
                                                    ...
                                                    <td style="width: 40%; padding-left: 10px;">
                                                        <asp:TextBox ID="txtOriginalValueDays" CssClass="Integer" runat="server"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td class="controlWidth">
                                            <table class="TableNoSpacingNoBorder">
                                                <tr>
                                                    ...
                                                    <td style="width: 40%; padding-left: 10px;">
                                                        <asp:TextBox ID="txtApprovedChangesDays" CssClass="Integer" runat="server"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td class="controlWidth">
                                            <table class="TableNoSpacingNoBorder">
                                                <tr>
                                                    ...
                                                    <td style="width: 40%; padding-left: 10px;">
                                                        <asp:TextBox ID="txtRevisedValueDays" CssClass="Integer" runat="server"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <td class="controlWidth">
                                            <table class="TableNoSpacingNoBorder">
                                                <tr>
                                                    ...
                                                    <td style="width: 40%; padding-left: 10px;">
                                                        <asp:TextBox ID="txtThisRequestDays" CssClass="Integer" runat="server"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
