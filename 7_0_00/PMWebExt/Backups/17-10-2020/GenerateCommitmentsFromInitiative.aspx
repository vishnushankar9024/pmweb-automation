                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Panel ID="pnlGenerate" runat="server"
                                        Style="float: right; text-align: center; width: 100%;" meta:resourcekey="pnlGenerateResource1">
            ...
            <div class="row">
                <div class="col-12">
                    <telerik:RadGrid ID="rdgContractDetails" runat="server" SetWidth="true" FitParentContainer="true" ClientSettings-Scrolling-AllowScroll="true"
                        AutoGenerateColumns="False" ShowStatusBar="True" CellPadding="0" Width="100%" AppendMenus="true" FitPageHeightOffset="24"
                        GridLines="None">
