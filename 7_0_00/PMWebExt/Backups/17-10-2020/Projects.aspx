...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <table class="ToolBar SmallToolbar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:LinkButton runat="server" ID="btnSearchDocument" PostBackUrl="SearchDocument.aspx?O=1">
                                        ...
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                <telerik:RadMenuItem Text="Print" Value="Print">
                                                    <Items>
                                                        <telerik:RadMenuItem SecurityButtonType="Read" Text="BI Reporting" Value="ViewReports"></telerik:RadMenuItem>
                                                    </Items>
                                                </telerik:RadMenuItem>
                                    ...
                                    <tr>
                                        ...
                                        <td class="controlWidth">
                                            <telerik:RadComboBox ID="ddlPrograms" runat="server" Height="300px" meta:Resourcekey="ddlPrograms"
                                                EmptyMessage="Select Program..." Skin="Default" AutoPostBack="true" AllowCustomText="true">
                                            ...
                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    ...
                                                    <td style="width: 50%; padding-left: 8px;">
                                                        <telerik:RadComboBox AllowCustomText="true" ID="ddlUOM" Filter="Contains" MarkFirstMatch="true" Width="100%" runat="server"></telerik:RadComboBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
