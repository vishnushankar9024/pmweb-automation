<%@ Page Language="vb" AutoEventWireup="false" meta:resourcekey="Page" CodeBehind="EstimatePMProcurement.aspx.vb" Inherits="Website.EstimatePMProcurement" %>
...
<body style="background: White !important;">
    <form id="form1" runat="server">
        ...
        <div class="PMMainPage PMPopupMainPage documentSinglePage">
                ...
                <div class="col-4">
                    <telerik:RadAjaxPanel ID="pnlDetailPane" runat="server" Width="100%" HorizontalAlign="NotSet">
                        <table class="colTable">
                                ...
                                <td class="controlWidth">
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            ...
                                            <td style="width: 50px; padding-left: 8px" align="right">
                            ...
                            <tr class="Hide">
                                <td class="labelWidth">
                                    <asp:Label ID="lblContracts" CssClass="Hide" runat="server"></asp:Label>
                                </td>
                                <td class="controlWidth">
                                    <asp:TextBox ID="txtContracts" CssClass="Hide" runat="server"></asp:TextBox>
                                </td>
                            </tr>
                            <tr class="Hide">
                                <td class="labelWidth">
                                    <asp:Label ID="lblPurchaseOrders" CssClass="Hide" runat="server"></asp:Label>
                                </td>
                                <td class="controlWidth">
                                    <asp:TextBox ID="txtPurchaseOrders" CssClass="Hide" runat="server"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="labelWidth">
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:Panel ID="pnlGenerate" runat="server"
                                        ...
                                        <asp:Button ID="btnContracts" runat="server" Text="<%$ Resources:PMWeb, Generate %>" CssClass="Hide" />
            ...
            <div class="row">
                <div class="col-12">
                    <telerik:RadGrid ID="rdgContractDetails" runat="server" SetWidth="true" FitParentContainer="true" ClientSettings-Scrolling-AllowScroll="true" FitPageHeightOffset="24"
                        AutoGenerateColumns="False" ShowStatusBar="True" CellPadding="0" Width="100%" ClientSettings-Resizing-AllowColumnResize="true"
                        GridLines="None">
                        ...
                        <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
                            ...
                            <Columns>
                                ...
                                <telerik:GridTemplateColumn HeaderText="Bid Category" UniqueName="BidCategory">
                                    <ItemTemplate>
                                        <telerik:RadComboBox ID="ddlBidCategory" runat="server" Width="100%">
                                        </telerik:RadComboBox>
                                    </ItemTemplate>
                                ...
                                <%--   <telerik:GridTemplateColumn HeaderText="Generate" UniqueName="Generate">
                                    <ItemTemplate>
                                        <asp:DropDownList ID="ddlTypes" runat="server" Width="100%" onchange="CalculateTotals(this); return false;"
                                            >
                                        </asp:DropDownList>
                                    </ItemTemplate>
                                    <ItemStyle Wrap="false" HorizontalAlign="Left" />
                                ...
                                <telerik:GridTemplateColumn HeaderText="">
                                    <ItemTemplate>
                                        ...
                                        <asp:HiddenField ID="hdnProcurementId" runat="server" />
                                    </ItemTemplate>
                                    <ItemStyle Wrap="false" HorizontalAlign="Center" />
