    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        <script type="text/javascript">
            ...
            function maintoolbarClick(Value) {
                if (Value == "Print") {
                    window.location = "ReportManager.aspx?ModuleId=5";
                    args.set_cancel(true);
                }
            }
            ...
            <td style="vertical-align: middle;" class="ToolbarTd">
                <telerik:RadToolBar ID="mainToolBar" runat="server" Skin="Default" AutoPostBack="true">
                    <Items>
                        ...
                        <telerik:RadToolBarButton SecurityButtonType="Read" ImageUrl="Images/ToolBar/Printer.png"
                            ToolTip="Print" PostBack="false" CommandName="Print" CssClass="" OuterCssClass="HideOnMobileToolbar">
                        </telerik:RadToolBarButton>
