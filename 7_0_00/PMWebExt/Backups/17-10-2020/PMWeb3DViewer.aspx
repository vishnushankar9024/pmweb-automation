                            ...
                            <td class="ToolbarTd">
                                <telerik:RadToolBar ID="mainToolBar" runat="server" AutoPostBack="false" Width="100%" CssClass="popup-toolbar">
                                    <Items>
                                        ...
                                        <telerik:RadToolBarButton PostBack="False" CommandName="LoadDefault" OuterCssClass="HideOnMobileToolbar" Value="LoadDefault" Style="margin-left: 10px" CssClass="ToolbarRefresh"
                                            EnableImageSprite="true" Visible="true" />
