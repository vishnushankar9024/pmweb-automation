        ...
        <div class="row">
                    ...
                    <div style="height: 218px; max-height: 218px; display: block; overflow: auto; border: 1px solid silver;">
                        <table style="width: 100%; vertical-align: top; text-align: left;" border="0">
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="lblPlanning" runat="server" meta:resourcekey="lblPlanning" CssClass="Bold" Text="Planning"></asp:Label>
                                </td>
                            ...
                            <tr id="trProcurement">
                                ...
                                <td class="CheckLicense">
                                    ...
                                    <asp:Label ID="lblProcurement" runat="server" meta:resourcekey="lblProcurement" Text="Procurement"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="CheckLicense">
                                ...
                                <td>
                                    <asp:Label ID="lblProjectManagement" runat="server" meta:resourcekey="lblProjectManagement" CssClass="Bold" Text="Engineering Forms"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="CheckLicense">
                                ...
                                <td>
                                    <asp:Label ID="lblCostManagement" runat="server" meta:resourcekey="lblCostManagement" CssClass="Bold" Text="Cost Management"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="CheckLicense">
                                ...
                                <td>
                                    <asp:Label ID="lblScheduling" runat="server" meta:resourcekey="lblScheduling" CssClass="Bold" Text="Scheduling"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="CheckLicense">
                                ...
                                <td>
                                    <asp:Label ID="lblAssetManagement" runat="server" meta:resourcekey="lblAssetManagement" CssClass="Bold" Text="Asset Management"></asp:Label>
                                </td>
                            </tr>
                            <tr id="trAssetExplorer">
                                ...
                                <td class="CheckLicense">
                                    ...
                                    <asp:Label ID="lblAssetExplorer" runat="server" meta:resourcekey="lblAssetExplorer" Text="Asset Explorer"></asp:Label>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="lblWorkflow" runat="server" meta:resourcekey="lblWorkflow" CssClass="Bold" Text="Workflow"></asp:Label>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="lblToolbox" runat="server" meta:resourcekey="lblToolbox" CssClass="Bold" Text="Workflow"></asp:Label>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="CheckLicense">
                                    ...
                                    <asp:Label ID="lblVendorPrequalification" runat="server" meta:resourcekey="lblVendorPrequalification" Text="Vendor Prequalification"></asp:Label>
                                </td>
                            </tr>
            ...
            <div class="col-4 col-4-middle">
                <table class="colTable">
                    ...
                    <tr>
                        <td runat="server" id="tdConcurrentUsers" colspan="2">
                            <fieldset style="width: 100%;">
                                <legend>
    ...
    <div class="row">
        <div class="col-12 ResponsiveMargin">
            <telerik:RadGrid ID="rdgUsers" runat="server" AutoGenerateColumns="False" ShowStatusBar="true" FilterType="HeaderContext" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true"
                HeaderStyle-Font-Size="8" PageSize="10" AllowPaging="true" AllowFilteringByColumn="true" AllowMultiRowEdit="false" AllowMultiRowSelection="True" allow-scroll="true" ClientSettings-Scrolling-AllowScroll="true"
