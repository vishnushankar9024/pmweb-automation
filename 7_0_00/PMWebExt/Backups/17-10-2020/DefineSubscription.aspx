...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OpenReminderMultipleCompanyFilterPopup(txtContact, txtEmail, txtIds, Type, Source) {
            ...
            var win = OpenPOPUp('CompaniesFilterPopup.aspx?txtContact=' + txtContact + '&Bidder=' + Bidder + '&txtEmail=' + txtEmail + '&Type=' + Type + '&txtIds=' + txtIds + '&ddlType=Multiple&Source=' + Source + '&ProjectId=' + ProjectId, '',
        ...
        function OpenSelectUserPopup() {
            ...
            var top = (screen.height - 300) / 2;
            var Bidder = 0;
            var win = OpenPOPUp('SelectUserPopup.aspx?&Bidder=' + Bidder + '&Source=Subscription', '',
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="pnlDetailPane" runat="server" Width="100%" ClientEvents-OnResponseEnd="ResponseEnd" ClientEvents-OnRequestStart="RequestStart">
            <div class="PMMainPage documentSinglePage PMPopupMainPage">
                <div class="row">
                    ...
                    <div class="col-4 col-4-middle">
                        ...
                        <table class="colTable" style="padding-top: 5px">
                            <tr>
                                ...
                                <td class="controlWidth">
                                    <div style="width: 100%; height: 70px; max-height: 70px; overflow: auto; float: left"
