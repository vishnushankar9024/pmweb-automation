...
<asp:Content ID="C2" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        ...
        <script type="text/javascript">
            ...
            function maintoolbarClick(Value) {
                ...
                switch (Value) {
                    case 'Print':
                        OpenReportViewerPOPUp("PrintPreview.aspx?ReportId=48&Param=EstimateId&Values=" + '<%=PM.Estimate.EstimateInfo.Id%>');
                        break;
                    case 'Estimate':
    ...
    <table style="width: 100%;" cellpadding="0" cellspacing="0" class="ToolBar EstimateToolBar LargeToolBar"> 
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:LinkButton runat="server" ID="btnSearchDocument" PostBackUrl="SearchDocument.aspx?O=2">
          ...
          <td class="ToolbarTd HideOnMobileToolbar showOnIpad Recent">
            ...
            <td style="width: 240px" class="ToolbarTd HideOnMobileToolbar ShowDropDown showOnIpad">
                <telerik:RadComboBox ID="ddlEstimates" runat="server" OnClientTextChange="LOD_DropDownTextChange" NoWrap="True"
                    ...
                    meta:resourcekey="ddlEstimates" ShowMoreResultsBox="True" EnableLoadOnDemand="true" OnItemsRequested="ddl_ItemsRequested">
                        ...
                        <div class="col-4 col-4-middle">
                            <fieldset id ="flsRecap" runat="server">
                                ...
                                <table id="tblEstimate2" class="colTable">
                                    <tr>
                                        <td class="labelWidth">
                                            <asp:Label ID="lblEstimateUnitOfMesure" runat="server" meta:resourcekey="lblEstimateUnitOfMesure"></asp:Label>
                                        </td>
                                        <td class="controlWidth">
                                    ...
                                    <tr>
                                        <td class="labelWidth">
                                            <asp:Label ID="lblEstimateUnits" runat="server" meta:resourcekey="lblEstimateUnits"></asp:Label>
                                        </td>
                                        <td class="controlWidth">
