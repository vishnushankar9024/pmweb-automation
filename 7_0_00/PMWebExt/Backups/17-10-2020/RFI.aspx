...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
                ...
                switch (Value) {
                    case 'ViewTemplates':
                        if (HasMergeTemplate == 'True') {
                            ...
                            //wnd.setSize(1045, 515);
                            //wnd.Center();

                            <%--window.open("MergeTemplatePopup.aspx?ObjectType=RFI&Id=" +
                                    '<%= PM.Document.RFIInfo.Id%>' + "&Description="
                            + Description
                            + "&RecordDescription=" + RecordDescription
                            + "&EntityId=" + '<%=PM.Document.RFIInfo.ProjectId%>' + "&EntityType=0",
                    ...
                    case 'Notification':
                        ...
                        //wnd.setSize(820, 500);
                        //wnd.Center();
                        <%--window.open("Notification.aspx?ObjectType=RFI&Id=" +
                               '<%= PM.Document.RFIInfo.Id%>' + "&Description="
                            + Description
                            + "&RecordDescription=" + RecordDescription
                            + "&EntityId=" + '<%=PM.Document.RFIInfo.ProjectId%>' + "&EntityType=0", "Notification",
                'location=no,status=0,menubar=0,addressbar=0,resizable=1,scrollbars=1,width=820,height=500,top=' + top + ',left=' + left);--%>
                    ...
                    case 'ViewReports':
                        if (HasReports == 'True') {
                           ...
                           <%-- window.open("ReportsPreviewPopup.aspx?ObjectType=RFI&Id=" +
                                   '<%= PM.Document.RFIInfo.Id%>'
                            + "&RecordDescription=" + RecordDescription
                            + "&EntityId=" + '<%=PM.Document.RFIInfo.ProjectId%>' + "&EntityType=0",
                    ...
                    case 'ViewPMWebReports':
                      ...
                      + "&EntityId=" + '<%=PM.Document.RFIInfo.ProjectId%>' + "&EntityType=0"
                          ...
                          <%--  window.open("PMWebReports.aspx?ObjectType=RFI&Id=" + Id
                        + "&EntityId=" + '<%=PM.Document.RFIInfo.ProjectId%>' + "&EntityType=0",
    ...
    <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0" class="SmallToolbar">
        <tr class="ToolBar">
            <td class="ToolbarTd">
                <asp:LinkButton runat="server" ID="btnSearchDocument" PostBackUrl="SearchDocument.aspx?O=68">
            ...
            <td style="width: 240px" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                <telerik:RadComboBox ID="ddlRFI" runat="server" meta:resourcekey="ddlRFI" OnClientTextChange="LOD_DropDownTextChange"
                    OnClientSelectedIndexChanging="MainDropDown_SelectedIndexChanging" AutoPostBack="false" Width="240px" NoWrap="True" AllowCustomText="True"
            ...
            <td valign="middle" style="vertical-align: middle; width: 70%" class="ToolbarTd">
                <telerik:RadToolBar ID="mainToolBar" runat="server" AutoPostBack="True">
                    <Items>
                        ...
                        <%--<telerik:RadToolBarButton SecurityButtonType="Add" CommandName="CreateRevision" Visible="false" ImageUrl="Images/ToolBar/Revision.png">
                    </telerik:RadToolBarButton>--%>
                        ...
                        <div class="col-4 col-4-left">
                            <table class="colTable">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlToContact" runat="server"
                                ...
                                <tr>
                                    <td class="labelWidth">
                                        <asp:Label ID="LblCost" meta:resourcekey="lblEffects" runat="server" Text="Affects Cost"></asp:Label>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="labelWidth">
                                        <asp:Label ID="LblSchedule" meta:resourcekey="lblEffects" runat="server" Text="Affects Schedule"></asp:Label>
                                    </td>
                                    <td>
