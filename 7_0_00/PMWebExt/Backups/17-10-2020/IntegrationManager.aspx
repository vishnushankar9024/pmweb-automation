...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <table style="width: 100%; vertical-align: top;" cellpadding="0" cellspacing="0">
        <tr class="ToolBar SmallToolbar">
            <td style="width: 240px" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                <telerik:RadComboBox ID="ddlIntegrationManager" runat="server" OnClientTextChange="LOD_DropDownTextChange"
                    CloseDropDownOnBlur="true" AllowCustomText="true" meta:resourcekey="ddlIntegrationManager"
                                    ...
                                    <Items>
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem Text="Get WEB SERVICE INSTALLER" Value="WebServiceInstaller" 
                                                    CssClass="lnkButtonBar" EnableImageSprite="true" Visible="false">
                                                </telerik:RadMenuItem>
                                            </Items>
                                        </telerik:RadMenuItem>
                                    </Items>
    ...
    <telerik:RadMultiPage ID="mlpIntegration" runat="server" SelectedIndex="0" Width="100%"
        ...
        <telerik:RadPageView ID="pvConfigure" runat="server" Width="100%" Selected="True">
            <%-- <uc1:IntegrationManagerConfigure ID="IntegrationManagerConfigure1" runat="server" />--%>
                    ...
                    <div class="row row-8-4-fit8" style="padding-top: 0px">
                        ...
                        <div class="col-8 AddTopPaddWhenUnfit">
                            ...
                            <telerik:RadGrid ID="rdgRecords" runat="server" SetWidth="true" AppendMenus="true" UseEditFormInMobile="true"
                                AutoGenerateColumns="False" ShowStatusBar="false" Font-Size="8px" PageSize="10"
                                ...
                                <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
                                    ...
                                    <Columns>
                                        <telerik:GridTemplateColumn HeaderText="Record Type" GroupByExpression="RecordType [GridColumn_RecordType] Group By RecordType ASC"
                                            ...
                                            <EditItemTemplate>
                                                <telerik:RadComboBox ID="ddlRecordType" MarkFirstMatch="true" runat="server" OnClientSelectedIndexChanged="SetfileName" Filter="Contains"
                                                    Width="100%" AutoPostBack="False" NoWrap="True" AllowCustomText="True"
                                                    CausesValidation="False">
                                                </telerik:RadComboBox>
                                                <asp:HiddenField ID="txtId" Value='<%#Eval("Id")%>' runat="server"></asp:HiddenField>
