...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <table class="ToolBar SmallToolbar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:LinkButton runat="server" ID="btnSearchDocument" PostBackUrl="SearchDocument.aspx?O=105">
            ...
            <td class="ToolbarTd HideOnMobileToolbar showOnIpad" style="width:240px;">
                <telerik:RadComboBox ID="ddlProductions" runat="server" Filter="Contains" MarkFirstMatch="true" DropDownCssClass="ddlTreeviewTemplate"
