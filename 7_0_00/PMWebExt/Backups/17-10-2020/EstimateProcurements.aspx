...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        ...
        <script type="text/javascript">
            ...
            function maintoolbarClick(Value) {
                {
                    ...
                    switch (Value) {
                        ...
                        case 'ViewReports':
                            ...
                            break;
                        case 'Print':
                            OpenReportViewerPOPUp("PrintPreview.aspx?ReportId=127&Param=ProcurementId&Values=" + '<%=PM.Estimate.ProcurementInfo.Id%>');
            ...
            function OpenNDAEditorPopup() {
                ...
                var wnd = window.radopen('NDAEditorPopUp.aspx?ObjectType=ESTIMATE_PROCUREMENT');
                if (isMobileScreen()) {
    ...
    <table style="width: 100%;" cellpadding="0" cellspacing="0" class="ToolBar SmallToolbar">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:LinkButton runat="server" ID="btnSearchDocument" PostBackUrl="SearchDocument.aspx?O=94">
                    ...
                    <div class="row">
                        <div class="col-4 col-4-left">
                            ...
                            <table class="colTable">
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlProgram" Filter="Contains" MarkFirstMatch="true" AllowCustomText="true"
                                            runat="server" AutoPostBack="true" Skin="Metro" NoWrap="true" Width="100%"
                                ...
                                <tr>
                                    <td class="labelWidth">
                                        <asp:Label ID="lblType" meta:Resourcekey="lblCommitmentType" runat="server" Text="Commitment Type"></asp:Label>
                                    </td>
                                    <td class="controlWidth">
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <asp:TextBox ID="txtEstimateNumber" runat="server" ReadOnly="true" disabled="disabled" CssClass="PositiveInteger"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="labelWidth">
                                        <asp:Label ID="lblCommitmentID" meta:Resourcekey="lblCommitment" runat="server" Text="Commitment" Visible="false"></asp:Label>
                                        <asp:HyperLink runat="server" CssClass="Link" ID="hliCommitmentID" meta:Resourcekey="lblCommitment" Text="Commitment" Visible="false"></asp:HyperLink>
                                    </td>
                                    <td class="controlWidth">
                        ...
                        <div class="col-4 col-4-middle">
                            <fieldset style="width: 100%">
                                ...
                                <table id="tblOptions" class="TableOptionsNoSpacingNoBorder" width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td></td>
