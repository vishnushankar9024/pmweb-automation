        ...
        <tr valign="top">
            <td>
                <table style="width: 100%;" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                       <td style="padding-left:24px;width:160px !important;">
                        ...
                        <td style="padding-left:24px">
                            <telerik:RadComboBox ID="ddlProjects" UseProjectFilter="1" runat="server" AutoPostBack="true"
                                Skin="Default" CausesValidation="false" OnSelectedIndexChanged="ddlProjects_SelectedIndexChanged"
                                Filter="Contains" MarkFirstMatch="true" 
                                NoWrap="true" Width="240px" Height="300px"
...
<%--                                            <telerik:RadComboBox ID="ddlProjects" UseProjectFilter="1" runat="server" AutoPostBack="true"
        ...
        <tr>
            <td style="padding-top: 10px; padding-left: 24px; ">
