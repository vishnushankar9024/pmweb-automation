...
<%@ Register Src="DocumentAttachments.ascx" TagName="DocumentAttachments" TagPrefix="uc1" %>
...
<%@ Register Src="DocumentTeam.ascx" TagName="DocumentTeam" TagPrefix="uc3" %>
<%@ Register Src="DocumentSpecifications.ascx" TagName="DocumentSpecifications" TagPrefix="uc12" %>
...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <table class="ToolBar LargeToolBar" style="width: 100%;" cellpadding="0" cellspacing="0">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:LinkButton runat="server" ID="btnSearchDocument" PostBackUrl="SearchDocument.aspx?O=49">
            ...
            <td style="width: 240px" class="ToolbarTd HideOnMobileToolbar showOnIpad">
                <telerik:RadComboBox ID="ddlTenantsRequest" runat="server" meta:resourceKey="ddlTenantsRequest" AllowCustomText="true"
                    Skin="Default" CloseDropDownOnBlur="true" Height="400px" CausesValidation="False" OnClientTextChange="LOD_DropDownTextChange"
                    Width="240px" AutoPostBack="False" NoWrap="true" OnClientSelectedIndexChanging="MainDropDown_SelectedIndexChanging"
                                    ...
                                    <Items>
                                        <telerik:RadMenuItem CssClass="menuMore">
                                            <Items>
                                                ...
                                                <telerik:RadMenuItem Text="Submit" Value="Submit"></telerik:RadMenuItem>
                    ...
                    <div class="row JustifyContent R3Cols">
                        ...
                        <div class="col-4 col-4-middle">
                            <table class="colTable">
                                ...
                                <tr>
                                    <td class="labelWidth" >
                                        <asp:HyperLink runat="server" CssClass="Link" ID="hliWorkOrder" meta:Resourcekey="hpLinkedRecords" Text="Linked Work Order" font-size="12px" ></asp:HyperLink>
                                    </td>
                                    <td class="controlWidth">
                                        <asp:TextBox runat="server" ID="txtWorkOrder"></asp:TextBox>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <telerik:RadComboBox ID="ddlContacts" runat="server" EnableVirtualScrolling="True" OnItemsRequested="ddl_ItemsRequested"
                                ...
                                <tr>
                                    ...
                                    <td class="controlWidth">
                                        <asp:TextBox ID="txtGeolocotion" MaxLength="100" runat="server"></asp:TextBox>
