...
<table border="0" style="width: 100%" cellpadding="0" cellspacing="0">
    <tr class="ToolBar" style="position: relative !important; top: 0px !important;">
            ...
            <table class="colTable">
                ...
                <tr>
                    ...
                    <td class="controlWidth"><span runat="server" id="rmd_dtpConstraintDate" style="display: block; width: 100%;">
                        <telerik:RadDatePicker Width="100%" ID="dtpConstraintDate" runat="server" MinDate="1901-01-01" MaxDate="2100-01-01"
                    ...
                    <MasterTableView CommandItemDisplay="None" Width="100%" TableLayout="Fixed" UseAllDataFields="true">
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderStyle-Width="150px" ItemStyle-Wrap="false" HeaderText="Start"
                                ...
                                <ItemTemplate>
                                    <telerik:RadDatePicker Width="145px" ID="dtpStartDate" Style="display: inline" runat="server" MinDate="1901-01-01" MaxDate="2100-01-01"
                                        EnableTyping="True">
                                    </telerik:RadDatePicker>
                                </ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderStyle-Width="150px" ItemStyle-Wrap="false" HeaderText="Finish"
                                ...
                                <ItemTemplate>
                                    <telerik:RadDatePicker Width="145px" ID="dtpFinishDate" Style="display: inline" runat="server" MinDate="1901-01-01" MaxDate="2100-01-01"
                                        EnableTyping="True">
                                    </telerik:RadDatePicker>
                                </ItemTemplate>
                                <HeaderStyle Width="150px"></HeaderStyle>
