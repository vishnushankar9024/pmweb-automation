...
<asp:Content ID="Content2" ContentPlaceHolderID="ACPH1" runat="server">
    ...
    <telerik:RadCodeBlock runat="server" ID="TERS">
        <table style="width:100%" cellpadding="0" cellspacing="0">
            ...
            <tr valign="top">
                <td class="ToolbarTd">
                    <asp:LinkButton runat="server" ID="btnSearchDocument" PostBackUrl="SearchDocument.aspx?O=9">
                            ...
                            <div class="col-4 col-4-left">
                                <table class="colTable">
                                    ...
                                    <tr>
                                        ...
                                        <td class="controlWidth">
                                            <asp:TextBox runat="server" ID="txtCode" MaxLength="15" Text="10002ABC"></asp:TextBox>
