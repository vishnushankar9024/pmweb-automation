...
<div style="width: 100%">
    <telerik:RadSplitter ID="RadSplitter1" runat="server" CssClass="treeSplitter height" Orientation="vertical" Skin="Default" Width="100%" SplitBarsSize="" OnClientLoad="onResized">
        <telerik:RadPane ID="rpPunchListDetails" Style="background: white;" runat="server" CssClass="tree-splitter-pane height" Width="35%" Index="0" EnableEmbeddedBaseStylesheet="False"
            Skin="" OnClientCollapsed="OnClientCollapsed" OnClientExpanded="OnClientExpanded" OnClientResized="AssetSplitterResized">
        ...
        <telerik:RadPane ID="RadContentPane" BorderWidth="0" Width="100%" runat="server" CssClass="height" Index="2" Skin="Default" OnClientResized="ClientResized">
            <div class="PMHeader">
                <div class="row">
