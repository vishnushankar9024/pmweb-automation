...
<body>
    <script type="text/javascript">
        ...
        function OpenRegionsWeatherPopup(Width, Height) {
            ...
            var qs = getQueryStrings();
            var PopupId = qs["PopupId"];
            OpenSmallPOPUpParent('RegionsWeatherPopup.aspx?PopupId=' + PopupId, Width, Height, null, null)
            ActivatePopup()
            return false;
        }
    ...
    <form id="form1" runat="server">
        ...
        <telerik:RadGrid ID="rdgWidgets" runat="server" HeaderStyle-Font-Size="8" Width="99%" AutoGenerateColumns="False" AllowMultiRowEdit="True" SetWidth="true" AppendMenus="true" Style="margin-top: 50px;"
