                ...
                <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>" DataKeyNames="Id" CommandItemDisplay="Top"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="110px" UniqueName="PaymentAmount" ItemStyle-Wrap="false" HeaderText="Payment Amount"
                            ...
                            <EditItemTemplate>
                                <asp:TextBox ID="txtPaymentAmount" CssClass="Currency" runat="server" MinNumber="0" Width="100%" Text='<%#FormatCurrency(Eval("PaymentAmount"), CurrencyId:=IIf(Eval("CurrencyId") Is DBNull.Value, 0, Eval("CurrencyId")))%>'></asp:TextBox>
                            </EditItemTemplate>
                            <HeaderStyle Width="110px" />
                            <ItemStyle HorizontalAlign="Right" />
                            <FooterStyle HorizontalAlign="Right" />
