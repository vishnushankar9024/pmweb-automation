...
<asp:Content ID="C1" ContentPlaceHolderID="CPH1" runat="server">
            ...
            function maintoolbarClick(Value) {
                ...
                switch (Value) {
                    ...
                    case 'ViewTemplates':
                        ...
                        break;
                    case 'New':
                        window.location = "PortfolioPlanning.aspx";
                        break;
    ...
    <table style="width: 100%;" class="ToolBar LargeToolBar" cellpadding="0" cellspacing="0">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:LinkButton runat="server" ID="btnSearchDocument" PostBackUrl="SearchDocument.aspx?O=137">
            ...
            <td valign="middle" style="padding-left: 24px; width: 70%" class="ToolbarTd">
                <telerik:RadToolBar ID="mainToolBar"
                    ...
                    <Items>
                        ...
                        <telerik:RadToolBarSplitButton EnableDefaultButton="false" PostBack="false" OuterCssClass="HideOnMobileToolbar" CssClass="ToolbarGenerate" CommandName="Generate" ImageUrl="Images/ToolBar/Generate.png" ToolTip="Generate" >
                            <Buttons>
                                <telerik:RadToolBarButton PostBack="false" Value="genProject" CommandName="GenerateProjectRecords" ImageUrl="Images/ToolBar/PMWebW.gif">
                                </telerik:RadToolBarButton>
                            </Buttons>
                        </telerik:RadToolBarSplitButton>
