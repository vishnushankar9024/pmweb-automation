<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ContractChanges.ascx.vb" Inherits="Website.ContractChanges" %>
...
<telerik:RadAjaxManagerProxy ID="RadAjaxManager1" runat="server">
    ...
    <telerik:RadGrid Id="rdgChanges" AllowMultiRowSelection="false" runat="server" CssClass="WithoutTopBorder" AllowFilteringByColumn="true" FilterType ="HeaderContext" EnableHeaderContextMenu ="true" EnableHeaderContextFilterMenu="true"
                        ...
                        <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>"
                            ...
                            NavigateUrl='<%# "~/CostManagementContractsCO.aspx?Id=" & CStr(Container.DataItem("Id"))%>'></asp:HyperLink>
                                 </ItemTemplate>
                ...
                <%--            <telerik:GridTemplateColumn HeaderText="Post As" UniqueName="PostAs" SortExpression ="PostAs"
                                ...
                                <HeaderStyle Width="60px"></HeaderStyle>
                                 ...
                                 <telerik:GridTemplateColumn HeaderText="Total" UniqueName="Totalchange" DataField ="Totalchange"  Aggregate="Sum" FooterAggregateFormatString="{0:N}"
                                Groupable="false" Reorderable="true" SortExpression ="Totalchange">
                                <ItemTemplate>
                                    <span><%#FormatCurrency(Eval("Totalchange"))%></span>
                                </ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Days" UniqueName="Days" DataField="Days"
                            ...
                            <telerik:GridTemplateColumn HeaderText="Status" UniqueName="Status" DataField="Status"
                             ...
                             <telerik:GridTemplateColumn HeaderText="Date" UniqueName="RevisionDate" DataField="RevisionDate"
                               ...
                               <telerik:GridBoundColumn Aggregate="SUM" DataField="Totalchange" Visible="False" />
                            </Columns>
