...
//        }
   ...
   <style type="text/css">
    ...
    <telerik:RadScriptManager ID="ScriptManager1" runat="server" />
       <telerik:RadAjaxManager ID="PMAjaxManager" runat="server" DefaultLoadingPanelID="ldpPM" ClientEvents-OnRequestStart="RequestStart" ClientEvents-OnResponseEnd="VendorApplicationCallBack">
            <AjaxSettings>
                                       ...
                                       <tr>
                                           ...
                                           <td class="padding displayRow">
                                            ...
                                            <tr>
                                                ...
                                                <td class="controlWidth"><asp:TextBox ID="txtApplicationYear" Enabled="false" runat="server" ></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="controlWidth"><asp:TextBox ID="txtAccountID"  Enabled="false" runat="server" ></asp:TextBox></td>
                                            </tr>
                                            <tr id="S_7">
                                                ...
                                                <td class="controlWidth"><asp:TextBox ID="txtApplicationID"  Enabled="false" runat="server"></asp:TextBox></td>
                                            </tr>
                                        </table>
                                           </td>
                                       </tr>
	...
	<script type="module" src="https://cmcs.pmweb.com/7_0_00/pmwebext/vendorapplication.js"></script>
</body>
</html>
