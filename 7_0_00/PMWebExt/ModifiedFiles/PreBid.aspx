...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <telerik:RadCodeBlock ID="CodeBlock" runat="server">
        ...
        <script type="text/javascript">
            ...
            function OpenNDAEditorPopup() {
                var browserWidth = $telerik.$(window).width();
                var browserHeight = $telerik.$(window).height();
                var wnd = window.radopen('NDAEditorPopUp.aspx?ObjectType=PREBID');
                if (isMobileScreen()) {
                    wnd.setSize(browserWidth - 10, browserHeight);
                    wnd.moveTo(0, 0);
                }
    ...
    <table style="width: 100%;" cellpadding="0" cellspacing="0" class="ToolBar SmallToolbar">
        <tr valign="top">
            <td class="ToolbarTd">
                <asp:LinkButton runat="server" ID="btnSearchDocument" PostBackUrl="SearchDocument.aspx?O=244">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 col-4-middle">
                            <fieldset>
                                ...
                                <table id="tblOptions" class="TableNoSpacingNoBorder" style="width: 100%">
                                    <tr>
                                        <td></td>
                                    ...
                                    <tr Style="Display:none">
                                        <td class="labelChkWidth">
                                            <asp:Label runat="server" Visble="False" ID="lblIncludeMWDBEColumn" Text=" Include MWDBE % Column in Online Bids" meta:Resourcekey="chkIncludeMWDBEColumn"></asp:Label>
                                        </td>
                                        <td style="text-align: right;">
