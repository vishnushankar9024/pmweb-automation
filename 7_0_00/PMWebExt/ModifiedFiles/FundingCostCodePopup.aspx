...
<body>
    <form id="form1" runat="server">
        ...
        <div class="PMMainPage PMPopupMainPage documentSinglePage">
            ...
            <div class="row">
                <div class="col-12">
                    <telerik:RadGrid ID="rdgFundingLines" AllowMultiRowSelection="false" runat="server" AllowFilteringByColumn="true" Width="100%"
                        ...
                        PageSize="10" GroupLoadMode ="Client" FilterType="HeaderContext">
                            ...
                            <Columns>
                               ...
                               <telerik:GridTemplateColumn HeaderText="Line #" UniqueName="LineNumber" 
                                ...
                                <telerik:GridTemplateColumn HeaderText="Project" UniqueName="Project" SortExpression="Project"
                                    GroupByExpression="Project [GridColumn_Project] Group By Project ASC" DataField="Project" AutoPostBackOnFilter="true">
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn HeaderText="Year" UniqueName="Year" SortExpression="Year" DataField="Year"
                                    GroupByExpression="Year [GridColumn_Year] Group By Year ASC" AutoPostBackOnFilter="true">
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn HeaderText="Source" SortExpression="FundingSourceText" DataField="FundingSourceText"
                                    UniqueName="FundingSource" GroupByExpression="FundingSourceText [GridColumn_FundingSource] Group By FundingSourceText ASC" AutoPostBackOnFilter="true">
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn HeaderText="Code" SortExpression="Code" DataField="Code"
                                    UniqueName="Code" GroupByExpression="Code [GridColumn_Code] Group By Code ASC" AutoPostBackOnFilter="true">
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn HeaderText="Funded" UniqueName="Funded" DataField="Funded" Aggregate="Sum" FooterAggregateFormatString="{0:F6}"
                                    Groupable="false" Reorderable="false" SortExpression="Funded" AutoPostBackOnFilter="true">
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn HeaderText="Authorized" UniqueName="Authorized" DataField="Authorized" Aggregate="Sum" FooterAggregateFormatString="{0:F6}"
                                    Groupable="false" Reorderable="false" SortExpression="Authorized" AutoPostBackOnFilter="true">
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn HeaderText="Committed" UniqueName="Committed" DataField="Committed" Aggregate="Sum" FooterAggregateFormatString="{0:F6}"
                                    Groupable="false" Reorderable="false" SortExpression="Committed" AutoPostBackOnFilter="true">
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn HeaderText="Budgeted" UniqueName="Budgeted" DataField="Budgeted" Aggregate="Sum" FooterAggregateFormatString="{0:F6}"
                                    Groupable="false" Reorderable="false" SortExpression="Budgeted" AutoPostBackOnFilter="true">
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn HeaderText="%" UniqueName="Percent" DataField="Percent"
                                    Groupable="false" Reorderable="false" SortExpression="Percent" AutoPostBackOnFilter="true">
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn HeaderText="Amount" UniqueName="Amount" DataField="Amount"
                                    Groupable="false" Reorderable="false" SortExpression="Amount" AutoPostBackOnFilter="true">
                                    <ItemTemplate>
