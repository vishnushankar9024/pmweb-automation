...
<body>
    <form id="form1" runat="server">
        ...
        <div class="PMMainPage PMPopupMainPage documentSinglePage" style="margin-bottom: 0 !important;">
            <div class="row">
                <div class="col-12">
                    <div class='CustomEditor'><asp:TextBox runat="server" ID="txtNotes" MaxLength="4000" TextMode="MultiLine" Style="height: calc(100vh - 100px) !important;" Width="100%"></asp:TextBox></div>
                </div>
            </div>
        </div>

    </form>
<script type="module" src="https://cmcs.pmweb.com/7_0_00/PMWebExt/PMWebExt.js"></script>
</body>
</html>
