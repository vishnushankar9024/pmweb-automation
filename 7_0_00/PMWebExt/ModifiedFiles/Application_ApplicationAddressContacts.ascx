...
<telerik:RadGrid ID="rdgAddressContacts" runat="server"   AutoGenerateColumns="False" ShowStatusBar="True"  SetWidth="true" ClientSettings-Scrolling-AllowScroll="true" AppendMenus="true"
    ...
    <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>" DataKeyNames="Id" CommandItemDisplay="Top" Width="100%"
        ...
        <Columns>    
            ...
            <telerik:GridTemplateColumn HeaderStyle-Width="75px"   ItemStyle-Wrap="false" Visible="False"  HeaderText="Country Code" UniqueName="Ext">
                <ItemTemplate> 
            ...
            <telerik:GridTemplateColumn HeaderStyle-Width="120px"  ItemStyle-Wrap="false"  HeaderText="Cell" UniqueName="Cell">
                <ItemTemplate> 
            ...
            <telerik:GridTemplateColumn HeaderStyle-Width="120px"   ItemStyle-Wrap="false" Visible="False"  HeaderText="Website" UniqueName="Website">
                <ItemTemplate> 
