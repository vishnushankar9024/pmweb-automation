...
<div class="PMHeader">
    <div class="row">
        <div class="col-12 ResponsiveMargin">
            <telerik:RadGrid ID="rdgBidderMatrix" Width="100%" runat="server" UseEditFormInMobile="true" AutoGenerateColumns="False" AllowPaging="True" PageSize="20" HeaderStyle-Font-Size="8" AllowMultiRowEdit="true" AllowMultiRowSelection="true" ShowGroupPanel="True" AllowSorting="true" CssClass="WithoutTopBorder" AllowFilteringByColumn="true" FilterType="HeaderContext" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true">
                ...
                <MasterTableView NoMasterRecordsText="<%$Resources:PMWeb, Grid_NoMasterRecordsText %>" DataKeyNames="Id"  ClientDataKeyNames="Id" CommandItemDisplay="Top" Width="100%" TableLayout="Fixed" InsertItemDisplay="Top"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn AllowFiltering="false"  HeaderStyle-Width="200px" DataField="BidCategory" ItemStyle-Wrap="false" HeaderText="Bid Category" SortExpression="BidCategory" UniqueName="BidCategory" GroupByExpression="BidCategory [GridColumn_BidCategory] Group By BidCategory ASC">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn AllowFiltering="false"  DataField="CompanyName" HeaderStyle-Width="200px" ItemStyle-Wrap="false" HeaderText="Company" SortExpression="CompanyName" UniqueName="CompanyName" GroupByExpression="CompanyName [GridColumn_CompanyName] Group By CompanyName ASC">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn AllowFiltering="false"  DataField="Notes" HeaderStyle-Width="200px" ItemStyle-Wrap="false" HeaderText="Notes" UniqueName="Notes" SortExpression="Notes" GroupByExpression="Notes [GridColumn_Notes] Group By Notes ASC">
                            <ItemTemplate>
                                <%#Eval("Notes").ToString%>&nbsp;
                            </ItemTemplate>
                            <EditItemTemplate>
                ...
                <span class="Icon"></span>
                        ...
                        <telerik:GridTemplateColumn AllowFiltering="false"  DataField="Inactive" HeaderStyle-Width="70px" ItemStyle-Wrap="false" HeaderText="Inactive" UniqueName="Inactive" SortExpression="Inactive" GroupByExpression="Inactive [GridColumn_Inactive] Group By Inactive ASC">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn AllowFiltering="false"  HeaderStyle-Width="90px" ItemStyle-Wrap="false" HeaderText="EOI Status" UniqueName="EOIStatus" >
                            <ItemTemplate> 
                                <div></div>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <select id="ddlEOIStatus">
                                    <option value=""></option>
                        ...
                        <telerik:GridTemplateColumn AllowFiltering="false"  HeaderStyle-Width="90px" ItemStyle-Wrap="false" HeaderText="EOI Received Date" UniqueName="EOIReceivedDate" >
                            <ItemTemplate> 
                                <div></div>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <input type="text" id="txtEOIReceivedDate" />
                            </EditItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                            <HeaderStyle Width="90px" />
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn AllowFiltering="false"  HeaderStyle-Width="90px" ItemStyle-Wrap="false" HeaderText="Capability" UniqueName="Capability" >
                            <ItemTemplate> 
                                <div></div>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <select id="ddlCapability">
                                    <option value=""></option>
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
                        ...
                        <telerik:GridTemplateColumn AllowFiltering="false"  HeaderStyle-Width="90px" ItemStyle-Wrap="false" HeaderText="Experience" UniqueName="Experience" >
                            <ItemTemplate> 
                                <div></div>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <select id="ddlExperience">
                                    <option value=""></option>
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
                        ...
                        <telerik:GridTemplateColumn AllowFiltering="false"  HeaderStyle-Width="90px" ItemStyle-Wrap="false" HeaderText="Resources" UniqueName="Resources" >
                            <ItemTemplate> 
                                <div></div>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <select id="ddlResources">
                                    <option value=""></option>
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                                </select>
						...
						<telerik:GridTemplateColumn AllowFiltering="false"  HeaderStyle-Width="90px" ItemStyle-Wrap="false" HeaderText="PQQ Status" UniqueName="PQQStatus" >
                <ItemTemplate> 
                    <div></div>
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" />
            ...
            <telerik:GridTemplateColumn AllowFiltering="false"  HeaderStyle-Width="90px" ItemStyle-Wrap="false" HeaderText="PQ Start Date" UniqueName="PQStartDate" >
                <ItemTemplate> 
                    <div></div>
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" />
            ...
            <telerik:GridTemplateColumn AllowFiltering="false"  HeaderStyle-Width="90px" ItemStyle-Wrap="false" HeaderText="PQ Expires Date" UniqueName="PQExpiresDate" >
                <ItemTemplate> 
                    <div></div>
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" />
            ...
            <telerik:GridTemplateColumn AllowFiltering="false"  HeaderStyle-Width="90px" ItemStyle-Wrap="false" HeaderText="NDA" UniqueName="NDA" >
                <ItemTemplate> 
                    <div></div>
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" />
                ...
                <ClientSettings AllowColumnHide="true" AllowColumnsReorder="true" AllowDragToGroup="true">
					...
					<ClientEvents OnRowCreated="GetPQDetails" OnGridCreated="PreBidMatrixRadGridCommand" />
                </ClientSettings>
            </telerik:RadGrid>
