    ...
    a.extend(a.jqx._jqxDateTimeInput.prototype, {
        ...
        createInstance: function (d) {
            ...
            if (k.isMaterialized()) {
                ...
                var l = z.getPropertyValue("--jqx-datetimeinput-dropdown-height") || 280;
            ...
            k._getMask();
            if (k.editMode === "full" && k.value === null && k._mask[0] !== undefined) {
            ...
            if (a.jqx._jqxCalendar != null && a.jqx._jqxCalendar != undefined) {
                try {
                    ...
                    if (k.dropDownContainer == "element") {
                        ...
                        k.calendarContainer.css({ position: "absolute", zIndex: k.popupZIndex, top: 0, left: 0 });
                    }
                    ...
                    k.timeContainer.css({ position: "absolute", zIndex: k.popupZIndex, top: 0, left: 0 });
        ...
        _addHandlers: function () {
            ...
            this.addHandler(a(document), "mousedown." + this.id, this._closeOpenedCalendar, { me: this });
            if (a.jqx.mobile.isTouchDevice()) {
                this.addHandler(a(document), a.jqx.mobile.getTouchEventName("touchstart") + "." + this.id, this._closeOpenedCalendar, { me: this });
            }
            ...
            this.addHandler(this.dateTimeInput, "keyup", function (f) {
                var g = this.value;
                if (d._fullEditInProgress && d._enteredValue && d._mask[g.length] !== undefined) {
        ...
        propertyChangedHandler: function (c, d, f, e) {
            ...
            if (d == "todayString" || d == "clearString") {
                c.calendarContainer.jqxCalendar({ clearString: c.clearString, todayString: c.todayString });
            }
            if (d == "dayNameFormat") {
            ...
            if (d == "culture" || d == "localization") {
                ...
                if (d == "formatString" || (d === "yearCutoff" && (e === null || f === null))) {
                    if (d === "formatString") {
                        c._getMask();
                    }
                    c.items = new Array();
            ...
            if (d == "dropDownWidth" || d == "dropDownHeight") {
                c.calendarContainer.jqxCalendar({ width: c.dropDownWidth, height: c.dropDownHeight });
                c._calendar.render();
        ...
        showCalendar: function () {
            ...
            if (this.enableBrowserBoundsDetection) {
                var j = this.testOffset(o, { left: parseInt(this.container.css("left")), top: parseInt(p) }, parseInt(this.host.outerHeight()));
        ...
        hideCalendar: function (j, o) {
            ...
            if (this.animationType != "none" && this.animationType != "transform") {
                ...
                if (this.showTimeButton) {
                    if (this.animationType == "fade") {
                        this.timeContainer.animate({ opacity: 0 }, this.closeDelay, function () {
                            b.css("display", "none");
                            p.isanimating = false;
                        });
                    } else {
                        this.timeContainer.animate({ "margin-top": m }, this.closeDelay, function () {
                            b.css("display", "none");
                            p.isanimating = false;
                        });
                    }
            ...
            for (var e = j; e < f; ++e) {
                ...
                if (this.isEditing && g.type != "ReadOnly") {
                    if (this.selectionMode != "range") {
                        ...
                        if (!d) {
                            if (this.yearCutoff !== null && g.type === "Year" && g.format === "yy") {
                                c = this.editors[e].value.toString().substring(2);
                            } else {
                                c = g.dateParserInEditMode(new Number(this.editors[e].value), "d" + this.editors[e].maxEditPositions, this);
                ...
                if (this._oldDT) {
                    ...
                    if (c == 9) {
                        ...
                        if (d != null) {
                            ...
                            if (e) {
                                if (
                                    !(d.getFullYear() != e.getFullYear() || d.getMonth() != e.getMonth() || d.getDate() != e.getDate() || d.getHours() != e.getHours() || d.getMinutes() != e.getMinutes() || d.getSeconds() != e.getSeconds())
                                ) {
                                    i = true;
                                }
                            }
        ...
        _handleKeyDown: function (l, r) {
            ...
            if (k._fullEditInProgress || (k.editMode === "full" && k.value === null)) {
                ...
                if (!l.altKey && !b && r == 46) {
                    ...
                    if (k.activeEditor != null) {
                        ...
                        if (k.activeEditor.positions >= 0) {
                            var f = k._format(Number(k.activeEditor.value), "d" + k.activeEditor.maxEditPositions, k.culture);
                            var d = f;
                            d = d.substring(0, k.activeEditor.positions) + "0" + d.substring(k.activeEditor.positions + 1);
                            if (parseInt(d) < k.activeEditor.minValue) {
                                d = k._format(Number(k.activeEditor.minValue), "d" + k.activeEditor.maxEditPositions, k.culture);
                            }
            ...
            if (r == 38) {
                //----edited 18-04-2022 (commented below line to disable arrow up feature)---
                // this.spinUp();
                k.changeType = "keyboard";
                //----edited 18-04-2022 (commented below line to disable arrow up feature)---
                // return false;
                ...
                if (r == 40) {
                    //----edited 18-04-2022 (commented below line to disable arrow down feature)---
                    // this.spinDown();
                    k.changeType = "keyboard";
                    //----edited 18-04-2022 (commented below line to disable arrow down feature)---
                    // return false;
            ...
            if (r == 37) {
                ...
                if (r == 39 || r == 191) {
                    if (this._editor) {
                        ...
                        //-----edited 18-04-2022 (added if k.value not null)----
            ...
            if (this.value == null && ((r >= 48 && r <= 57) || (r >= 96 && r <= 105))) {
                k.changeType = "keyboard";
            ...
            for (var d = 0; d < this.items.length; d++) {
                ...
                if (this.isEditing && this.items[d].type != "ReadOnly") {
                    ...
                    if (!j && this.items[d].type != "FORMAT_AMPM") {
                        if (this.yearCutoff !== null && this.items[d].type === "Year" && this.items[d].format === "yy") {
        ...
        _getMask: function () {
            ...
            var j = k.replace(/([\^\$\.\*\+\?\|\[\]\(\)\{\}])/g, "\\\\$1"),
                ...
                h = 0,
                d = 0,
                o = /\/|dddd|ddd|dd|d|MMMM|MMM|MM|M|yyyy|yy|y|hh|h|HH|H|mm|m|ss|s|tt|t|fff|ff|f|zzz|zz|z|gg|g/g,
                e;
        ...
        getDateTimeEditorByItemType: function (m, e) {
            switch (this.type) {
                ...
                case "Second":
                    ...
                    return d;
                case "Year":
                    var o = a.jqx._jqxDateTimeInput.DateEditor._createYearEditor(m.year, e.yearCutoff !== null && this.format === "yy" ? 2 : 4, this, e);
                    var d = a.extend({}, o);
                    return d;
            }
            return null;
        ...
        insert: function (b) {
            if (this.handleDays) {
                ...
                if (this.handleMonths) {
                    ...
                    if (this.that.yearCutoff !== null && this.handleYears && this.formatValueLength === 2) {
                        if (b == null || b.length == 0) {
                            return this.deleteValue();
                        }
                        ...
                        c = c.substring(0, this.positions) + e + c.substring(this.positions + 1);
...
(function (a) {
    a.jqx._jqxDateTimeInput.getDateTime = function (c) {
        var b = {
            ...
            daysPer4Years: 1461,
            daysPerYear: 365,
            daysToMonth365: { 0: 0, 1: 31, 2: 59, 3: 90, 4: 120, 5: 151, 6: 181, 7: 212, 8: 243, 9: 273, 10: 304, 11: 334, 12: 365 },
            daysToMonth366: { 0: 0, 1: 31, 2: 60, 3: 91, 4: 121, 5: 152, 6: 182, 7: 213, 8: 244, 9: 274, 10: 305, 11: 335, 12: 366 },
