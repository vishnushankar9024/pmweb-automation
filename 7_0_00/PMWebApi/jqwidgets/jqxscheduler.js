    ...
    a.extend(a.jqx._jqxScheduler.prototype, {
        defineInstance: function () {
            var b = {
                ...
                timeZone: null,
                statuses: { free: "white", tentative: "tentative", busy: "transparent", outOfOffice: "#800080" },
                ...
                columnRenderer: null,
                exportSettings: { serverURL: null, characterSet: null, fileName: "jqxScheduler", dateTimeFormatString: "S", resourcesInMultipleICSFiles: false, ICSXWRCALNAME: "jqxScheduler", ICSXWRCALDESC: "jqxScheduler Description" },
                source: {
        ...
        _applyThemeSettings: function () {
            const d = this;
            var f = window.getComputedStyle(d.element);
            var c = f.getPropertyValue("--jqx-grid-row-height");
            var e = f.getPropertyValue("--jqx-grid-column-height");
            var b = f.getPropertyValue("--jqx-scrollbar-size");
            if (c) {
                d.rowsHeight = parseInt(c);
            }
            if (e) {
                d.columnsHeight = parseInt(e);
            }
            if (b) {
            }
        },
        ...
        createEditRecurrenceDialog: function () {
            ...
            var b = a(
                "<div><div>" +
                    ...
                    "</div><div style='position: absolute; white-space:nowrap; text-overflow: ellipsis; left:0px; width:100%; bottom: 0px;'><button title='" +
                    d.schedulerLocalization.editRecurringAppointmentDialogOccurrenceString +
                    "' id='editRecurringAppointmentOccurrence." +
                    d.element.id +
                    "' style='white-space:nowrap; text-overflow: ellipsis; border-left-width: 0px;  border-bottom-width: 0px; border-radius:0px; width:50%;'>" +
                    d.schedulerLocalization.editRecurringAppointmentDialogOccurrenceString +
                    "</button><button title='" +
                    d.schedulerLocalization.editRecurringAppointmentDialogSeriesString +
                    "' id='editRecurringAppointmentSeries." +
                    d.element.id +
                    "' style=' white-space:nowrap; text-overflow: ellipsis; border-bottom-width: 0px;  border-left-width: 0px; border-right-width:0px; width:50%; border-radius:0px;'>" +
                    d.schedulerLocalization.editRecurringAppointmentDialogSeriesString +
                    "</button></div></div></div>"
            );
            d.editRecurrenceDialog = b;
            a(b).jqxWindow({ rtl: d.rtl, autoFocus: false, animationType: "none", autoOpen: false, theme: d.theme, minWidth: 300, minHeight: 110, resizable: false });
            var c = b.find("button");
            c.jqxButton({ theme: d.theme, width: "50%" });
            var e = false;
            ...
            this.addHandler(a(b), "open", function (f) {
                d._raiseEvent("editRecurrenceDialogOpen", { dialog: b, appointment: d.selectedJQXAppointment ? d.selectedJQXAppointment.boundAppointment : null });
            });
            ...
            this.addHandler(a(b), "close", function (f) {
                if (!e) {
                    ...
                    d.overlay.hide();
                    d.focus();
                    d._raiseEvent("editRecurrenceDialogClose", { dialog: b, appointment: d.selectedJQXAppointment ? d.selectedJQXAppointment.boundAppointment : null });
                    return false;
                }
                e = false;
                d.overlay.hide();
        ...
        _builddataloadelement: function () {
            ...
            var c = a(
                '<div style="z-index: 99999; margin-left: -66px; left: 50%; top: 50%; margin-top: -24px; position: relative; width: 100px; height: 33px; padding: 5px; font-family: verdana; font-size: 12px; color: #767676; border-color: #898989; border-width: 1px; border-style: solid; background: #f6f6f6; border-collapse: collapse;"><div style="float: left;"><div style="float: left; overflow: hidden; width: 32px; height: 32px;" class="jqx-grid-load"/><span style="margin-top: 10px; float: left; display: block; margin-left: 5px;" >' +
        ...
        localizestrings: function (b, c) {
            ...
            if (b != null) {
                ...
                this.schedulerLocalization = {
                    ...
                    editDialogStatuses: { free: "Free", tentative: "Tentative", busy: "Busy", outOfOffice: "Out of Office" },
                };
            }
        },
        _updateScrollbars: function (r) {
            ...
            if (!m && s > f && d.getRows().length > 0) {
                ...
                i = 4 + parseInt(b);
                d.vScrollBar.jqxScrollBar({ max: s - f });
            } else {
                d.vScrollBar[0].style.visibility = "hidden";
            }
            if (k != d.vScrollBar[0].style.visibility) {
            ...
            if (p > l && !j) {
                ...
                d.hScrollBar.jqxScrollBar({ max: 2 + q + p - l });
                i = 4 + parseInt(b);
                if (b == 0) {
                    i = 0;
                }
                if (!m && s != f) {
                    if (s > f - i + 4 && d.getRows().length > 0) {
                        d.hScrollBar.jqxScrollBar({ max: q + p - l });
                        var c = d.vScrollBar[0].style.visibility === "hidden";
                        d.vScrollBar[0].style.visibility = n;
                        d._updatecolumnwidths();
                        if (c) {
                            d.hScrollBar.jqxScrollBar({ max: p - l + q });
                        }
                        ...
                        if (e != p) {
                            if (e < l) {
                                d.hScrollBar.jqxScrollBar({ max: q + e - l });
                                d.hScrollBar[0].style.visibility = "hidden";
                                i = 0;
                            } else {
                                if (!c) {
                                    d.hScrollBar.jqxScrollBar({ max: p - l + q - b });
                                } else {
                                    if (e > l) {
                                        d.hScrollBar.jqxScrollBar({ max: q + e - l });
                                    }
                    ...
                    if (s - f > 0) {
                        d.vScrollBar.jqxScrollBar({ max: s - f + i });
                    } else {
                        d.vScrollBar[0].style.visibility = "hidden";
                    }
                }
        ...
        _arrange: function () {
            ...
            if (this.rtl) {
                this.vScrollBar.css({ left: "0px", top: p });
                if (this.vScrollBar.css("visibility") != "hidden") {
                    this.hScrollBar.css({ left: b + 2 });
                }
            }
        ...
        ensureVisible: function (c, k) {
            var f = this;
            var l = a.type(c) == "date" ? c : c.toDate();
            for (var e = 0; e < f.rows.length; e++) {
                for (var d = 0; d < f.rows[e].cells.length; d++) {
                    var h = f.rows[e].cells[d];
                    if (k) {
                        if (h.getAttribute("data-view") !== k) {
                            continue;
                        }
                    }
                    var g = h.getAttribute("data-date");
                    var b = f._getDateByString(g);
                    if (b.valueOf() == l.valueOf()) {
                        return f._ensureVisible(h);
                    }
                }
            }
        },
            ...
            if (c.isTouchDevice()) {
                ...
                if (c.schedulercontent) {
                    ...
                    a.jqx.mobile.touchScroll(
                        c._table[0],
                        Math.max(c.vScrollInstance.max, c.hScrollInstance.max),
                        function (h, g) {
                            if (c.dragOrResize) {
                                return;
                            }
        ...
        render: function (i) {
            var e =
                "<div style='overflow: hidden; -webkit-appearance: none; outline: none; width:100%; height: 100%; align:left; border: 0px; padding: 0px; margin: 0px; left: 0px; top: 0px; valign:top; position: relative;'><div id='wrapper" +
                this.element.id +
                "' style='overflow: hidden; -webkit-appearance: none; border: none; background: transparent; outline: none; width:100%; height: 100%; padding: 0px; margin: 0px; align:left; left: 0px; top: 0px; valign:top; position: relative;'><div id='toolbar' style='visibility: hidden; align:left; valign:top; left: 0px; top: 0px; position: absolute;'></div><div id='legendbartop' style='align:left; valign:top; left: 0px; top: 0px; position: absolute;'></div><div id='filter' style='visibility: hidden; align:left; valign:top; left: 0px; top: 0px; position: absolute;'></div><div id='content" +
                this.element.id +
                ...
                this.element.id +
                "' style='align:left; valign:top; left: 0px; top: 0px; position: absolute;'></div><div id='bottomRight' style='align:left; valign:top; left: 0px; top: 0px; border: none; position: absolute;'></div><div id='aggregates' style='align:left; valign:top; left: 0px; top: 0px; position: absolute;'></div><div id='legendbarbottom' style='align:left; valign:top; left: 0px; top: 0px; position: absolute;'></div><div id='pager' style='z-index: 20; align:left; valign:top; left: 0px; top: 0px; position: absolute;'></div></div></div>";
            ...
            this.vScrollBar = g.jqxScrollBar({ vertical: true, rtl: this.rtl, touchMode: this.touchMode, theme: this.theme, _triggervaluechanged: false });
            this.hScrollBar = k.jqxScrollBar({ vertical: false, rtl: this.rtl, touchMode: this.touchMode, theme: this.theme, _triggervaluechanged: false });
        ...
        getAppointmentElement: function (e) {
            var b = null;
            if (
                e.className.indexOf("jqx-scheduler-appointment") >= 0 &&
                e.className.indexOf("jqx-scheduler-appointment-inner-content") == -1 &&
                e.className.indexOf("jqx-scheduler-appointment-content") == -1 &&
                e.className.indexOf("jqx-scheduler-appointment-resize-indicator") == -1
            ) {
                b = e;
            }
            var d = e;
            for (var c = 0; c < 4; c++) {
                if (d.parentNode) {
                    if (
                        d.className.indexOf("jqx-scheduler-appointment") >= 0 &&
                        d.className.indexOf("jqx-scheduler-appointment-inner-content") == -1 &&
                        d.className.indexOf("jqx-scheduler-appointment-content") == -1 &&
                        d.className.indexOf("jqx-scheduler-appointment-resize-indicator") == -1
                    ) {
                        b = d;
                    }
                    d = d.parentNode;
        ...
        _renderToolBar: function () {
            ...
            b.css("top", k);
            i.toolbarLeftButton = a('<div type="button" style="outline: none; padding: 0px; display: flex; justify-content: center; align-items: center; margin-left: 3px; margin-right: 3px; height: 24px; width: 27px; float: left;"></div>');
            i.toolbarRightButton = a('<div type="button" style="outline: none; padding: 0px; display: flex; justify-content: center; align-items: center; margin-right: 3px; width: 27px; height: 24px; float: left;"></div>');
            ...
            i.toolbarRightButton.jqxButton({ enableHover: false, enableDefault: false, enablePressed: false, cursor: "pointer", disabled: i.disabled, theme: i.theme });
            i.toolbarLeftButton.jqxButton({ enableHover: false, enableDefault: false, enablePressed: false, cursor: "pointer", disabled: i.disabled, theme: i.theme });
            ...
            var e = a("<div style='outline: none;  width: 15px; height: 15px;'></div>");
            e.addClass(i.toThemeProperty("jqx-icon-arrow-left"));
            i.toolbarLeftButton.wrapInner(e);
            var j = a("<div style='outline: none; width: 15px; height: 15px;'></div>");
        ...
        _setView: function (g) {
            ...
            f._raiseEvent("viewChange", { date: f.date, from: d, to: j, oldViewType: i, newViewType: e });
        },
        ...
        navigateTo: function (b) {
            ...
            d._raiseEvent("dateChange", { date: b, from: e, to: c });
        },
                ...
                if (this.columnGroups.length) {
                    ...
                    for (var f = 0; f < this.columnGroups.length; f++) {
                        ...
                        for (var h = 1; h < g.length; h++) {
                            if (g[h] != g[h - 1] + 1) {
                                throw new Error(
                                    "jqxScheduler: Column Groups initialization Error. Please, check the initialization of the jqxScheduler's columns array. The columns in a column group are expected to be siblings in the columns array."
                                );
                                this.host.remove();
                            }
                        }
        ...
        selectCell: function (b, l, k) {
            ...
            for (var e = 0; e < f.rows.length; e++) {
                for (var d = 0; d < f.rows[e].cells.length; d++) {
                    ...
                    var g = h.getAttribute("data-date");
                    var c = f._getDateByString(g);
                    if (l && h.getAttribute("data-end-date")) {
                        if (c.valueOf() == b.valueOf()) {
                            h.setAttribute("data-selected", "true");
                            f.focusedCell = h;
                            f._lastSelectedCell = h;
                            f._updateCellsSelection();
                            f._ensureVisible(f.focusedCell);
                            return;
                        }
                    } else {
                        if (!l && h.getAttribute("data-end-date")) {
        ...
        selectRange: function (l, m, p, o) {
            ...
            for (var g = 0; g < h.rows.length; g++) {
                for (var d = 0; d < h.rows[g].cells.length; d++) {
                    var n = h.rows[g].cells[d];
                    if (o) {
                        if (n.getAttribute("data-view") !== o) {
                            continue;
                        }
                    }
                    var k = n.getAttribute("data-date");
                    var b = h._getDateByString(k);
                    if (p && n.getAttribute("data-end-date")) {
                        if (b.valueOf() >= e.valueOf() && b.valueOf() <= c.valueOf()) {
        ...
        _selectRange: function (b, q) {
            var h = this;
            if (h._views[h._view].type == "agendaView") {
                return;
            }
            var k = b;
            var u = q.getAttribute("data-view");
            if (b.getAttribute("data-view") !== u) {
                return;
            }
            var p = q.getAttribute("data-date");
            var m = k.getAttribute("data-date");
            if (null == p || null == m) {
                return;
            }
            var B = q.getAttribute("data-end-date");
            var E = k.getAttribute("data-end-date");
            var G = B != null || E != null;
            var r = B != null && E != null;
            var t = h._getDateByString(p);
            var s = h._getDateByString(m);
            if (t < this.min.toDate()) {
                t = this.min.toDate();
            }
            if (s < this.min.toDate()) {
                s = this.min.toDate();
            }
            if (t > this.max.toDate()) {
                t = this.max.toDate();
            }
            if (s > this.max.toDate()) {
                s = this.max.toDate();
            }
            var v = Math.min(t, s);
            var z = Math.max(t, s);
            ...
            if (G) {
                ...
                if (b.getAttribute("data-end-date") == null) {
                    s.setHours(0, 0, 0, 0);
                    var A = new a.jqx.date(s, h.timeZone).toString();
                    var D = a(k).parent().index();
                    a.each(o[0].cells, function () {
                        var i = this.getAttribute("data-date");
                        if (i === A) {
                            b = this;
                            r = q.getAttribute("data-end-date") != null && b.getAttribute("data-end-date") != null;
                            var H = q.getAttribute("data-date");
                            var j = b.getAttribute("data-date");
                            var J = h._getDateByString(H);
                            var I = h._getDateByString(j);
                            v = Math.min(J, I);
                            z = Math.max(J, I);
                            return false;
                        }
            ...
            for (var y = 0; y < d; y++) {
                var g = o[y];
                if (G && this.tableRows > 1) {
                    var x = parseInt(b.getAttribute("data-view"));
                    var l = o.length / h.tableRows;
                    var n = (-1 + x) * l;
                    c = o[n];
                    g = o[n];
                }
                var c = g.cells;
                for (var w = f; w < c.length - e; w++) {
                    if (c[w].getAttribute("data-view") !== u) {
                        continue;
                    }
                    c[w].removeAttribute("data-selected");
                    if (!r && c[w].getAttribute("data-end-date")) {
                        continue;
                    }
                    var F = c[w].getAttribute("data-date");
                    var C = h._getDateByString(F).valueOf();
                    if (v <= C && C <= z) {
                        c[w].setAttribute("data-selected", "true");
                    }
                }
            }
            h._updateCellsSelection();
        ...
        _handleMouseUp: function (k, i, g) {
            ...
            var e = function (t, q) {
                ...
                f._raiseEvent("appointmentChange", { appointment: q.boundAppointment });
                f.changedAppointments[q.id] = { type: "Update", appointment: q.boundAppointment };
        ...
        _addHandlers: function () {
            ...
            this.addHandler(this.host, h, function (o) {
                ...
                var n = null;
                if (
                    o.target.className.indexOf("jqx-scheduler-appointment") >= 0 &&
                    o.target.className.indexOf("jqx-scheduler-appointment-inner-content") == -1 &&
                    o.target.className.indexOf("jqx-scheduler-appointment-content") == -1 &&
                    o.target.className.indexOf("jqx-scheduler-appointment-resize-indicator") == -1
                ) {
                    n = o.target;
                }
                var u = o.target;
                for (var v = 0; v < 4; v++) {
                    if (u.parentNode) {
                        if (
                            u.className.indexOf("jqx-scheduler-appointment") >= 0 &&
                            u.className.indexOf("jqx-scheduler-appointment-inner-content") == -1 &&
                            u.className.indexOf("jqx-scheduler-appointment-content") == -1 &&
                            u.className.indexOf("jqx-scheduler-appointment-resize-indicator") == -1
                        ) {
                            n = u;
                        }
                        u = u.parentNode;
                ...
                if (n) {
                    ...
                    if (D.resizable) {
                        ...
                        var z = a(n).coord();
                        var w = a(n).position();
                        i.selectedAppointmentBounds = { top: z.top, left: z.left, width: a(n).width(), height: a(n).height() };
                        ...
                        if (B == "weekView" || B == "dayView") {
                            ...
                            if (B == "monthView" && D.elements.length > 1) {
                                ...
                                for (var v = 0; v < D.elements.length; v++) {
                                    var q = D.elements[v];
                                    var m = { top: s.top + q.y, left: s.left + q.x, width: q.width, height: q.height };
            ...
            var j = function (K) {
                ...
                if (i.isTouchDevice()) {
                    var O = a.jqx.position(K);
                    B = O.left;
                    w = O.top;
                    if (isNaN(B) || isNaN(w)) {
                        var O = a.jqx.position(K.originalEvent);
                        B = O.left;
                        w = O.top;
                    }
                }
                i.mouseDown = { top: w, left: B };
                ...
                var t = a(u).parent();
                var Q = t.attr("data-key");
                i.mousecaptureposition = { left: K.pageX, top: K.pageY, clickedrow: a(t).index(), clickedcell: a(u) };
                if (K.which !== 3) {
                    i.isMouseDown = true;
                ...
                var q =
                    K.target.className.indexOf("jqx-scheduler-appointment") >= 0 &&
                    K.target.className.indexOf("jqx-scheduler-appointment-duration-status") == -1 &&
                    K.target.className.indexOf("jqx-scheduler-appointment-inner-content") == -1 &&
                    K.target.className.indexOf("jqx-scheduler-appointment-status") == -1 &&
                    K.target.className.indexOf("jqx-scheduler-appointment-resize-indicator") == -1 &&
                    K.target.className.indexOf("jqx-scheduler-appointment-content") == -1
                        ? a(K.target)
                        : a(K.target).parents(".jqx-scheduler-appointment");
                if (q.length == 0) {
                    q = null;
                }
                if (q && q[0].className.indexOf("feedback") == -1) {
                    ...
                    i.mouseDownPosition = { top: w, left: B };
                    var H = a(q).coord();
                    i.selectedAppointmentBounds = { top: H.top, left: H.left, width: a(q).width(), height: a(q).height() };
                    var O = a(q).position();
                    i.selectedAppointmentTableBounds = { top: O.top, left: O.left, width: a(q).width(), height: a(q).height() };
                    if (!i._dragStartCell) {
                        i._dragStartCell = i.findCell(H.left, H.top);
                    }
                    var p = i.getJQXAppointmentByElement(q);
                    i._selectAppointment(p, q, "mouse");
                    i._raiseEvent("appointmentClick", { appointment: p.boundAppointment });
                    i.clearSelection();
                    ...
                    if (s - i.clickTime.getTime() < F && i._lastSelectedAppointment && p.id == i._lastSelectedAppointment.id && K.which != 3) {
                        ...
                        i._raiseEvent("appointmentDoubleClick", { appointment: p.boundAppointment });
                    } else {
                        if (!p.readOnly) {
                            if (K.which !== 3) {
                                i.focus();
                    ...
                    if (K.which === 3) {
                        ...
                        if (P !== null) {
                            ...
                            r(false);
                            var M = new a.jqx.date(u.getAttribute("data-date"), i.timeZone);
                            i._raiseEvent("cellClick", { cell: u, date: M });
                        }
                    } else {
                        if (K.which != 3) {
                            i.clearAppointmentsSelection();
                ...
                if (i.view == "agendaView") {
                    ...
                    var L = false;
                    if (!q && K.target && K.target.parentNode) {
                        q = K.target.parentNode.className.indexOf("jqx-scheduler-agenda-appointment") != -1;
                        L = true;
                    }
                    if (q) {
                        q = K.target;
                        if (L) {
                            q = K.target.parentNode;
                        }
                        var p = i.getJQXAppointmentByElement(q);
                        i._selectAppointment(p, q, "mouse");
                        i._raiseEvent("appointmentClick", { appointment: p.boundAppointment });
                ...
                if (Q !== undefined && K.which != 3) {
                    ...
                    if (o) {
                        ...
                        if (i._lastSelectedCell && i._lastSelectedCell.getAttribute("data-selected") == "true" && u.getAttribute("data-selected") === "true" && s - i.clickTime.getTime() < F) {
                            var M = new a.jqx.date(u.getAttribute("data-date"), i.timeZone);
                            i._raiseEvent("cellDoubleClick", { cell: u, date: M });
                            G = true;
                            i._initDialog();
                            i._openDialog();
                            if (K.preventDefault) {
                    ...
                    if (u.getAttribute("data-selected") != "true" || K.shiftKey || s - i.clickTime.getTime() > F) {
                        ...
                        a('[data-key="' + Q + '"]').removeClass(i.toTP("jqx-scheduler-selected-appointment"));
        ...
        moveAppointment: function (k, c, g, f, j) {
            ...
            if (k) {
                ...
                var e = function (r) {
                    ...
                    h._raiseEvent("appointmentChange", { appointment: k.boundAppointment });
                    h.changedAppointments[k.id] = { type: "Update", appointment: k.boundAppointment };
        ...
        setAppointmentProperty: function (e, b, g) {
            ...
            c[b] = g;
            f.changedAppointments[e] = { type: b, appointment: c.boundAppointment };
            switch (e) {
                case "draggable":
                case "resizable":
                    break;
        ...
        _deleteAppointment: function (b) {
            ...
            g._raiseEvent("appointmentDelete", { appointment: b.boundAppointment });
            var d = b.id;
            ...
            g.changedAppointments[d] = { type: "Delete", appointment: b.boundAppointment };
            g._renderrows();
        },
        addAppointment: function (o) {
            ...
            c.jqxAppointment = o;
            o.jqxAppointment = o;
            g._raiseEvent("appointmentAdd", { appointment: o.boundAppointment });
            g.uiappointments.push(o);
            g.changedAppointments[w] = { type: "Add", appointment: o.boundAppointment };
        ...
        _getDateByString: function (j) {
            if (j && this._dateByStringCache && this._dateByStringCache[j]) {
                var b = this._dateByStringCache[j];
        ...
        getSelection: function () {
            ...
            if (e._views[e._view].type.toLowerCase().indexOf("month") >= 0) {
                return { from: new a.jqx.date(h, e.timeZone), to: a.jqx.scheduler.utilities.getEndOfDay(g), resourceId: f };
            }
            if (e._views[e._view].type.toLowerCase().indexOf("day") >= 0 || e._views[e._view].type.toLowerCase().indexOf("week") >= 0) {
                ...
                if (g.minute() === 0 && g.hour() === 0 && h.hour() === 0 && h.minute() === 0) {
                    if (g.day() === h.day()) {
                        ...
                        return { from: new a.jqx.date(h, e.timeZone), to: a.jqx.scheduler.utilities.getEndOfDay(g).addDays(-1), resourceId: f };
                    }
                }
                return { from: new a.jqx.date(h, e.timeZone), to: g, resourceId: f };
            }
            ...
            for (var x = 0; x < this.tableColumns; x++) {
                ...
                switch (p) {
                    case "dayView":
                        ...
                        var f = h._resources[x] ? h._resources[x] : "Resource" + x;
                        this.columns.push({ align: w, width: v, columnGroup: f, text: this._getDayName(g.dayOfWeek()) });
                        break;
                    case "weekView":
                    case "monthView":
                        for (var z = 0; z < 7; z++) {
                            ...
                            var f = h._resources[x] ? h._resources[x] : "Resource" + x;
                            this.columns.push({ align: p == "weekView" ? w : "center", width: v, columnGroup: f, text: this._getDayName(y) });
                        }
                        break;
                    case "timelineDayView":
                        var f = h._resources[x] ? h._resources[x] : "Resource" + x;
                    ...
                    case "timelineWeekView":
                        for (var z = 0; z < 7; z++) {
                            ...
                            var f = h._resources[x] ? h._resources[x] : "Resource" + x;
                            B.push({ align: h.rtl ? "right" : "left", parentGroup: f, name: this._getDayName(y) + x, text: this._getDayName(y) });
                    ...
                    case "timelineMonthView":
                        ...
                        for (var z = 0; z < 41; z++) {
                            ...
                            k = k.addDays(1);
                            var f = h._resources[x] ? h._resources[x] : "Resource" + x;
                            h.columns.push({ minwidth: 30, columnGroup: f, text: r, width: v });
                        }
                        break;
                    case "agendaView":
                        ...
                        h.columns.push({ text: h.schedulerLocalization.agendaDateColumn, width: l });
                        h.columns.push({ text: h.schedulerLocalization.agendaTimeColumn, width: u });
                        h.columns.push({ text: h.schedulerLocalization.agendaAppointmentColumn, width: o });
                        break;
                }
            }
            if (B.length > 0) {
        ...
        _renderagenda: function () {
            ...
            for (var at = 0; at < ab.appointmentsToRender.length; at++) {
                ...
                while (au < a.jqx.scheduler.utilities.getEndOfDay(q.to)) {
                    var d = au.toString();
                    if (!al[d]) {
                        al[d] = { date: au, appointments: new Array() };
                    ...
                    for (var aq = 0; aq < G; aq++) {
                        ...
                        if (ao == 1) {
                            ...
                            if (ao == 2) {
                                    ...
                                    a.each(ab._resources, function (r, x) {
                                        if (u.resourceId == x) {
                                            ...
                                            var t =
                                                ...
                                                "' class='" +
                                                w +
                                                "' style='margin-right: 5px; border-color: " +
                                                i.border +
                                                "; background: " +
                                                i.background +
                                                ";' class='" +
                                                ab.toThemeProperty("jqx-scheduler-legend") +
                                                "'></div>";
                                            an = t;
                                        }
                                    });
                                ...
                                an += "<span data-key='" + u.id + "' title='" + ab.escape_HTML(Y) + "' class='" + ar + "'>" + ab.escape_HTML(W) + "</span>";
                            }
                        }
                        e += an;
                        e += "</td>";
                    ...
                    for (var X = 0; X < b; X++) {
                        ...
                        if (Y == 0 && f && (aF === "dayView" || aF === "weekView")) {
                            var aJ =
                                ...
                                aG +
                                '" data-end-date="' +
                                a.jqx.scheduler.utilities.getEndOfDay(C).toString() +
                                '" data-date="' +
                                C.clearTime().toString() +
                                '" role="gridcell" ' +
                                Z +
                                ' style="max-width:' +
                                aK +
                        ...
                        if (R.timeColumn && !R.hidden && (aF === "dayView" || aF === "weekView")) {
                            ...
                            if (Y > 0) {
                                ...
                                // if (C.minute() ) {
                                	...
                                	var hideTime = '';
                                	var hideZeroBorder = '';
                                	if(C.minute() == 5 || C.minute() == 10 || C.minute() == 20 || C.minute() == 25 || C.minute() == 35 || C.minute() == 40 || C.minute() == 50 || C.minute() == 55){
                                		hideTime = "color: transparent!important;"
                                	}
                                	if(C.minute() == 0 || C.minute() == 5 || C.minute() == 15 || C.minute() == 20 || C.minute() == 30 || C.minute() == 35 || C.minute() == 45 || C.minute() == 50){
                                		hideZeroBorder = "border-bottom-color: transparent !important;"
                                	}

                                    var aJ = '<td classname="jqx-disableselect" data-time-slot="true" data-date="' + C.toString() + '" rowspan=' + 1 + ' role="gridcell" ' + Z + ' style="max-width:' + aK + "px; width:" + aK + "px;"+hideTime+ hideZeroBorder;
                                    if (X == b - 1 && b == 1 && !V.rtl) {
                                        aJ += "border-right-color: transparent;";
                                    } else {
                                        if (V.rtl && X == 0) {
                                ...
                                if (Y == 0 && f && (aF === "dayView" || aF === "weekView")) {
                                    var aJ =
                                        '<td data-view="' +
                                        aG +
                                        '" data-time-slot="true" data-end-date="' +
                                        a.jqx.scheduler.utilities.getEndOfDay(C).toString() +
                                        '" data-date="' +
                                        C.toString() +
                                        '" role="gridcell" ' +
                            ...
                            if (V.touchDevice) {
                                if (B > 16) {
                                    ah =
                                        "<div class='" +
                                        a1 +
                                        V.toTP("jqx-scheduler-month-cell-touch") +
                                        "'>" +
                                        a.jqx.dataFormat.formatdate(ah, af, V.schedulerLocalization) +
                                        "<span style='display: none; float: right; cursor: pointer; width:16px; height: 16px;' class='" +
                                        V.toTP("jqx-icon-arrow-down") +
                                        "'></span></div>";
                                } else {
                                    ah =
                                        "<div class='" +
                                        ...
                                        "'>" +
                                        a.jqx.dataFormat.formatdate(ah, af, V.schedulerLocalization) +
                                        "<span style='display: none; float: right; cursor: pointer;' class='" +
                                        V.toTP("jqx-icon-arrow-down") +
                                        "'></span></div>";
                                }
                            } else {
                                if (B > 16) {
                                    ah =
                                        "<div class='" +
                                        a1 +
                                        V.toTP("jqx-scheduler-month-cell") +
                                        "'>" +
                                        a.jqx.dataFormat.formatdate(ah, af, V.schedulerLocalization) +
                                        "<span style='display: none; float: right; cursor: pointer; width:16px; height: 16px;' class='" +
                                        V.toTP("jqx-icon-arrow-down") +
        ...
        _renderDayWeekAppointments: function () {
            var M = this;
            var aa = M._views[M._view].type;
            var L = M._views[M._view];
            var z = new Array();
            var J = new Array();
            var Y = this.rows;
            var D = M.showAllDayRow;
            var ac = M.getMinutesPerScale();
            if (L.timeRuler && L.timeRuler.showAllDayRow != undefined) {
                D = L.timeRuler.showAllDayRow;
            }
            for (var f = 0; f < this.appointmentsToRender.length; f++) {
                var s = this.appointmentsToRender[f];
                var u = s.from;
                var ad = s.to;
                var U = a.jqx.scheduler.utilities.getEndOfDay(ad);
                var C = u.day();
                var e = s.allDay;
                var F = new Array();
                var r = new Array();
                var p = s.resourceId;
                var h = M._resources.indexOf(p);
                if (M.resources && M.resources.orientation == "none") {
                    h = -1;
                }
                var A = u.toDate().valueOf();
                var k = ad.toDate().valueOf();
                var P = U.toDate().valueOf();
                var ae = function (j, i) {
                    if (j.date < i.date) {
                        return -1;
                    }
                ...
                if ((!s.allDay && s.duration().days() < 1) || !D) {
                    var q = ad.toDate();
                    var H = false;
                    if (q.getHours() == 0 && q.getMinutes() == 0) {
                        H = true;
                    }
                    for (var W = 0; W < M.columnCells.length; W++) {
                        if (!M.columnCells[W]) {
                            continue;
                        }
                        var v = M.columnCells[W];
                        if (M.rtl) {
                            v = M.columnCells[M.columnCells.length - 1 - W];
                        }
                        for (var V = 0; V < v.length; V++) {
                            if (v[V].getAttribute("data-end-date")) {
                                continue;
                            }
                            var n = v[V].getAttribute("data-date");
                            var X = M._getDateByString(n);
                            var E = M._getDateByString(n);
                            E.setMinutes(E.getMinutes() + ac - 1);
                            var m = X.valueOf();
                            var G = E.valueOf();
                            if (m > ad) {
                                continue;
                            }
                            if ((A <= m && m < k) || (A <= G && G < k) || (A >= m && G >= k)) {
                                if (h != -1) {
                                    if (1 + h != v[V].getAttribute("data-view")) {
                                        continue;
                                    }
                                }
                                if (C != X.getDate()) {
                    ...
                    for (var W = 0; W < r.length; W++) {
                        ...
                        var c = M.cellWidth;
                        var d = v[v.length - 1].cell.offsetTop + M.cellHeight;
                        var O = v[0].cell.offsetLeft;
                        var N = v[0].cell.offsetTop;
                        var R = M.getMinutesPerScale();
                        var q = new a.jqx.date(v[v.length - 1].date, M.timeZone).addMinutes(R);
                        var ab = { cells: v, x: O, y: N, height: d - N, width: c, appointment: s, from: new a.jqx.date(v[0].date, M.timeZone), to: q };
                        B.push(ab);
                        z.push(ab);
                    }
                    s.elements = B;
                    ...
                    var v = Y[0].cells;
                    if (this.tableRows > 1) {
                        var T = Y.length / M.tableRows;
                        var b = h * T;
                        v = Y[b].cells;
                    }
                    for (var V = 0; V < v.length; V++) {
                        var n = v[V].getAttribute("data-date");
                        var af = M._getDateByString(n);
                        var X = new a.jqx.date(af, M.timeZone);
                        X = a.jqx.scheduler.utilities.getEndOfDay(X);
                        var m = X.toDate().valueOf();
                        if (m > U) {
                            continue;
                        }
                        if (u <= X && X <= U) {
                            ...
                            if (F.length == 0) {
                                X = a.jqx.scheduler.utilities.getStartOfDay(X);
                            }
                            F.push({ cell: v[V], date: X });
                        }
                    }
                    ...
                    for (var W = 0; W < r.length; W++) {
                        ...
                        var l = a(v[0].cell).position();
                        var c = a(v[v.length - 1].cell).position().left + this.cellWidth - l.left;
                        var d = a(v[v.length - 1].cell).position().top;
                        var O = l.left;
                        var N = l.top;
                        if (this.rtl) {
                            var l = a(v[v.length - 1].cell).position();
                            var O = l.left;
                            var c = a(v[0].cell).position().left + this.cellWidth - l.left;
                        }
                        var S = v[v.length - 1].date;
                        S = new a.jqx.date(a.jqx.scheduler.utilities.getEndOfDay(S), M.timeZone);
                        var ab = { cells: v, x: O, y: N, height: d - N + this.cellHeight, width: c, appointment: s, from: a.jqx.scheduler.utilities.getStartOfDay(new a.jqx.date(v[0].date, M.timeZone)), to: S };
                        B.push(ab);
                        J.push(ab);
                    }
                    s.elements = B;
            ...
            var w = this.getViewStart();
            var Q = this.getViewEnd();
            if (this._resources.length < 2 || this.resources.orientation == "none") {
                ...
                for (var W = 0; W < Z.length; W++) {
                    this._renderAppointmentsInDay(Z[W]);
                }
                this._renderAllDayAppointments(J);
            } else {
                for (var V = 0; V < this._resources.length; V++) {
                    var K = this._resources[V];
                    var Z = new Array();
                    var g = w;
                    var I = 0;
                    while (g < Q) {
                    ...
                    for (var W = 0; W < J.length; W++) {
                        if (J[W].appointment.resourceId == K) {
                            o.push(J[W]);
                        }
                    }
        ...
        _renderAllDayAppointments: function (ar) {
            ...
            for (var ae = 0; ae < B.length; ae++) {
                ...
                if (ao === "") {
                    if (k) {
                        var ao =
                            "<div style='white-space:nowrap;' class='" + ac.toTP("jqx-scheduler-appointment-content") + "'>" + S + "<div class='" + ac.toTP("jqx-scheduler-appointment-inner-content") + "'>" + Q + "</div>" + G + "</div>";
                    } else {
                ...
                if (r) {
                    ...
                    N =
                        ...
                        at +
                        W +
                        ac.toTP("jqx-scheduler-appointment jqx-rc-all") +
                        "' style='position:absolute; z-index: 399; left: " +
                        ak.x +
                        "px; top: " +
                        ak.y +
                        "px; width: " +
                        ...
                        ao +
                        "<div class='" +
                        ac.toTP("jqx-scheduler-appointment-resize-indicator jqx-scheduler-appointment-left-resize-indicator") +
                        "'></div><div class='" +
                        ac.toTP("jqx-scheduler-appointment-resize-indicator jqx-scheduler-appointment-right-resize-indicator") +
                        "'></div>";
                } else {
                    if (b) {
            ...
            for (var aa = 0; aa < B.length; aa++) {
                ...
                if (s) {
                    ...
                    K =
                        ...
                        ao +
                        T +
                        Z.toTP("jqx-scheduler-appointment jqx-rc-all") +
                        "' style='position:absolute; z-index: 399; left: " +
                        ah.x +
                        "px; top: " +
                        ah.y +
                        ...
                        ak +
                        "<div class='" +
                        Z.toTP("jqx-scheduler-appointment-resize-indicator jqx-scheduler-appointment-top-resize-indicator") +
                        "'></div><div class='" +
                        Z.toTP("jqx-scheduler-appointment-resize-indicator jqx-scheduler-appointment-bottom-resize-indicator") +
                        "'></div></div>";
                } else {
                    if (b) {
        ...
        _renderTimelineAppointments: function (t, I) {
            ...
            for (var d = 0; d < this.appointmentsToRender.length; d++) {
                ...
                for (var M = 0; M < s.length; M++) {
                    ...
                    var O = E._getDateByString(k);
                    var h = O.valueOf();
                    var z = E._getDateByString(k);
                ...
                var R = { cellX: G, cellY: F, cellHeight: L, cells: s, x: G, y: F, height: c, width: b, appointment: o, from: new a.jqx.date(s[0].date, E.timeZone), to: n };
        ...
        _renderUITimelineAppointments: function (ap, w, ad) {
            var Z = this;
            var aq = Z._views[Z._view].type;
            var Y = Z._views[Z._view];
            var E = ap;
            var C = 1;
            var Z = this;
            var U = new Array();
            C = Z.getMaxTimelineAppointments(ap, U, w, ad);
            var h = Z.appointmentsMinHeight;
            if (Z.isTouchDevice()) {
                h = Z.touchAppointmentsMinHeight;
            }
            if (Y.appointmentHeight) {
                h = Y.appointmentHeight;
            }
            for (var ao = 0; ao < ap.length; ao++) {
                var g = ap[ao];
                g.row = -1;
                var d = Z.getCollisionAppointments(g, ap);
                d.sort(Z._sortAppointmentsByFrom);
                var t = d.indexOf(g);
                if (t >= 0) {
                    for (var ak = t; ak < d.length; ak++) {
                        d[ak].row = -1;
                    }
                }
                for (var al = 0; al < C; al++) {
                    var o = al;
                    if (al > 30) {
                        break;
                    }
                    for (var Q in d) {
                        ...
                        var V = d[Q];
                        if (V.row == -1 && !Z.isBusyRow(o, d)) {
                            V.row = o;
                            var am = C;
                            var c = Z.getMaxTimelineAppointments(d, U, w, ad);
                            if (am > c) {
                                am = c;
                            }
                            V.rowsCount = am;
            ...
            for (var al = 0; al < E.length; al++) {
                var g = E[al];
                var d = Z.getCollisionAppointments(g, E);
                d.sort(Z._sortAppointmentsByFrom);
                var n = 1;
                for (var Q in d) {
                    if (Q == "indexOf") {
            ...
            for (var ab = 0; ab < E.length; ab++) {
                ...
                g.x += 1;
                g.width -= 5;
                var e = Z._views[Z._view].type;
                var Y = Z._views[Z._view];
                if (e == "timelineMonthView" && Y.appointmentsRenderMode) {
                    if (g.appointment.from.hour() != 0 || g.appointment.to.hour() != 23) {
                        if (!Z.rtl) {
                            var F = parseFloat(Z.cellWidth / 24) * g.appointment.from.hour() + parseFloat(Z.cellWidth / 48) * (g.appointment.from.minute() / 30);
                            var G = parseFloat(Z.cellWidth / 24) * g.appointment.to.hour() + parseFloat(Z.cellWidth / 48) * (g.appointment.to.minute() / 30);
                            g.timewidth = g.width;
                            g.timex = F;
                            g.timewidth -= F;
                            g.timewidth -= Z.cellWidth;
                            g.timewidth += G;
                            if (Y.appointmentsRenderMode == "exactTime") {
                                g.width = g.timewidth;
                                if (Z.date.month() === g.appointment.from.month()) {
                                    g.x += F;
                                } else {
                            ...
                            var F = parseFloat(Z.cellWidth / 24) * g.appointment.to.hour() + parseFloat(Z.cellWidth / 48) * (g.appointment.to.minute() / 30);
                            var G = parseFloat(Z.cellWidth / 24) * g.appointment.from.hour() + parseFloat(Z.cellWidth / 48) * (g.appointment.from.minute() / 30);
                            if (F > 0) {
                                F = Z.cellWidth - F;
                            }
                            if (Y.appointmentsRenderMode == "exactTime") {
                    ...
                    if (Y.appointmentsRenderMode) {
                        if (Y.appointmentsRenderMode == "exactTime") {
                            var af = Z.getMinutesPerScale();
                            if (g.appointment.from.minute() % af != 0) {
                                var av = g.appointment.from.minute() % af;
                                var F = parseFloat(Z.cellWidth / af) * av;
                                if (Z.rtl) {
                                    var F = parseFloat(Z.cellWidth / af) * av;
                                }
                            } else {
                            ...
                            if (g.appointment.to.minute() % af != 0) {
                                var av = g.appointment.to.minute() % af;
                                var G = Z.cellWidth - parseFloat(Z.cellWidth / af) * av;
                                if (Z.rtl) {
                                    var G = Z.cellWidth - parseFloat(Z.cellWidth / af) * av;
                                }
                            } else {
            ...
            for (var ab = 0; ab < E.length; ab++) {
                ...
                var J = "auto";
                var Y = Z._views[Z._view];
                var q = aj.appointment.from;
                var au = aj.appointment.to;
                if (Y.timeRuler && Y.timeRuler.formatString) {
                    J = Y.timeRuler.formatString;
                }
                var X = aj.appointment.background;
                var P = aj.appointment.subject ? aj.appointment.subject : "(No Title)";
                var u = aj.appointment.location;
                if (u && u.length > 1) {
                    u = ", " + u;
                }
                var H = aj.appointment.color;
                var k = aj.appointment.resourceId;
                var ae = Z.getColors(Z._resources.indexOf(k));
                var ag = " data-resourceId='" + k + "' ";
                var T = aj.appointment.borderColor;
                if (!X) {
                    X = ae.background;
                }
                if (!T) {
                ...
                var b = aj.appointment.isRecurrentAppointment();
                var s = aj.appointment.isException();
                var an = "";
                var v = Z.toTP("jqx-scheduler-appointment-status");
                var O = "";
                var M = Z.statuses[aj.appointment.status];
                var l = false;
                if (M) {
                    if (M == "transparent") {
                        l = false;
                    } else {
                        O = "<div style='background: " + M + "; border-right-color: " + T + "' class='" + v + "'></div>";
                        if (M == "tentative") {
                            v = Z.toTP("jqx-scheduler-appointment-status jqx-scheduler-appointment-status-stripes");
                            O = "<div style='background-color: " + T + "; border-right-color: " + T + "' class='" + v + "'></div>";
                        }
                        l = true;
                    }
                }
                var A = "";
                if (Z.rtl) {
                    var v = Z.toTP("jqx-scheduler-appointment-status-rtl jqx-scheduler-appointment-status");
                    O = "<div style='background: " + M + "; border-left-color: " + T + "' class='" + v + "'></div>";
                    if (M == "tentative") {
                        v = Z.toTP("jqx-scheduler-appointment-status-rtl jqx-scheduler-appointment-status jqx-scheduler-appointment-status-stripes");
                        O = "<div style='background-color: " + T + "; border-left-color: " + T + "' class='" + v + "'></div>";
                    }
                    A = O;
                    O = "";
                }
                ...
                var L = P + "<br/>" + u;
                if (Z.renderAppointment) {
                    var at = Z.renderAppointment({
                        appointment: aj.appointment.boundAppointment,
                        textColor: H,
                        background: X,
                        borderColor: T,
                        html: L,
                    ...
                    if (at) {
                        ...
                        if (at.style != "") {
                            var ae = Z.getAppointmentColors(at.style);
                            X = ae.background;
                            T = ae.border;
                            H = ae.color;
                        }
                ...
                if (an === "") {
                    if (l) {
                        var an = "<div style='white-space:nowrap;' class='" + Z.toTP("jqx-scheduler-appointment-content") + "'>" + O + "<div class='" + Z.toTP("jqx-scheduler-appointment-inner-content") + "'>" + L + "</div>" + A + "</div>";
                    } else {
                        var an = "<div style='white-space:nowrap;' class='" + Z.toTP("jqx-scheduler-appointment-content") + "'><div class='" + Z.toTP("jqx-scheduler-appointment-inner-content") + "'>" + L + "</div></div>";
                    }
                }
                var ar = "";
                if (Z.rtl) {
                    ar = Z.toTP("jqx-rtl jqx-scheduler-appointment-rtl") + " ";
                }
                if (s) {
                    var i = H.toLowerCase() == "white" ? Z.toTP("jqx-icon-recurrence-exception-white") : Z.toTP("jqx-icon-recurrence-exception");
                    I =
                        "<div data-key='" +
                        aj.appointment.id +
                        "'" +
                        ...
                        an +
                        "<div class='" +
                        Z.toTP("jqx-scheduler-appointment-resize-indicator jqx-scheduler-appointment-left-resize-indicator") +
                        "'></div><div class='" +
                        Z.toTP("jqx-scheduler-appointment-resize-indicator jqx-scheduler-appointment-right-resize-indicator") +
                        "'></div>";
                } else {
                    if (b) {
                        var r = H.toLowerCase() == "white" ? Z.toTP("jqx-icon-recurrence-white") : Z.toTP("jqx-icon-recurrence");
                        I =
                            "<div data-key='" +
                            aj.appointment.id +
                            "'" +
                ...
                ai = I;
                var R = a(I);
                R.appendTo(this.table);
                aj.element = R;
                if (this.appointmentTooltips) {
                    if (!aj.appointment.tooltip) {
                        var W = aj.appointment.subject;
                        if (W) {
                            var u = aj.appointment.location;
                            if (u) {
                                W += "\n" + u;
                            }
                            R[0].setAttribute("title", W);
                        }
                    } else {
                        R[0].setAttribute("title", aj.appointment.tooltip);
                    }
                }
            }
            var ah = Z.table.find(".jqx-scheduler-appointment");
            var B = function (m) {
                for (var j = 0; j < ah.length; j++) {
                    var p = ah[j].getAttribute("data-key");
                    if (p == m) {
                        return ah[j];
                    }
                }
            ...
            for (var ab = 0; ab < N.length; ab++) {
                var aj = N[ab];
                var ac = false;
                var R = a(B(aj.appointment.id));
                a.each(aj.cells, function (p) {
                    var m = a(this.cell);
                    var ax = aj.cellY;
                    var aw = aj.cellX;
                    var j = aj.cellHeight;
                    ...
                    m[0].appointments.push({ ui: R, appointment: aj });
                    R = R;
                    if (aj.y + aj.height >= ax + j - 12) {
                        R[0].style.visibility = "hidden";
                        var x = m.find(".jqx-icon-arrow-down");
                        if (x.length > 0) {
                            x[0].style.display = "block";
                            x[0].mousedown = function () {
                                if (Z.openedMonthCellPopup) {
                                    Z.openedMonthCellPopup.remove();
                                }
                                var ay = a("<div></div>");
                                var aB = new a.jqx.date(m.attr("data-date"), Z.timeZone);
                                var aE = a("<div class='" + Z.toTP("jqx-scheduler-month-cell") + "'><span style='float: right; cursor: pointer; width:16px; height: 16px;' class='" + Z.toTP("jqx-icon-close") + "'></span></div>");
                                aE.height(16);
                                aE.find("span")[0].mousedown = function () {
                                    ay.remove();
                                };
                                aE.addClass(Z.toTP("jqx-widget-header"));
                                ay.addClass(Z.toTP("jqx-widget"));
                                ay.addClass(Z.toTP("jqx-window"));
                                ay.addClass(Z.toTP("jqx-scheduler-month-cell-popup"));
                                ay.addClass(Z.toTP("jqx-popup"));
                                var aF = a("<div></div>");
                                ay.append(aE);
                                ay.append(aF);
                                aF.addClass(Z.toTP("jqx-widget-content"));
                                var az = m.width();
                                var aH = 21;
                                for (var aC = 0; aC < m[0].appointments.length; aC++) {
                                    var aA = m[0].appointments[aC].ui.clone(true);
                                    aA.css("left", "3px");
                                    aA.css("top", "0px");
                                    ...
                                    aA.width(az - 6);
                                    aA.click(function (aI) {
                                        var aJ = Z.getJQXAppointmentByElement(Z.getAppointmentElement(aI.target));
                                        Z._raiseEvent("appointmentClick", { appointment: aJ.boundAppointment });
                                    });
                                    aA.dblclick(function (aJ) {
                                        var aK = Z.getJQXAppointmentByElement(Z.getAppointmentElement(aJ.target));
                                        if (!aK.readOnly && !Z.editRecurrenceDialog.jqxWindow("isOpen") && (!Z._editDialog || (Z._editDialog && !Z._editDialog.jqxWindow("isOpen")))) {
                                            var aI = Z._initDialog(aK);
                                            if (aI !== false) {
                                                Z._openDialog();
                                            }
                                        }
                                        Z._raiseEvent("appointmentDoubleClick", { appointment: aK.boundAppointment });
                                    });
                                    aH += aA.outerHeight() + 4;
                                    aF.append(aA);
                                }
                                ...
                                var aG = Z.table.height() - ax - 25;
                                if (aG < j) {
                                    aG = j;
                                }
                                ay.css("max-height", aG);
                                ay.height(aH);
                                ay.width(az);
                                ay.css("z-index", "9999");
                                var aD = m.position();
        ...
        _renderMonthAppointments: function () {
            var M = this;
            var Y = M._views[M._view].type;
            var L = M._views[M._view];
            var C = new Array();
            var W = this.rows;
            var R = 0;
            if (this.host.find(".jqx-scheduler-month-cell").length > 0) {
                R = a(this.host.find(".jqx-scheduler-month-cell")[0]).height();
            }
            for (var e = 0; e < this.appointmentsToRender.length; e++) {
                var t = this.appointmentsToRender[e];
                var w = a.jqx.scheduler.utilities.getStartOfDay(t.from);
                var ab = a.jqx.scheduler.utilities.getEndOfDay(t.to);
                var c = t.allDay;
                var H = new Array();
                var s = new Array();
                var D = w.toDate().valueOf();
                var k = ab.toDate().valueOf();
                var ac = function (j, i) {
                    if (j.date < i.date) {
                        return -1;
                    }
                ...
                var z = -1;
                var q = t.resourceId;
                var h = M._resources.indexOf(q);
                if (M.resources && M.resources.orientation == "none") {
                    h = -1;
                }
                for (var T = 0; T < M.rows.length; T++) {
                    var A = M.rows[T].cells;
                    for (var S = 0; S < A.length; S++) {
                        var n = A[S].getAttribute("data-date");
                        var V = this._getDateByString(n);
                        var l = V.valueOf();
                        if (l > ab) {
                            continue;
                        }
                        A[S].appointments = new Array();
                        if (h != -1) {
                            if (1 + h != A[S].getAttribute("data-view")) {
                                continue;
                            }
                        }
                        if (D <= l && l < k) {
                ...
                for (var T = 0; T < s.length; T++) {
                    ...
                    var O = I.left;
                    var N = I.top + R;
                    var r = a.jqx.scheduler.utilities.getEndOfDay(new a.jqx.date(A[A.length - 1].date, M.timeZone));
                    var F = new a.jqx.date(A[0].date, M.timeZone);
                    if (M.rtl) {
                        var r = a.jqx.scheduler.utilities.getEndOfDay(new a.jqx.date(A[0].date, M.timeZone));
                    ...
                    var Z = { cells: A, cellY: parseInt(I.top), cellX: parseInt(I.left), lastCellY: parseInt(I.top), lastCellX: G, x: O, y: N, height: d, width: b, appointment: t, from: F, to: r };
                    E.push(Z);
                    C.push(Z);
                }
                t.elements = E;
                if (t.rootAppointment) {
                    t.rootAppointment.elements = t.rootAppointment.elements.concat(t.elements);
                }
            }
            ...
            if (this._resources.length < 2 || this.resources.orientation == "none") {
                ...
                for (var T = 0; T < X.length; T++) {
                    if (X[T].length > 0) {
                        ...
                        var u = [];
                        for (var S = 0; S < 7; S++) {
                            var aa = U.filter(function (j) {
                                var i = a.jqx.scheduler.utilities.rangeIntersection(j.from, j.to, f, a.jqx.scheduler.utilities.getEndOfDay(f));
                                return i;
                            });
                            f = f.addDays(1);
                        ...
                        this._renderUIMonthAppointments(u);
                    }
                    p = p.addDays(7);
                    f = p;
                }
            } else {
                for (var S = 0; S < this._resources.length; S++) {
                    var K = this._resources[S];
                    var g = new Array();
                    var X = new Array();
                    var f = B;
                    var J = 0;
                    ...
                    for (var T = 0; T < X.length; T++) {
                        if (X[T].length > 0) {
                            this._renderUIMonthAppointments(X[T]);
                        }
                    }
                }
            }
        ...
        _getMonthAppointmentsPerWeek: function () {
            ...
            for (var e = 0; e < this.appointmentsToRender.length; e++) {
                ...
                for (var S = 0; S < r.length; S++) {
                    ...
                    var X = { cells: A, cellY: parseInt(I.top), cellX: parseInt(I.left), lastCellY: parseInt(I.top), lastCellX: G, x: O, y: N, height: d, width: b, appointment: s, from: F, to: q };
                    E.push(X);
                    C.push(X);
                }
            }
        ...
        _renderUIMonthAppointments: function (ar) {
            ...
            for (var ae = 0; ae < I.length; ae++) {
                ...
                if (ap === "") {
                    if (n) {
                        var ap =
                            "<div style='white-space:nowrap;' class='" + ac.toTP("jqx-scheduler-appointment-content") + "'>" + S + "<div class='" + ac.toTP("jqx-scheduler-appointment-inner-content") + "'>" + Q + "</div>" + F + "</div>";
                    } else {
                ...
                a.each(al.cells, function () {
                    ...
                    m[0].appointments.push({ ui: V, appointment: al });
                            ...
                            p[0].mousedown = function () {
                                ...
                                for (var ax = 0; ax < m[0].appointments.length; ax++) {
                                    ...
                                    aA.click(function (aC) {
                                        ...
                                        ac._raiseEvent("appointmentClick", { appointment: aD.boundAppointment });
                                    });
                                    aA.dblclick(function (aD) {
                                        ...
                                        ac._raiseEvent("appointmentDoubleClick", { appointment: aE.boundAppointment });
                                    });
                                }
        ...
        _sortAppointmentsByFrom: function (b, f) {
            if (b.from.dateData === f.from.dateData) {
                var d = b.to.dateData - b.from.dateData;
                var e = d * 10000;
                var d = f.to.dateData - f.from.dateData;
                var c = d * 10000;
                if (e > c) {
                    return -1;
                }
                                            ...
                                            if (d === "columns" || d === "columnGroups") {
                                                ...
                                                if (d === "selectionMode") {
                                                    ...
                                                    if (d == "touchMode") {
                                                        b._removeHandlers();
                                                        b.touchDevice = null;
                                                        b.vScrollBar.jqxScrollBar({ touchMode: e });
                                                        b.hScrollBar.jqxScrollBar({ touchMode: e });
                                                        b.refresh();
                                                        b._addHandlers();
                                                    } else {
                                                        if (d == "enableHover") {
        ...
        _rendercolumnheader: function (g, h, d, e) {
            ...
            var c =
                '<div style="overflow: hidden; text-overflow: ellipsis; text-align: ' +
                h +
